...
class TTIRBuilder(Builder):
    ...
    # chunked_scaled_dot_product_attention is no longer a dedicated TTIR op: it
    # is a ttcore.composite built from the StableHLO custom_call (issue #8843).
    # The builder support therefore lives on the StableHLO builder, not here.
