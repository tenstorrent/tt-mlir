...
class TTNNBuilder(Builder):
    ...
    def update_cache(
        ...
        *Cache update operation.*
        ...
        return self._op_proxy(
            ...
            [in0, in1, in2],
            ttnn_kwargs={"batch_offset": batch_offset},
            organize_ttnn_args=lambda i, o: (self._get_type(o), i[0], i[1], i[2]),
            organize_golden_args=lambda i, o: (
                self._get_golden_tensor(i[0]),
                self._get_golden_tensor(i[1]),
                self._get_golden_tensor(i[2]),
    ...
    def batch_norm(
        ...
        *Batch normalization operation.*
        ...
        return self._op_proxy(
            ...
            # organize_ttnn_args=lambda i, o: (self._get_type(o), *i, o),
            unit_attrs=unit_attrs,
        )
    ...
    def upsample2d(
        ...
        return self._op_proxy(
            ...
            [in0, in1],
            ttnn_kwargs=kwargs,
            organize_ttnn_args=lambda i, o: (self._get_type(i[1]), i[0], o),
            output_shape=output_shape,
            unit_attrs=unit_attrs,
        )
    ...
    def arange(
        ...
        *Creates a 1-D tensor of sequential values.*
        ...
        return self._op_proxy(
            ...
            organize_ttnn_args=lambda i, o: (self._get_type(o),),
            organize_golden_args=lambda i, o: [i[1]],
            output_shape=shape,
            output_type=self._get_type_from_torch_dtype(
    ...
    def mesh_shard(
        ...
        *Shard a tensor across a device mesh.*
        ...
        return self._op_proxy(
            ttnn.MeshShardOp,
            [input],
            organize_ttnn_args=lambda i, o: (self._get_type(o), i[0]),
            ttnn_kwargs=ttnn_kwargs,
            golden_kwargs=golden_kwargs,
        )
