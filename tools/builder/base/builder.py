...
class Builder:
    ...
    def __init__(
        ...
        self._goldens: Dict[Operand, GoldenFunction] = {}
    ...
    def set_goldens_from_builder_tensor(
        self,
        inputs: Dict[Operand, GoldenFunction],
        outputs: Dict[Operand, GoldenFunction] = None,
    ):
    ...
    def _organize_eltwise_golden(self, inputs: List[Operand]) -> List[GoldenFunction]:
    ...
    def _generate_golden_tensor(
        ...
        return GoldenFunction({0: random_tensor}, mesh_shape=self._mesh_shape)

    def _generate_golden_device_tensor(
        self, loc: str, builder_golden_tensor: GoldenFunction
    ...
    def _create_builder_golden_from_torch_tensor(
        self,
        inputs: Dict[Operand, Union[Callable, torch.Tensor, Dict[int, torch.Tensor]]],
    ) -> Dict[Operand, GoldenFunction]:
        input_goldens: Dict[Operand, GoldenFunction] = {}
    ...
    def _set_goldens(
        self,
        goldens: Dict[Operand, GoldenFunction],
    ):
