...
class Semaphore:
    def set(this, value, core=None, mcast=None):
        return d2m.semaphore_set(this, _asindex(value), _asindex(core), _asindex(mcast))

    def inc(this, value, core=None, mcast=None):
        return d2m.semaphore_inc(this, _asindex(value), _asindex(core), _asindex(mcast))

    def wait(this, value, reset=None):
        return d2m.semaphore_wait(this, _asindex(value), reset_value=_asindex(reset))
