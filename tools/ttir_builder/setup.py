...
class CMakeBuild(build_ext):
    ...
    def build_(self, ext):
        ...
        cmake_args = [
            ...
            "-DTTMLIR_ENABLE_TTIRBUILDER=ON",  # Enable TTIR Builder Build Here
...
ttir_builder_c = TTExtension("ttir_builder")

# Write a small "long" description here:

readme = """
TTIR Builder - Python TTIR Dialect Infrastructure for building MLIR graphs for Tenstorrent Hardware

Please refer to documentation: https://docs.tenstorrent.com/tt-mlir/ttir_builder.html
"""
...
setup(
    ...
    packages=["ttir_builder"],
    package_dir={"ttir_builder": ""},
    ext_modules=[ttir_builder_c],
