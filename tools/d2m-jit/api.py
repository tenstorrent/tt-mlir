            ...
            with ctx, loc:
                ...
                pipeline = ",".join(
                    [
                        ...
                        "d2m-lower-to-layout",
                        # Replicate the post-grid-selection portion of
                        # d2m-fe-pipeline (skips TTIR cleanup and grid passes
                        ...
                        "canonicalize",
                        f"d2m-be-pipeline{{use-tile-matmul={1 if use_tile_matmul else 0}}}",
