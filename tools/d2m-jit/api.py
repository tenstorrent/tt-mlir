...
def logical_left_shift(lhs, rhs):
    ...
    return _eltwise_block(lambda l, r: d2m.tile_logical_left_shift(l.type, l, r), lhs, rhs)

@syntax("logical_right_shift")
def logical_right_shift(lhs, rhs):
    """Block-level elementwise logical (zero-fill) right shift."""
    return _eltwise_block(lambda l, r: d2m.tile_logical_right_shift(l.type, l, r), lhs, rhs)
