...
std::vector<ttnn::Tensor> add(std::vector<ttnn::Tensor> v1, ttnn::Device *v2) {
  ttnn::Tensor v3 = v1[0];
  ttnn::Tensor v4 = v1[1];
  ...
  ttnn::Tensor v7 =
      ttnn::to_layout(v6, ttnn::Layout::TILE, std::nullopt, std::nullopt,
  ...
  ttnn::Tensor v10 =
      ttnn::to_layout(v9, ttnn::Layout::TILE, std::nullopt, std::nullopt,
                      static_cast<::ttnn::Device *>(nullptr));
  ttnn::deallocate(v9, false);
  ttnn::Shape v11 = ttnn::Shape(tt::tt_metal::LegacyShape({
      32,
      32,
  }));
  ttnn::MemoryConfig v12 = ttnn::MemoryConfig(
      ttnn::TensorMemoryLayout::INTERLEAVED, ttnn::BufferType::DRAM);
  ttnn::Tensor v13 =
      ttnn::empty(v11, ttnn::DataType::BFLOAT16, ttnn::Layout::TILE, v2, v12);
  ...
  ttnn::Tensor v16 =
      ttnn::to_layout(v15, ttnn::Layout::ROW_MAJOR, std::nullopt, std::nullopt,
                      static_cast<::ttnn::Device *>(nullptr));
