...
std::tuple<::ttnn::Tensor, ::ttnn::Tensor> create_inputs_for_add() {
  ...
  ::ttnn::Tensor v2 = ttnn::ones(::ttnn::Shape({64, 128}), ::ttnn::DataType::FLOAT32, ::ttnn::Layout::TILE, ::std::nullopt, ::ttnn::MemoryConfig {.memory_layout = ::ttnn::TensorMemoryLayout::INTERLEAVED, .buffer_type = ::ttnn::BufferType::DRAM});
  ...
  ::ttnn::Tensor v4 = ttnn::ones(::ttnn::Shape({64, 128}), ::ttnn::DataType::FLOAT32, ::ttnn::Layout::TILE, ::std::nullopt, ::ttnn::MemoryConfig {.memory_layout = ::ttnn::TensorMemoryLayout::INTERLEAVED, .buffer_type = ::ttnn::BufferType::DRAM});
