...
#ttnn_layout = #ttnn.ttnn_layout<(d0, d1) -> (d0, d1), <1x1>, memref<3x3x!ttcore.tile<32x32, f32>, #l1>, <block_sharded>, core_ranges = <[#ttnn.core_range<(0, 0), (0, 0)>]>>
module {
  ttcore.device_module {
    builtin.module attributes {ttcore.system_desc = #system_desc, ttnn.l1_const_eval_usage = 1024 : ui64} {
      ...
      func.func @e(%arg0: tensor<96x96xf32, #ttnn_layout>) -> tensor<96x96xf32, #ttnn_layout> attributes {tt.function_type = "forward_device"} {
        %0 = "ttnn.exp"(%arg0) : (tensor<96x96xf32, #ttnn_layout>) -> tensor<96x96xf32, #ttnn_layout>
