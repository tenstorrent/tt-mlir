...
add_custom_command(
  ...
  COMMAND cmake --install ${Metalium_BINARY_DIR} --prefix ${TTNN_INSTALL_DIR} --component metalium-runtime
...
add_custom_command(
  ...
  COMMAND cmake --install ${Metalium_BINARY_DIR} --prefix ${TTNN_INSTALL_DIR} --component metalium-dev
...
add_custom_command(
  ...
  DEPENDS ${TTNN_INSTALL_DIR}/.metalium-runtime-installed
  COMMAND cmake --install ${Metalium_BINARY_DIR} --prefix ${TTNN_INSTALL_DIR} --component ttnn-runtime
...
add_custom_command(
  ...
  COMMAND cmake --install ${Metalium_BINARY_DIR} --prefix ${TTNN_INSTALL_DIR} --component ttnn-dev
...
add_custom_command(
  ...
  COMMAND cmake --install ${Metalium_BINARY_DIR} --prefix ${TTNN_INSTALL_DIR}
...
add_custom_command(
  ...
  DEPENDS ${TTNN_INSTALL_DIR}/.ttnn-dev-installed
  # Copy tracy
  COMMAND ${CMAKE_COMMAND} -E copy_directory ${Metalium_SOURCE_DIR}/tt_metal/third_party/tracy/public/tracy ${TTNN_INSTALL_DIR}/include/tracy
  COMMAND ${CMAKE_COMMAND} -E copy_directory ${Metalium_SOURCE_DIR}/tt_metal/third_party/tracy/public/common ${TTNN_INSTALL_DIR}/include/common
  COMMAND ${CMAKE_COMMAND} -E copy_directory ${Metalium_SOURCE_DIR}/tt_metal/third_party/tracy/public/client ${TTNN_INSTALL_DIR}/include/client
  # Copy op-related missing hpp files
  COMMAND ${CMAKE_COMMAND} -DSOURCE_DIR=${Metalium_SOURCE_DIR}/ttnn/cpp/ttnn/operations -DDEST_DIR=${TTNN_INSTALL_DIR}/include/ttnn/operations -P ${CMAKE_CURRENT_SOURCE_DIR}/CopyHppFiles.cmake
  # Copy kernel-related missing hpp/cpp files (needed for kernel compilation in runtime)
  COMMAND ${CMAKE_COMMAND} -DSOURCE_DIR=${Metalium_SOURCE_DIR}/ttnn/cpp/ttnn/operations -DDEST_DIR=${TTNN_INSTALL_DIR}/libexec/tt-metalium/ttnn/cpp/ttnn/operations -P ${CMAKE_CURRENT_SOURCE_DIR}/CopyHppFiles.cmake
  COMMAND ${CMAKE_COMMAND} -DSOURCE_DIR=${Metalium_SOURCE_DIR}/ttnn/cpp/ttnn/operations -DDEST_DIR=${TTNN_INSTALL_DIR}/libexec/tt-metalium/ttnn/cpp/ttnn/operations -P ${CMAKE_CURRENT_SOURCE_DIR}/CopyCppFiles.cmake
  COMMAND ${CMAKE_COMMAND} -E copy_directory ${Metalium_SOURCE_DIR}/tt_metal/api/tt-metalium ${TTNN_INSTALL_DIR}/libexec/tt-metalium/tt_metal/api/tt-metalium
  #
