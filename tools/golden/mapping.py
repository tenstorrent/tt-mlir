...
def logical_left_shift_golden(
    input_tensor: GoldenFunction, shift_tensor: GoldenFunction, **kwargs
) -> GoldenFunction:
    """
...
def silu_golden(input_tensor: GoldenFunction, **kwargs) -> GoldenFunction:
    """
