...
GOLDEN_MAPPINGS: Dict[type, Callable] = {
    ...
    # ttnn.SliceDynamicOp: None,
    # Neural network operations
    ttnn.SoftmaxOp: softmax_golden,
    ttnn.MatmulOp: torch.matmul,
    # ttnn.UpsampleOp: None,
    ttnn.BatchNormInferenceOp: batch_norm_golden,
    # ttnn.BatchNormTrainingOp: None,
    ttnn.RMSNormOp: rms_norm_golden,
    # Tensor creation
    ttnn.ZerosOp: zeros_golden,
    ttnn.OnesOp: ones_golden,
    ttnn.ArangeOp: arange_golden,
    # ttnn.FullOp: ,
    # ttnn.ConstantOp: ,
    # ttnn.RandOp: ,
    # ttnn.EmptyOp: , #***???????
    # Other Operations # Rename?????
    ttnn.QuantizeOp: quantize_golden,
    ttnn.DequantizeOp: torch.dequantize,
    ttnn.RequantizeOp: requantize_golden,
    # ttnn.PointToPointOp: ,
    # ttnn.WriteTensorOp: ,
    # Complex operations
    ...
    # ttnn.PrepareConv2dBiasOp: ,
    ttnn.Conv2dOp: conv2d_golden,
    ttnn.ConvTranspose2dOp: conv_transpose2d_golden,
    # Embedding Operations
    ttnn.EmbeddingOp: embedding_golden,
    ttnn.UpdateCacheOp: update_cache_golden,
    ttnn.FillCacheOp: fill_cache_golden,
    # ttnn.EmbeddingBackwardOp: ,
    # CCL (Collective Communication Library) operations
    ttnn.MeshShardOp: mesh_shard_golden,
    ttnn.AllGatherOp: all_gather_golden,
    ttnn.AllReduceOp: all_reduce_golden,
    ttnn.ReduceScatterOp: reduce_scatter_golden,
    ttnn.CollectivePermuteOp: collective_permute_golden,
    # Special Operations not in yet
    # ttnn.MorehCumSumOp: ,
    # ttnn.ConcatenateHeadsOp: ,
    # ttnn.NLPConcatHeadsDecodeOp: ,
    # ttnn.SplitQueryKeyValueAndSplitHeadsOp: ,
    # ttnn.SortOp:
    # idk
    # ttnn.ScatterOp: ,
    ttnn.TypecastOp: typecast_golden,
    # ttnn.ToDTypeOp: , # should be here???
    # Trace Operations
    # ttnn.BeginTraceCaptureOp: ,
    # ttnn.EndTraceCaptureOp: ,
    # ttnn.ExecuteTraceOp: ,
    # ttnn.CaptureOrExecuteTraceOp: ,
    # Advanced Operations # should be here???
    # ttnn.RotaryEmbeddingLlamaOp: ,
    # ttnn.NLPConcatHeadsOp: ,
    # ttnn.DumpTensorOp: ,
    # ttnn.LoadTensorOp: ,
    # ttnn.ScaledDotProductAttentionDecodeOp: ,
    # ttnn.ScaledDotProductAttentionOp: ,
