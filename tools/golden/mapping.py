...
def rearrange_golden(input_tensor: GoldenMapTensor, pattern: str, **kwargs) -> GoldenMapTensor:
    """
    ...
    **kwargs : dict
    ...
    result = GoldenMapTensor.__torch_function__(torch_fn, (GoldenMapTensor,), args=(input_tensor,))
    return result
