...
from runner import KernelBench, PatternTest, TensorSpec
...
def rmsnorm_run(kernel, inputs, tensors, grid_shape):
...
KERNEL_BENCHES = {
    "rmsnorm_multicore_h3200_g4": KernelBench(
...
if __name__ == "__main__":
    ...
    actual, expected = run_bench(KERNEL_BENCHES["rmsnorm_multicore_h3200_g4"])
