...
test_view_layout_identity_round_trip()
test_view_identity_round_trip()
test_view_raises_on_non_permutation()
test_view_raises_on_rank_mismatch()
test_permute_happy()
test_permute_rejects_torch_tensor()
test_permute_rejects_wrong_arity()
test_permute_rejects_non_permutation()
test_to_host_on_view_raises()
test_to_layout_clears_view_flag()
print("PASS views")
