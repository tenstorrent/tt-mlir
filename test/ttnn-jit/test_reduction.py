...
# ------------------------------------------------------------
@pytest.mark.parametrize("shape, max_grid", L1_REDUCTION_SHAPES)
...
def test_reductions_l1(device, shape, max_grid, dim, op_name, op_func, dtype):
    ...
    if op_name == "sum" and dtype == torch.bfloat16:
        pytest.xfail("failing allclose for some shapes for bfloat16")
