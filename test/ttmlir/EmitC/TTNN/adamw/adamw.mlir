...
module {
  func.func @adamw(%param: tensor<1x1x64x64xf32>, %grad: tensor<1x1x64x64xbf16>,
    ...
    // CHECK: {{^ *}}ttml::metal::adamw({{v[0-9]+}}, {{v[0-9]+}}, {{v[0-9]+}}, {{v[0-9]+}}, ::std::nullopt, [[LR]], 0.899999976, 0.999000012, [[BETA1]], [[BETA2]], 9.99999993E-9, 0.00999999977, ::ttml::metal::StochasticRounding::Disabled);
