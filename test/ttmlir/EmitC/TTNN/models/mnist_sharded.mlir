...
func.func @mnist_fwd(%arg0: tensor<1x784xf32, #ttnn_layout>, %arg1: tensor<1x10xf32, #ttnn_layout1>, %arg2: tensor<256x10xf32, #ttnn_layout2>, %arg3: tensor<1x256xf32, #ttnn_layout3>, %arg4: tensor<784x256xf32, #ttnn_layout4>) -> tensor<1x10xf32, #ttnn_layout5> {
  ...
  %2 = "ttnn.add"(%1, %arg3) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<1x256xf32, #ttnn_layout5>, tensor<1x256xf32, #ttnn_layout3>) -> tensor<1x256xf32, #ttnn_layout5>
  ...
  %7 = "ttnn.add"(%6, %arg1) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<1x10xf32, #ttnn_layout5>, tensor<1x10xf32, #ttnn_layout1>) -> tensor<1x10xf32, #ttnn_layout5>
