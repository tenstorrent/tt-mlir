...
func.func @prepare_conv2d_bias_asymmetric_padding_bf16(%arg0: tensor<1x1x1x128xbf16, #ttnn_layout_bias_bf16>) -> tensor<1x1x1x128xbf16, #ttnn_layout_prepared_bias_bf16> {
  ...
  return %1 : tensor<1x1x1x128xbf16, #ttnn_layout_prepared_bias_bf16>
}

#ttnn_layout_bias_f32 = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0 + d1 + d2, d3), <1x1>, memref<1x64xf32, #system_memory>>
#ttnn_layout_prepared_bias_f32 = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0 * 32 + d1 * 32 + d2, d3), <1x1>, memref<1x2x!ttcore.tile<32x32, f32>, #dram>, <interleaved>>
#conv2d_config_f32 = #ttnn.conv2d_config<weights_dtype = f32>

func.func @prepare_conv2d_bias_f32(%arg0: tensor<1x1x1x64xf32, #ttnn_layout_bias_f32>) -> tensor<1x1x1x64xf32, #ttnn_layout_prepared_bias_f32> {
  %0 = "ttnn.get_device"() <{mesh_offset = #ttnn<mesh_offset 0x0>, mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
  %1 = "ttnn.prepare_conv2d_bias"(%arg0, %0)
      <{
        batch_size = 1 : i32,
  ...
  return %1 : tensor<1x1x1x64xf32, #ttnn_layout_prepared_bias_f32>
}
