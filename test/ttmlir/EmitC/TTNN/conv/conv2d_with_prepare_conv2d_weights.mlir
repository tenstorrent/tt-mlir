...
#ttnn_layout6 = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0 * 1024 + d1 * 1024 + d2, d3), <1x1>, memref<32x2x!tt.tile<32x32, bf16>, #system_memory>>
...
func.func @conv2d_with_prepare_conv2d_weights(%arg0: tensor<1x32x32x64xbf16, #ttnn_layout>, %arg1: tensor<64x16x3x3xbf16, #ttnn_layout1>, %arg2: tensor<1x1x1x64xbf16, #ttnn_layout3>) -> tensor<1x8x4x64xbf16, #ttnn_layout4> {
  ...
  %5 = "ttnn.to_device"(%4, %0) <{memory_config = #ttnn.memory_config<#dram, <<1024x64>>, <interleaved>>}> : (tensor<1x1x1024x64xbf16, #ttnn_layout7>, !ttnn.device) -> tensor<1x1x1024x64xbf16, #ttnn_layout8>
