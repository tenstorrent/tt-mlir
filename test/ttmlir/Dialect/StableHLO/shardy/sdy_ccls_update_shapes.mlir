...
// CHECK: sdy.return %1, %2 : tensor<2048xbf16>, tensor<7x512xbf16>
...
// CHECK: sdy.return %1, %2, %3, %4 : tensor<544x4096xbf16>, tensor<544x256xbf16>, tensor<544x256xbf16>, tensor<272x256xbf16>
