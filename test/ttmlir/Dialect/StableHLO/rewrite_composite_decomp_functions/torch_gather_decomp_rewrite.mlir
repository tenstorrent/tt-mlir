...
module @Rank2_Dim0_MatchingAxes {
  func.func @main(%arg0: tensor<5x3xf32>, %arg1: tensor<2x3xi32>) -> tensor<2x3xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 0 : i64}, decomposition = @tenstorrent.gather_dim.impl_d0_match} : (tensor<5x3xf32>, tensor<2x3xi32>) -> tensor<2x3xf32>
    return %0 : tensor<2x3xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_d0_match
  ...
  func.func private @tenstorrent.gather_dim.impl_d0_match(%arg0: tensor<5x3xf32>, %arg1: tensor<2x3xi32>) -> tensor<2x3xf32> {
...
module @Rank2_Dim1_MatchingAxes {
  func.func @main(%arg0: tensor<3x5xbf16>, %arg1: tensor<3x2xi64>) -> tensor<3x2xbf16> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 1 : i64}, decomposition = @tenstorrent.gather_dim.impl_d1_match} : (tensor<3x5xbf16>, tensor<3x2xi64>) -> tensor<3x2xbf16>
    return %0 : tensor<3x2xbf16>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_d1_match
  // CHECK-NOT:  stablehlo.slice
  ...
  // CHECK-SAME: index_vector_dim = 2
  // CHECK-SAME: slice_sizes = array<i64: 1, 1>
  func.func private @tenstorrent.gather_dim.impl_d1_match(%arg0: tensor<3x5xbf16>, %arg1: tensor<3x2xi64>) -> tensor<3x2xbf16> {
...
module @Rank2_Dim0_NonDimAxisLarger {
  func.func @main(%arg0: tensor<5x32xf32>, %arg1: tensor<2x16xi32>) -> tensor<2x16xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 0 : i64}, decomposition = @tenstorrent.gather_dim.impl_d0_slice} : (tensor<5x32xf32>, tensor<2x16xi32>) -> tensor<2x16xf32>
    return %0 : tensor<2x16xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_d0_slice
  ...
  // CHECK:      return %[[G]]
  func.func private @tenstorrent.gather_dim.impl_d0_slice(%arg0: tensor<5x32xf32>, %arg1: tensor<2x16xi32>) -> tensor<2x16xf32> {
...
module @Rank2_Dim1_NonDimAxisLarger {
  func.func @main(%arg0: tensor<10x5xbf16>, %arg1: tensor<6x3xi64>) -> tensor<6x3xbf16> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 1 : i64}, decomposition = @tenstorrent.gather_dim.impl_d1_slice} : (tensor<10x5xbf16>, tensor<6x3xi64>) -> tensor<6x3xbf16>
    return %0 : tensor<6x3xbf16>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_d1_slice
  ...
  func.func private @tenstorrent.gather_dim.impl_d1_slice(%arg0: tensor<10x5xbf16>, %arg1: tensor<6x3xi64>) -> tensor<6x3xbf16> {
...
module @NegativeDim_NegOne_Rank2 {
  func.func @main(%arg0: tensor<4x6xf32>, %arg1: tensor<4x3xi32>) -> tensor<4x3xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = -1 : i64}, decomposition = @tenstorrent.gather_dim.impl_neg1} : (tensor<4x6xf32>, tensor<4x3xi32>) -> tensor<4x3xf32>
    return %0 : tensor<4x3xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_neg1
  // CHECK-NOT:  stablehlo.slice
  // CHECK:      "stablehlo.gather"
  // CHECK-SAME: collapsed_slice_dims = [1]
  // CHECK-SAME: operand_batching_dims = [0]
  ...
  // CHECK-SAME: start_index_map = [1]
  // CHECK-SAME: index_vector_dim = 2
  func.func private @tenstorrent.gather_dim.impl_neg1(%arg0: tensor<4x6xf32>, %arg1: tensor<4x3xi32>) -> tensor<4x3xf32> {
...
module @NegativeDim_NegTwo_Rank3 {
  func.func @main(%arg0: tensor<2x5x4xf32>, %arg1: tensor<2x3x4xi32>) -> tensor<2x3x4xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = -2 : i64}, decomposition = @tenstorrent.gather_dim.impl_neg2} : (tensor<2x5x4xf32>, tensor<2x3x4xi32>) -> tensor<2x3x4xf32>
    return %0 : tensor<2x3x4xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_neg2
  // CHECK-NOT:  stablehlo.slice
  ...
  func.func private @tenstorrent.gather_dim.impl_neg2(%arg0: tensor<2x5x4xf32>, %arg1: tensor<2x3x4xi32>) -> tensor<2x3x4xf32> {
...
module @Rank3_DimFirst {
  func.func @main(%arg0: tensor<6x4x3xf32>, %arg1: tensor<2x4x3xi32>) -> tensor<2x4x3xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 0 : i64}, decomposition = @tenstorrent.gather_dim.impl_3dfirst} : (tensor<6x4x3xf32>, tensor<2x4x3xi32>) -> tensor<2x4x3xf32>
    return %0 : tensor<2x4x3xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_3dfirst
  // CHECK-NOT:  stablehlo.slice
  // CHECK:      "stablehlo.gather"
  // CHECK-SAME: collapsed_slice_dims = [0]
  ...
  // CHECK-SAME: index_vector_dim = 3
  // CHECK-SAME: slice_sizes = array<i64: 1, 1, 1>
  func.func private @tenstorrent.gather_dim.impl_3dfirst(%arg0: tensor<6x4x3xf32>, %arg1: tensor<2x4x3xi32>) -> tensor<2x4x3xf32> {
...
module @Rank3_DimMiddle {
  func.func @main(%arg0: tensor<2x7x4xf32>, %arg1: tensor<2x3x4xi32>) -> tensor<2x3x4xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 1 : i64}, decomposition = @tenstorrent.gather_dim.impl_3dmid} : (tensor<2x7x4xf32>, tensor<2x3x4xi32>) -> tensor<2x3x4xf32>
    return %0 : tensor<2x3x4xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_3dmid
  // CHECK-NOT:  stablehlo.slice
  // CHECK:      "stablehlo.gather"
  // CHECK-SAME: collapsed_slice_dims = [1]
  // CHECK-SAME: operand_batching_dims = [0, 2]
  ...
  // CHECK-SAME: start_index_map = [1]
  // CHECK-SAME: index_vector_dim = 3
  func.func private @tenstorrent.gather_dim.impl_3dmid(%arg0: tensor<2x7x4xf32>, %arg1: tensor<2x3x4xi32>) -> tensor<2x3x4xf32> {
    %0 = stablehlo.constant dense<0.000000e+00> : tensor<2x3x4xf32>
    return %0 : tensor<2x3x4xf32>
  }
}
...
module @Rank3_DimLast {
  func.func @main(%arg0: tensor<2x4x6xf32>, %arg1: tensor<2x4x3xi32>) -> tensor<2x4x3xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 2 : i64}, decomposition = @tenstorrent.gather_dim.impl_3dlast} : (tensor<2x4x6xf32>, tensor<2x4x3xi32>) -> tensor<2x4x3xf32>
    return %0 : tensor<2x4x3xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_3dlast
  // CHECK-NOT:  stablehlo.slice
  ...
  // CHECK-SAME: index_vector_dim = 3
  // CHECK-SAME: slice_sizes = array<i64: 1, 1, 1>
  func.func private @tenstorrent.gather_dim.impl_3dlast(%arg0: tensor<2x4x6xf32>, %arg1: tensor<2x4x3xi32>) -> tensor<2x4x3xf32> {
    %0 = stablehlo.constant dense<0.000000e+00> : tensor<2x4x3xf32>
    return %0 : tensor<2x4x3xf32>
  }
}
...
module @Rank3_MixedNonDimAxisSizes {
  func.func @main(%arg0: tensor<5x8x7xf32>, %arg1: tensor<5x6x3xi32>) -> tensor<5x6x3xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 0 : i64}, decomposition = @tenstorrent.gather_dim.impl_mixed} : (tensor<5x8x7xf32>, tensor<5x6x3xi32>) -> tensor<5x6x3xf32>
  ...
  func.func private @tenstorrent.gather_dim.impl_mixed(%arg0: tensor<5x8x7xf32>, %arg1: tensor<5x6x3xi32>) -> tensor<5x6x3xf32> {
...
module @Rank2_IndexLargerOnDim {
  func.func @main(%arg0: tensor<4x3xf32>, %arg1: tensor<4x9xi32>) -> tensor<4x9xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 1 : i64}, decomposition = @tenstorrent.gather_dim.impl_bigidx} : (tensor<4x3xf32>, tensor<4x9xi32>) -> tensor<4x9xf32>
    return %0 : tensor<4x9xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_bigidx
  // CHECK-NOT:  stablehlo.slice
  ...
  func.func private @tenstorrent.gather_dim.impl_bigidx(%arg0: tensor<4x3xf32>, %arg1: tensor<4x9xi32>) -> tensor<4x9xf32> {
...
module @Rank4_DimMiddle {
  func.func @main(%arg0: tensor<2x3x8x5xf32>, %arg1: tensor<2x3x4x5xi32>) -> tensor<2x3x4x5xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 2 : i64}, decomposition = @tenstorrent.gather_dim.impl_4d} : (tensor<2x3x8x5xf32>, tensor<2x3x4x5xi32>) -> tensor<2x3x4x5xf32>
    return %0 : tensor<2x3x4x5xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_4d
  // CHECK-NOT:  stablehlo.slice
  ...
  func.func private @tenstorrent.gather_dim.impl_4d(%arg0: tensor<2x3x8x5xf32>, %arg1: tensor<2x3x4x5xi32>) -> tensor<2x3x4x5xf32> {
...
module @Rank1 {
  func.func @main(%arg0: tensor<5xf32>, %arg1: tensor<2xi32>) -> tensor<2xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 0 : i64}, decomposition = @tenstorrent.gather_dim.impl_rank1} : (tensor<5xf32>, tensor<2xi32>) -> tensor<2xf32>
    return %0 : tensor<2xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_rank1
  // CHECK-NOT:  stablehlo.slice
  ...
  func.func private @tenstorrent.gather_dim.impl_rank1(%arg0: tensor<5xf32>, %arg1: tensor<2xi32>) -> tensor<2xf32> {
...
module @GatherDefaultAttrs {
  ...
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_default
  // CHECK:      "stablehlo.gather"
  // CHECK-SAME: collapsed_slice_dims = [0]
  // CHECK-SAME: operand_batching_dims = [1]
  // CHECK-SAME: start_index_map = [0]
...
module @IndexType_Ui32 {
  ...
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_ui32
...
module @IndexType_Ui16 {
  func.func @main(%arg0: tensor<5x3xf32>, %arg1: tensor<2x3xui16>) -> tensor<2x3xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 0 : i64}, decomposition = @tenstorrent.gather_dim.impl_ui16} : (tensor<5x3xf32>, tensor<2x3xui16>) -> tensor<2x3xf32>
    return %0 : tensor<2x3xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_ui16
  // CHECK:      stablehlo.reshape {{.*}} : (tensor<2x3xui16>) -> tensor<2x3x1xui16>
  // CHECK:      "stablehlo.gather"
  // CHECK-SAME: (tensor<5x3xf32>, tensor<2x3x1xui16>) -> tensor<2x3xf32>
  func.func private @tenstorrent.gather_dim.impl_ui16(%arg0: tensor<5x3xf32>, %arg1: tensor<2x3xui16>) -> tensor<2x3xf32> {
    %0 = stablehlo.constant dense<0.000000e+00> : tensor<2x3xf32>
    return %0 : tensor<2x3xf32>
  }
}
...
module @Bf16Input_I64Index_WithSlice {
  func.func @main(%arg0: tensor<8x32xbf16>, %arg1: tensor<8x16xi64>) -> tensor<8x16xbf16> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 0 : i64}, decomposition = @tenstorrent.gather_dim.impl_bf16} : (tensor<8x32xbf16>, tensor<8x16xi64>) -> tensor<8x16xbf16>
    return %0 : tensor<8x16xbf16>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_bf16
  ...
  func.func private @tenstorrent.gather_dim.impl_bf16(%arg0: tensor<8x32xbf16>, %arg1: tensor<8x16xi64>) -> tensor<8x16xbf16> {
...
module @GatherSparseGradAttr {
  func.func @main(%arg0: tensor<5x3xf32>, %arg1: tensor<2x3xi32>) -> tensor<2x3xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 0 : i64, sparse_grad = false}, decomposition = @tenstorrent.gather_dim.impl_sparsegrad} : (tensor<5x3xf32>, tensor<2x3xi32>) -> tensor<2x3xf32>
    return %0 : tensor<2x3xf32>
  }
  // CHECK-LABEL: func.func private @tenstorrent.gather_dim.impl_sparsegrad
  // CHECK:      "stablehlo.gather"
  // CHECK-SAME: collapsed_slice_dims = [0]
  // CHECK-SAME: operand_batching_dims = [1]
  func.func private @tenstorrent.gather_dim.impl_sparsegrad(%arg0: tensor<5x3xf32>, %arg1: tensor<2x3xi32>) -> tensor<2x3xf32> {
    %0 = stablehlo.constant dense<0.000000e+00> : tensor<2x3xf32>
    return %0 : tensor<2x3xf32>
  }
}
...
module @PreservesFunctionSignature {
  func.func @main(%arg0: tensor<5x3xf32>, %arg1: tensor<2x3xi32>) -> tensor<2x3xf32> {
    %0 = stablehlo.composite "tenstorrent.gather_dim" %arg0, %arg1 {composite_attributes = {dim = 0 : i64}, decomposition = @tenstorrent.gather_dim.impl_sig} : (tensor<5x3xf32>, tensor<2x3xi32>) -> tensor<2x3xf32>
    return %0 : tensor<2x3xf32>
  }
  // CHECK:      func.func private @tenstorrent.gather_dim.impl_sig
  // CHECK-SAME: (%{{.*}}: tensor<5x3xf32>, %{{.*}}: tensor<2x3xi32>) -> tensor<2x3xf32>
  func.func private @tenstorrent.gather_dim.impl_sig(%arg0: tensor<5x3xf32>, %arg1: tensor<2x3xi32>) -> tensor<2x3xf32> {
    %0 = stablehlo.constant dense<0.000000e+00> : tensor<2x3xf32>
    return %0 : tensor<2x3xf32>
  }
}
