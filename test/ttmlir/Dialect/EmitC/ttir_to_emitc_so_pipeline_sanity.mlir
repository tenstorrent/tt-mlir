...
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path%" --tt-unwrap-device-module --ttnn-tuplify-tensors --convert-ttnn-to-emitc %s > %t_indirect.mlir
