...
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path%" --ttnn-to-emitc-device-pipeline="target-dylib=true" --emitc-link-modules -o %t_indirect.mlir %s
