...
func.func public @test_avgpool2d_workaround(%arg0: tensor<8x256x6x6xf32>) -> tensor<8x256x8x8xf32> {
  ...
  %7 = "ttir.broadcast"(%5) <{broadcast_dimensions = array<i64: 8, 256, 8, 8>}> : (tensor<1x1x1x1xf32>) -> tensor<8x256x8x8xf32>
  %9 = "ttir.typecast"(%0) : (tensor<1xi32>) -> tensor<1xf32>
  %11 = "ttir.reshape"(%9) <{shape = [1 : i32, 1 : i32, 1 : i32, 1 : i32]}> : (tensor<1xf32>) -> tensor<1x1x1x1xf32>
  %13 = "ttir.broadcast"(%11) <{broadcast_dimensions = array<i64: 8, 256, 8, 8>}> : (tensor<1x1x1x1xf32>) -> tensor<8x256x8x8xf32>
