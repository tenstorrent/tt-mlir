...
func.func public @test_avgpool2d_workaround(%arg0: tensor<8x256x6x6xf32>) -> tensor<8x256x8x8xf32> {
  ...
  %2 = ttir.empty() : tensor<8x256x8x8xf32>
  ...
  // CHECK-SAME: (tensor<8x6x6x256xf32>, tensor<8x8x8x256xf32>)
  ...
  // CHECK-SAME: (tensor<8x8x8x256xf32>, tensor<8x256x8x8xf32>)
  ...
  // CHECK-SAME: (tensor<8x256x8x8xf32>, tensor<8x256x8x8xf32>, tensor<8x256x8x8xf32>)
  // CHECK-SAME: -> tensor<8x256x8x8xf32>
