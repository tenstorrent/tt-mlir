...
module @test_convolution3d {
    // Test basic 3D convolution decomposition with NDHWC layout
    func.func @test_conv3d_simple() -> tensor<1x6x26x26x16xbf16> {
    %0 = ttir.empty() : tensor<1x8x28x28x4xbf16>
    %1 = ttir.empty() : tensor<16x4x3x3x3xbf16>
    %2 = ttir.empty() : tensor<1x6x26x26x16xbf16>
    // CHECK: "ttir.conv3d"
    ...
    return %3 : tensor<1x6x26x26x16xbf16>
  }
    ...
    func.func @test_conv3d_stride_padding() -> tensor<1x4x14x14x32xbf16> {
    %0 = ttir.empty() : tensor<1x8x28x28x16xbf16>
    %1 = ttir.empty() : tensor<32x16x3x3x3xbf16>
    %2 = ttir.empty() : tensor<1x4x14x14x32xbf16>
    // CHECK: "ttir.conv3d"
    %3 = "ttir.convolution"(%0, %1, %2) <{
        batch_group_count = 1 : i64,
        convolution_layout = #ttir<
    ...
    return %3 : tensor<1x4x14x14x32xbf16>
  }

    // Test 3D convolution with bias
    func.func @test_conv3d_with_bias(%bias: tensor<1x1x1x1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = ttir.empty() : tensor<1x8x28x28x4xbf16>
    %1 = ttir.empty() : tensor<16x4x3x3x3xbf16>
    %2 = ttir.empty() : tensor<1x6x26x26x16xbf16>
    // CHECK: "ttir.conv3d"
