...
module attributes {} {
  ...
  func.func @test_avgpool2d_kernel_1x1_stride_1x1(%arg0: tensor<1x192x28x28xbf16>) -> tensor<1x192x28x28xbf16> {
    ...
    // CHECK-SAME: -> tensor<1x28x28x192xbf16>
    %1 = "ttir.pooling"(%arg0, %0) <{base_dilations = array<i64: 1, 1, 1, 1>, operandSegmentSizes = array<i32: 1, 1>, padding = array<i64: 0, 0, 0, 0, 0, 0, 0, 0>, pooling_method = #ttir<pooling_method Average>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 1>, window_strides = array<i64: 1, 1, 1, 1>, ceil_mode = false, ceil_mode_padding = array<i64: 0, 0, 0, 0, 0, 0, 0, 0>}> : (tensor<1x192x28x28xbf16>, tensor<1x192x28x28xbf16>) -> tensor<1x192x28x28xbf16>
  ...
  func.func @test_avgpool2d_kernel_3x3_stride_1x1(%arg0: tensor<1x256x28x28xbf16>) -> tensor<1x256x28x28xbf16> {
    ...
    // CHECK-SAME: -> tensor<1x28x28x256xbf16>
    %1 = "ttir.pooling"(%arg0, %0) <{base_dilations = array<i64: 1, 1, 1, 1>, operandSegmentSizes = array<i32: 1, 1>, padding = array<i64: 0, 0, 0, 0, 1, 1, 1, 1>, pooling_method = #ttir<pooling_method Average>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 1, 1>, ceil_mode = false, ceil_mode_padding = array<i64: 0, 0, 0, 0, 0, 0, 0, 0>}> : (tensor<1x256x28x28xbf16>, tensor<1x256x28x28xbf16>) -> tensor<1x256x28x28xbf16>
    // CHECK: %[[RET:[0-9]+]] = "ttir.permute"(%[[AVGPOOL]],
    // CHECK-SAME: permutation = array<i64: 0, 3, 1, 2>
  ...
  func.func @test_avgpool2d_kernel_2x1_stride_1x1(%arg0: tensor<1x192x28x28xbf16>) -> tensor<1x192x27x28xbf16> {
    ...
    %1 = "ttir.pooling"(%arg0, %0) <{base_dilations = array<i64: 1, 1, 1, 1>, operandSegmentSizes = array<i32: 1, 1>, padding = array<i64: 0, 0, 0, 0, 0, 0, 0, 0>, pooling_method = #ttir<pooling_method Average>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 2, 1>, window_strides = array<i64: 1, 1, 1, 1>, ceil_mode = false, ceil_mode_padding = array<i64: 0, 0, 0, 0, 0, 0, 0, 0>}> : (tensor<1x192x28x28xbf16>, tensor<1x192x27x28xbf16>) -> tensor<1x192x27x28xbf16>
    // CHECK: %[[RET:[0-9]+]] = "ttir.permute"(%[[AVGPOOL]],
    // CHECK-SAME: permutation = array<i64: 0, 3, 1, 2>
  ...
  func.func @test_avgpool2d_kernel_1x2_stride_3x1(%arg0: tensor<1x192x28x28xbf16>) -> tensor<1x192x10x27xbf16> {
    ...
    %1 = "ttir.pooling"(%arg0, %0) <{base_dilations = array<i64: 1, 1, 1, 1>, operandSegmentSizes = array<i32: 1, 1>, padding = array<i64: 0, 0, 0, 0, 0, 0, 0, 0>, pooling_method = #ttir<pooling_method Average>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 2>, window_strides = array<i64: 1, 1, 3, 1>, ceil_mode = false, ceil_mode_padding = array<i64: 0, 0, 0, 0, 0, 0, 0, 0>}> : (tensor<1x192x28x28xbf16>, tensor<1x192x10x27xbf16>) -> tensor<1x192x10x27xbf16>
    // CHECK: %[[RET:[0-9]+]] = "ttir.permute"(%[[AVGPOOL]],
    // CHECK-SAME: permutation = array<i64: 0, 3, 1, 2>
