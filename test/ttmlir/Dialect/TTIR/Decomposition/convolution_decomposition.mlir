...
module @test_convolution {
    func.func @test_conv_output_order_not_nchw(%arg0: tensor<1x32x26x26xbf16>, %arg1: tensor<1x64x24x24xbf16>) -> tensor<3x3x32x64xbf16> {
    // CHECK: "ttir.permute"
    // CHECK-SAME: <{permutation = array<i64: 1, 2, 3, 0>}>
    // CHECK: "ttir.permute"
    // CHECK-SAME: <{permutation = array<i64: 1, 0, 2, 3>}>
    %3 = "ttir.convolution"(%arg0, %arg1) <{
        ...
        }> : (tensor<1x32x26x26xbf16>, tensor<1x64x24x24xbf16>) -> tensor<3x3x32x64xbf16>
    // CHECK: "ttir.permute"
