...
module {
  func.func @test_axis_out_of_range_requantize(%arg0: tensor<1x3x320x320x!quant.uniform<i32:f32:4, {0.1, 0.2, 0.3}>>) -> tensor<1x3x320x320x!quant.uniform<i32:f32:4, {0.2, 0.3, 0.4}>> {
    ...
    %1 = "ttir.requantize"(%arg0) : (tensor<1x3x320x320x!quant.uniform<i32:f32:4, {0.1, 0.2, 0.3}>>, tensor<1x3x320x320x!quant.uniform<i32:f32:4, {0.2, 0.3) -> tensor<1x3x320x320x!quant.uniform<i32:f32:4, {0.2, 0.3, 0.4}>>
...
module {
  func.func @test_mismatched_scales_requantize(%arg0: tensor<1x3x320x320x!quant.uniform<i32:f32:1, {0.1, 0.2}>>) -> tensor<1x3x320x320x!quant.uniform<i32:f32:1, {0.3, 0.4, 0.5}>> {
    ...
    %1 = "ttir.requantize"(%arg0) : (tensor<1x3x320x320x!quant.uniform<i32:f32:1, {0.1, 0.2}>>, tensor<1x3x320x320x!quant.uniform<i32:f32:1, {0.3, 0.4) -> tensor<1x3x320x320x!quant.uniform<i32:f32:1, {0.3, 0.4, 0.5}>>
...
module {
  func.func @test_zero_point_out_of_range_requantize(%arg0: tensor<1x3x320x320x!quant.uniform<i8:f32:1, {0.1:0, 0.2:0, 0.3:300}>>) -> tensor<1x3x320x320x!quant.uniform<i8:f32:1, {0.3:0, 0.4:0, 0.5:0}>> {
    ...
    %1 = "ttir.requantize"(%arg0) : (tensor<1x3x320x320x!quant.uniform<i8:f32:1, {0.1:0, 0.2:0, 0.3:300}>>, tensor<1x3x320x320x!quant.uniform<i8:f32:1, {0.3:0, 0.4:0) -> tensor<1x3x320x320x!quant.uniform<i8:f32:1, {0.3:0, 0.4:0, 0.5:0}>>
...
module {
  func.func @test_input_output_quantization_types_different_requantize(%arg0: tensor<1x3x320x320x!quant.uniform<i32:f32:1, {0.1, 0.2, 0.3}>>) -> tensor<1x3x320x320x!quant.uniform<i32:f32, 0.2>> {
    ...
    %1 = "ttir.requantize"(%arg0) : (tensor<1x3x320x320x!quant.uniform<i32:f32:1, {0.1, 0.2, 0.3}>>, tensor<1x3x320x320x!quant.uniform<i32:f32) -> tensor<1x3x320x320x!quant.uniform<i32:f32, 0.2>>
