...
module attributes {} {
  ...
  func.func @test_arange_multiply(%arg0: tensor<1x32x128x128xf32>) -> tensor<1x32x128x128xf32> {
    ...
    // CHECK-SAME: (tensor<1x32x1x1xf32>) -> tensor<1x32x128x128xf32>
    %1 = "ttir.arange"() <{start = 0: si64, end = 32: si64, step = 1: si64, dtype = f32, arange_dimension = 1: i64}> : () -> tensor<1x32x128x128xf32>
