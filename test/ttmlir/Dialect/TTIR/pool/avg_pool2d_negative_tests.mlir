...
// -----
// Test 6: AvgPool2dOp with invalid padding
module {
...
// -----
// Test 7: AvgPool2dOp with effective kernel size larger than input size
module {
...
// -----
// Test 8: AvgPool2dOp without flattened compat info and mismatch on batch size
module {
...
// -----
// Test 9: AvgPool2dOp without flattened compat info and mismatch on channel size
module {
...
// -----
// Test 10: AvgPool2dOp without flattened compat info and mismatch on height dimension
module {
...
// -----
// Test 11: AvgPool2dOp without flattened compat info and mismatch on width dimension
module {
...
// -----
// Test 12: AvgPool2dOp without flattened compat info and mismatch on height and width dimensions
module {
...
// -----
// Test 13: AvgPool2dOp with flattened compat info and mismatch on channel size
module {
...
// -----
// Test 14: AvgPool2dOp with flattened compat info and mismatch on flattened dimension
module {
...
// -----
// Test 15: AvgPool2dOp with invalid kernel array size
module {
  func.func @avg_pool2d_invalid_kernel(%arg0: tensor<1x1x1024x64xbf16>) -> tensor<1x1x900x64xbf16> {
...
// -----
// Test 16: AvgPool2dOp with invalid stride array size
module {
  func.func @avg_pool2d_invalid_kernel(%arg0: tensor<1x1x1024x64xbf16>) -> tensor<1x1x900x64xbf16> {
...
// -----
// Test 17: AvgPool2dOp with invalid padding array size
module {
  func.func @avg_pool2d_invalid_kernel(%arg0: tensor<1x1x1024x64xbf16>) -> tensor<1x1x900x64xbf16> {
