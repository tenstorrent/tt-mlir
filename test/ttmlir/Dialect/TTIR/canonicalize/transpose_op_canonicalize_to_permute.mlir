...
module {
  func.func @transpose_involution(%arg0: tensor<64x128xbf16>) -> tensor<64x128xbf16> {
    ...
    %3 = "ttir.transpose"(%1) <{dim0 = 1 : si32, dim1 = 0 : si32}> : (tensor<128x64xbf16>) -> tensor<64x128xbf16>
  ...
  func.func @transpose_normalize_range(%arg0: tensor<32x64x128xbf16>) -> tensor<32x128x64xbf16> {
    ...
    %1 = "ttir.transpose"(%arg0) <{dim0 = -1 : si32, dim1 = -2 : si32}> : (tensor<32x64x128xbf16>) -> tensor<32x128x64xbf16>
