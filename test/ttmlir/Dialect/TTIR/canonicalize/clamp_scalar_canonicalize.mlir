...
func.func @clamp_scalar_relu6(%arg0: tensor<8x32x112x112xbf16>) -> tensor<8x32x112x112xbf16> {
    ...
    %1 = "ttir.clamp_scalar"(%arg0) <{max = 6.000000e+00 : f32, min = 0.000000e+00 : f32}> : (tensor<8x32x112x112xbf16>) -> tensor<8x32x112x112xbf16>
    // CHECK: return %[[RELU6]]
...
func.func @clamp_scalar_chained_relu6(%arg0: tensor<8x1x1x256xbf16>) -> tensor<8x1x1x256xbf16> {
    // CHECK: %[[RELU6:.*]] = "ttir.relu6"
    // CHECK-NOT: "ttir.clamp_scalar"
    %2 = "ttir.clamp_scalar"(%arg0) <{max = 0x7F800000 : f32, min = 0.000000e+00 : f32}> : (tensor<8x1x1x256xbf16>) -> tensor<8x1x1x256xbf16>
    %3 = "ttir.clamp_scalar"(%2) <{max = 6.000000e+00 : f32, min = 0xFF800000 : f32}> : (tensor<8x1x1x256xbf16>) -> tensor<8x1x1x256xbf16>
    // CHECK: return %[[RELU6]]
...
func.func @clamp_scalar_chained_multiple_use(%arg0: tensor<8x1x1x256xbf16>) -> (tensor<8x1x1x256xbf16>, tensor<8x1x1x256xbf16>) {
    ...
    %3 = "ttir.clamp_scalar"(%arg0) <{max = 0x7F800000 : f32, min = 0.000000e+00 : f32}> : (tensor<8x1x1x256xbf16>) -> tensor<8x1x1x256xbf16>
    %4 = "ttir.clamp_scalar"(%3) <{max = 6.000000e+00 : f32, min = 0xFF800000 : f32}> : (tensor<8x1x1x256xbf16>) -> tensor<8x1x1x256xbf16>
    %5 = "ttir.add"(%3, %arg0) : (tensor<8x1x1x256xbf16>, tensor<8x1x1x256xbf16>) -> tensor<8x1x1x256xbf16>
