...
module attributes {} {
  func.func @erase_inverse_ops_example(%arg0: tensor<1x1024xbf16>) -> tensor<1x1024xbf16> {
    // CHECK-NOT: %[[C:.*]] = "ttir.reshape"[[C:.*]]
    // CHECK-NOT: %[[C:.*]] = "ttir.permute"[[C:.*]]
    %permute1DPS = tensor.empty() : tensor<1024x1xbf16>
    %permute1 = "ttir.permute"(%arg0, %permute1DPS) <{permutation = array<i64: 1, 0>}> : (tensor<1x1024xbf16>, tensor<1024x1xbf16>) -> tensor<1024x1xbf16>
