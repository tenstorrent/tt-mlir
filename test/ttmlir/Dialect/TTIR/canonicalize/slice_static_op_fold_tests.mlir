...
module {
  ...
  func.func @consecutive_slice_static_no_fold_multiple_producer_uses(%arg0: tensor<128x128x128xbf16>) -> tensor<64x31x31xbf16> {
    // CHECK: "ttir.slice_static"
    ...
    %3 = ttir.empty() : tensor<64x64x64xbf16>
    %4 = "ttir.permute"(%1, %3) <{permutation = array<i32: 2, 1, 0>}> : (tensor<64x64x64xbf16>, tensor<64x64x64xbf16>) -> tensor<64x64x64xbf16>
    return %2: tensor<64x31x31xbf16>
  }
}
