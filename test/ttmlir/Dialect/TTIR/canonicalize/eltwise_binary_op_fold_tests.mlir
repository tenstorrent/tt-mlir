...
module {
  ...
  func.func @bitwise_xor_same_args_integer(%arg0: tensor<64x128xui16>) -> tensor<64x128xui16> {
    // CHECK-LABEL: @bitwise_xor_same_args_integer
  ...
  func.func @bitwise_xor_same_args_float(%arg0: tensor<64x128xbf16>) -> tensor<64x128xbf16> {
    // CHECK-LABEL: @bitwise_xor_same_args_float
    // CHECK-NOT: "ttir.bitwise_xor"
    // CHECK:  "ttir.zeros"
