...
func.func @compound(%arg0: tensor<256x768xf32>) -> tensor<256x768xf32> {
  ...
  // reblock
  // CHECK: "ttir.view_layout"(%{{.*}}) <{allowFormatChange = false}> : (tensor<256x768xf32, [[tiled]]>) -> tensor<256x768xf32, [[reblocked:#layout[0-9]*]]>
  ...
  // undo reblock
  // CHECK: "ttir.view_layout"(%{{.*}}) <{allowFormatChange = false}> : (tensor<256x768xf32, [[reblocked]]>) -> tensor<256x768xf32, [[tiled]]>
