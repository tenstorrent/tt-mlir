...
#l1_ = #ttcore.tmemory_space<l1>
#layout = #ttcore.tmetal_layout<[256, 768], undef, l1, dim_alignments = [32, 32], collapse_dims = dense<[[0, -1]]> : tensor<1x2xi64>>
#layout1 = #ttcore.tmetal_layout<[256, 768], undef, l1, dim_alignments = [32, 32], collapse_dims = dense<[[0, -1]]> : tensor<1x2xi64>>
#layout2 = #ttcore.tmetal_layout<[256, 768], undef, l1, dim_alignments = [32, 32], collapse_dims = dense<[[0, -1]]> : tensor<1x2xi64>>
...
func.func @tilize(%arg0: tensor<1x1x256x768xf32, #layout>) -> tensor<1x1x8x24x!ttcore.ttile<32x32, f32>, #layout1> {
  %0 = ttir.empty() : tensor<1x1x8x24x!ttcore.ttile<32x32, f32>, #layout1>
  // CHECK: ttir.generic {block_factors = [1, 1], grid = #ttcore.grid<1x1>
  // CHECK: ttir.tile_tilize_block
  %1 = ttir.to_layout %arg0, %0 : tensor<1x1x256x768xf32, #layout> into tensor<1x1x8x24x!ttcore.ttile<32x32, f32>, #layout1> -> tensor<1x1x8x24x!ttcore.ttile<32x32, f32>, #layout1>
  return %1 : tensor<1x1x8x24x!ttcore.ttile<32x32, f32>, #layout1>
}

func.func @untilize(%arg0: tensor<1x1x8x24x!ttcore.ttile<32x32, f32>, #layout1>) -> tensor<1x1x256x768xf32, #layout> {
  %0 = ttir.empty() : tensor<1x1x256x768xf32, #layout>
  // CHECK: ttir.generic {block_factors = [1, 1], grid = #ttcore.grid<1x1>
  // CHECK: ttir.tile_untilize_block
  %1 = ttir.to_layout %arg0, %0 : tensor<1x1x8x24x!ttcore.ttile<32x32, f32>, #layout1> into tensor<1x1x256x768xf32, #layout> -> tensor<1x1x256x768xf32, #layout>
  return %1 : tensor<1x1x256x768xf32, #layout>
}

func.func @reblock(%arg0: tensor<1x1x8x24x!ttcore.ttile<32x32, f32>, #layout1>) -> tensor<8x8x1x3x!ttcore.ttile<32x32, f32>, #layout2> {
  %0 = ttir.empty() : tensor<8x8x1x3x!ttcore.ttile<32x32, f32>, #layout2>
  // CHECK: ttir.generic {block_factors = [1, 1], grid = #ttcore.grid<8x8>
  // CHECK: ^datamovement0
  %1 = ttir.to_layout %arg0, %0 : tensor<1x1x8x24x!ttcore.ttile<32x32, f32>, #layout1> into tensor<8x8x1x3x!ttcore.ttile<32x32, f32>, #layout2> -> tensor<8x8x1x3x!ttcore.ttile<32x32, f32>, #layout2>
  return %1 : tensor<8x8x1x3x!ttcore.ttile<32x32, f32>, #layout2>
}
...
func.func @compound(%arg0: tensor<256x768xf32>) -> tensor<256x768xf32> {
  ...
  %3 = ttir.to_layout %2, %1 : tensor<8x8x1x3x!ttcore.ttile<32x32, f32>, #layout2> into tensor<256x768xf32> -> tensor<256x768xf32>
