...
func.func @add1(%arg0: tensor<32x32xbf16>, %arg1: tensor<32x32xbf16>) -> tensor<32x32xbf16> {
  ...
  // CHECK: %{{.*}} = call @hoisted_ttir_add_32x32xbf16_32x32xbf16_32x32xbf16_func_decl
...
func.func @add2(%arg0: tensor<32x32xf32>, %arg1: tensor<32x32xf32>) -> tensor<32x32xf32> {
  ...
  // CHECK: %{{.*}} = call @hoisted_ttir_add_32x32xf32_32x32xf32_32x32xf32_func_decl
...
func.func @add3(%arg0: tensor<32x3xf32>, %arg1: tensor<32x3xf32>) -> tensor<32x3xf32> {
  ...
  // CHECK: %{{.*}} = call @hoisted_ttir_add_32x3xf32_32x3xf32_32x3xf32_func_decl
...
// CHECK: func.func private @hoisted_ttir_add_32x32xbf16_32x32xbf16_32x32xbf16_func_decl
// CHECK: func.func private @hoisted_ttir_add_32x32xf32_32x32xf32_32x32xf32_func_decl
// CHECK: func.func private @hoisted_ttir_add_32x3xf32_32x3xf32_32x3xf32_func_decl

// CHECK: tt.cpu_module {
// CHECK: builtin.module {
// CHECK: func.func @hoisted_ttir_add_32x32xbf16_32x32xbf16_32x32xbf16_func
// CHECK: func.func @hoisted_ttir_add_32x32xf32_32x32xf32_32x32xf32_func
// CHECK: func.func @hoisted_ttir_add_32x3xf32_32x3xf32_32x3xf32_func
