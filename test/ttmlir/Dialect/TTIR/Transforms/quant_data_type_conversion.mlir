// RUN: ttmlir-opt --ttir-quant-data-type-conversion="quant-data-type=int32" --split-input-file %s > %t.mlir
...
// RUN: ttmlir-opt --ttir-quant-data-type-conversion="quant-data-type=int16" --split-input-file %s > %t-int16.mlir
