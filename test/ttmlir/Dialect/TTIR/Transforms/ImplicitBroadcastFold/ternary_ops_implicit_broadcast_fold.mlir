...
module {
  ...
  func.func @ternary_explicit_broadcast_first_and_third_operand(%arg0: tensor<1x1x128xf32>, %arg1: tensor<1x64x1xf32>, %arg2: tensor<1x1x128xf32>) -> tensor<32x64x128xf32> {
    %1 = "ttir.broadcast"(%arg0) <{broadcast_dimensions = array<i64: 32, 64, 1>}> : (tensor<1x1x128xf32>, tensor<32x64x128xf32>) -> tensor<32x64x128xf32>
    %3 = "ttir.broadcast"(%arg2) <{broadcast_dimensions = array<i64: 32, 64, 1>}> : (tensor<1x1x128xf32>, tensor<32x64x128xf32>) -> tensor<32x64x128xf32>
  ...
  func.func @ternary_explicit_broadcast_second_and_third_operand(%arg0: tensor<1x1x128xf32>, %arg1: tensor<1x64x1xf32>, %arg2: tensor<32x1x1xf32>) -> tensor<32x64x128xf32> {
    %1 = "ttir.broadcast"(%arg1) <{broadcast_dimensions = array<i64: 32, 1, 128>}> : (tensor<1x64x1xf32>, tensor<32x64x128xf32>) -> tensor<32x64x128xf32>
    %3 = "ttir.broadcast"(%arg2) <{broadcast_dimensions = array<i64: 1, 64, 128>}> : (tensor<32x1x1xf32>, tensor<32x64x128xf32>) -> tensor<32x64x128xf32>
  ...
  func.func @ternary_explicit_broadcast_all_operands(%arg0: tensor<1x1x1xf32>, %arg1: tensor<1x1x128xf32>, %arg2: tensor<1x1x128xf32>) -> tensor<32x64x128xf32> {
    %1 = "ttir.broadcast"(%arg0) <{broadcast_dimensions = array<i64: 32, 64, 128>}> : (tensor<1x1x1xf32>, tensor<32x64x128xf32>) -> tensor<32x64x128xf32>
    %3 = "ttir.broadcast"(%arg1) <{broadcast_dimensions = array<i64: 32, 64, 1>}> : (tensor<1x1x128xf32>, tensor<32x64x128xf32>) -> tensor<32x64x128xf32>
    %5 = "ttir.broadcast"(%arg2) <{broadcast_dimensions = array<i64: 32, 64, 1>}> : (tensor<1x1x128xf32>, tensor<32x64x128xf32>) -> tensor<32x64x128xf32>
  ...
  func.func @ternary_chained_operations(%arg0: tensor<1x1x128xf32>, %arg1: tensor<1x1x1xf32>, %arg2: tensor<1x1x128xf32>, %arg3: tensor<1x1x1xf32>, %arg4: tensor<1x1x1xf32>, %arg5: tensor<1x1x1xf32>, %arg6: tensor<1x1x1xf32>, %arg7: tensor<1x1x1xf32>, %arg8: tensor<1x1x1xf32>) -> tensor<32x64x128xf32> {
    %1 = "ttir.broadcast"(%arg0) <{broadcast_dimensions = array<i64: 1, 64, 1>}> : (tensor<1x1x128xf32>, tensor<1x64x128xf32>) -> tensor<1x64x128xf32>
    %3 = "ttir.broadcast"(%arg1) <{broadcast_dimensions = array<i64: 1, 64, 128>}> : (tensor<1x1x1xf32>, tensor<1x64x128xf32>) -> tensor<1x64x128xf32>
    %5 = "ttir.broadcast"(%arg2) <{broadcast_dimensions = array<i64: 1, 64, 1>}> : (tensor<1x1x128xf32>, tensor<1x64x128xf32>) -> tensor<1x64x128xf32>
    %7 = "ttir.where"(%1, %3, %5) : (tensor<1x64x128xf32>, tensor<1x64x128xf32>, tensor<1x64x128xf32>) -> tensor<1x64x128xf32>

    %9 = "ttir.broadcast"(%arg3) <{broadcast_dimensions = array<i64: 1, 1, 128>}> : (tensor<1x1x1xf32>, tensor<1x1x128xf32>) -> tensor<1x1x128xf32>
    %11 = "ttir.broadcast"(%arg4) <{broadcast_dimensions = array<i64: 1, 1, 128>}> : (tensor<1x1x1xf32>, tensor<1x1x128xf32>) -> tensor<1x1x128xf32>
    %13 = "ttir.broadcast"(%arg5) <{broadcast_dimensions = array<i64: 1, 1, 128>}> : (tensor<1x1x1xf32>, tensor<1x1x128xf32>) -> tensor<1x1x128xf32>
    %15 = "ttir.where"(%9, %11, %13) : (tensor<1x1x128xf32>, tensor<1x1x128xf32>, tensor<1x1x128xf32>) -> tensor<1x1x128xf32>

    %17 = "ttir.broadcast"(%arg6) <{broadcast_dimensions = array<i64: 1, 64, 128>}> : (tensor<1x1x1xf32>, tensor<1x64x128xf32>) -> tensor<1x64x128xf32>
