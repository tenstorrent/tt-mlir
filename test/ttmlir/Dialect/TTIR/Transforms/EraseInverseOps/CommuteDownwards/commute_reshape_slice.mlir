...
module {
    func.func @test_reshape_slice_commute_downwards(%arg0: tensor<1x1x25600x128xbf16>) -> tensor<1x160x160x64xbf16> {
        ...
        %1 = "ttir.reshape"(%arg0) <{shape = [1 : i32, 160 : i32, 160 : i32, 128 : i32]}> : (tensor<1x1x25600x128xbf16>) -> tensor<1x160x160x128xbf16>
        %3 = "ttir.slice_static"(%1) <{begins = [0 : i32, 0 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 160 : i32, 160 : i32, 64 : i32], step = [1 : i32, 1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x160x160x128xbf16>) -> tensor<1x160x160x64xbf16>
    ...
    func.func @test_reshape_slice_commute_downwards_dim_dec(%arg0: tensor<25600x128xbf16>) -> tensor<1x160x160x64xbf16> {
        ...
        // CHECK: shape = [1 : i32, 160 : i32, 160 : i32, 64 : i32]
        // CHECK: return %[[RESHAPE]]
        %1 = "ttir.reshape"(%arg0) <{shape = [1 : i32, 160 : i32, 160 : i32, 128 : i32]}> : (tensor<25600x128xbf16>) -> tensor<1x160x160x128xbf16>
        %3 = "ttir.slice_static"(%1) <{begins = [0 : i32, 0 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 160 : i32, 160 : i32, 64 : i32], step = [1 : i32, 1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x160x160x128xbf16>) -> tensor<1x160x160x64xbf16>
        return %3 : tensor<1x160x160x64xbf16>
    }
    func.func @test_reshape_slice_commute_downwards_dim_inc(%arg0: tensor<1x160x160x128xbf16>) -> tensor<25600x64xbf16> {
         ...
         // CHECK: return %[[RESHAPE]]
        %1 = "ttir.reshape"(%arg0) <{shape = [25600 : i32, 128 : i32]}> : (tensor<1x160x160x128xbf16>) -> tensor<25600x128xbf16>
        %3 = "ttir.slice_static"(%1) <{begins = [0 : i32, 0 : i32], ends = [25600 : i32, 64 : i32], step = [1 : i32, 1 : i32]}> : (tensor<25600x128xbf16>) -> tensor<25600x64xbf16>
    ...
    func.func @test_reshape_slice_commute_downwards_squeeze(%arg0: tensor<1x1x25600x128xbf16>) -> tensor<25600x64xbf16> {
        // CHECK: "ttir.slice_static"
        // CHECK: "ttir.reshape"
        %1 = "ttir.reshape"(%arg0) <{shape = [25600 : i32, 128 : i32]}> : (tensor<1x1x25600x128xbf16>) -> tensor<25600x128xbf16>
        %3 = "ttir.slice_static"(%1) <{begins = [0 : i32, 0 : i32], ends = [25600 : i32, 64 : i32], step = [1 : i32, 1 : i32]}> : (tensor<25600x128xbf16>) -> tensor<25600x64xbf16>
        return %3 : tensor<25600x64xbf16>
    }
    func.func @test_reshape_slice_commute_downwards_unsqueeze(%arg0: tensor<25600x128xbf16>) -> tensor<1x1x25600x64xbf16> {
        // CHECK: "ttir.slice_static"
        // CHECK: "ttir.reshape"
        %1 = "ttir.reshape"(%arg0) <{shape = [1 : i32, 1 : i32, 25600 : i32, 128 : i32]}> : (tensor<25600x128xbf16>) -> tensor<1x1x25600x128xbf16>
        %3 = "ttir.slice_static"(%1) <{begins = [0 : i32, 0 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 1 : i32, 25600 : i32, 64 : i32], step = [1 : i32, 1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x1x25600x128xbf16>) -> tensor<1x1x25600x64xbf16>
    ...
    func.func @test_reshape_slice_no_commute_multiple_users(%arg0: tensor<25600x128xbf16>) -> (tensor<1x160x160x64xbf16>, tensor<1x160x160x64xbf16>) {
        ...
        %1 = "ttir.reshape"(%arg0) <{shape = [1 : i32, 160 : i32, 160 : i32, 128 : i32]}> : (tensor<25600x128xbf16>, tensor<1x160x160x128xbf16>) -> tensor<1x160x160x128xbf16>
        %3 = "ttir.slice_static"(%1) <{begins = [0 : i32, 0 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 160 : i32, 160 : i32, 64 : i32], step = [1 : i32, 1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x160x160x128xbf16>) -> tensor<1x160x160x64xbf16>
        %5 = "ttir.slice_static"(%1) <{begins = [0 : i32, 0 : i32, 0 : i32, 64 : i32], ends = [1 : i32, 160 : i32, 160 : i32, 128 : i32], step = [1 : i32, 1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x160x160x128xbf16>) -> tensor<1x160x160x64xbf16>
