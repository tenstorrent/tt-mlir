...
module {
    ...
    func.func @test_permute_max_inverse_permute_downwards(%arg0: tensor<12x7x7x1152xbf16>) -> tensor<12x1x1x1152xbf16> {
        ...
        // CHECK-NOT: "ttir.permute"
        %1 = "ttir.permute"(%arg0) <{permutation = array<i64: 0, 3, 1, 2>}> : (tensor<12x7x7x1152xbf16>) -> tensor<12x1152x7x7xbf16>
        %3 = "ttir.max"(%1) <{dim_arg = [2 : i32, 3 : i32], keep_dim = true}> : (tensor<12x1152x7x7xbf16>) -> tensor<12x1152x1x1xbf16>
        %5 = "ttir.permute"(%3) <{permutation = array<i64: 0, 2, 3, 1>}> : (tensor<12x1152x1x1xbf16>) -> tensor<12x1x1x1152xbf16>
        return %5 : tensor<12x1x1x1152xbf16>
    }
    func.func @test_permute_min_inverse_permute_downwards(%arg0: tensor<12x7x7x1152xbf16>) -> tensor<12x1x1x1152xbf16> {
        ...
        // CHECK-NOT: "ttir.permute"
        %1 = "ttir.permute"(%arg0) <{permutation = array<i64: 0, 3, 1, 2>}> : (tensor<12x7x7x1152xbf16>) -> tensor<12x1152x7x7xbf16>
        %3 = "ttir.min"(%1) <{dim_arg = [2 : i32, 3 : i32], keep_dim = true}> : (tensor<12x1152x7x7xbf16>) -> tensor<12x1152x1x1xbf16>
        %5 = "ttir.permute"(%3) <{permutation = array<i64: 0, 2, 3, 1>}> : (tensor<12x1152x1x1xbf16>) -> tensor<12x1x1x1152xbf16>
        return %5 : tensor<12x1x1x1152xbf16>
    }
    func.func @test_permute_prod_inverse_permute_downwards(%arg0: tensor<12x7x7x1152xbf16>) -> tensor<12x1x1x1152xbf16> {
        ...
        // CHECK-NOT: "ttir.permute"
        %1 = "ttir.permute"(%arg0) <{permutation = array<i64: 0, 3, 1, 2>}> : (tensor<12x7x7x1152xbf16>) -> tensor<12x1152x7x7xbf16>
        %3 = "ttir.prod"(%1) <{dim_arg = [2 : i32, 3 : i32], keep_dim = true}> : (tensor<12x1152x7x7xbf16>) -> tensor<12x1152x1x1xbf16>
        %5 = "ttir.permute"(%3) <{permutation = array<i64: 0, 2, 3, 1>}> : (tensor<12x1152x1x1xbf16>) -> tensor<12x1x1x1152xbf16>
        return %5 : tensor<12x1x1x1152xbf16>
    }
    func.func @test_permute_reduce_and_inverse_permute_downwards(%arg0: tensor<12x7x7x1152xi1>) -> tensor<12x1x1x1152xi1> {
        ...
        // CHECK-NOT: "ttir.permute"
        %1 = "ttir.permute"(%arg0) <{permutation = array<i64: 0, 3, 1, 2>}> : (tensor<12x7x7x1152xi1>) -> tensor<12x1152x7x7xi1>
        %3 = "ttir.reduce_and"(%1) <{dim_arg = [2 : i32, 3 : i32], keep_dim = true}> : (tensor<12x1152x7x7xi1>) -> tensor<12x1152x1x1xi1>
        %5 = "ttir.permute"(%3) <{permutation = array<i64: 0, 2, 3, 1>}> : (tensor<12x1152x1x1xi1>) -> tensor<12x1x1x1152xi1>
    ...
    func.func @test_permute_reduce_or_inverse_permute_downwards(%arg0: tensor<12x7x7x1152xi1>) -> tensor<12x1x1x1152xi1> {
        ...
        // CHECK-NOT: "ttir.permute"
        %1 = "ttir.permute"(%arg0) <{permutation = array<i64: 0, 3, 1, 2>}> : (tensor<12x7x7x1152xi1>) -> tensor<12x1152x7x7xi1>
        %3 = "ttir.reduce_or"(%1) <{dim_arg = [2 : i32, 3 : i32], keep_dim = true}> : (tensor<12x1152x7x7xi1>) -> tensor<12x1152x1x1xi1>
        %5 = "ttir.permute"(%3) <{permutation = array<i64: 0, 2, 3, 1>}> : (tensor<12x1152x1x1xi1>) -> tensor<12x1x1x1152xi1>
        return %5 : tensor<12x1x1x1152xi1>
    }
