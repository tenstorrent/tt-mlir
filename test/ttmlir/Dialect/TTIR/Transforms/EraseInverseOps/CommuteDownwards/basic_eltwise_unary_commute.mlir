...
module {
    func.func @test_commute_reshape_downwards(%arg0: tensor<32x64xbf16>) -> tensor<1x2048xbf16> {
      ...
      %1 = "ttir.reshape"(%arg0) <{shape = [1 : i32, 2048 : i32]}> : (tensor<32x64xbf16>, tensor<1x2048xbf16>) -> tensor<1x2048xbf16>
      %3 = "ttir.exp"(%1) : (tensor<1x2048xbf16>) -> tensor<1x2048xbf16>
...
module {
    func.func @test_commute_permute_downwards(%arg0: tensor<1x3x224x224xbf16>) -> tensor<1x224x224x3xbf16> {
      ...
      %1 = "ttir.permute"(%arg0) <{permutation = array<i64: 0, 2, 3, 1>}> : (tensor<1x3x224x224xbf16>, tensor<1x224x224x3xbf16>) -> tensor<1x224x224x3xbf16>
