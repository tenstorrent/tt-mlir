...
module {
    ...
    func.func @test_slice_reshape_commute_upwards_squeeze(%arg0: tensor<1x1x25600x128xbf16>) -> tensor<25600x64xbf16> {
        // CHECK: "ttir.reshape"
        // CHECK: "ttir.slice_static"
        %0 = ttir.empty() : tensor<1x1x25600x64xbf16>
        %1 = "ttir.slice_static"(%arg0, %0) <{begins = [0 : i32, 0 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 1 : i32, 25600 : i32, 64 : i32], step = [1 : i32, 1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x1x25600x128xbf16>, tensor<1x1x25600x64xbf16>) -> tensor<1x1x25600x64xbf16>
        %2 = ttir.empty() : tensor<25600x64xbf16>
        %3 = "ttir.reshape"(%1, %2) <{shape = [25600 : i32, 64 : i32]}> : (tensor<1x1x25600x64xbf16>, tensor<25600x64xbf16>) -> tensor<25600x64xbf16>
        return %3 : tensor<25600x64xbf16>
    }
    func.func @test_slice_reshape_commute_upwards_unsqueeze(%arg0: tensor<25600x128xbf16>) -> tensor<1x1x25600x64xbf16> {
        ...
        %1 = "ttir.slice_static"(%arg0, %0) <{begins = [0 : i32, 0 : i32], ends = [25600 : i32, 64 : i32], step = [1 : i32, 1 : i32]}> : (tensor<25600x128xbf16>, tensor<25600x64xbf16>) -> tensor<25600x64xbf16>
        %2 = ttir.empty() : tensor<1x1x25600x64xbf16>
        %3 = "ttir.reshape"(%1, %2) <{shape = [1 : i32, 1 : i32, 25600 : i32, 64 : i32]}> : (tensor<25600x64xbf16>, tensor<1x1x25600x64xbf16>) -> tensor<1x1x25600x64xbf16>
        return %3 : tensor<1x1x25600x64xbf16>
    }
