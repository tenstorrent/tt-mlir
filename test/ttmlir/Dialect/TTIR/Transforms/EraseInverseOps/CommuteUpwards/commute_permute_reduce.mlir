...
module {
    func.func @test_permute_mean_commute_upwards(%arg0: tensor<12x7x7x1152xbf16>) -> tensor<12x1152x1x1xbf16> {
        ...
        %1 = "ttir.mean"(%arg0) <{dim_arg = [1 : i32, 2 : i32], keep_dim = true}> : (tensor<12x7x7x1152xbf16>) -> tensor<12x1x1x1152xbf16>
    ...
    func.func @test_permute_mean_diff_users_upwards(%arg0: tensor<12x7x7x1152xbf16>) -> (tensor<12x1152x1x1xbf16>, tensor<12x1x1x1152xbf16>) {
        ...
        %1 = "ttir.mean"(%arg0) <{dim_arg = [1 : i32, 2 : i32], keep_dim = true}> : (tensor<12x7x7x1152xbf16>) -> tensor<12x1x1x1152xbf16>
        %3 = "ttir.permute"(%1) <{permutation = array<i64: 0, 3, 1, 2>}> : (tensor<12x1x1x1152xbf16>) -> tensor<12x1152x1x1xbf16>
        %5 = "ttir.relu"(%1) : (tensor<12x1x1x1152xbf16>) -> tensor<12x1x1x1152xbf16>
