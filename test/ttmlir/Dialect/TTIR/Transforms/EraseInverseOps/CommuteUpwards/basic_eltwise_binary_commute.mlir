...
module {
    func.func @test_permute_binary_commute_upwards(%arg0: tensor<1x3x224x224xbf16>, %arg1: tensor<1x3x224x224xbf16>) -> tensor<1x224x224x3xbf16> {
        ...
        // CHECK: return %[[ADD]]
        %1 = "ttir.add"(%arg0, %arg1) : (tensor<1x3x224x224xbf16>, tensor<1x3x224x224xbf16>) -> tensor<1x3x224x224xbf16>
...
module {
    ...
    // CHECK: return %[[ADD]]
    %1 = "ttir.add"(%arg0, %arg1) : (tensor<1x3x224x224xbf16>, tensor<1x3x224x224xbf16>) -> tensor<1x3x224x224xbf16>
    %3 = "ttir.reshape"(%1) <{shape = [1:i32, 1: i32, 3: i32, 50176: i32]}> : (tensor<1x3x224x224xbf16>) -> tensor<1x1x3x50176xbf16>
