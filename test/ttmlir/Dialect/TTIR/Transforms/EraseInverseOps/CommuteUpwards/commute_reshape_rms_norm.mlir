...
module {
    ...
    // Case: reshapes are not inverses (different output shape), but last dim is same.
    // The output reshape moves above rms_norm, and consecutive reshapes get folded.
    ...
    // Case: no input reshape.
    // The output reshape moves above rms_norm (reshape is created before rms_norm).
    ...
    func.func @test_reshape_rms_norm_appends_trailing_one(%arg0: tensor<1x3648x3840xbf16>, %arg1: tensor<3840xbf16>) -> tensor<1x3648x3840x1xbf16> {
        ...
        %0 = "ttir.rms_norm"(%arg0, %arg1) <{epsilon = 9.99999974E-6 : f32, normalized_shape = array<i64: 3840>, operandSegmentSizes = array<i32: 1, 1, 0, 0>}> : (tensor<1x3648x3840xbf16>, tensor<3840xbf16>) -> tensor<1x3648x3840xbf16>
