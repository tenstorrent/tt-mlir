...
module {
  func.func @test_permute_concat_commute_upwards(%arg0: tensor<1x160x160x160xbf16>) -> tensor<1x160x160x80xbf16> {
    // CHECK: %[[PERMUTE1:[0-9]+]] = "ttir.permute"(%arg0) <{permutation = array<i64: 0, 2, 3, 1>}>
    ...
    %1 = "ttir.slice_static"(%arg0) <{begins = [0 : i32, 80 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 160 : i32, 160 : i32, 160 : i32], step = [1 : i32, 1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x160x160x160xbf16>) -> tensor<1x80x160x160xbf16>
    %3 = "ttir.permute"(%1) <{permutation = array<i64: 0, 2, 3, 1>}> : (tensor<1x80x160x160xbf16>) -> tensor<1x160x160x80xbf16>
