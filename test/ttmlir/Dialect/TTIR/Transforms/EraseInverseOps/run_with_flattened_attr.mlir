...
module {
    func.func @test_inverse_tms_erased(%arg0: tensor<1x3x224x224xbf16>) -> tensor<1x3x224x224xbf16> {
        ...
        %3 = "ttir.exp"(%1, %2) {flattened_compat_info = #ttir<flattened_compat batch_size = 1, input_height = 224, input_width = 224>} : (tensor<1x224x224x3xbf16>, tensor<1x224x224x3xbf16>) -> tensor<1x224x224x3xbf16>
