...
module {
  ...
  func.func @update_cache_through_mesh_shard(
    ...
    %result = "ttir.mesh_shard"(%updated) <{shard_dims = array<i64: -1, 0>, shard_direction = #ttcore.shard_direction<shard_to_full>, shard_shape = array<i64: 2, 1, 1, 1>, shard_type = #ttcore.shard_type<devices>}> : (tensor<1x32x64x512xbf16>) -> tensor<2x32x64x512xbf16>
