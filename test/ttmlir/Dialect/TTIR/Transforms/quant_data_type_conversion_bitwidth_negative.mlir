...
func.func @requantize_datatype_bad_bit_width_negative(%arg0: tensor<1x3x320x320x!quant.uniform<i32:f32, 1.000000e-01>>) -> tensor<1x3x320x320x!quant.uniform<i32:f32, 2.000000e-01>> {
  ...
  %1 = "ttir.requantize"(%arg0) : (tensor<1x3x320x320x!quant.uniform<i32:f32, 1.000000e-01>>, tensor<1x3x320x320x!quant.uniform<i32:f32) -> tensor<1x3x320x320x!quant.uniform<i32:f32, 2.000000e-01>>
