...
module {
  func.func @resnet_conv2d_bias_relu_pooling_pattern(%arg0: tensor<1x3x224x224xf32>, %arg1: tensor<64x3x7x7xf32>, %arg2: tensor<64xf32>) -> tensor<1x64x56x56x!quant.uniform<i8:f32, 0.46909785270690918>> {
    ...
    %11 = "ttir.pooling"(%10) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = array<i64: 0, 0, 0, 0, 1, 1, 1, 1>, pooling_method = #ttir<pooling_method Max>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 2, 2>}> : (tensor<1x64x112x112xf32>) -> tensor<1x64x56x56xf32>
    %12 = "ttir.quantize"(%11) : (tensor<1x64x56x56xf32>) -> tensor<1x64x56x56x!quant.uniform<i8:f32, 0.46909785270690918>>
    return %12 : tensor<1x64x56x56x!quant.uniform<i8:f32, 0.46909785270690918>>
  }
}
