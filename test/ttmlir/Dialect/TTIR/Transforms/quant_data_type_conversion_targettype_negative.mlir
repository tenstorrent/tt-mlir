// RUN: not ttmlir-opt --ttir-quant-data-type-conversion="target-bit-width=8" %s 2>&1 | FileCheck %s
func.func @requantize_datatype_bad_bit_width_negative(%arg0: tensor<1x3x320x320x!quant.uniform<i32:f32, 1.000000e-01>>) -> tensor<1x3x320x320x!quant.uniform<i32:f32, 2.000000e-01>> {
  // CHECK: error: Target integer type of width 8 is smaller than quantized type of width 32. Out of range.
