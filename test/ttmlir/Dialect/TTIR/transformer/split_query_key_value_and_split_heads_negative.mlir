...
module {
  func.func @split_qkv_and_split_heads_invalid_1(%arg0: tensor<68x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>) {
    ...
    %3, %4, %5 = "ttir.split_query_key_value_and_split_heads"(%arg0) <{num_heads = 16 : ui32, transpose_key = false}> : (tensor<68x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>)
...
module {
  func.func @split_qkv_and_split_heads_invalid_2(%arg0: tensor<2x32x3072xf32>) -> (tensor<2x16x32xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>) {
    ...
    %3, %4, %5 = "ttir.split_query_key_value_and_split_heads"(%arg0) <{num_heads = 16 : ui32, transpose_key = false}> : (tensor<2x32x3072xf32>) -> (tensor<2x16x32xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>)
...
module {
  func.func @split_qkv_and_split_heads_invalid_2(%arg0: tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32xf32>, tensor<2x16x32x64xf32>) {
    ...
    %3, %4, %5 = "ttir.split_query_key_value_and_split_heads"(%arg0) <{num_heads = 16 : ui32, transpose_key = false}> : (tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32xf32>, tensor<2x16x32x64xf32>)
...
module {
  func.func @split_qkv_and_split_heads_invalid_2(%arg0: tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32xf32>, tensor<2x16x32xf32>) {
    ...
    %3, %4, %5 = "ttir.split_query_key_value_and_split_heads"(%arg0) <{num_heads = 16 : ui32, transpose_key = false}> : (tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32xf32>)
...
module {
  func.func @split_qkv_invalid_query_shape(%arg0: tensor<2x32x3072xf32>) -> (tensor<4x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>) {
    ...
    %3, %4, %5 = "ttir.split_query_key_value_and_split_heads"(%arg0) <{num_heads = 16 : ui32, transpose_key = false}> : (tensor<2x32x3072xf32>) -> (tensor<4x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>)
...
module {
  func.func @split_qkv_invalid_key_shape(%arg0: tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<4x16x32x64xf32>, tensor<2x16x32x64xf32>) {
    ...
    %3, %4, %5 = "ttir.split_query_key_value_and_split_heads"(%arg0) <{num_heads = 16 : ui32, transpose_key = false}> : (tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<4x16x32x64xf32>, tensor<2x16x32x64xf32>)
...
module {
  func.func @split_qkv_invalid_value_shape(%arg0: tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<4x16x32x64xf32>) {
    ...
    %3, %4, %5 = "ttir.split_query_key_value_and_split_heads"(%arg0) <{num_heads = 16 : ui32, transpose_key = false}> : (tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<4x16x32x64xf32>)
...
module {
  func.func @split_qkv_invalid_key_shape_transpose(%arg0: tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>) {
    // CHECK:  error: 'ttir.split_query_key_value_and_split_heads' op expected key output shape
    %3, %4, %5 = "ttir.split_query_key_value_and_split_heads"(%arg0) <{num_heads = 16 : ui32, transpose_key = true}> : (tensor<2x32x3072xf32>) -> (tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>)
    return %3, %4, %5 : tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>, tensor<2x16x32x64xf32>
  }
}
