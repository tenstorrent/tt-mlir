// RUN: ttmlir-opt --ttcore-register-device --ttir-lower-ttnn-layouts -o %t.mlir %s
...
func.func @test_lower_block_sharded_l1(
  ...
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<32x32xf32, #ttnn_layout> -> tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<32x32xf32, #ttnn_layout> -> tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>
  // CHECK: "ttir.abs"({{.*}}) : (tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>, tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>) -> tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout>
  // CHECK: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<1x1x1x1x!ttcore.tile<32x32, f32>, #layout> -> tensor<32x32xf32, #ttnn_layout>
...
func.func @test_lower_block_sharded_l1_1(
  ...
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<256x256xf32, #ttnn_layout1> -> tensor<8x8x1x1x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<256x256xf32, #ttnn_layout1> -> tensor<8x8x1x1x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK: "ttir.abs"({{.*}}) : (tensor<8x8x1x1x!ttcore.tile<32x32, f32>, #layout1>, tensor<8x8x1x1x!ttcore.tile<32x32, f32>, #layout1>) -> tensor<8x8x1x1x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<8x8x1x1x!ttcore.tile<32x32, f32>, #layout1> -> tensor<256x256xf32, #ttnn_layout1>
...
func.func @test_lower_block_sharded_l1_2(
  ...
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<256x256xf32, #ttnn_layout2> -> tensor<1x1x8x8x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<256x256xf32, #ttnn_layout2> -> tensor<1x1x8x8x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK: "ttir.abs"({{.*}}) : (tensor<1x1x8x8x!ttcore.tile<32x32, f32>, #layout1>, tensor<1x1x8x8x!ttcore.tile<32x32, f32>, #layout1>) -> tensor<1x1x8x8x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<1x1x8x8x!ttcore.tile<32x32, f32>, #layout1> -> tensor<256x256xf32, #ttnn_layout2>
...
func.func @test_lower_block_sharded_l1_3(
  ...
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<256x256xf32, #ttnn_layout3> -> tensor<1x4x8x2x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<256x256xf32, #ttnn_layout3> -> tensor<1x4x8x2x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK: "ttir.abs"({{.*}}) : (tensor<1x4x8x2x!ttcore.tile<32x32, f32>, #layout1>, tensor<1x4x8x2x!ttcore.tile<32x32, f32>, #layout1>) -> tensor<1x4x8x2x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<1x4x8x2x!ttcore.tile<32x32, f32>, #layout1> -> tensor<256x256xf32, #ttnn_layout3>
...
func.func @test_lower_block_sharded_l1_4(
  ...
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<256x256xf32, #ttnn_layout4> -> tensor<4x1x2x8x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK-DAG: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<256x256xf32, #ttnn_layout4> -> tensor<4x1x2x8x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK: "ttir.abs"({{.*}}) : (tensor<4x1x2x8x!ttcore.tile<32x32, f32>, #layout1>, tensor<4x1x2x8x!ttcore.tile<32x32, f32>, #layout1>) -> tensor<4x1x2x8x!ttcore.tile<32x32, f32>, #layout1>
  // CHECK: = ttir.ttnn_metal_layout_cast %{{.*}} : tensor<4x1x2x8x!ttcore.tile<32x32, f32>, #layout1> -> tensor<256x256xf32, #ttnn_layout4>
