...
module attributes {} {
  func.func @reverse_non_unique_dims(%arg0: tensor<32x64xf32>) -> tensor<32x64xf32> {
    ...
    %1 = "ttir.reverse"(%arg0) <{dimensions = array<i64: 0, 0>}> : (tensor<32x64xf32>) -> tensor<32x64xf32>
...
module attributes {} {
  func.func @reverse_negative_dim(%arg0: tensor<32x64xf32>) -> tensor<32x64xf32> {
    ...
    %1 = "ttir.reverse"(%arg0) <{dimensions = array<i64: 0, -1>}> : (tensor<32x64xf32>) -> tensor<32x64xf32>
    return %1 : tensor<32x64xf32>
  }
}
...
module attributes {} {
  func.func @reverse_out_of_bounds_dim(%arg0: tensor<32x64xf32>) -> tensor<32x64xf32> {
    ...
    %1 = "ttir.reverse"(%arg0) <{dimensions = array<i64: 2>}> : (tensor<32x64xf32>) -> tensor<32x64xf32>
    return %1 : tensor<32x64xf32>
  }
}
