        ...
        ^bb0(%arg2: memref<2x4x!ttcore.tile<32x32, f32>, #l1_alias>,
            ...
            linalg.generic {
                ...
                ^bb0(%a: !ttcore.tile<32x32, f32>, %b: !ttcore.tile<32x32, f32>, %c: !ttcore.tile<32x32, f32>):
                    // CHECK: %{{[0-9]+}} = "ttir.tile_reduce_max"(%{{[a-z0-9_]+}}, %{{[a-z0-9_]+}}, %{{[a-z0-9_]+}}) <{reduce_dim = #ttir<reduce_dim R>}> : (!ttcore.tile<32x32, f32>, !ttcore.tile<32x32, f32>, !ttcore.tile<32x32, f32>) -> !ttcore.tile<32x32, f32>
                    %4 = "ttir.tile_reduce_max" (%a, %b, %c) {reduce_dim = #ttir<reduce_dim R>} : (!ttcore.tile<32x32, f32>, !ttcore.tile<32x32, f32>, !ttcore.tile<32x32, f32>) -> !ttcore.tile<32x32, f32>
