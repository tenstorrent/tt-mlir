...
module {
  func.func @main(%arg0: tensor<128x128x3x3xbf16>, %arg1: tensor<1x128x1x1xbf16>, %arg2: tensor<1x128x28x28xbf16>, %arg3: tensor<1x128x1x1xbf16>, %arg4: tensor<1x128x1x1xbf16>, %arg5: tensor<128x128x3x3xbf16>, %arg6: tensor<128xbf16>) -> tensor<1x128x28x28xbf16> {
    ...
    %7 = "ttir.conv2d"(%5, %arg0, %6) <{dilation = array<i32: 1, 1>, flattened_compat_info = #ttir<flattened_compat in_channels = 128, out_channels = 128, batch_size = 1, input_height = 28, input_width = 28,>, groups = 1 : i32, padding = array<i32: 1, 1, 1, 1>, stride = array<i32: 1, 1>}> : (tensor<1x1x784x128xbf16>, tensor<128x128x3x3xbf16>, tensor<1x1x784x128xbf16>) -> tensor<1x1x784x128xbf16>
    ...
    %27 = "ttir.conv2d"(%25, %arg5, %26) <{dilation = array<i32: 1, 1>, flattened_compat_info = #ttir<flattened_compat in_channels = 128, out_channels = 128, batch_size = 1, input_height = 28, input_width = 28,>, groups = 1 : i32, padding = array<i32: 1, 1, 1, 1>, stride = array<i32: 1, 1>}> : (tensor<1x1x784x128xbf16>, tensor<128x128x3x3xbf16>, tensor<1x1x784x128xbf16>) -> tensor<1x1x784x128xbf16>
