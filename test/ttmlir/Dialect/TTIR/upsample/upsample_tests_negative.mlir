...
module {
  func.func @upsample2d_input_3d(%arg0: tensor<3x16x16xbf16>) -> tensor<3x16x16xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = 1 : si64}> : (tensor<3x16x16xbf16>, tensor<3x16x16xbf16>) -> tensor<3x16x16xbf16>
...
module {
  func.func @upsample2d_input_5d(%arg0: tensor<3x16x16x32x4xbf16>) -> tensor<3x16x16x32x4xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = 1 : si64}> : (tensor<3x16x16x32x4xbf16>, tensor<3x16x16x32x4xbf16>) -> tensor<3x16x16x32x4xbf16>
...
module {
  func.func @upsample2d_output_2d(%arg0: tensor<1x16x16x1xbf16>) -> tensor<16x16xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = 1 : si64}> : (tensor<1x16x16x1xbf16>, tensor<16x16xbf16>) -> tensor<16x16xbf16>
...
module {
  func.func @upsample2d_scale_factor_triplet(%arg0: tensor<3x16x16x4xbf16>) -> tensor<3x16x16x4xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = array<i64: 1, 1, 1>}> : (tensor<3x16x16x4xbf16>, tensor<3x16x16x4xbf16>) -> tensor<3x16x16x4xbf16>
...
module {
  func.func @upsample2d_nonpositive_scale_factor_uniform(%arg0: tensor<3x16x16x4xbf16>) -> tensor<3x16x16x4xbf16> {
    ...
    %0 = tensor.empty() : tensor<3x16x16x4xbf16>
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = 0 : si64}> : (tensor<3x16x16x4xbf16>, tensor<3x16x16x4xbf16>) -> tensor<3x16x16x4xbf16>
    return %1 : tensor<3x16x16x4xbf16>
  }
}
...
module {
  func.func @upsample2d_nonpositive_scale_factor_nonuniform(%arg0: tensor<3x16x16x4xbf16>) -> tensor<3x16x16x4xbf16> {
    ...
    %0 = tensor.empty() : tensor<3x16x16x4xbf16>
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = array<i64: 1, -1>}> : (tensor<3x16x16x4xbf16>, tensor<3x16x16x4xbf16>) -> tensor<3x16x16x4xbf16>
    return %1 : tensor<3x16x16x4xbf16>
  }
}
...
module {
  func.func @upsample2d_mismatch_n(%arg0: tensor<3x16x16x4xbf16>) -> tensor<6x16x16x4xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = 1 : si64}> : (tensor<3x16x16x4xbf16>, tensor<6x16x16x4xbf16>) -> tensor<6x16x16x4xbf16>
...
module {
  func.func @upsample2d_mismatch_c(%arg0: tensor<3x16x16x4xbf16>) -> tensor<3x16x16x8xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = 1 : si64}> : (tensor<3x16x16x4xbf16>, tensor<3x16x16x8xbf16>) -> tensor<3x16x16x8xbf16>
...
module {
  func.func @upsample2d__mismatch_c_channel_first(%arg0: tensor<3x4x16x16xbf16>) -> tensor<3x8x16x16xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = 1 : si64, channel_last = false}> : (tensor<3x4x16x16xbf16>, tensor<3x8x16x16xbf16>) -> tensor<3x8x16x16xbf16>
...
module {
  func.func @upsample2d_unifrom_scale_mismatch_h(%arg0: tensor<3x16x32x4xbf16>) -> tensor<3x16x32x4xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = 2 : si64}> : (tensor<3x16x32x4xbf16>, tensor<3x16x32x4xbf16>) -> tensor<3x16x32x4xbf16>
...
module {
  func.func @upsample2d_unifrom_scale_mismatch_w(%arg0: tensor<3x16x32x4xbf16>) -> tensor<3x32x32x4xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = 2 : si64}> : (tensor<3x16x32x4xbf16>, tensor<3x32x32x4xbf16>) -> tensor<3x32x32x4xbf16>
...
module {
  func.func @upsample2d_nonunifrom_scale_mismatch_h(%arg0: tensor<3x16x32x4xbf16>) -> tensor<3x16x128x4xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = array<i64 : 2, 4>}> : (tensor<3x16x32x4xbf16>, tensor<3x16x128x4xbf16>) -> tensor<3x16x128x4xbf16>
...
module {
  func.func @upsample2d_nonunifrom_scale_mismatch_w(%arg0: tensor<3x16x32x4xbf16>) -> tensor<3x32x64x4xbf16> {
    ...
    %1 = "ttir.upsample2d"(%arg0, %0) <{scale_factor = array<i64 : 2, 4>}> : (tensor<3x16x32x4xbf16>, tensor<3x32x64x4xbf16>) -> tensor<3x32x64x4xbf16>
...
module {
  func.func @upsample2d_supported_mode(%arg0: tensor<3x16x32x4xbf16>) -> tensor<3x16x32x4xbf16> {
    ...
    %0 = tensor.empty() : tensor<3x16x32x4xbf16>
    %1 = "ttir.upsample2d"(%arg0, %0) <{mode = "x", scale_factor = 1 : si64}> : (tensor<3x16x32x4xbf16>, tensor<3x16x32x4xbf16>) -> tensor<3x16x32x4xbf16>
    return %1 : tensor<3x16x32x4xbf16>
  }
}
