...
module attributes {} {
  func.func @slice_1d(%arg0: tensor<64xbf16>, %arg1 : tensor<1xi32>, %arg2 : tensor<1xi32>) -> tensor<32xbf16> {
    ...
    %1 = "ttir.slice_dynamic"(%arg0, %arg1, %arg2) <{step = [1: i32]}> : (tensor<64xbf16>, tensor<1xi32>, tensor<1xi32>) -> tensor<32xbf16>
    return %1 : tensor<32xbf16>
  }

  func.func @slice_1d_step(%arg0: tensor<64xbf16>, %arg1 : tensor<1xi32>, %arg2 : tensor<1xi32>) -> tensor<16xbf16> {
    // CHECK: = "ttir.slice_dynamic"
    %1 = "ttir.slice_dynamic"(%arg0, %arg1, %arg2) <{step = [4: i32]}> : (tensor<64xbf16>, tensor<1xi32>, tensor<1xi32>) -> tensor<16xbf16>
    return %1 : tensor<16xbf16>
  }

  func.func @slice_2d(%arg0: tensor<128x64xbf16>, %arg1 : tensor<2xi32>, %arg2 : tensor<2xi32>) -> tensor<64x32xbf16> {
    // CHECK: = "ttir.slice_dynamic"
    %1 = "ttir.slice_dynamic"(%arg0, %arg1, %arg2) <{step = [1: i32, 1: i32]}> : (tensor<128x64xbf16>, tensor<2xi32>, tensor<2xi32>) -> tensor<64x32xbf16>
  ...
  func.func @slice_2d_step(%arg0: tensor<128x64xbf16>, %arg1 : tensor<2xi32>, %arg2 : tensor<2xi32>) -> tensor<32x16xbf16> {
    // CHECK: = "ttir.slice_dynamic"
    %1 = "ttir.slice_dynamic"(%arg0, %arg1, %arg2) <{step = [2: i32, 4: i32]}> : (tensor<128x64xbf16>, tensor<2xi32>, tensor<2xi32>) -> tensor<32x16xbf16>
  ...
  func.func @slice_3d(%arg0: tensor<3x128x64xbf16>, %arg1 : tensor<3xi32>, %arg2 : tensor<3xi32>) -> tensor<1x64x64xbf16> {
    // CHECK: = "ttir.slice_dynamic"
    %1 = "ttir.slice_dynamic"(%arg0, %arg1, %arg2) <{step = [1: i32, 1: i32, 1: i32]}> : (tensor<3x128x64xbf16>, tensor<3xi32>, tensor<3xi32>) -> tensor<1x64x64xbf16>
  ...
  func.func @slice_3d_step(%arg0: tensor<3x128x64xbf16>, %arg1 : tensor<3xi32>, %arg2 : tensor<3xi32>) -> tensor<2x32x32xbf16> {
    // CHECK: = "ttir.slice_dynamic"
    %1 = "ttir.slice_dynamic"(%arg0, %arg1, %arg2) <{step = [2: i32, 4: i32, 1: i32]}> : (tensor<3x128x64xbf16>, tensor<3xi32>, tensor<3xi32>) -> tensor<2x32x32xbf16>
  ...
  func.func @slice_4d(%arg0: tensor<10x3x128x64xbf16>, %arg1 : tensor<4xi32>, %arg2 : tensor<4xi32>) -> tensor<5x3x32x64xbf16> {
    // CHECK: = "ttir.slice_dynamic"
    %1 = "ttir.slice_dynamic"(%arg0, %arg1, %arg2) <{step = [1: i32, 1: i32, 1: i32, 1: i32]}> : (tensor<10x3x128x64xbf16>, tensor<4xi32>, tensor<4xi32>) -> tensor<5x3x32x64xbf16>
  ...
  func.func @slice_4d_step(%arg0: tensor<10x3x128x64xbf16>, %arg1 : tensor<4xi32>, %arg2 : tensor<4xi32>) -> tensor<4x1x16x32xbf16> {
    // CHECK: = "ttir.slice_dynamic"
    %1 = "ttir.slice_dynamic"(%arg0, %arg1, %arg2) <{step = [3: i32, -2: i32, 8: i32, 2: i32]}> : (tensor<10x3x128x64xbf16>, tensor<4xi32>, tensor<4xi32>) -> tensor<4x1x16x32xbf16>
