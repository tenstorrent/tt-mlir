...
module {
  func.func @reshape_input_output_elements_mismatch(%arg0: tensor<2x32x32xbf16>) -> tensor<32x3x32xbf16> {
    %1 = "ttir.reshape"(%arg0) <{shape = [32: i32, 3: i32, 32: i32]}> : (tensor<2x32x32xbf16>) -> tensor<32x3x32xbf16>
...
module {
  func.func @reshape_infer_dim_negative(%arg0: tensor<2x32x32xbf16>) -> tensor<32x2x32xbf16> {
    %1 = "ttir.reshape"(%arg0) <{shape = [32: i32, -1: i32, -1: i32]}> : (tensor<2x32x32xbf16>) -> tensor<32x2x32xbf16>
...
module {
  func.func @reshape_infer_dim_negative(%arg0: tensor<2x32x32xbf16>) -> tensor<32x2x32xbf16> {
    %1 = "ttir.reshape"(%arg0) <{shape = [32: i32, -1: i32, -32: i32]}> : (tensor<2x32x32xbf16>) -> tensor<32x2x32xbf16>
...
module {
  func.func @reshape_shape_mismatch(%arg0: tensor<2x32x32xbf16>) -> tensor<32x2x32xbf16> {
    %1 = "ttir.reshape"(%arg0) <{shape = [32: i32, 3: i32, 32: i32]}> : (tensor<2x32x32xbf16>) -> tensor<32x2x32xbf16>
