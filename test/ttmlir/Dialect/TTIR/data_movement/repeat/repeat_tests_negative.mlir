...
module {
  func.func @repeat_not_valid_repeat_dimension_attribute(%arg0: tensor<32x32xf32>) -> tensor<32x64xf32> {
    ...
    %1 = "ttir.repeat"(%arg0) {repeat_dimensions = array<i64 : 2>} : (tensor<32x32xf32>) -> tensor<32x64xf32>
...
module {
  func.func @repeat_not_valid_input_output(%arg0: tensor<32x32xf32>) -> tensor<1x32x64xf32> {
    ...
    %1 = "ttir.repeat"(%arg0) {repeat_dimensions = array<i64 : 1, 2>} : (tensor<32x32xf32>) -> tensor<1x32x64xf32>
