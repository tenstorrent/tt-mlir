...
module {
  ...
  func.func @propagate_through_mesh_partition(
    ...
    %0 = "ttir.mesh_shard"(%arg1) <{shard_dims = array<i64: -1>, shard_direction = #ttcore.shard_direction<full_to_shard>, shard_shape = array<i64: 1>, shard_type = #ttcore.shard_type<devices>}> : (tensor<128x2880x5760xbf16>) -> tensor<128x2880x5760xbf16>
