...
// Test that weight_dtype propagates through mesh_partition to the
// sparse_matmul. This is the typical pattern for MoE expert weights in
...
module {
  ...
  func.func @propagate_through_mesh_partition(
    ...
    %1 = "ttir.mesh_partition"(%arg1) <{cluster_axis = 1 : ui32, dim = 0 : si32}> : (tensor<128x2880x5760xbf16>) -> tensor<32x2880x5760xbf16>
    ...
    %3 = "ttir.sparse_matmul"(%arg0, %2, %arg2) <{is_input_a_sparse = false, is_input_b_sparse = true}> : (tensor<4x4x32x2880xbf16>, tensor<1x32x2880x5760xbf16>, tensor<4x4x1x32xbf16>) -> tensor<4x4x1x32x32x5760xbf16>
