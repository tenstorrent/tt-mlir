...
module attributes {} {
  func.func @reduce_scatter_sum_positive(%arg0: tensor<8192x2048xf32>) -> tensor<8192x1024xf32> {
    ...
    %1 = "ttir.reduce_scatter"(%arg0) <{cluster_axis = 1 : ui32, reduce_type = #ttcore.reduce_type<sum>, scatter_dim = 1 : si32}> : (tensor<8192x2048xf32>) -> tensor<8192x1024xf32>
...
module attributes {} {
  func.func @reduce_scatter_sum_4d_positive(%arg0: tensor<1x1x8192x2048xf32>) -> tensor<1x1x8192x1024xf32> {
    ...
    %1 = "ttir.reduce_scatter"(%arg0) <{cluster_axis = 1 : ui32, reduce_type = #ttcore.reduce_type<sum>, scatter_dim = 3 : si32}> : (tensor<1x1x8192x2048xf32>) -> tensor<1x1x8192x1024xf32>
