...
module attributes {} {
  func.func public @collective_broadcast_invalid_output_type(%arg0: tensor<1x1x8192x512xf32>) -> (tensor<1x1x4096x512xf32> {jax.result_info = ""}) {
    %1 = "ttir.collective_broadcast"(%arg0) <{replica_groups = dense<[[0, 1, 2, 3], [4, 5, 6, 7]]> : tensor<2x4xi64>}> : (tensor<1x1x8192x512xf32>) -> tensor<1x1x4096x512xf32>
...
module attributes {} {
  func.func public @collective_broadcast_invalid_replica_groups_shape(%arg0: tensor<1x1x8192x512xf32>) -> (tensor<1x1x8192x512xf32> {jax.result_info = ""}) {
    %1 = "ttir.collective_broadcast"(%arg0) <{replica_groups = dense<[[[0, 1], [2, 3]], [[4, 5], [6, 7]]]> : tensor<2x2x2xi64>}> : (tensor<1x1x8192x512xf32>) -> tensor<1x1x8192x512xf32>
...
module attributes {} {
  func.func public @collective_broadcast_negative_device_id(%arg0: tensor<1x1x8192x512xf32>) -> (tensor<1x1x8192x512xf32> {jax.result_info = ""}) {
    %1 = "ttir.collective_broadcast"(%arg0) <{replica_groups = dense<[[0, 1, 2, -1], [4, 5, 6, -1]]> : tensor<2x4xi64>}> : (tensor<1x1x8192x512xf32>) -> tensor<1x1x8192x512xf32>
    return %1 : tensor<1x1x8192x512xf32>
  }
}
...
module attributes {} {
  func.func public @collective_broadcast_duplicated_device_id(%arg0: tensor<1x1x8192x512xf32>) -> (tensor<1x1x8192x512xf32> {jax.result_info = ""}) {
    %1 = "ttir.collective_broadcast"(%arg0) <{replica_groups = dense<[[0, 1, 2, 3], [0, 5, 6, 7]]> : tensor<2x4xi64>}> : (tensor<1x1x8192x512xf32>) -> tensor<1x1x8192x512xf32>
    return %1 : tensor<1x1x8192x512xf32>
  }
}
...
module attributes {} {
  func.func public @collective_broadcast_duplicated_device_id(%arg0: tensor<1x1x8192x512xf32>) -> (tensor<1x1x8192x512xf32> {jax.result_info = ""}) {
    %1 = "ttir.collective_broadcast"(%arg0) <{replica_groups = dense<[[1, 2, 3, 4], [5, 6, 7, 8]]> : tensor<2x4xi64>}> : (tensor<1x1x8192x512xf32>) -> tensor<1x1x8192x512xf32>
    return %1 : tensor<1x1x8192x512xf32>
  }
}
