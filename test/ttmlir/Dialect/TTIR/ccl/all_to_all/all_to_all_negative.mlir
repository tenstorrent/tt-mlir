...
module attributes {} {
  func.func public @all_to_all_split_dimension_range_1(%arg0: tensor<1x1x32x32xf32>) -> (tensor<1x1x32x32xf32> {jax.result_info = ""}) {
    %1 = "ttir.all_to_all"(%arg0) <{replica_groups = dense<[[0, 1]]> : tensor<1x2xi64>, concat_dim = 3 : si32, split_count = 2 : si32, split_dim = -1 : si32}> : (tensor<1x1x32x32xf32>) -> tensor<1x1x32x32xf32>
...
module attributes {} {
  func.func public @all_to_all_split_dimension_range_2(%arg0: tensor<1x1x32x32xf32>) -> (tensor<1x1x32x32xf32> {jax.result_info = ""}) {
    %1 = "ttir.all_to_all"(%arg0) <{replica_groups = dense<[[0, 1]]> : tensor<1x2xi64>,  concat_dim = 3 : si32, split_count = 2 : si32, split_dim = 4 : si32}> : (tensor<1x1x32x32xf32>) -> tensor<1x1x32x32xf32>
    return %1 : tensor<1x1x32x32xf32>
  }
}
...
module attributes {} {
  func.func public @all_to_all_concat_dimension_range_1(%arg0: tensor<1x1x32x32xf32>) -> (tensor<1x1x32x32xf32> {jax.result_info = ""}) {
    %1 = "ttir.all_to_all"(%arg0) <{replica_groups = dense<[[0, 1]]> : tensor<1x2xi64>,  concat_dim = -1 : si32, split_count = 2 : si32, split_dim = 3 : si32}> : (tensor<1x1x32x32xf32>) -> tensor<1x1x32x32xf32>
    return %1 : tensor<1x1x32x32xf32>
  }
}
...
module attributes {} {
  func.func public @all_to_all_concat_dimension_range_2(%arg0: tensor<1x1x32x32xf32>) -> (tensor<1x1x32x32xf32> {jax.result_info = ""}) {
    %1 = "ttir.all_to_all"(%arg0) <{replica_groups = dense<[[0, 1]]> : tensor<1x2xi64>,  concat_dim = 4 : si32, split_count = 2 : si32, split_dim = 3 : si32}> : (tensor<1x1x32x32xf32>) -> tensor<1x1x32x32xf32>
    return %1 : tensor<1x1x32x32xf32>
  }
}
...
module attributes {} {
  func.func public @all_to_all_split_count_range(%arg0: tensor<1x1x32x32xf32>) -> (tensor<1x1x32x32xf32> {jax.result_info = ""}) {
    %1 = "ttir.all_to_all"(%arg0) <{replica_groups = dense<[[0, 1]]> : tensor<1x2xi64>,  concat_dim = 3 : si32, split_count = 0 : si32, split_dim = 3 : si32}> : (tensor<1x1x32x32xf32>) -> tensor<1x1x32x32xf32>
    return %1 : tensor<1x1x32x32xf32>
  }
}
...
module attributes {} {
  func.func public @all_to_all_output_type_1(%arg0: tensor<1x1x32x32xf32>) -> (tensor<1x1x16x64xf32> {jax.result_info = ""}) {
    %1 = "ttir.all_to_all"(%arg0) <{replica_groups = dense<[[0, 1]]> : tensor<1x2xi64>,  concat_dim = 3 : si32, split_count = 2 : si32, split_dim = 3 : si32}> : (tensor<1x1x32x32xf32>) -> tensor<1x1x16x64xf32>
...
module attributes {} {
  func.func public @all_to_all_output_type_2(%arg0: tensor<1x1x32x32xf32>) -> (tensor<1x1x32x32xf32> {jax.result_info = ""}) {
    %1 = "ttir.all_to_all"(%arg0) <{replica_groups = dense<[[0, 1]]> : tensor<1x2xi64>,  concat_dim = 2 : si32, split_count = 4 : si32, split_dim = 3 : si32}> : (tensor<1x1x32x32xf32>) -> tensor<1x1x32x32xf32>
    return %1 : tensor<1x1x32x32xf32>
  }
}
...
module attributes {} {
  func.func public @all_to_all_output_type_3(%arg0: tensor<1x1x32x32xf32>) -> (tensor<1x1x32x32xf32> {jax.result_info = ""}) {
    %1 = "ttir.all_to_all"(%arg0) <{replica_groups = dense<[[0, 1]]> : tensor<1x2xi64>,  concat_dim = 3 : si32, split_count = 8 : si32, split_dim = 2 : si32}> : (tensor<1x1x32x32xf32>) -> tensor<1x1x32x32xf32>
    return %1 : tensor<1x1x32x32xf32>
  }
}
...
module attributes {} {
  func.func public @all_to_all_output_type_4(%arg0: tensor<1x1x32x32xf32>) -> (tensor<1x1x32x32xi32> {jax.result_info = ""}) {
    %1 = "ttir.all_to_all"(%arg0) <{replica_groups = dense<[[0, 1]]> : tensor<1x2xi64>,  concat_dim = 3 : si32, split_count = 2 : si32, split_dim = 3 : si32}> : (tensor<1x1x32x32xf32>) -> tensor<1x1x32x32xi32>
