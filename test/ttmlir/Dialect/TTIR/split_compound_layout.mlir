...
func.func @noncompound_linear(%in: tensor<64x128xf32, #row_major1x1>) -> tensor<64x128xf32, #row_major1x1_T> {
    %out = ttir.empty() : tensor<64x128xf32, #row_major1x1_T>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[row_major1x1]]>, tensor<64x128xf32, #[[row_major1x1_T]]>) -> tensor<64x128xf32, #[[row_major1x1_T]]>
    // CHECK-NOT: = "ttir.to_layout"[[LAYOUT:.*]]
...
func.func @noncompound_grid(%in: tensor<64x128xf32, #row_major1x1>) -> tensor<64x128xf32, #row_major2x2> {
    %out = ttir.empty() : tensor<64x128xf32, #row_major2x2>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[row_major1x1]]>, tensor<64x128xf32, #[[row_major2x2]]>) -> tensor<64x128xf32, #[[row_major2x2]]>
    // CHECK-NOT: = "ttir.to_layout"[[LAYOUT:.*]]
...
func.func @noncompound_format(%in: tensor<64x128xf32, #tile1x1_f32>) -> tensor<64x128xf32, #tile1x1_bf16> {
    %out = ttir.empty() : tensor<64x128xf32, #tile1x1_bf16>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[tile1x1_f32]]>, tensor<64x128xf32, #[[tile1x1_bf16]]>) -> tensor<64x128xf32, #[[tile1x1_bf16]]>
    // CHECK-NOT: = "ttir.to_layout"[[LAYOUT:.*]]
...
func.func @noncompound_memspace(%in: tensor<64x128xf32, #tile1x1_f32>) -> tensor<64x128xf32, #tile1x1_f32_dram> {
    %out = ttir.empty() : tensor<64x128xf32, #tile1x1_f32_dram>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[tile1x1_f32]]>, tensor<64x128xf32, #[[tile1x1_f32_dram]]>) -> tensor<64x128xf32, #[[tile1x1_f32_dram]]>
    // CHECK-NOT: = "ttir.to_layout"[[LAYOUT:.*]]
...
func.func @compound_gridformat(%in: tensor<64x128xf32, #row_major1x1>) -> tensor<64x128xf32, #tile2x2_f32> {
    %out = ttir.empty() : tensor<64x128xf32, #tile2x2_f32>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[row_major1x1]]>, tensor<64x128xf32, #[[tile1x1_f32]]>) -> tensor<64x128xf32, #[[tile1x1_f32]]>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[tile1x1_f32]]>, tensor<64x128xf32, #[[tile2x2_f32]]>) -> tensor<64x128xf32, #[[tile2x2_f32]]>
    // CHECK-NOT: = "ttir.to_layout"[[LAYOUT:.*]]
...
func.func @compound_gridmemspace(%in: tensor<64x128xf32, #tile1x1_f32_dram>) -> tensor<64x128xf32, #tile2x2_f32> {
    %out = ttir.empty() : tensor<64x128xf32, #tile2x2_f32>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[tile1x1_f32_dram]]>, tensor<64x128xf32, #[[tile1x1_f32]]>) -> tensor<64x128xf32, #[[tile1x1_f32]]>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[tile1x1_f32]]>, tensor<64x128xf32, #[[tile2x2_f32]]>) -> tensor<64x128xf32, #[[tile2x2_f32]]>
    // CHECK-NOT: = "ttir.to_layout"[[LAYOUT:.*]]
...
func.func @compound_gridmemspaceformat(%in: tensor<64x128xf32, #tile1x1_f32_dram>) -> tensor<64x128xf32, #row_major2x2> {
    ...
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[tile1x1_f32_dram]]>, tensor<64x128xf32, #[[tile1x1_f32]]>) -> tensor<64x128xf32, #[[tile1x1_f32]]>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[tile1x1_f32]]>, tensor<64x128xf32, #[[tile2x2_f32]]>) -> tensor<64x128xf32, #[[tile2x2_f32]]>
    // CHECK-COUNT-1: = "ttir.to_layout"(%[[IN:.*]], %[[OUT:.*]]) : (tensor<64x128xf32, #[[tile2x2_f32]]>, tensor<64x128xf32, #[[row_major2x2]]>) -> tensor<64x128xf32, #[[row_major2x2]]>
    // CHECK-NOT: = "ttir.to_layout"[[LAYOUT:.*]]
