...
module {
    ...
    func.func @silu_fusing_with_typecast(%arg0: tensor<32x3x3x3xbf16> {ttcore.argument_type = #ttcore.argument_type<constant>}, %arg1: tensor<1x3x224x224xbf16>) -> tensor<1x32x112x112xbf16> {
        ...
        // CHECK-NOT: "ttir.sigmoid"
        %3 = "ttir.sigmoid"(%1) : (tensor<1x32x112x112xbf16>) -> tensor<1x32x112x112xbf16>
        %5 = "ttir.typecast"(%1) : (tensor<1x32x112x112xbf16>) -> tensor<1x32x112x112xf32>
        %7 = "ttir.typecast"(%3) : (tensor<1x32x112x112xbf16>) -> tensor<1x32x112x112xf32>
        // CHECK-NOT: "ttir.multiply"
        %9 = "ttir.multiply"(%5, %7) : (tensor<1x32x112x112xf32>, tensor<1x32x112x112xf32>) -> tensor<1x32x112x112xf32>
        %11 = "ttir.typecast"(%9) : (tensor<1x32x112x112xf32>) -> tensor<1x32x112x112xbf16>
        // CHECK: "ttir.silu"{{.*}} -> [[LAYOUT_0]]
