...
func.func @convolution_batch_norm(%arg0: tensor<1x3x224x224xbf16>, %arg1: tensor<64x3x7x7xbf16>, %arg2: tensor<64xbf16>, %arg3: tensor<64xbf16>, %arg4: tensor<64xbf16>, %arg5: tensor<64xbf16>) -> tensor<1x64x112x112xbf16> {
    ...
    %3 = "ttir.batch_norm"(%1, %arg2, %arg3, %arg4, %arg5, %2) <{dimension = 1 : i32, epsilon = 0.0 : f32, training = false}> : (tensor<1x64x112x112xbf16>, tensor<64xbf16>, tensor<64xbf16>, tensor<64xbf16>, tensor<64xbf16>, tensor<1x64x112x112xbf16>) -> tensor<1x64x112x112xbf16>
