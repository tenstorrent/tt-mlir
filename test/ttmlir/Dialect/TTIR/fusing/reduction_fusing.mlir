...
module {
  ...
  func.func @sum_reshape_fusion(%arg0: tensor<32x64x128xf32>) -> tensor<32x1x128xf32> {
    ...
    %3 = "ttir.reshape"(%1) {shape = [32 : i32, 1 : i32, 128 : i32]} : (tensor<32x128xf32>) -> tensor<32x1x128xf32>
...
module {
  ...
  func.func @mean_reshape_fusion(%arg0: tensor<32x64x128xf32>) -> tensor<32x64x1xf32> {
    ...
    %3 = "ttir.reshape"(%1) {shape = [32 : i32, 64 : i32, 1 : i32]} : (tensor<32x64xf32>) -> tensor<32x64x1xf32>
...
module {
  ...
  func.func @max_reshape_fusion(%arg0: tensor<32x64x128xf32>) -> tensor<1x64x128xf32> {
    ...
    %3 = "ttir.reshape"(%1) {shape = [1 : i32, 64 : i32, 128 : i32]} : (tensor<64x128xf32>) -> tensor<1x64x128xf32>
...
module {
  ...
  func.func @multi_dim_reduction_reshape_fusion(%arg0: tensor<32x64x128xf32>) -> tensor<32x1x1xf32> {
    // CHECK: %[[RESULT:.*]] = "ttir.sum"(%arg0) <{dim_arg = [1 : i32, 2 : i32], keep_dim = true}> : (tensor<32x64x128xf32>) -> tensor<32x1x1xf32>
    // CHECK-NOT: ttir.reshape
    // CHECK: return %[[RESULT]]

    %1 = "ttir.sum"(%arg0) {dim_arg = [1 : i32, 2 : i32], keep_dim = false} : (tensor<32x64x128xf32>) -> tensor<32xf32>

    %3 = "ttir.reshape"(%1) {shape = [32 : i32, 1 : i32, 1 : i32]} : (tensor<32xf32>) -> tensor<32x1x1xf32>
...
module {
  ...
  func.func @no_fusion_already_keep_dim(%arg0: tensor<32x64x128xf32>) -> tensor<32x1x128xf32> {
    ...
    %1 = "ttir.sum"(%arg0) {dim_arg = [1 : i32], keep_dim = true} : (tensor<32x64x128xf32>) -> tensor<32x1x128xf32>

    %3 = "ttir.reshape"(%1) {shape = [32 : i32, 1 : i32, 128 : i32]} : (tensor<32x1x128xf32>) -> tensor<32x1x128xf32>
...
module {
  ...
  func.func @no_fusion_more_than_one_use(%arg0: tensor<32x64x128xf32>) -> tensor<32x1x128xf32> {
    ...
    %5 = "ttir.reshape"(%3) {shape = [32 : i32, 1 : i32, 128 : i32]} : (tensor<32x128xf32>) -> tensor<32x1x128xf32>

    %7 = "ttir.reshape"(%1) {shape = [32 : i32, 1 : i32, 128 : i32]} : (tensor<32x128xf32>) -> tensor<32x1x128xf32>
...
module {
  ...
  func.func @no_fusion_rank_mismatch(%arg0: tensor<32x64x128xf32>) -> tensor<32x1x1x128xf32> {
    ...
    %3 = "ttir.reshape"(%1) {shape = [32 : i32, 1 : i32, 1 : i32, 128 : i32]} : (tensor<32x128xf32>) -> tensor<32x1x1x128xf32>
