...
func.func @test_mixed_semantics(%arg0: memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096>, #l1_>) {
  ...
  ins(%arg0 : memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096>, #l1_>)
  outs(%alloc : memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096>, #l1_>) {
  ^datamovement(%mem0: memref<2x4x!ttcore.tile<32x32, f32>, #l1_>, %mem1: memref<2x4x!ttcore.tile<32x32, f32>, #l1_>):
    d2m.yield %mem0 : (memref<2x4x!ttcore.tile<32x32, f32>, #l1_>)
  }, {
  ^compute(%mem0: memref<2x4x!ttcore.tile<32x32, f32>, #l1_>, %mem1: memref<2x4x!ttcore.tile<32x32, f32>, #l1_>):
    // This region uses traditional memref semantics with d2m.await
    d2m.await %mem0 : (memref<2x4x!ttcore.tile<32x32, f32>, #l1_>)
  }
