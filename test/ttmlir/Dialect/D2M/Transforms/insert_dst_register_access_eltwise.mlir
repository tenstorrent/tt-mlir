...
module {
  ...
  func.func @intermediates_thru_dst_chain_2(%in0: memref<1x1x1x1x!ttcore.tile<32x32, f16>, #ttcore.shard<2048x2048, 1>, #l1_>,
    ...
    ^unified0(%arg0_cb: !d2m.cb<memref<1x1x!ttcore.tile<32x32, f16>, #l1_>>, %arg1_cb: !d2m.cb<memref<1x1x!ttcore.tile<32x32, f16>, #l1_>>, %arg2_cb: !d2m.cb<memref<1x1x!ttcore.tile<32x32, f16>, #l1_>>):
      ...
      scf.for %arg0 = %c0 to %c1 step %c1 {
        scf.for %arg1 = %c0 to %c1 step %c1 {
          ...
          ^bb0(%in: !ttcore.tile<32x32, f16>, %in_17: !ttcore.tile<32x32, f16>, %out: !ttcore.tile<32x32, f16>):
            ...
            // CHECK: affine.store %[[DIV_RESULT]], %[[DST:.*]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
            // CHECK: %[[DST_DIV:.*]] = affine.load %[[DST]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
            ...
            // CHECK: affine.store %[[RECIP_RESULT]], %[[DST]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
            // CHECK: %[[FINAL_VAL:.*]] = affine.load %[[DST]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
      ...
      scf.for %arg0 = %c0 to %c1 step %c1 {
        scf.for %arg1 = %c0 to %c1 step %c1 {
          ...
          ^bb0(%in: !ttcore.tile<32x32, f16>, %in_17: !ttcore.tile<32x32, f16>, %out: !ttcore.tile<32x32, f16>):
            ...
            // CHECK: affine.store %[[SUB_RESULT]], %[[DST:.*]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
            // CHECK: %[[DST_SUB:.*]] = affine.load %[[DST]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
            ...
            // CHECK: affine.store %[[EQZ1_RESULT]], %[[DST]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
            // CHECK: %[[DST_EQZ1:.*]] = affine.load %[[DST]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
            ...
            // CHECK: affine.store %[[EQZ2_RESULT]], %[[DST]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
            // CHECK: %[[FINAL_VAL:.*]] = affine.load %[[DST]][2] : memref<8x!ttcore.tile<32x32, f16>, #dst>
            // CHECK: affine.store %[[FINAL_VAL]], {{.*}} : memref<1x1x!ttcore.tile<32x32, f16>, #l1>
  ...
  // CHECK-LABEL: func.func @eltwise_binary_fpu_add
  func.func @eltwise_binary_fpu_add(%in0: memref<1x1x1x1x!ttcore.tile<32x32, f16>, #ttcore.shard<2048x2048, 1>, #l1_>,
                                              %in1: memref<1x1x1x1x!ttcore.tile<32x32, f16>, #ttcore.shard<2048x2048, 1>, #l1_>,
                                              %out0: memref<1x1x1x1x!ttcore.tile<32x32, f16>, #ttcore.shard<2048x2048, 1>, #l1_>) {
    d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<1x1>, indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = [#ttcore.iterator_type<parallel>, #ttcore.iterator_type<parallel>], threads = [#d2m.thread<unified>]}
        ins(%in0, %in1 : memref<1x1x1x1x!ttcore.tile<32x32, f16>, #ttcore.shard<2048x2048, 1>, #l1_>, memref<1x1x1x1x!ttcore.tile<32x32, f16>, #ttcore.shard<2048x2048, 1>, #l1_>)
  ...
  func.func @eltwise_unary_chain_multi_tile(%in0: memref<1x1x4x4x!ttcore.tile<32x32, bf16>, #ttcore.shard<8192x2048, 1>, #l1_>,
    ...
    ^unified0(%arg0_cb: !d2m.cb<memref<4x4x!ttcore.tile<32x32, bf16>, #l1_>>, %arg1_cb: !d2m.cb<memref<4x4x!ttcore.tile<32x32, bf16>, #l1_>>):
  ...
  // CHECK-LABEL: func.func @eltwise_with_scalar_operands
  func.func @eltwise_with_scalar_operands(%in0: memref<1x1x1x1x!ttcore.tile<32x32, bf16>, #ttcore.shard<2048x2048, 1>, #l1_>,
                                            %out0: memref<1x1x1x1x!ttcore.tile<32x32, bf16>, #ttcore.shard<2048x2048, 1>, #l1_>) {
    d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<1x1>, indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = [#ttcore.iterator_type<parallel>, #ttcore.iterator_type<parallel>], threads = [#d2m.thread<unified>]}
        ins(%in0 : memref<1x1x1x1x!ttcore.tile<32x32, bf16>, #ttcore.shard<2048x2048, 1>, #l1_>)
        outs(%out0 : memref<1x1x1x1x!ttcore.tile<32x32, bf16>, #ttcore.shard<2048x2048, 1>, #l1_>)  {
    ^unified0(%arg0_cb: !d2m.cb<memref<1x1x!ttcore.tile<32x32, bf16>, #l1_>>, %arg1_cb: !d2m.cb<memref<1x1x!ttcore.tile<32x32, bf16>, #l1_>>):
      ...
      // dstCapicity should not take be affected by scalar operand type and should be 8 slices.
      // CHECK: d2m.acquire_dst() : memref<8x!ttcore.tile<32x32, bf16>, #dst>
      scf.for %arg0 = %c0 to %c1 step %c1 {
        scf.for %arg1 = %c0 to %c1 step %c1 {
          %subview_in = memref.subview %cb0[%arg0, %arg1] [1, 1] [1, 1] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1_> to memref<1x1x!ttcore.tile<32x32, bf16>, strided<[1, 1], offset: ?>, #l1_>
          %subview_out = memref.subview %cb1[%arg0, %arg1] [1, 1] [1, 1] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1_> to memref<1x1x!ttcore.tile<32x32, bf16>, strided<[1, 1], offset: ?>, #l1_>
          linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%subview_in : memref<1x1x!ttcore.tile<32x32, bf16>, strided<[1, 1], offset: ?>, #l1_>) outs(%subview_out : memref<1x1x!ttcore.tile<32x32, bf16>, strided<[1, 1], offset: ?>, #l1_>) {
          ^bb0(%in: !ttcore.tile<32x32, bf16>, %out: !ttcore.tile<32x32, bf16>):
            %0 = "d2m.tile_sub"(%in, %cst) : (!ttcore.tile<32x32, bf16>, f32) -> !ttcore.tile<32x32, bf16>
