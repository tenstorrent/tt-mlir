...
module {
 ...
 // CHECK-AFTER: #[[LAYOUT_STREAM_1:.*]] = #ttcore.metal_layout<logical_shape = 32x2048, dim_alignments = 32x32, {{.*}} index_map = (d0, d1, d2, d3) -> ((d1 floordiv 8) mod 8, d1 mod 8, d2, d3)>
 // CHECK-AFTER: #[[LAYOUT_STREAM_2:.*]] = #ttcore.metal_layout<logical_shape = 32x2048, dim_alignments = 32x32, {{.*}} index_map = (d0, d1, d2, d3) -> (0, (d1 mod 64) floordiv 4, 0, d1 mod 4)>
