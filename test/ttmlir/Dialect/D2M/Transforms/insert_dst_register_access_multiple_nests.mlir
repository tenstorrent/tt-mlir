// RUN: ttmlir-opt --ttcore-register-device --d2m-generic-tile-compute-loops --d2m-linalg-to-affine --d2m-insert-dst-register-access-unscheduled --canonicalize -o %t %s
