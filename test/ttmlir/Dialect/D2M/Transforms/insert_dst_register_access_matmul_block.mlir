...
// RUN: ttmlir-opt --ttcore-register-device --d2m-linalg-to-affine --d2m-insert-dst-register-access='use-tile-matmul=false allocation-strategy=chaitin' --canonicalize %s | FileCheck %s
