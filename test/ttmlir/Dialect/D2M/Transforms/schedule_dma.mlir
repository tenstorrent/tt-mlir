...
module {
  ...
  func.func @test_two_remote_loads(%arg0: memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram>,
    ...
    ^datamovement0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      // CHECK-NOT: d2m.remote_load %cb1
      // CHECK: ^datamovement1
      // CHECK:   d2m.remote_load %cb1
      // CHECK-NOT: d2m.remote_load %cb0
      // CHECK: ^compute0
      ...
      scf.for %arg2 = %c0 to %c1 step %c1 {
        ...
        scf.for %arg3 = %c0 to %c1 step %c1 {
          ...
          %2 = d2m.remote_load %cb0, %arg0[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
          %3 = d2m.remote_load %cb1, %arg1[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
        } {d2m.outer_loop}
      } {d2m.outer_loop}
    }, {
  ...
  func.func @test_three_remote_loads(%arg0: memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram>,
    ...
    // CHECK-SAME: threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]
    d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<2x4>, indexing_maps = [#map, #map, #map, #map], iterator_types = [#parallel, #parallel], threads = [#d2m.thread<datamovement>, #d2m.thread<compute>]}
    ...
    ^datamovement0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb3: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      scf.for %arg3 = %c0 to %c1 step %c1 {
        ...
        scf.for %arg4 = %c0 to %c1 step %c1 {
          ...
          %2 = d2m.remote_load %cb0, %arg0[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
          %3 = d2m.remote_load %cb1, %arg1[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
          %4 = d2m.remote_load %cb2, %arg2[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
        } {d2m.outer_loop}
      } {d2m.outer_loop}
    }, {
    ...
    ^datamovement0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      scf.for %arg2 = %c0 to %c1 step %c1 {
        ...
        scf.for %arg3 = %c0 to %c1 step %c1 {
          ...
          %1 = arith.addi %core1, %arg3 : index
          %2 = d2m.remote_load %cb0, %arg0[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
          %3 = d2m.remote_store %arg1[%0, %1], %cb2 : memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram>, <memref<2x4x!ttcore.tile<32x32, f32>, #l1>> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
        } {d2m.outer_loop}
      } {d2m.outer_loop}
    }, {
    ^compute0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
  ...
  func.func @test_two_loads_one_store(%arg0: memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram>,
    ...
    ^datamovement0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb3: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      // CHECK: ^datamovement0
      // CHECK: d2m.remote_load %cb0
      // CHECK: d2m.remote_store %arg2{{.*}}, %cb3
      // CHECK: ^datamovement1
      // CHECK: d2m.remote_load %cb1
      // CHECK-NOT: d2m.remote_load %cb0
      // CHECK-NOT: d2m.remote_store
      ...
      scf.for %arg3 = %c0 to %c1 step %c1 {
        ...
        scf.for %arg4 = %c0 to %c1 step %c1 {
          ...
          %2 = d2m.remote_load %cb0, %arg0[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
          %3 = d2m.remote_load %cb1, %arg1[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
          %4 = d2m.remote_store %arg2[%0, %1], %cb3 : memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram>, <memref<2x4x!ttcore.tile<32x32, f32>, #l1>> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
        } {d2m.outer_loop}
      } {d2m.outer_loop}
    }, {
    ^compute0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb3: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
    ...
    ^datamovement0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      scf.for %arg2 = %c0 to %c1 step %c1 {
        ...
        scf.for %arg3 = %c0 to %c1 step %c1 {
          %0 = arith.addi %core0, %arg2 : index
          %1 = arith.addi %core1, %arg3 : index
          %2 = d2m.remote_store %arg1[%0, %1], %cb1 : memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram>, <memref<2x4x!ttcore.tile<32x32, f32>, #l1>> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
        } {d2m.outer_loop}
      } {d2m.outer_loop}
    }, {
    ^compute0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
  ...
  func.func @test_three_loads_one_store_balanced(%arg0: memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram>,
    ...
    // CHECK-SAME: threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]
    d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<2x4>, indexing_maps = [#map, #map, #map, #map, #map], iterator_types = [#parallel, #parallel], threads = [#d2m.thread<datamovement>, #d2m.thread<compute>]}
    ...
    ^datamovement0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb3: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb4: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      // cb0 -> thread0 (1), cb4 -> thread1 (1), cb1 -> thread0 (2), cb2 -> thread1 (2)
      // Thread0 gets cb0 + cb4 (remote_store), Thread1 gets cb1 + cb2
      // CHECK: ^datamovement0
      // Thread 0 should have 2 operations: cb0 load and cb4 store
      // CHECK: d2m.remote_load %cb0
      // CHECK: d2m.remote_store %arg3{{.*}}, %cb4
      // CHECK: ^datamovement1
      // Thread 1 should have 2 operations: cb1 load and cb2 load
      // CHECK: d2m.remote_load %cb1
      // CHECK: d2m.remote_load %cb2
      // CHECK: ^compute0
      %c0 = arith.constant 0 : index
      %c1 = arith.constant 1 : index
      scf.for %arg4 = %c0 to %c1 step %c1 {
        ...
        scf.for %arg5 = %c0 to %c1 step %c1 {
          ...
          %3 = d2m.remote_load %cb1, %arg1[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
          %4 = d2m.remote_load %cb2, %arg2[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
          %5 = d2m.remote_store %arg3[%0, %1], %cb4 : memref<2x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram>, <memref<2x4x!ttcore.tile<32x32, f32>, #l1>> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
        } {d2m.outer_loop}
      } {d2m.outer_loop}
    }, {
