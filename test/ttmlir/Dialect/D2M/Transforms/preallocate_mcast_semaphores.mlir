...
module {
    ...
    ^datamovement0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      scf.for %arg1 = %c0 to %c1 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c1 step %c1 {
          ...
          %2 = d2m.remote_load %cb0, %arg0[%0, %1] core[%c0, %c0] mcast[%c1, %c4] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<4x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
        } {d2m.outer_loop}
      } {d2m.outer_loop}
    }, {
  ...
  func.func @test_two_mcast_remote_loads(%arg0: memref<4x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram>,
    ...
    // CHECK: d2m.remote_load %cb0{{.*}} {preallocated_semaphores = [3, 4]}
    // Second load gets indices [5, 6]
    // CHECK: d2m.remote_load %cb1{{.*}} {preallocated_semaphores = [5, 6]}
    ...
    ^datamovement0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      scf.for %arg2 = %c0 to %c1 step %c1 {
        ...
        scf.for %arg3 = %c0 to %c1 step %c1 {
          ...
          %3 = d2m.remote_load %cb1, %arg1[%0, %1] core[%c0, %c0] mcast[%c4, %c1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<4x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
        } {d2m.outer_loop}
      } {d2m.outer_loop}
    }, {
    ...
    ^datamovement0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      scf.for %arg2 = %c0 to %c1 step %c1 {
        ...
        scf.for %arg3 = %c0 to %c1 step %c1 {
          ...
          %2 = d2m.remote_load %cb0, %arg0[%0, %1] core[%c0, %c0] mcast[%c1, %c4] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<4x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
          // Non-multicast load
          %3 = d2m.remote_load %cb1, %arg1[%0, %1] : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, memref<4x4x2x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #dram> -> memref<2x4x!ttcore.tile<32x32, f32>, #l1>
        } {d2m.outer_loop}
      } {d2m.outer_loop}
    }, {
    ^compute0(%cb0: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<2x4x!ttcore.tile<32x32, f32>, #l1>>):
