// RUN: ttmlir-opt --d2m-linalg-to-affine --d2m-insert-dst-register-access-unscheduled %s | FileCheck %s

#layout = #ttcore.metal_layout<logical_shape = 1x32x32x32, dim_alignments = 1x1x32x32, collapsed_intervals = dense<> : tensor<0x2xi64>, l1, sharded>
