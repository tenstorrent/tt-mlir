// RUN: ttmlir-opt --d2m-linalg-to-affine --d2m-insert-dst-register-access='allocation-strategy=basic' %s | FileCheck %s
// RUN: ttmlir-opt --d2m-linalg-to-affine --d2m-insert-dst-register-access='allocation-strategy=greedy' %s | FileCheck %s
// RUN: ttmlir-opt --d2m-linalg-to-affine --d2m-insert-dst-register-access='allocation-strategy=chaitin-briggs' %s | FileCheck %s
