...
module {
  ...
  func.func @binary(%in0: memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>,
    ...
    affine.for %i = 0 to 1 {
      affine.for %j = 0 to 1 {
        %0 = affine.load %in0[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
        affine.store %0, %dst[0, %i, %j] : memref<4x1x1x!ttcore.tile<32x32, f32>, #dst_>
        %1 = affine.load %in1[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
    ...
    affine.for %i = 0 to 1 {
      affine.for %j = 0 to 1 {
        ...
        affine.store %0, %out0[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
      }
    }
  ...
  func.func @ternary_with_interference_and_reuse(%in0: memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>,
                                       %in1: memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>,
                                       %in2: memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>,
                                       %out0: memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>) {
    ...
    affine.for %i = 0 to 1 {
      affine.for %j = 0 to 1 {
        ...
        %2 = affine.load %in2[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
    ...
    affine.for %i = 0 to 1 {
      affine.for %j = 0 to 1 {
        %load2 = affine.load %in2[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
    ...
    affine.for %i = 0 to 1 {
      affine.for %j = 0 to 1 {
        ...
        %load0 = affine.load %in0[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
