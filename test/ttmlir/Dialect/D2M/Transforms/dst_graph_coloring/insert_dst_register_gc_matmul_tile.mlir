...
module {
  ...
  func.func @matmul_simple(%in0: memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>,
    ...
    affine.for %i = 0 to 1 {
      affine.for %j = 0 to 1 {
        %a = affine.load %in0[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
        affine.store %a, %dst[0, %i, %j] : memref<3x1x1x!ttcore.tile<32x32, f32>, #dst_>
        %b = affine.load %in1[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
    ...
    affine.for %i = 0 to 1 {
      affine.for %j = 0 to 1 {
        ...
        %c = affine.load %out0[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
    ...
    affine.for %i = 0 to 1 {
      affine.for %j = 0 to 1 {
        ...
        affine.store %result, %out0[0, 0, %i, %j] : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #l1_>
      }
    }
