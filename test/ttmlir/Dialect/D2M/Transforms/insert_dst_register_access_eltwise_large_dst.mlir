// RUN: ttmlir-opt --ttcore-register-device --d2m-linalg-to-affine --d2m-insert-dst-register-access-unscheduled="max-dst-physical-size-tiles=32" --canonicalize -o %t %s
...
module {
  ...
  func.func @eltwise_unary_chain_multi_tile(%in0: memref<1x1x4x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096, 1>, #l1_>,
    ...
    ^unified0:
      %arg0_cb = d2m.get_cb(0) : !d2m.cb<memref<4x4x!ttcore.tile<32x32, f32>, #l1_>>
      %arg1_cb = d2m.get_cb(1) : !d2m.cb<memref<4x4x!ttcore.tile<32x32, f32>, #l1_>>
