...
module {
      ...
      scf.for %arg0 = %c0 to %c1 step %c1 {
        scf.for %arg1 = %c0 to %c1 step %c1 {
          ...
          ^bb0(%in: !ttcore.tile<32x32, f32>, %in_17: !ttcore.tile<32x32, f32>, %out: !ttcore.tile<32x32, f32>):
            ...
            // CHECK: affine.store %[[FINAL_VAL]], %cb2[%[[ARG_I]], %[[ARG_J]]] : memref<1x1x!ttcore.tile<32x32, f32>, #l1>
  ...
  func.func @eltwise_unary_chain_multi_tile(%in0: memref<1x1x4x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096>, #l1_>,
    ...
    ^compute0(%cb0: memref<4x4x!ttcore.tile<32x32, f32>, #l1_>, %cb1: memref<4x4x!ttcore.tile<32x32, f32>, #l1_>):
      %c0 = arith.constant 0 : index
        ...
        scf.for %arg2 = %c0 to %c4 step %c4 {
          ...
          affine.for %arg3 = 0 to 2 {
            affine.for %arg4 = 0 to 4 {
              ...
              // CHECK: affine.store %[[FINAL_VAL]], %subview_{{[0-9]*}}[%[[ARG_I]], %[[ARG_J]]] : memref<2x4x!ttcore.tile<32x32, f32>, strided<[4, 1], offset: ?>, #l1>
