...
// GridSelection materializes inputs as 1x8 storage, collapses tensors to 1x1
// for the output-driven generic grid, then re-expands only participating input
// operands and block factors to the execution plan needed by the generic.
