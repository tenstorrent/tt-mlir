// RUN: ttmlir-opt --ttcore-register-device --d2m-linalg-to-affine="use-tile-matmul=true" --d2m-insert-dst-register-access="use-tile-matmul=true" --canonicalize -o %t %s
...
module {
  ...
  func.func @generic_matmul(
    ...
    ^unified0(%arg0_cb: !d2m.cb<memref<3x3x!ttcore.tile<32x32, f16>, #l1_>>, %arg1_cb: !d2m.cb<memref<3x2x!ttcore.tile<32x32, f16>, #l1_>>, %arg2_cb: !d2m.cb<memref<3x2x!ttcore.tile<32x32, f16>, #l1_>>):
      ...
      // CHECK: affine.store %[[INIT_VAL]], %[[DST]][0] : memref<8x!ttcore.tile<32x32, f16>, #dst>
      ...
      // CHECK: %[[C_VAL:.*]] = affine.load %[[DST]][0] : memref<8x!ttcore.tile<32x32, f16>, #dst>
      ...
      // CHECK: affine.store %[[MATMUL_RESULT]], %[[DST]][0] : memref<8x!ttcore.tile<32x32, f16>, #dst>
      %c0 = arith.constant 0 : index
      ...
      // CHECK: %[[FINAL_VAL:.*]] = affine.load %[[DST]][0] : memref<8x!ttcore.tile<32x32, f16>, #dst>
