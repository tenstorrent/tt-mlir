...
module attributes {ttcore.system_desc = #system_desc} {
  ...
  func.func @test_skip_forwardable_local_remote_store_stream_input(%arg0: memref<4x3x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1>, #dram>) {
    ...
    ^unified0:
      ...
      d2m.remote_load %buffer %stream_in[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, f32>>, memref<4x3x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1>, #ttcore.view<4>, #dram> -> memref<1x1x!ttcore.tile<32x32, f32>>
      d2m.remote_store %alloc_0[%c0, %c0] %buffer : memref<4x3x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1>, #l1>, memref<1x1x!ttcore.tile<32x32, f32>> -> memref<4x3x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1>, #l1>
    }
    return
  }
}
