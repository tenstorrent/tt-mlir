...
// RUN: ttmlir-opt %s --ttir-to-ttmetal-pipeline="dst-allocation-strategy=graph-coloring-greedy" | FileCheck %s
// RUN: ttmlir-opt %s --ttir-to-ttmetal-pipeline="dst-allocation-strategy=graph-coloring-cb" | FileCheck %s
