...
func.func @pure_tensor_multiple_regions(%arg0: tensor<64x128xf32>, %arg1: tensor<64x128xf32>) -> tensor<64x128xf32> {
  ...
  ^datamovement0(%cb_in0: !d2m.cb<tensor<64x128xf32>>, %cb_in1: !d2m.cb<tensor<64x128xf32>>, %cb_out: !d2m.cb<tensor<64x128xf32>>, %sem0: !d2m.local_semaphore, %sem1: !d2m.local_semaphore, %sem2: !d2m.local_semaphore, %sem3: !d2m.local_semaphore):
  ...
  ^datamovement1(%cb_in0_2: !d2m.cb<tensor<64x128xf32>>, %cb_in1_2: !d2m.cb<tensor<64x128xf32>>, %cb_out_2: !d2m.cb<tensor<64x128xf32>>, %sem0_2: !d2m.local_semaphore, %sem1_2: !d2m.local_semaphore, %sem2_2: !d2m.local_semaphore, %sem3_2: !d2m.local_semaphore):
  ...
  ^compute0(%cb_in0_3: !d2m.cb<tensor<64x128xf32>>, %cb_in1_3: !d2m.cb<tensor<64x128xf32>>, %cb_out_3: !d2m.cb<tensor<64x128xf32>>, %sem0_3: !d2m.local_semaphore, %sem1_3: !d2m.local_semaphore, %sem2_3: !d2m.local_semaphore, %sem3_3: !d2m.local_semaphore):
