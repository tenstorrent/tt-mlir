...
!physT2 = memref<8x8x16x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096,1,(d0, d1) -> (0, 8 * d0 + d1)>, #ttcore.memory_space<l1>>
!virtT2 = memref<1x256x4x4x!ttcore.tile<32x32, f32>, #ttcore.view<(d0, d1, d2, d3) -> ((d1 floordiv 4) floordiv 8, (d1 floordiv 4) mod 8, d2, d3)>, #ttcore.memory_space<l1>>
!cbT2 = memref<4x4x!ttcore.tile<32x32, f32>, #ttcore.memory_space<l1>>

func.func @virtual_grid_blocked(%arg0 : memref<1x64x4x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096>, #ttcore.memory_space<l1>>)  {

  // input
  %physInA = memref.alloc() {address = 296352 : i64, alignment = 16 : i64} : !physT2
  %physSbA = memref.alloc() {address = 296352 : i64, alignment = 16 : i64} : !physT2
  %virtInA = "d2m.stream_layout"(%physInA,%physSbA) : (!physT2,!physT2) -> !virtT2

  // output
  %physOut   = memref.alloc() {address = 558496 : i64, alignment = 16 : i64} : !physT2
  %virtOut   = d2m.view_layout %physOut : !physT2 -> !virtT2
