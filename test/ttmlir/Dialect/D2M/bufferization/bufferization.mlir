...
// Test remote_load bufferization - loads from a view with a different index_map
...
// Test remote_store bufferization - stores to a tensor with non-identity index_map
// CHECK-LABEL: func.func @remote_store_bufferization
func.func @remote_store_bufferization() -> tensor<2x2x1x1x!ttcore.tile<32x32, f32>, #layout_view> {
  %input = d2m.empty() : tensor<2x2x1x1x!ttcore.tile<32x32, f32>, #layout_grid2x2>
