// RUN: not ttmlir-opt --ttcore-register-device "--d2m-allocate=test-assume-l1-capacity=393216 allow-l1-output-spilling=0" %s 2>&1 | FileCheck %s

// This is a negative version of `allocate.spill.mlir`, it will fail because output spilling
// is disabled (current default) and there aren't enough spillable allocs in this IR otherwise.
