...
module attributes {ttcore.system_desc = #system_desc} {
  ...
  func.func @test_view_to_stream_remote_load_update() -> memref<1x64x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1, (d0, d1, d2, d3) -> (d1 floordiv 8, d1 mod 8, d2, d3)>, #l1> {
    ...
    %view_5 = d2m.view_layout %alloc : memref<1x64x1x2x!ttcore.tile<32x32, f32>, #ttcore.shard<8192x4096, 1, (d0, d1, d2, d3) -> (d1 floordiv 8, d1 mod 8, d2, d3)>, #l1> -> memref<1x64x1x2x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #l1>
    %view_6 = d2m.view_layout %alloc_2 : memref<8x8x16x8x!ttcore.tile<32x32, f32>, #ttcore.shard<32768x4096, 1>, #l1> -> memref<64x64x2x1x!ttcore.tile<32x32, f32>, #ttcore.view<(d0, d1, d2, d3) -> ((d0 * 128 + d2 * 64 + d1) floordiv 1024, (d1 floordiv 8) mod 8, (d0 * 2 + d2 + d1 floordiv 64) mod 16, d1 mod 8)>, #l1>
    ...
    d2m.generic {block_factors = [1, 1, 64], grid = #ttcore.grid<1x64, (d0, d1) -> (0, 0, d0 * 8 + d1)>, indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d2, d1)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = [#ttcore.iterator_type<parallel>, #ttcore.iterator_type<parallel>, #ttcore.iterator_type<reduction>], threads = [#d2m.thread<unified>]}
        ins(%view_5, %view_6 : memref<1x64x1x2x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #l1>, memref<64x64x2x1x!ttcore.tile<32x32, f32>, #ttcore.view<(d0, d1, d2, d3) -> ((d0 * 128 + d2 * 64 + d1) floordiv 1024, (d1 floordiv 8) mod 8, (d0 * 2 + d2 + d1 floordiv 64) mod 16, d1 mod 8)>, #l1>)
        outs(%alloc_4 : memref<1x64x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1, (d0, d1, d2, d3) -> (d1 floordiv 8, d1 mod 8, d2, d3)>, #l1>) {
    ^unified0(%cb0: !d2m.cb<memref<1x2x!ttcore.tile<32x32, f32>, #l1>>, %cb1: !d2m.cb<memref<2x1x!ttcore.tile<32x32, f32>, #l1>>, %cb2: !d2m.cb<memref<1x1x!ttcore.tile<32x32, f32>, #l1>>):
      ...
      %iter2_11 = d2m.iter_index(2) : index
      ...
      %iter0_12 = d2m.iter_index(0) : index
      %iter1_13 = d2m.iter_index(1) : index
