...
func.func private @datamovement_kernel4() attributes {d2m.thread = #d2m.thread<datamovement>, tt.function_type = "kernel"} {
  ...
  // CHECK: %2 = ttkernel.get_semaphore(%1) : (!ttkernel.local_semaphore) -> !ttkernel.local_semaphore
  // CHECK: %3 = ttkernel.get_compile_time_arg_val(2) : () -> !ttkernel.local_semaphore
  // CHECK: %4 = ttkernel.get_semaphore(%3) : (!ttkernel.local_semaphore) -> !ttkernel.local_semaphore
