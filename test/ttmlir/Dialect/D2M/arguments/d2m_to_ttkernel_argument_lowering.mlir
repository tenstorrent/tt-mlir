...
func.func private @scalar_lowering() attributes {d2m.thread = #d2m.thread<datamovement>, tt.function_type = "kernel"} {
  ...
  %scalar = d2m.get_scalar operand_index = 2 : ui32
...
func.func private @datamovement_kernel1() attributes {d2m.thread = #d2m.thread<datamovement>, tt.function_type = "kernel"} {
  ...
  %arg3 = d2m.get_global_semaphore operand_index = 3 : !d2m.global_semaphore
  ...
  scf.for %arg4 = %c0 to %c2 step %c1 {
    scf.for %arg5 = %c0 to %c2 step %c1 {
      ...
      %1 = d2m.get_buffer operand_index = 1 : memref<2x2x2x2x!ttcore.tile<32x32, f32>, #ttcore.shard<8192x4096, 1>, #l1>
...
func.func private @datamovement_kernel4() attributes {d2m.thread = #d2m.thread<datamovement>, tt.function_type = "kernel"} {
  ...
  %arg5 = d2m.get_local_semaphore operand_index = 5 : !d2m.local_semaphore
  %arg6 = d2m.get_local_semaphore operand_index = 6 : !d2m.local_semaphore
  ...
  scf.for %arg7 = %c0 to %c4 step %c1 {
    ...
    scf.if %0 {
      ...
      %2 = d2m.get_buffer operand_index = 0 : memref<8x4x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096, 1>, #l1>
...
module {
  ...
  func.func private @datamovement0() attributes {d2m.thread = #d2m.thread<datamovement>, tt.function_type = "kernel"} {
    ...
    %arg2 = d2m.get_scalar operand_index = 2 : i32
    %arg3 = d2m.get_scalar operand_index = 3 : si32
    %arg4 = d2m.get_scalar operand_index = 4 : ui16
    %arg5 = d2m.get_scalar operand_index = 5 : si16
    %arg6 = d2m.get_scalar operand_index = 6 : ui8
    %arg7 = d2m.get_scalar operand_index = 7 : si8
    %arg8 = d2m.get_scalar operand_index = 8 : i1
    %arg9 = d2m.get_scalar operand_index = 9 : f32
    %arg10 = d2m.get_scalar operand_index = 10 : bf16
    %arg11 = d2m.get_scalar operand_index = 11 : f16
...
// Test for lowering d2m.get_buffer used as kernel argument.
#l1 = #ttcore.memory_space<l1>
  ...
  func.func @add(%arg0: memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<0x0, 1>, #l1>, %arg1: memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<0x0, 1>, #l1>) -> memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<0x0, 1>, #l1> {
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<1x1>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>]}
        ...
        outs(%alloc : memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<0x0, 1>, #l1>)
     {
      ...
      %4 = d2m.get_buffer operand_index = 0 resolution_stage =  compile : memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<0x0, 1>, #l1>
...
// Test for lowering d2m.get_buffer as a runtime arg.
#l1 = #ttcore.memory_space<l1>
#map = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>
module {
  ...
  func.func @runtime_arg_test() {
    ...
    %4 = d2m.get_buffer operand_index = 0 resolution_stage = runtime : memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<0x0, 1>, #l1>
    %tx = d2m.dma_read %4[%c0, %c0, %c0], %3[%c0], <1> : (memref<1x1x2x4x!ttcore.tile<32x32, f32>, #ttcore.shard<0x0, 1>, #l1>, memref<2x4x!ttcore.tile<32x32, f32>, #l1>) -> !d2m.mem_tx
    d2m.dma_wait %tx
    d2m.push %1 : <memref<2x4x!ttcore.tile<32x32, f32>, #l1>>
    return
