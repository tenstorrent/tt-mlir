...
// CHECK: func.func @add(%arg0: !emitpy.opaque<"vector<ttnn.Tensor>">) -> !emitpy.opaque<"vector<ttnn.Tensor>">
// CHECK: func.func @create_inputs_for_add() -> !emitpy.opaque<"vector<ttnn.Tensor>">
