...
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path%" --ttnn-to-emitpy-device-pipeline --ttcore-unwrap-device-module --emitpy-split-files -o %t_indirect.mlir %s
