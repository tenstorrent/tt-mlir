...
// CHECK-NEXT:  ttcore.global @global_var = memref<2x2x2x2x!ttcore.tile<32x32, f32>, #ttcore.shard<8192x4096>, #[[MEM_SPACE]]> [0]
// CHECK-NEXT: }
// CHECK-NEXT: }
// CHECK-NEXT: }
...
module attributes {ttcore.system_desc = #system_desc} {
  ttcore.device_module {
    builtin.module attributes {ttcore.system_desc = #system_desc} {
      ...
      ttcore.global @global_var = tensor<2x2x2x2x!ttcore.tile<32x32, f32>, #layout> [0]
    }
  }
}
