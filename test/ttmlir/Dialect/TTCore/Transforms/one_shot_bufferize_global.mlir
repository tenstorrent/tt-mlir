...
// CHECK-NEXT: ttcore.global @global_in_device_module = memref<2x2x2x2x!ttcore.tile<32x32, f32>, #ttcore.shard<8192x4096, 1>, #[[MEM_SPACE:.*]]> [0]
...
// CHECK: module attributes {ttcore.system_desc = #system_desc}
// CHECK: ttcore.device @default_device
// CHECK-NEXT: ttcore.global @global_in_toplevel = memref<2x2x2x2x!ttcore.tile<32x32, f32>, #ttcore.shard<8192x4096, 1>, #[[MEM_SPACE2:.*]]> [0]
