...
module {
  func.func @matmul_with_bias(%arg0: tensor<784x1096xbf16> {ttcore.argument_type = #ttcore.argument_type<input>}, %arg1: tensor<1096x784xbf16> {ttcore.argument_type = #ttcore.argument_type<parameter>}, %arg2: tensor<1x784xbf16> {ttcore.argument_type = #ttcore.argument_type<parameter>}) -> tensor<784x784xbf16> {
    ...
    %3 = "ttir.add"(%1, %arg2, %2) : (tensor<784x784xbf16>, tensor<1x784xbf16>, tensor<784x784xbf16>) -> tensor<784x784xbf16>
