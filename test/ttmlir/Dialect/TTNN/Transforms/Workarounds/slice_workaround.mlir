// RUN: ttmlir-opt --tt-register-device="system-desc-path=%system_desc_path%" --ttnn-workaround  %s -o slice_workaround_ttnn.mlir
...
#ttnn_layout1 = #ttnn.ttnn_layout<(d0, d1, d2) -> (d0 * 32 + d1, d2), <1x1>, memref<2x1x!tt.tile<32x32, f32>, #dram>, <interleaved>>
module attributes {} {
