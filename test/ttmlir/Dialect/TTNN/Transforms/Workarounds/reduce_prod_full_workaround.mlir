...
module {
  func.func public @test_reduce_prod_full_workaround(%arg0: tensor<128x10x32x32xf32>) -> tensor<f32> {
    ...
    %0 = "ttir.prod"(%arg0) <{dim_arg = [0 : i32, 1 : i32, 2 : i32, 3 : i32], keep_dim = false}> : (tensor<128x10x32x32xf32>) -> tensor<f32>
