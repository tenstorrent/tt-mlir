...
module attributes {tt.device = #device, tt.system_desc = #system_desc} {
  func.func @forward(%arg0: tensor<32x32xf32, #ttnn_layout>, %arg1: tensor<512x128xf32, #ttnn_layout1>) -> tensor<32x32x128xf32, #ttnn_layout2> {
    ...
    %4 = "ttnn.embedding"(%1, %3, %2) : (tensor<32x32xf32, #ttnn_layout3>, tensor<32x32x128xf32, #ttnn_layout5>, tensor<512x128xf32, #ttnn_layout4>) -> tensor<32x32x128xf32, #ttnn_layout5>
