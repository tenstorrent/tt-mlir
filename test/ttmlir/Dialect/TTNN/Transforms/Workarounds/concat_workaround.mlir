...
module attributes {} {
  func.func @test_concat_workaround(%arg0: tensor<1x53xui32, #ttnn_layout>, %arg1: tensor<1x1xui32, #ttnn_layout1>) -> tensor<1x54xui32, #ttnn_layout> {
    ...
    %1 = "ttnn.empty"(%0) <{dtype = #tt.supportedDataTypes<u32>, layout = #ttnn.layout<tile>, memory_config = #ttnn.memory_config<#dram, <interleaved>>, shape = #ttnn.shape<1x54>}> : (!ttnn.device) -> tensor<1x54xui32, #ttnn_layout>
