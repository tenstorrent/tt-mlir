...
func.func @test_subtract_to_add_and_neg_workaround(%arg0: tensor<1x16x32xf32, #ttnn_layout_lhs>, %arg1: tensor<8x16x32xf32, #ttnn_layout_rhs>) -> tensor<8x16x32xf32, #ttnn_layout_result> {
  ...
  %1 = "ttnn.subtract"(%arg0, %arg1) <{output_dtype = #ttcore.supportedDataTypes<f32>}> : (tensor<1x16x32xf32, #ttnn_layout_lhs>, tensor<8x16x32xf32, #ttnn_layout_rhs>) -> tensor<8x16x32xf32, #ttnn_layout_result>
  // CHECK: = "ttnn.neg"
  // CHECK: = "ttnn.add"
