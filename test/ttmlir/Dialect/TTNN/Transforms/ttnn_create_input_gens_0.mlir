...
module attributes {ttcore.system_desc = #system_desc} {
  ...
  func.func @add(%arg0: tuple<tensor<64x128xf32, #ttnn_layout>, tensor<64x128xf32, #ttnn_layout>>) -> tuple<tensor<64x128xf32, #ttnn_layout>> {
    ...
    %2 = "ttnn.add"(%0, %1) <{lhs_activations = [], output_dtype = #ttcore.supportedDataTypes<f32>, post_activations = [], rhs_activations = []}> : (tensor<64x128xf32, #ttnn_layout>, tensor<64x128xf32, #ttnn_layout>) -> tensor<64x128xf32, #ttnn_layout>
