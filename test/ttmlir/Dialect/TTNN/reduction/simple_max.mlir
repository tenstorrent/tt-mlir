...
module attributes {} {
  func.func @forward(%arg0: tensor<512x32xbf16>) -> tensor<512xbf16> {
    // CHECK: = "ttnn.max"
    %1 = "ttir.max"(%arg0) <{dim_arg = [1: i32], keep_dim = false}> : (tensor<512x32xbf16>) -> tensor<512xbf16>
  ...
  func.func @test_reduce_max_multi_dim(%arg0: tensor<128x32x64x32xbf16>) -> tensor<128x1x1x1xbf16> {
    ...
    %1 = "ttir.max"(%arg0) <{dim_arg = [1: i32, 2: i32, 3: i32], keep_dim = true}> : (tensor<128x32x64x32xbf16>) -> tensor<128x1x1x1xbf16>
