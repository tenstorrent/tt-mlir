...
module attributes {} {
  ...
  func.func @test_reduce_sum_multi_dim(%arg0: tensor<128x32x10x4xbf16>) -> tensor<128x1x1x1xbf16> {
    ...
    // CHECK-SAME: tensor<128x32x32x32xbf16
  ...
  func.func @test_reduce_sum_requires_padding_workaround(%arg0: tensor<128x32x60x90xbf16>) -> tensor<128x1x1x90xbf16> {
    // CHECK-LABEL: @test_reduce_sum_requires_padding_workaround(
    ...
    %1 = "ttir.sum"(%arg0, %0) <{dim_arg = [1: i32, 2: i32], keep_dim = true}> : (tensor<128x32x60x90xbf16>, tensor<128x1x1x90xbf16>) -> tensor<128x1x1x90xbf16>
