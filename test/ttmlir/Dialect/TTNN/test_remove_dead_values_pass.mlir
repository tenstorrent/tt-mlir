...
module attributes {} {
  func.func @forward(%arg0: tensor<64x128xf32, #ttnn_layout>, %arg1: tensor<64x128xf32, #ttnn_layout>) -> tensor<64x128xf32, #ttnn_layout> {
    ...
    // CHECK: "ttnn.multiply"
    %5 = "ttnn.multiply"(%2, %4) <{lhs_activations = [], output_dtype = #ttcore.supportedDataTypes<f32>, post_activations = [], rhs_activations = []}> : (tensor<64x128xf32, #ttnn_layout1>, tensor<64x128xf32, #ttnn_layout1>) -> tensor<64x128xf32, #ttnn_layout2>
    ...
    // CHECK-NOT: "ttnn.add"
    %10 = "ttnn.add"(%7, %9) <{lhs_activations = [], output_dtype = #ttcore.supportedDataTypes<f32>, post_activations = [], rhs_activations = []}> : (tensor<64x128xf32, #ttnn_layout1>, tensor<64x128xf32, #ttnn_layout1>) -> tensor<64x128xf32, #ttnn_layout2>
    ...
    %15 = "ttnn.subtract"(%12, %14) <{lhs_activations = [], output_dtype = #ttcore.supportedDataTypes<f32>, post_activations = [], rhs_activations = []}> : (tensor<64x128xf32, #ttnn_layout1>, tensor<64x128xf32, #ttnn_layout1>) -> tensor<64x128xf32, #ttnn_layout2>
    ...
    %20 = "ttnn.divide"(%17, %19) <{lhs_activations = [], output_dtype = #ttcore.supportedDataTypes<f32>, post_activations = [], rhs_activations = []}> : (tensor<64x128xf32, #ttnn_layout1>, tensor<64x128xf32, #ttnn_layout1>) -> tensor<64x128xf32, #ttnn_layout2>
    ...
    // CHECK-NOT: "ttnn.eq"
    %25 = "ttnn.eq"(%22, %24)<{lhs_activations = [], output_dtype = #ttcore.supportedDataTypes<f32>, post_activations = [], rhs_activations = []}> : (tensor<64x128xf32, #ttnn_layout1>, tensor<64x128xf32, #ttnn_layout1>) -> tensor<64x128xf32, #ttnn_layout2>
