...
module attributes {} {
  ...
  func.func @gather_dim0(%arg0: tensor<3x4xbf16>, %arg1: tensor<2x4xui32>) -> tensor<2x4xbf16> {
    %0 = "ttir.gather_dim"(%arg0, %arg1) <{dim = 0 : i32}> : (tensor<3x4xbf16>, tensor<2x4xui32>) -> tensor<2x4xbf16>
  ...
  func.func @gather_dim1(%arg0: tensor<3x4xf32>, %arg1: tensor<3x2xui32>) -> tensor<3x2xf32> {
    %0 = "ttir.gather_dim"(%arg0, %arg1) <{dim = 1 : i32}> : (tensor<3x4xf32>, tensor<3x2xui32>) -> tensor<3x2xf32>
  ...
  func.func @gather_4d(%arg0: tensor<2x3x4x5xbf16>, %arg1: tensor<2x3x2x5xui32>) -> tensor<2x3x2x5xbf16> {
    %0 = "ttir.gather_dim"(%arg0, %arg1) <{dim = 2 : i32}> : (tensor<2x3x4x5xbf16>, tensor<2x3x2x5xui32>) -> tensor<2x3x2x5xbf16>
