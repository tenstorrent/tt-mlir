...
// Verify that the we reshape the input of the all_gather op
module attributes {} {
  // CHECK-LABEL: all_gather_reshape
  func.func @all_gather_reshape(%arg0: tensor<32x128xbf16>) -> tensor<128x128xbf16> {
