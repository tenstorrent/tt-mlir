...
module @mesh_shard_test attributes {ttcore.meshes = #ttcore.meshes<[<"mesh" = 1x1>]>} {
  func.func @forward(%arg0: tensor<8192x784xf32>) -> tensor<8192x392xf32> {
    %0 = ttir.empty() : tensor<8192x392xf32>
    %1 = "ttir.mesh_shard"(%arg0, %0) <{shard_dims = array<i64: 0, 1>, shard_direction = #ttcore.shard_direction<full_to_shard>, shard_shape = array<i64: 1, 2>, shard_type = #ttcore.shard_type<identity>}> : (tensor<8192x784xf32>, tensor<8192x392xf32>) -> tensor<8192x392xf32>
    return %1 : tensor<8192x392xf32>
  }
}
// CHECK: [[DEVICE:%[0-9]+]] = "ttnn.get_device"()
...
module @mesh_shard_test attributes {ttcore.meshes = #ttcore.meshes<[<"mesh" = 1x1>]>} {
  func.func @forward(%arg0: tensor<8192x784xf32>) -> (tensor<8192x392xf32>, tensor<1xf32>) {
    ...
    %3 = "ttir.mesh_shard"(%cst, %2) <{shard_dims = array<i64: -1>, shard_direction = #ttcore.shard_direction<shard_to_full>, shard_shape = array<i64: 1>, shard_type = #ttcore.shard_type<replicate>}> : (tensor<1xf32>, tensor<1xf32>) -> tensor<1xf32>
    return %1, %3 : tensor<8192x392xf32>, tensor<1xf32>
  }
}
// CHECK: [[DEVICE:%[0-9]+]] = "ttnn.get_device"()
