...
// CHECK-NEXT: [[REG:.*]] = "ttnn.distribute_tensor"([[ARG:.*]], [[DEVICE]])
// CHECK-SAME: mapper_config
// CHECK-SAME: placements
// CHECK-SAME: <shard, 0 : i32>, <shard, 1 : i32>
// CHECK-SAME: mesh_shape_override
// CHECK-SAME: 1 : ui32, 2 : ui32
...
// CHECK: [[DEVICE:%[0-9]+]] = "ttnn.get_device"()
// CHECK: [[REG:.*]] = "ttnn.aggregate_tensor"([[ARG:.*]], [[DEVICE]])
