...
module attributes {} {
  func.func @forward(%arg0: tensor<1x32x128x128xbf16>, %arg1: tensor<1x32x128x128xbf16>) -> tensor<1x32x64x64xbf16> {
    ...
    %0, %1 = "ttir.pooling"(%arg0, %arg1) <{
        ...
        padding = array<i64: 0, 0, 0, 0, 0, 0, 0, 0>}> : (tensor<1x32x128x128xbf16>, tensor<1x32x128x128xbf16>) -> (tensor<1x32x64x64xbf16>, tensor<1x32x64x64xbf16>)

    %2 = "ttir.add"(%0, %1) : (tensor<1x32x64x64xbf16>, tensor<1x32x64x64xbf16>) -> tensor<1x32x64x64xbf16>
  ...
  func.func @forward_mixed_types(%arg0: tensor<1x32x128x128xbf16>, %arg1: tensor<1x32x128x128xf32>) -> (tensor<1x32x64x64xbf16>, tensor<1x32x64x64xf32>) {
    ...
    return %0, %1 : tensor<1x32x64x64xbf16>, tensor<1x32x64x64xf32>
  }
}
