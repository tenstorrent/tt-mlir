...
module {
  func.func @conv3d_invalid_input_shape(%arg0: tensor<8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    ...
    %1 = "ttnn.conv3d"(%arg0, %arg1, %arg2, %0)
            ...
            }> : (tensor<8x28x28x4xbf16>, tensor<108x16xbf16>, tensor<1x16xbf16>, !ttnn.device) -> tensor<1x6x26x26x16xbf16>
  ...
  func.func @conv3d_invalid_weight_shape(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x3x16xbf16>, %arg2: tensor<1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    ...
    %1 = "ttnn.conv3d"(%arg0, %arg1, %arg2, %0)
            <{
              ...
              groups = 1: i32,
              dtype = #ttcore.supportedDataTypes<bf16>
            }> : (tensor<1x8x28x28x4xbf16>, tensor<108x3x16xbf16>, tensor<1x16xbf16>, !ttnn.device) -> tensor<1x6x26x26x16xbf16>
    return %1 : tensor<1x6x26x26x16xbf16>
  }
}
...
module {
  func.func @conv3d_invalid_bias_shape(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<1x1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
    // CHECK: error: 'ttnn.conv3d' op bias must be a 2D tensor [1, O]
    %1 = "ttnn.conv3d"(%arg0, %arg1, %arg2, %0)
            <{
              in_channels = 4: i32,
              out_channels = 16: i32,
...
// -----
module {
  func.func @conv3d_invalid_output_shape(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<1x16xbf16>) -> tensor<6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
    ...
    %1 = "ttnn.conv3d"(%arg0, %arg1, %arg2, %0)
            <{
              ...
              groups = 1: i32,
              dtype = #ttcore.supportedDataTypes<bf16>
            }> : (tensor<1x8x28x28x4xbf16>, tensor<108x16xbf16>, tensor<1x16xbf16>, !ttnn.device) -> tensor<6x26x26x16xbf16>
...
// -----
module {
  func.func @conv3d_invalid_kernel_size_shape(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<36x16xbf16>, %arg2: tensor<1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
    ...
    %1 = "ttnn.conv3d"(%arg0, %arg1, %arg2, %0)
            <{
              ...
              groups = 1: i32,
              dtype = #ttcore.supportedDataTypes<bf16>
            }> : (tensor<1x8x28x28x4xbf16>, tensor<36x16xbf16>, tensor<1x16xbf16>, !ttnn.device) -> tensor<1x6x26x26x16xbf16>
    return %1 : tensor<1x6x26x26x16xbf16>
  }
}
...
// -----
module {
  func.func @conv3d_invalid_stride_shape(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
    ...
    %1 = "ttnn.conv3d"(%arg0, %arg1, %arg2, %0)
            <{
              ...
              groups = 1: i32,
              dtype = #ttcore.supportedDataTypes<bf16>
            }> : (tensor<1x8x28x28x4xbf16>, tensor<108x16xbf16>, tensor<1x16xbf16>, !ttnn.device) -> tensor<1x6x26x26x16xbf16>
    return %1 : tensor<1x6x26x26x16xbf16>
  }
}
...
// -----
module {
  func.func @conv3d_invalid_padding_shape(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
...
// -----
module {
  func.func @conv3d_invalid_stride_values(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
...
// -----
module {
  func.func @conv3d_invalid_padding_values(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
...
// -----
module {
  func.func @conv3d_invalid_groups(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<1x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
...
module {
  func.func @conv3d_bias_shape_invalid(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<16x16xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
    // CHECK: error: 'ttnn.conv3d' op bias first dimension must be 1, got 16
    %1 = "ttnn.conv3d"(%arg0, %arg1, %arg2, %0)
            <{
              in_channels = 4: i32,
              out_channels = 16: i32,
...
// -----
module {
  func.func @conv3d_out_channels_not_divisible_by_groups(%arg0: tensor<1x8x28x28x8xbf16>, %arg1: tensor<54x15xbf16>, %arg2: tensor<1x15xbf16>) -> tensor<1x6x26x26x15xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
    ...
    %1 = "ttnn.conv3d"(%arg0, %arg1, %arg2, %0)
            <{
              ...
              groups = 4: i32,
              dtype = #ttcore.supportedDataTypes<bf16>
            }> : (tensor<1x8x28x28x8xbf16>, tensor<54x15xbf16>, tensor<1x15xbf16>, !ttnn.device) -> tensor<1x6x26x26x15xbf16>
...
// -----
module {
  func.func @conv3d_bias_channels_mismatch(%arg0: tensor<1x8x28x28x4xbf16>, %arg1: tensor<108x16xbf16>, %arg2: tensor<1x32xbf16>) -> tensor<1x6x26x26x16xbf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device
    ...
    %1 = "ttnn.conv3d"(%arg0, %arg1, %arg2, %0)
            <{
              ...
              groups = 1: i32,
              dtype = #ttcore.supportedDataTypes<bf16>
            }> : (tensor<1x8x28x28x4xbf16>, tensor<108x16xbf16>, tensor<1x32xbf16>, !ttnn.device) -> tensor<1x6x26x26x16xbf16>
    return %1 : tensor<1x6x26x26x16xbf16>
  }
}
