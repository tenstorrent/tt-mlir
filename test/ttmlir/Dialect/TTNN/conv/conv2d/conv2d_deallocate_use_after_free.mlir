...
#ttnn_layout = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0, d1, d2, d3), <1x1>, memref<32x2x!ttcore.tile<32x32, bf16>, #l1>, <interleaved>>
#ttnn_layout1 = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0, d1, d2, d3), <1x1>, memref<2x2x!ttcore.tile<32x32, bf16>, #l1>, <interleaved>>
#ttnn_layout2 = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0, d1, d2, d3), <1x1>, memref<1x2x!ttcore.tile<32x32, bf16>, #l1>, <interleaved>>

module {
  func.func @forward(%input: tensor<1x1x1024x64xbf16, #ttnn_layout>, %weight: tensor<64x64x3x3xbf16, #ttnn_layout1>, %bias: tensor<1x1x1x64xbf16, #ttnn_layout2>) -> tensor<1x1x1024x64xbf16, #ttnn_layout> {
    ...
    %result = "ttnn.add"(%input, %conv_out) <{dtype = #ttcore.supportedDataTypes<bf16>, activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<1x1x1024x64xbf16, #ttnn_layout>, tensor<1x1x1024x64xbf16, #ttnn_layout>) -> tensor<1x1x1024x64xbf16, #ttnn_layout>
