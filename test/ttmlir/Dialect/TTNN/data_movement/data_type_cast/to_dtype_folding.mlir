...
module attributes {} {
    ...
    func.func @to_dtype_folding(%arg0: tensor<64x128xf32, #ttnn_layout_host_rm_f32>) -> tensor<64x128xf32, #ttnn_layout_host_rm_f32> {
        ...
        %0 = "ttnn.to_dtype"(%arg0) <{dtype = #tt.supportedDataTypes<f32>}> : (tensor<64x128xf32, #ttnn_layout_host_rm_f32>) -> tensor<64x128xf32, #ttnn_layout_host_rm_f32>
    ...
    func.func @to_dtype_folding_consecutive_typecasts(%arg0: tensor<64x128xf32, #ttnn_layout_host_rm_f32>) -> tensor<64x128xbf16, #ttnn_layout_host_rm_bf16> {
        ...
        // CHECK: ttnn.to_dtype
        // CHECK-NEXT: return
        %0 = "ttnn.to_dtype"(%arg0) <{dtype = #tt.supportedDataTypes<si32>}> : (tensor<64x128xf32, #ttnn_layout_host_rm_f32>) -> tensor<64x128xi32, #ttnn_layout_host_rm_si32>
        %1 = "ttnn.to_dtype"(%0) <{dtype = #tt.supportedDataTypes<bf16>}> : (tensor<64x128xi32, #ttnn_layout_host_rm_si32>) -> tensor<64x128xbf16, #ttnn_layout_host_rm_bf16>
