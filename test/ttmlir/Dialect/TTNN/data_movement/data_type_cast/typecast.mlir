...
module {
  func.func public @main(%arg0: tensor<32x32xui32>) -> tensor<32x32xui16> {
    ...
    // CHECK: "ttnn.typecast"
    %1 = "ttir.typecast"(%arg0) : (tensor<32x32xui32>) -> tensor<32x32xui16>
  ...
  func.func public @main3(%arg0: tensor<32x32xi32>) -> tensor<32x32xui16> {
    %0 = ttir.empty() : tensor<32x32xui16>
    // CHECK: "ttnn.typecast"
    %1 = "ttir.typecast"(%arg0) : (tensor<32x32xi32>) -> tensor<32x32xui16>
    // CHECK: return {{.*}} : tensor<32x32xui16
    return %1 : tensor<32x32xui16>
  }
  ...
  func.func public @main5(%arg0: tensor<32x32xf32>) -> tensor<32x32xui16> {
    %0 = ttir.empty() : tensor<32x32xui16>
    // CHECK: "ttnn.typecast"
    %1 = "ttir.typecast"(%arg0) : (tensor<32x32xf32>) -> tensor<32x32xui16>
    // CHECK: return {{.*}} : tensor<32x32xui16
    return %1 : tensor<32x32xui16>
  }
  func.func public @main6(%arg0: tensor<32x32xbf16>) -> tensor<32x32xui16> {
    %0 = ttir.empty() : tensor<32x32xui16>
    // CHECK: "ttnn.typecast"
    %1 = "ttir.typecast"(%arg0) : (tensor<32x32xbf16>) -> tensor<32x32xui16>
    // CHECK: return {{.*}} : tensor<32x32xui16
    return %1 : tensor<32x32xui16>
  }
  func.func public @main7(%arg0: tensor<32x32xui16>) -> tensor<32x32xui32> {
    ...
    // CHECK: "ttnn.typecast"
    %1 = "ttir.typecast"(%arg0) : (tensor<32x32xui16>) -> tensor<32x32xui32>
  ...
  func.func public @main8(%arg0: tensor<32x32xi16>) -> tensor<32x32xui32> {
    %0 = ttir.empty() : tensor<32x32xui32>
    // CHECK: "ttnn.typecast"
    %1 = "ttir.typecast"(%arg0) : (tensor<32x32xi16>) -> tensor<32x32xui32>
    // CHECK: return {{.*}} : tensor<32x32xui32
    return %1 : tensor<32x32xui32>
  }
  func.func public @main9(%arg0: tensor<32x32xi32>) -> tensor<32x32xui32> {
    %0 = ttir.empty() : tensor<32x32xui32>
    // CHECK: "ttnn.typecast"
    %1 = "ttir.typecast"(%arg0) : (tensor<32x32xi32>) -> tensor<32x32xui32>
    // CHECK: return {{.*}} : tensor<32x32xui32
    return %1 : tensor<32x32xui32>
  }
  func.func public @main11(%arg0: tensor<32x32xf32>) -> tensor<32x32xui32> {
    %0 = ttir.empty() : tensor<32x32xui32>
    // CHECK: "ttnn.typecast"
    %1 = "ttir.typecast"(%arg0) : (tensor<32x32xf32>) -> tensor<32x32xui32>
    // CHECK: return {{.*}} : tensor<32x32xui32
    return %1 : tensor<32x32xui32>
  }
  func.func public @main12(%arg0: tensor<32x32xbf16>) -> tensor<32x32xui32> {
    %0 = ttir.empty() : tensor<32x32xui32>
    // CHECK: "ttnn.typecast"
    %1 = "ttir.typecast"(%arg0) : (tensor<32x32xbf16>) -> tensor<32x32xui32>
    // CHECK: return {{.*}} : tensor<32x32xui32
    return %1 : tensor<32x32xui32>
  }
