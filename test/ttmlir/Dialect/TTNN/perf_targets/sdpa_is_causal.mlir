...
// SDPA prefill with is_causal=true on a square Sq=Sk=512. The pass
// halves the tile-mul count for causal (per the perf model).
//   tile_muls  = 16,384 / 2 = 8,192
//   compute_us = 8,192·32 / 64 GHz = 4.096 us
//   K/V bytes  = 1,114,112; dram_us = 3.868 us
//   → compute-bound (4.10 > 3.87 — just barely)
...
// CHECK: "roofline_ms": 0.0040959999999999998
// CHECK: "skipped_ops": 0
// CHECK: "top_perf_estimate_ms": 0.0058514285714285717
