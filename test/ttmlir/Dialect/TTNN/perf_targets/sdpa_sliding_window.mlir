...
// SDPA prefill with sliding_window_size=128. Effective Sk narrows to
// 128 (was 512) so tile-muls drop 4x.
//   effective Sk = 128, up32 = 4 (was 16)
//   tile_muls    = 1·8·16·8·4 = 4,096
//   compute_us   = 4,096·32 / 64 GHz = 2.048 us
//   K/V bytes    = 1,114,112; dram_us = 3.868 us
//   → DRAM-bound (3.87 > 2.05 — sliding window narrowed it past compute)
...
module attributes {ttcore.system_desc = #system_desc} {
  func.func @forward(
    ...
    %0 = "ttnn.scaled_dot_product_attention"(%q, %k, %v)
        <{is_causal = false, sliding_window_size = 128 : ui32, operandSegmentSizes = array<i32: 1, 1, 1, 0, 0>}>
        : (tensor<1x8x512x128xbf16, #q_full>,
