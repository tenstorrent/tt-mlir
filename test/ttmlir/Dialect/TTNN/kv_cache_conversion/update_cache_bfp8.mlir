...
module attributes {} {
  func.func @test_paged_update_cache_bfp8(
    ...
    // paged_update_cache accepts bf16 input with a bfp_bf8 cache; the kernel
    // handles quantization internally, so the input is not typecast.
    // CHECK: "ttnn.paged_update_cache"(%[[CACHED]], %arg1, %arg2)
