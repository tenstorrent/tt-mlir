...
module attributes {} {
  func.func @test_update_cache_bfp8(
    ...
    "ttnn.update_cache"(%arg0, %arg1, %arg2) <{batch_offset = 0 : i32}> : (
        ...
        tensor<1xi32, #ttnn.ttnn_layout<(d0) -> (0, d0), <1x1>, memref<1x1xi32, #dram>, <interleaved>>>
    ) -> ()
    return
  }
}
