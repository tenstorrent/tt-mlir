...
#ttnn_layout_row_major_bf16 = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0, d1, d2, d3), <1x1>, memref<1x1xbf16, #dram>, <interleaved>>

module attributes {} {
  func.func @max_pool2d_with_tile_f32_input(%arg0: tensor<1x1x16384x32xf32, #ttnn_layout_tile_f32>) -> tensor<1x1x4096x32xbf16, #ttnn_layout_row_major_bf16> {
    %0 = "ttnn.get_device"() <{mesh_shape = #ttnn<mesh_shape 1x1>}> : () -> !ttnn.device

    // The post-optimizer validation should detect that max_pool2d requires:
    // 1. Row-major layout for both input and output
    // 2. BFloat16 data type for both input and output
    ...
    %1 = "ttnn.max_pool2d"(%arg0) <{
      ...
      in_place_halo = false
    }> : (tensor<1x1x16384x32xf32, #ttnn_layout_tile_f32>) -> tensor<1x1x4096x32xbf16, #ttnn_layout_row_major_bf16>

    return %1 : tensor<1x1x4096x32xbf16, #ttnn_layout_row_major_bf16>
  }
}
