...
// that reshape ops do not work with int32 and converts to float32.
...
module attributes {} {
  func.func @reshape_with_int32(%arg0: tensor<1x1x32x32xsi32, #ttnn_layout_tile_si32>) -> tensor<1x32x32xf32, #ttnn_layout_tile_f32> {
    ...
    // The post-optimizer validation should detect that reshape requires:
    // float32 instead of int32, then typecast back
