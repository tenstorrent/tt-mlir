...
module {
  ttcore.device_module {
    builtin.module attributes {ttcore.system_desc = #system_desc} {
      ...
      func.func @main(%arg0: tensor<1x1x32x64xbf16, #ttnn_layout1>, %arg1: tensor<1x1x32x64xbf16, #ttnn_layout1>, %arg2: tensor<1x1x32x64xbf16, #ttnn_layout1>) -> tensor<1x1x32x64xbf16, #ttnn_layout1> {
        %0 = "ttnn.reshape"(%arg2) <{shape = [1 : i32, 1 : i32, 32 : i32, 64 : i32]}> : (tensor<1x1x32x64xbf16, #ttnn_layout1>) -> tensor<1x1x32x64xbf16, #ttnn_layout2>
        %1 = "ttnn.reshape"(%arg0) <{shape = [1 : i32, 1 : i32, 32 : i32, 64 : i32]}> : (tensor<1x1x32x64xbf16, #ttnn_layout1>) -> tensor<1x1x32x64xbf16, #ttnn_layout2>
        // CHECK: "ttnn.rotary_embedding"{{.*}}height_sharded
        %2 = "ttnn.rotary_embedding"(%arg1, %0, %1) : (tensor<1x1x32x64xbf16, #ttnn_layout1>, tensor<1x1x32x64xbf16, #ttnn_layout2>, tensor<1x1x32x64xbf16, #ttnn_layout2>) -> tensor<1x1x32x64xbf16, #ttnn_layout1>
        %3 = "ttnn.add"(%2, %2) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<1x1x32x64xbf16, #ttnn_layout1>, tensor<1x1x32x64xbf16, #ttnn_layout1>) -> tensor<1x1x32x64xbf16, #ttnn_layout1>
