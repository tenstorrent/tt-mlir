...
#ttnn_layout = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0 * 8 + d1 * 8 + d2, d3), <1x1>, memref<1x2x!ttcore.tile<32x32, bf16>, #dram>, <interleaved>>
#ttnn_layout1 = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0 * 32 + d1 * 32 + d2, d3), <1x1>, memref<1x2x!ttcore.tile<32x32, bf16>, #dram>, <interleaved>>
#ttnn_layout2 = #ttnn.ttnn_layout<(d0, d1, d2, d3) -> (d0 * 8 + d1 * 8 + d2, d3), <1x1>, memref<1x2x!ttcore.tile<32x32, bf16>, #dram>, <interleaved>>
module {
  ttcore.device_module {
    builtin.module attributes {ttcore.system_desc = #system_desc} {
      ...
      func.func @main(%arg0: tensor<1x1x1x64xbf16, #ttnn_layout>, %arg1: tensor<1x1x8x64xbf16, #ttnn_layout1>, %arg2: tensor<1x1x1x64xbf16, #ttnn_layout>) -> tensor<1x1x8x64xbf16, #ttnn_layout1> {
        ...
        %2 = "ttnn.rotary_embedding"(%arg1, %0, %1) : (tensor<1x1x8x64xbf16, #ttnn_layout1>, tensor<1x1x1x64xbf16, #ttnn_layout2>, tensor<1x1x1x64xbf16, #ttnn_layout2>) -> tensor<1x1x8x64xbf16, #ttnn_layout1>
        %3 = "ttnn.add"(%2, %2) <{dtype = #ttcore.supportedDataTypes<bf16>, activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<1x1x8x64xbf16, #ttnn_layout1>, tensor<1x1x8x64xbf16, #ttnn_layout1>) -> tensor<1x1x8x64xbf16, #ttnn_layout1>
        return %3 : tensor<1x1x8x64xbf16, #ttnn_layout1>
      }
    }
  }
}
