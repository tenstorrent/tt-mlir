...
module attributes {} {
  func.func @forward(%arg0: tensor<4096x5120xbf16>, %arg1: tensor<5120x9216xbf16>, %arg2: tensor<9216x1024xbf16>, %arg3: tensor<5120x1024xbf16>) -> tensor<4096x1024xbf16> {
    ...
    %3 = "ttir.matmul"(%1, %arg1) : (tensor<4096x5120xbf16>, tensor<5120x9216xbf16>) -> tensor<4096x9216xbf16>
    // CHECK-DAG: %{{.*}} = "ttnn.matmul"{{.*}} -> tensor<4096x1024xbf16, #[[LAYOUT_4]]>
    %5 = "ttir.matmul"(%3, %arg2) : (tensor<4096x9216xbf16>, tensor<9216x1024xbf16>) -> tensor<4096x1024xbf16>
    // CHECK-DAG: %{{.*}} = "ttnn.matmul"{{.*}} -> tensor<4096x1024xbf16, #[[LAYOUT_4]]>
    %7 = "ttir.matmul"(%1, %arg3) : (tensor<4096x5120xbf16>, tensor<5120x1024xbf16>) -> tensor<4096x1024xbf16>
    // CHECK-DAG: %{{.*}} = "ttnn.add"{{.*}} -> tensor<4096x1024xbf16, #[[LAYOUT_4]]>
    %9 = "ttir.add"(%5, %7) : (tensor<4096x1024xbf16>, tensor<4096x1024xbf16>) -> tensor<4096x1024xbf16>
