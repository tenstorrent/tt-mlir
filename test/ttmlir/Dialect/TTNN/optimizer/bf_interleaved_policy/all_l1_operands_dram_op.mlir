...
module attributes {} {
  func.func @forward(%arg0: tensor<6144x1024xbf16>, %arg1: tensor<1024x6144xbf16>) -> tensor<6144x6144xbf16> {
    ...
    %1 = "ttir.relu"(%arg0) : (tensor<6144x1024xbf16>) -> tensor<6144x1024xbf16>
    // CHECK-DAG: %{{.*}} = "ttnn.relu"{{.*}} -> tensor<1024x6144xbf16, #[[LAYOUT_5]]>
    %3 = "ttir.relu"(%arg1) : (tensor<1024x6144xbf16>) -> tensor<1024x6144xbf16>
    // CHECK: %{{.*}} = "ttnn.matmul"{{.*}} -> tensor<6144x6144xbf16, #[[LAYOUT_6]]>
    %5 = "ttir.matmul"(%1, %3) : (tensor<6144x1024xbf16>, tensor<1024x6144xbf16>) -> tensor<6144x6144xbf16>
