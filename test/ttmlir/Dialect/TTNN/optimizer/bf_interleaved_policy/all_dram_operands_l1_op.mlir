...
module attributes {} {
  func.func @forward(%arg0: tensor<5120x8192xbf16>, %arg1: tensor<8192x5120xbf16>) -> tensor<5120x5120xbf16> {
    ...
    %1 = "ttir.relu"(%arg0) : (tensor<5120x8192xbf16>) -> tensor<5120x8192xbf16>
    // CHECK-DAG: %{{.*}} = "ttnn.relu"{{.*}} -> tensor<8192x5120xbf16, #[[LAYOUT_5]]>
    %3 = "ttir.relu"(%arg1) : (tensor<8192x5120xbf16>) -> tensor<8192x5120xbf16>
    // CHECK: %{{.*}} = "ttnn.matmul"{{.*}} -> tensor<5120x5120xbf16, #[[LAYOUT_7]]>
    %5 = "ttir.matmul"(%1, %3) : (tensor<5120x8192xbf16>, tensor<8192x5120xbf16>) -> tensor<5120x5120xbf16>
