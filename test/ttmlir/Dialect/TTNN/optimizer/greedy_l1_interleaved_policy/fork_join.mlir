...
module attributes {} {
  func.func @forward(%arg0: tensor<64x64xbf16>, %arg1: tensor<64x32xbf16>) -> tensor<64x32xbf16> {
    ...
    %1 = "ttir.relu"(%arg0) : (tensor<64x64xbf16>) -> tensor<64x64xbf16>
    %3 = "ttir.gelu"(%1) : (tensor<64x64xbf16>) -> tensor<64x64xbf16>
    %5 = "ttir.matmul"(%1, %arg1) : (tensor<64x64xbf16>, tensor<64x32xbf16>) -> tensor<64x32xbf16>
    // CHECK: %{{.*}} = "ttnn.relu"{{.*}} -> tensor<64x32xbf16, #[[LAYOUT_2]]>
    %7 = "ttir.relu"(%5) : (tensor<64x32xbf16>) -> tensor<64x32xbf16>
    // CHECK: %{{.*}} = "ttnn.matmul"{{.*}} -> tensor<64x32xbf16, #[[LAYOUT_2]]>
    %9 = "ttir.matmul"(%3, %7) : (tensor<64x64xbf16>, tensor<64x32xbf16>) -> tensor<64x32xbf16>
