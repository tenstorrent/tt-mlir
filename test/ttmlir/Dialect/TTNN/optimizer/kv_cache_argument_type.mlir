...
// KV cache tensors have different layout requirements than regular inputs.
...
func.func @kv_cache_stays_tiled(
    %cache: tensor<1x32x64x512xbf16> {ttcore.argument_type = #ttcore.argument_type<input>, ttcore.kv_cache},
