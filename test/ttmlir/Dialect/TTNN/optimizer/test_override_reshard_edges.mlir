// REQUIRES: opmodel
// RUN: ttmlir-opt --tt-register-device --ttnn-optimizer=" insert-memreconfig=add_0_1_2=0 override-output-layout=add_1_2=1x1:dram:interleaved:row_major:f32" %s | FileCheck %s
// XFAIL: *
