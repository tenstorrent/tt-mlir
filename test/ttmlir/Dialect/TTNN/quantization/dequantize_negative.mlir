...
module {
  func.func @test_rank_mismatch(%arg0: tensor<3x320x320x!quant.uniform<i32:f32, 1.000000e-01>>) -> tensor<1x3x320x320xf32> {
    ...
    %0 = "ttir.dequantize"(%arg0) : (tensor<3x320x320x!quant.uniform<i32:f32, 1.000000e-01>>) -> tensor<1x3x320x320xf32>
...
module {
  func.func @test_shape_mismatch(%arg0: tensor<1x4x320x320x!quant.uniform<i32:f32, 1.000000e-01>>) -> tensor<1x3x320x320xf32> {
    ...
    %0 = "ttir.dequantize"(%arg0) : (tensor<1x4x320x320x!quant.uniform<i32:f32, 1.000000e-01>>) -> tensor<1x3x320x320xf32>
    return %0 : tensor<1x3x320x320xf32>
  }
}
...
module {
  func.func @test_invalid_input_data_type(%arg0: tensor<1x3x320x320xf32>) -> tensor<1x3x320x320xf32> {
    ...
    %0 = "ttir.dequantize"(%arg0) : (tensor<1x3x320x320xf32>) -> tensor<1x3x320x320xf32>
    return %0 : tensor<1x3x320x320xf32>
  }
}
...
module {
  func.func @test_invalid_output_data_type(%arg0: tensor<1x3x320x320x!quant.uniform<i32:f32, 1.000000e-01>>) -> tensor<1x3x320x320xi32> {
    ...
    %0 = "ttir.dequantize"(%arg0) : (tensor<1x3x320x320x!quant.uniform<i32:f32, 1.000000e-01>>) -> tensor<1x3x320x320xi32>
    return %0 : tensor<1x3x320x320xi32>
  }
}
