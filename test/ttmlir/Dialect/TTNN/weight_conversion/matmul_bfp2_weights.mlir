// RUN: ttmlir-opt --ttnn-weight-dtype-conversion="target-dtype=bfp_bf2" %s | FileCheck %s

// Test that the weight dtype conversion pass correctly:
// 1. Inserts a ttnn.typecast operation before the matmul
// 2. Converts the weight tensor (B operand) to bfp_bf2
