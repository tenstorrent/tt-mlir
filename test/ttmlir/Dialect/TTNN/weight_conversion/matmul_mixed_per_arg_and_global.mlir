...
// Test mixed per-arg and global weight dtype. Two matmuls:
// - First matmul: weight has per-arg annotation "bfp_bf4" → typecast to bfp4
...
module attributes {} {
  ...
  func.func @test_mixed_per_arg_and_global(
    ...
    %arg1: tensor<1x128x256xbf16, #ttnn.ttnn_layout<(d0, d1, d2) -> (d0, d1, d2), <1x1>, memref<1x4x8x!ttcore.tile<32x32, bf16>, #dram>, <interleaved>>> {ttcore.argument_type = #ttcore.argument_type<parameter>, ttcore.weight_dtype = "bfp_bf4"},
    ...
    // First matmul: arg1 has per-arg "bfp_bf4" annotation.
