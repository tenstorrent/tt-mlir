...
module {
  ...
  func.func @forward(%arg0: tensor<1x1x32x128xbf16, #ttnn_layout>) -> tensor<1x1x32x64xbf16, #ttnn_layout_out> {
    ...
    %0 = "ttnn.layer_norm_pre_all_gather"(%arg0) <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (tensor<1x1x32x128xbf16, #ttnn_layout>) -> tensor<1x1x32x64xbf16, #ttnn_layout_out>
  ...
  func.func @forward_with_residual(%arg0: tensor<1x1x32x128xbf16, #ttnn_layout>, %arg1: tensor<1x1x32x128xbf16, #ttnn_layout>) -> tensor<1x1x32x64xbf16, #ttnn_layout_out> {
    // CHECK: "ttnn.layer_norm_pre_all_gather"
    %0 = "ttnn.layer_norm_pre_all_gather"(%arg0, %arg1) <{operandSegmentSizes = array<i32: 1, 1, 0>}> : (tensor<1x1x32x128xbf16, #ttnn_layout>, tensor<1x1x32x128xbf16, #ttnn_layout>) -> tensor<1x1x32x64xbf16, #ttnn_layout_out>
    return %0 : tensor<1x1x32x64xbf16, #ttnn_layout_out>
  }
