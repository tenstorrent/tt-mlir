...
module {
  func.func @upsample_scale_unifrom(%arg0: tensor<4x32x64x3xf32>) -> tensor<4x64x128x3xf32> {
    ...
    %1 = "ttir.upsample"(%arg0, %0) <{scale_factor = 2 : si32}> : (tensor<4x32x64x3xf32>, tensor<4x64x128x3xf32>) -> tensor<4x64x128x3xf32>
  ...
  func.func @upsample_scale_nonunifrom(%arg0: tensor<4x32x64x3xf32>) -> tensor<4x64x64x3xf32> {
    ...
    %1 = "ttir.upsample"(%arg0, %0) <{scale_factor = array<i32: 2, 1>}> : (tensor<4x32x64x3xf32>, tensor<4x64x64x3xf32>) -> tensor<4x64x64x3xf32>
