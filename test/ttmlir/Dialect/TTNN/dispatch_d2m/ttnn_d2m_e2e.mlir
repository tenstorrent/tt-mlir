// RUN: ttmlir-opt --ttcore-register-device --ttcore-wrap-device-module --ttnn-create-d2m-subgraphs --ttnn-through-d2m-pipeline --ttnn-collaspe-d2m --canonicalize %s | FileCheck %s
...
#layout = #ttnn.ttnn_layout<(d0, d1) -> (d0, d1), <1x1>, memref<2x8x!ttcore.tile<32x32, bf16>, #l1>, <block_sharded>, core_ranges = <[#ttnn.core_range<(0, 0), (0, 0)>]>>
module {
