// RUN: ttmlir-opt --ttcore-register-device --ttcore-wrap-device-module --ttnn-d2m-subgraphs --ttnn-through-d2m-pipeline --ttnn-collaspe-d2m --canonicalize %s | FileCheck %s
