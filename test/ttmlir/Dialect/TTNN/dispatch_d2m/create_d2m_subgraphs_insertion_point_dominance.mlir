...
module {
  func.func @d2m_subgraphs_two_legs_insertion_dominance(%arg0: tensor<64x256xbf16, #layout_256>, %arg1: tensor<64x128xbf16, #layout_128>) -> tensor<64x128xbf16, #layout_128> {
    ...
    %1 = "ttnn.add"(%0, %arg1) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<64x128xbf16, #layout_128>, tensor<64x128xbf16, #layout_128>) -> tensor<64x128xbf16, #layout_128>
    ...
    %3 = "ttnn.add"(%2, %arg1) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<64x128xbf16, #layout_128>, tensor<64x128xbf16, #layout_128>) -> tensor<64x128xbf16, #layout_128>
    %4 = "ttnn.multiply"(%1, %3) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<64x128xbf16, #layout_128>, tensor<64x128xbf16, #layout_128>) -> tensor<64x128xbf16, #layout_128>
...
// CHECK: %[[MULTIPLY:.*]] = "ttnn.multiply"(%[[ADD_0]], %[[ADD_1]]) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}>
