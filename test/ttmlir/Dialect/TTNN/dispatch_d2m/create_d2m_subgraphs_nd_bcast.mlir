...
module {
  ...
  func.func @nd4_bcast_chain_fused(
    ...
    %0 = "ttnn.add"(%arg0, %arg1) : (tensor<1x1x32x128xbf16, #layout4d_full>, tensor<1x1x32x1xbf16, #layout4d_col_bcast>) -> tensor<1x1x32x128xbf16, #layout4d_full>
    %1 = "ttnn.multiply"(%0, %arg2) : (tensor<1x1x32x128xbf16, #layout4d_full>, tensor<1x1x1x128xbf16, #layout4d_row_bcast>) -> tensor<1x1x32x128xbf16, #layout4d_full>
  ...
  func.func @nd3_bcast_chain_fused(
    ...
    // CHECK-NOT: "ttnn.add"
    // CHECK-NOT: "ttnn.multiply"
    %0 = "ttnn.add"(%arg0, %arg1) : (tensor<1x32x128xbf16, #layout3d_full>, tensor<1x32x1xbf16, #layout3d_col_bcast>) -> tensor<1x32x128xbf16, #layout3d_full>
    %1 = "ttnn.multiply"(%0, %arg0) : (tensor<1x32x128xbf16, #layout3d_full>, tensor<1x32x128xbf16, #layout3d_full>) -> tensor<1x32x128xbf16, #layout3d_full>
  ...
  func.func @nd4_no_bcast_still_fused(
    ...
    // CHECK: ttnn.d2m_subgraph
    %0 = "ttnn.add"(%arg0, %arg1) : (tensor<1x1x32x128xbf16, #layout4d_full>, tensor<1x1x32x128xbf16, #layout4d_full>) -> tensor<1x1x32x128xbf16, #layout4d_full>
    %1 = "ttnn.multiply"(%0, %arg2) : (tensor<1x1x32x128xbf16, #layout4d_full>, tensor<1x1x32x128xbf16, #layout4d_full>) -> tensor<1x1x32x128xbf16, #layout4d_full>
    return %1 : tensor<1x1x32x128xbf16, #layout4d_full>
  }
  ...
  func.func @nd2_bcast_still_fused(
    ...
    // CHECK: ttnn.d2m_subgraph
    %0 = "ttnn.add"(%arg0, %arg1) : (tensor<64x256xbf16, #layout2d>, tensor<1x256xbf16, #layout2d_row>) -> tensor<64x256xbf16, #layout2d>
    %1 = "ttnn.multiply"(%0, %arg2) : (tensor<64x256xbf16, #layout2d>, tensor<64x256xbf16, #layout2d>) -> tensor<64x256xbf16, #layout2d>
