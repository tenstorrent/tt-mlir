...
module {
  ...
  func.func @standalone_full(%arg0: tensor<32x32xbf16, #ttnn_layout> {ttcore.argument_type = #ttcore.argument_type<input>}) -> tensor<32x32xbf16, #ttnn_layout> {
    ...
    // CHECK: %[[RESULT:.*]] = "ttnn.add"(%arg0, %[[CACHED]]) <{dtype = #ttcore.supportedDataTypes<bf16>, input_tensor_a_activations = [], activations = [], input_tensor_b_activations = []}>
  ...
  func.func @multiple_creation_ops(%arg0: tensor<32x32xbf16, #ttnn_layout> {ttcore.argument_type = #ttcore.argument_type<input>}) -> tensor<32x32xbf16, #ttnn_layout> {
    ...
    // CHECK: %[[ADD1:.*]] = "ttnn.add"(%arg0, %[[CACHED1]]) <{dtype = #ttcore.supportedDataTypes<bf16>, input_tensor_a_activations = [], activations = [], input_tensor_b_activations = []}>
    ...
    // CHECK: %[[ADD2:.*]] = "ttnn.add"(%[[ADD1]], %[[CACHED2]]) <{dtype = #ttcore.supportedDataTypes<bf16>, input_tensor_a_activations = [], activations = [], input_tensor_b_activations = []}>
  ...
  func.func @constant_op(%arg0: tensor<32x32xbf16, #ttnn_layout> {ttcore.argument_type = #ttcore.argument_type<input>}) -> tensor<32x32xbf16, #ttnn_layout> {
    ...
    // CHECK: %[[RESULT:.*]] = "ttnn.multiply"(%arg0, %[[CACHED]]) <{dtype = #ttcore.supportedDataTypes<bf16>, input_tensor_a_activations = [], activations = [], input_tensor_b_activations = []}>
