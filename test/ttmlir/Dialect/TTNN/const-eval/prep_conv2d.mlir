// REQUIRES: opmodel
// RUN: ttmlir-opt --tt-populate-argument-types="argument-types=prepare_conv2d_weights=input,constant,input" --ttir-to-ttnn-backend-pipeline="enable-optimizer=true enable-const-eval=true" %s -o prep_conv2d.mlir
// RUN: FileCheck %s --input-file=prep_conv2d.mlir
