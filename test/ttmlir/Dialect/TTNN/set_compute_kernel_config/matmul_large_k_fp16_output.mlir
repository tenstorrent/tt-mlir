...
// CHECK-LABEL: func @test_large_k_fp16_matmul
func.func @test_large_k_fp16_matmul(%arg0: tensor<1x50001xf16>, %arg1: tensor<50001x128xf16>) -> tensor<1x128xf16> {
  // CHECK: "ttnn.matmul"
  ...
  } : (tensor<1x50001xf16>, tensor<50001x128xf16>) -> tensor<1x128xf16>
