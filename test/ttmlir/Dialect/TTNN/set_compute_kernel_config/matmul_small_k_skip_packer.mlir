...
// CHECK-LABEL: func @test_small_k_matmul
func.func @test_small_k_matmul(%arg0: tensor<1x32xbf16>, %arg1: tensor<32x128xbf16>) -> tensor<1x128xbf16> {
  // CHECK: "ttnn.matmul"
  ...
  } : (tensor<1x32xbf16>, tensor<32x128xbf16>) -> tensor<1x128xbf16>
