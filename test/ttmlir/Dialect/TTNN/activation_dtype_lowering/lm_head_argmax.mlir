...
// sum. A ttnn.to_layout(RowMajor, bf16) is inserted before argmax; this
// lowers (via the DecomposeLayouts bfp_bf8 -> bf16 fast-path) to a single
// tt-metal untilize kernel that does the bfp8 -> bf16 upcast inline.
