...
module {
  func.func @matmul_with_div(%arg0: tensor<784x1096xbf16> {ttcore.argument_type = #ttcore.argument_type<parameter>}, %arg1: tensor<1096x784xbf16> {ttcore.argument_type = #ttcore.argument_type<parameter>}, %arg2: tensor<784x784xbf16> {ttcore.argument_type = #ttcore.argument_type<input>}) -> tensor<784x784xbf16> {
