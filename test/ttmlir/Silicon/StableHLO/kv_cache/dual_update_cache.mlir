...
module {
  func.func @main(%arg0: tensor<1xi32>, %arg1: tensor<1x32x64x64xbf16>, %arg2: tensor<1x32x64x64xbf16>, %arg3: tensor<1x32x1x64xbf16>, %arg4: tensor<1x32x1x64xbf16>) -> (tensor<1x32x64x64xbf16>, tensor<1x32x64x64xbf16>) {
    ...
    %11 = stablehlo.reshape %arg0 : (tensor<1xi32>) -> tensor<1x1xi32>
    ...
    %37 = stablehlo.broadcast_in_dim %36, dims = [0, 1, 2, 3] : (tensor<1x1x1x1xi64>) -> tensor<1x32x1x64xi64>
    %38 = stablehlo.reshape %37 : (tensor<1x32x1x64xi64>) -> tensor<1x32x1x64x1xi64>
    %39 = stablehlo.broadcast_in_dim %23, dims = [1, 2, 3] : (tensor<32x1x1xi64>) -> tensor<1x32x1x64xi64>
    %40 = stablehlo.reshape %39 : (tensor<1x32x1x64xi64>) -> tensor<1x32x1x64x1xi64>
    %41 = stablehlo.convert %11 : (tensor<1x1xi32>) -> tensor<1x1xi64>
    %42 = stablehlo.broadcast_in_dim %41, dims = [2, 3] : (tensor<1x1xi64>) -> tensor<1x32x1x64xi64>
    %43 = stablehlo.reshape %42 : (tensor<1x32x1x64xi64>) -> tensor<1x32x1x64x1xi64>
    %44 = stablehlo.broadcast_in_dim %10, dims = [3] : (tensor<64xi64>) -> tensor<1x32x1x64xi64>
    %45 = stablehlo.reshape %44 : (tensor<1x32x1x64xi64>) -> tensor<1x32x1x64x1xi64>
    %46 = stablehlo.concatenate %38, %40, %43, %45, dim = 4 : (tensor<1x32x1x64x1xi64>, tensor<1x32x1x64x1xi64>, tensor<1x32x1x64x1xi64>, tensor<1x32x1x64x1xi64>) -> tensor<1x32x1x64x4xi64>
    ...
    }) : (tensor<1x32x64x64xbf16>, tensor<1x32x1x64x4xi64>, tensor<1x32x1x64xbf16>) -> tensor<1x32x64x64xbf16>
