...
module {
  ...
  func.func @scatter_test(%arg0: tensor<71x4xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {}]>},
  ...
  func.func @scatter_test_2(%arg0: tensor<4x8xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {}]>},
