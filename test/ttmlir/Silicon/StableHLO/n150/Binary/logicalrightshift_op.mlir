...
module @jit_eltwise_logicalshiftright attributes {} {
  func.func public @test_logicalrightshift(%arg0: tensor<5xui32>, %arg1: tensor<5xui32>) -> tensor<5xui32> {
    // CHECK-LABEL: func.func public @test_logicalrightshift
