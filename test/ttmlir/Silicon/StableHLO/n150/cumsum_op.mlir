...
module @cumsum attributes {} {
  func.func @test_cumsum_dim0(%arg0: tensor<8x2x4x16xbf16>) -> tensor<8x2x4x16xbf16> {
  ...
  func.func @test_cumsum_dim1(%arg0: tensor<8x2x4x16xbf16>) -> tensor<8x2x4x16xbf16> {
  ...
  func.func @test_cumsum_dim2(%arg0: tensor<8x2x4x16xbf16>) -> tensor<8x2x4x16xbf16> {
  ...
  func.func @test_cumsum_dim3(%arg0: tensor<8x2x4x16xbf16>) -> tensor<8x2x4x16xbf16> {
  ...
  func.func @test_cumsum_low_rank(%arg0: tensor<1x10xi64>) -> tensor<1x10xi64> {
