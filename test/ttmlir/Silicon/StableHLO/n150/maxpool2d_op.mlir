...
module @max_pool2d attributes {} {
  ...
  func.func @test_max_pool2d_0(%arg0: tensor<1x128x32x32xbf16>) -> tensor<1x128x11x11xbf16> {
    // CHECK-LABEL: func.func @test_max_pool2d_0(
  ...
  func.func @test_max_pool2d_1(%arg0: tensor<1x192x28x28xbf16>) -> tensor<1x192x28x28xbf16> {
    // CHECK-LABEL: func.func @test_max_pool2d_1(
    %cst = stablehlo.constant dense<0xFF80> : tensor<bf16>
    // CHECK: %[[PERMUTE:[0-9]+]] = "ttnn.permute"(%arg0)
    // CHECK-SAME: permutation = array<i64: 0, 2, 3, 1>
  ...
  func.func @test_max_pool2d_2(%arg0: tensor<1x192x28x28xbf16>) -> tensor<1x192x10x27xbf16> {
    // CHECK-LABEL: func.func @test_max_pool2d_2(
    %cst = stablehlo.constant dense<0xFF80> : tensor<bf16>
    // CHECK: %[[PERMUTE:[0-9]+]] = "ttnn.permute"(%arg0)
    // CHECK-SAME: permutation = array<i64: 0, 2, 3, 1>
    // CHECK-SAME: tensor<1x192x28x28xbf16
