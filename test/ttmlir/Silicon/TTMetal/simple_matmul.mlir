...
#input_constraint = #tt.operand_constraint<l1|tile>
#output_constraint = #tt.operand_constraint<l1|tile>

#in0 = #tt.layout<(d0, d1) -> (d0, d1), undef, <2x8>, memref<32x32xf16, #l1_>>
#in1 = #tt.layout<(d0, d1) -> (d0, d1), undef, <8x4>, memref<32x32xf16, #l1_>>
#out0 = #tt.layout<(d0, d1) -> (d0, d1), undef, <2x2>, memref<32x64xf16, #l1_>>
...
func.func @simple_matmul(%arg0: tensor<64x256xf16, #in0>, %arg1: tensor<256x128xf16, #in1>) -> tensor<64x128xf16, #out0> {
  ...
  %1 = "ttir.matmul"(%arg0, %arg1, %0) <{operand_constraints = [#input_constraint, #input_constraint, #output_constraint]}>: (tensor<64x256xf16, #in0>, tensor<256x128xf16, #in1>, tensor<64x128xf16, #out0>) -> tensor<64x128xf16, #out0>
