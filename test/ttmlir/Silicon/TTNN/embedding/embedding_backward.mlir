...
module attributes {} {
  func.func @backward(%arg0: tensor<1x32xbf16>, %arg1: tensor<512x128xbf16>, %arg2: tensor<1x1x32x128xbf16>) -> tensor<512x128xbf16> {
    ...
    %1 = "ttir.embedding_backward"(%arg0, %arg1, %arg2, %0) <{operandSegmentSizes = array<i32: 3, 1>, operand_constraints = [#any_device, #any_device, #any_device, #any_device]}> :
      (tensor<1x32xbf16>, tensor<512x128xbf16>, tensor<1x1x32x128xbf16>, tensor<512x128xbf16>) -> tensor<512x128xbf16>
