...
module {
  func.func @main(%arg0: tensor<1x16x32xf32>, %arg1: tensor<1x1x32xf32>) -> tensor<1x16x32xf32> {
    ...
    %1 = "ttir.broadcast"(%arg1, %0) <{broadcast_dimensions = [1 : i32, 16 : i32, 1 : i32]}> : (tensor<1x1x32xf32>, tensor<1x16x32xf32>) -> tensor<1x16x32xf32>
...
module {
  func.func public @main(%arg0: tensor<1xf32>, %arg1: tensor<512x512xf32>) -> (tensor<512x512xf32>) {
    ...
    %3 = "ttir.broadcast"(%1, %2) <{broadcast_dimensions = [512 : i32, 512 : i32]}> : (tensor<1x1xf32>, tensor<512x512xf32>) -> tensor<512x512xf32>
...
module {
    func.func @main(%arg0: tensor<1x23x40x1xf32>, %arg1: tensor<128xf32>) -> tensor<1x23x40x128xf32> {
      ...
      %1 = "ttir.broadcast"(%arg0, %0) <{broadcast_dimensions = [1 : i32, 1 : i32, 1 : i32, 128 : i32]}> : (tensor<1x23x40x1xf32>, tensor<1x23x40x128xf32>) -> tensor<1x23x40x128xf32>
      ...
      %5 = "ttir.broadcast"(%3, %4) <{broadcast_dimensions = [1 : i32, 23 : i32, 40 : i32, 1 : i32]}> : (tensor<1x1x1x128xf32>, tensor<1x23x40x128xf32>) -> tensor<1x23x40x128xf32>
...
module {
    func.func @main(%arg0: tensor<6x2xf32>) -> tensor<2400x2xf32> {
      ...
      %5 = "ttir.broadcast"(%3, %4) <{broadcast_dimensions = [400 : i32, 1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x6x1x2xf32>, tensor<400x6x1x2xf32>) -> tensor<400x6x1x2xf32>
