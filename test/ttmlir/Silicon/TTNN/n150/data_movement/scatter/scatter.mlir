...
func.func @scatter_simple_2(%arg0: tensor<32x32xi32>, %arg1: tensor<16x1xi32>, %arg2: tensor<16x32xi32>) -> tensor<32x32xi32> {
  %0 = "stablehlo.scatter"(%arg0, %arg1, %arg2) <{indices_are_sorted = false, scatter_dimension_numbers = #stablehlo.scatter<update_window_dims = [1], inserted_window_dims = [0], scatter_dims_to_operand_dims = [0], index_vector_dim = 1>, unique_indices = false}> ({
  ^bb0(%arg3: tensor<i32>, %arg4: tensor<i32>):
    stablehlo.return %arg4 : tensor<i32>
  }) : (tensor<32x32xi32>, tensor<16x1xi32>, tensor<16x32xi32>) -> tensor<32x32xi32>
...
func.func @scatter_simple_4(%arg0: tensor<1000x32xf32>, %arg1: tensor<10x1xi64>, %arg2: tensor<10x32xf32>) -> tensor<1000x32xf32> {
  ...
  ^bb0(%arg3: tensor<f32>, %arg4: tensor<f32>):
    stablehlo.return %arg4 : tensor<f32>
  }) : (tensor<1000x32xf32>, tensor<10x1xi64>, tensor<10x32xf32>) -> tensor<1000x32xf32>
