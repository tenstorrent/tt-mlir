...
module {
  ...
  func.func @test_composite_no_fuse(%arg0: tensor<128x128xf32, #dram_layout_0>, %arg1: tensor<128x128xf32, #dram_layout_0>, %arg2: tensor<128x128xf32, #dram_layout_0>) -> tensor<128x128xf32, #dram_layout_0> {
    ...
    %3 = "ttnn.add"(%0, %1) <{dtype = #ttcore.supportedDataTypes<f32>, post_activations = [], lhs_activations = [], rhs_activations = []}> {ttnn.hoist_generic_via_d2m} : (tensor<128x128xf32, #l1_layout_0>, tensor<128x128xf32, #l1_layout_0>) -> tensor<128x128xf32, #l1_layout_0>
    %4 = "ttnn.add"(%3, %2) <{dtype = #ttcore.supportedDataTypes<f32>, post_activations = [], lhs_activations = [], rhs_activations = []}> {ttnn.hoist_generic_via_d2m} : (tensor<128x128xf32, #l1_layout_0>, tensor<128x128xf32, #l1_layout_0>) -> tensor<128x128xf32, #l1_layout_0>
  ...
  func.func @test_scalarize(%arg0: tensor<32x32xf32, #l1_layout>) -> tensor<32x32xf32, #l1_layout> {
    ...
    %2 = "ttnn.add"(%arg0, %1) <{dtype = #ttcore.supportedDataTypes<f32>, post_activations = [], lhs_activations = [], rhs_activations = []}> {ttnn.hoist_generic_via_d2m} : (tensor<32x32xf32, #l1_layout>, tensor<32x32xf32, #l1_layout>) -> tensor<32x32xf32, #l1_layout>
