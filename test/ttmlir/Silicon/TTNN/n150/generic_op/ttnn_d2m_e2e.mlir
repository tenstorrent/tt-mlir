...
module {
  ...
  func.func @test_composite_fuse(%arg0: tensor<32x32xf32, #dram_layout>) -> tensor<32x32xf32, #dram_layout> {
    %0 = "ttnn.to_memory_config"(%arg0) : (tensor<32x32xf32, #dram_layout>) -> tensor<32x32xf32, #l1_layout>
  ...
  func.func @test_composite_no_fuse(%arg0: tensor<128x128xf32, #dram_layout_0>, %arg1: tensor<128x128xf32, #dram_layout_0>, %arg2: tensor<128x128xf32, #dram_layout_0>) -> tensor<128x128xf32, #dram_layout_0> {
    %0 = "ttnn.to_memory_config"(%arg0) : (tensor<128x128xf32, #dram_layout_0>) -> tensor<128x128xf32, #l1_layout_0>
    %1 = "ttnn.to_memory_config"(%arg1) : (tensor<128x128xf32, #dram_layout_0>) -> tensor<128x128xf32, #l1_layout_0>
    %2 = "ttnn.to_memory_config"(%arg2) : (tensor<128x128xf32, #dram_layout_0>) -> tensor<128x128xf32, #l1_layout_0>
    ...
    %5 = "ttnn.to_memory_config"(%4) : (tensor<128x128xf32, #l1_layout_0>) -> tensor<128x128xf32, #dram_layout_0>
