// REQUIRES: opmodel
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% optimization-level=2 max-legal-layouts=32 override-conv2d-config=conv1=weights_dtype#bf16:activation#relu:deallocate_activation#false" -o resnet50_fused_single_layer_ttnn.mlir %s
