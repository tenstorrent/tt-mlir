...
//
// Previously XFAIL'd because tt-metal's conv3d kernel rejected the
// optimizer-emitted IR with a runtime layout mismatch. Resolved
// structurally by TTNNPrepareConv3dWeights, which materializes the
// prepare op post-optimizer (see conv3d_optimizer.mlir).
