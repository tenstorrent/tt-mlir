...
func.func @prepare_conv2d_weights(%arg0: tensor<16x32x32x64xbf16>, %arg1: tensor<64x64x3x3xbf16>, %arg2: tensor<1x1x1x64xbf16>) -> tensor<16x32x32x64xbf16> {
    // CHECK-DAG: #[[LAYOUT_0:.*]] = #ttnn.ttnn_layout{{.*}}{{(height|width)_sharded}}{{.*}}
    %0 = ttir.empty() : tensor<16x32x32x64xbf16>
    // CHECK: = "ttnn.conv2d"{{.*}}#[[LAYOUT_0]]{{.*}} -> {{.*}}#[[LAYOUT_0]]{{.*}}
