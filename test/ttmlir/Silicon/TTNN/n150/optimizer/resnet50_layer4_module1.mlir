...
module @ResNetLayer4Module1 attributes {} {
  func.func @forward(%arg0: tensor<8x14x14x1024xbf16> {tt.argument_type = #tt.argument_type<input>, ttir.name = "input"}, %arg1: tensor<1x1x1x512xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_703"}, %arg2: tensor<1x1x1x512xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_703_fork_clone287"}, %arg3: tensor<1x1x1x512xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_719"}, %arg4: tensor<1x1x1x512xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_719_fork_clone190"}, %arg5: tensor<1x2048x1x1xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_735"}, %arg6: tensor<1x2048x1x1xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_735_fork_clone101"}, %arg7: tensor<1x2048x1x1xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_750"}, %arg8: tensor<1x2048x1x1xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_750_fork_clone105"}, %arg9: tensor<512x1024x1x1xbf16> {tt.argument_type = #tt.argument_type<parameter>, ttir.name = "resnet.encoder.stages.3.layers.0.layer.0.convolution.weight"}, %arg10: tensor<512x512x3x3xbf16> {tt.argument_type = #tt.argument_type<parameter>, ttir.name = "resnet.encoder.stages.3.layers.0.layer.1.convolution.weight"}, %arg11: tensor<2048x512x1x1xbf16> {tt.argument_type = #tt.argument_type<parameter>, ttir.name = "resnet.encoder.stages.3.layers.0.layer.2.convolution.weight"}, %arg12: tensor<2048x1024x1x1xbf16> {tt.argument_type = #tt.argument_type<parameter>, ttir.name = "resnet.encoder.stages.3.layers.0.shortcut.convolution.weight"}) -> (tensor<8x2048x7x7xbf16> {ttir.name = "output"}) {
