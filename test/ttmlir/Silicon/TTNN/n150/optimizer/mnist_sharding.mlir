// REQUIRES: opmodel
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% optimization-level=2" -o mnist_sharding_ttnn.mlir -mlir-print-local-scope %s
