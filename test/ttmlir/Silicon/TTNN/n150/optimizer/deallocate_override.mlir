// REQUIRES: opmodel
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% optimization-level=1 override-conv2d-config=conv1=deallocate_activation#true,conv2=deallocate_activation#true" -o deallocate_override_ttnn.mlir %s --mlir-print-debuginfo
