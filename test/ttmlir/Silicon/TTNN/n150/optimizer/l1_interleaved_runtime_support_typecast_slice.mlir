...
module @L1InterleavedSliceComparison attributes {} {
  func.func @forward(%arg0: tensor<1x144x8400xbf16>, %arg1: tensor<1x64x8400xbf16>) -> tensor<1x16x8400xf32> {
    ...
    // Slice operation - not supported runtime upgrade to L1 interleaved
    // CHECK: %{{.*}} = "ttnn.slice"{{.*}} -> tensor<1x64x8400xbf16, #[[DRAM_LAYOUT2]]>
    %1 = "ttir.slice"(%arg0, %0) <{begins = [0 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 64 : i32, 8400 : i32], step = [1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x144x8400xbf16>, tensor<1x64x8400xbf16>) -> tensor<1x64x8400xbf16>
    ...
    // CHECK: %{{.*}} = "ttnn.slice"{{.*}} -> tensor<1x32x8400xf32, #[[DRAM_LAYOUT3]]>
    %7 = "ttir.slice"(%5, %6) <{begins = [0 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 32 : i32, 8400 : i32], step = [1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x64x8400xf32>, tensor<1x32x8400xf32>) -> tensor<1x32x8400xf32>

    %8 = ttir.empty() : tensor<1x32x8400xbf16>
    // CHECK: %{{.*}} = "ttnn.slice"{{.*}} -> tensor<1x32x8400xbf16, #[[DRAM_LAYOUT5]]>
    %9 = "ttir.slice"(%arg1, %8) <{begins = [0 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 32 : i32, 8400 : i32], step = [1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x64x8400xbf16>, tensor<1x32x8400xbf16>) -> tensor<1x32x8400xbf16>
    ...
    // CHECK: %{{.*}} = "ttnn.slice"{{.*}} -> tensor<1x32x8400xbf16, #[[DRAM_LAYOUT5]]>
    %15 = "ttir.slice"(%arg1, %14) <{begins = [0 : i32, 32 : i32, 0 : i32], ends = [1 : i32, 64 : i32, 8400 : i32], step = [1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x64x8400xbf16>, tensor<1x32x8400xbf16>) -> tensor<1x32x8400xbf16>
    ...
    // CHECK: %{{.*}} = "ttnn.slice"{{.*}} -> tensor<1x32x8400xbf16, #[[DRAM_LAYOUT5]]>
    %23 = "ttir.slice"(%arg0, %22) <{begins = [0 : i32, 96 : i32, 0 : i32], ends = [1 : i32, 128 : i32, 8400 : i32], step = [1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x144x8400xbf16>, tensor<1x32x8400xbf16>) -> tensor<1x32x8400xbf16>
    ...
    // Add operation - because of consumer being Slice (not supported for input upgrade), not upgraded to L1 interleaved
    ...
    // CHECK: %{{.*}} = "ttnn.slice"{{.*}} -> tensor<1x16x8400xf32, #[[DRAM_LAYOUT3]]>
    %33 = "ttir.slice"(%31, %32) <{begins = [0 : i32, 0 : i32, 0 : i32], ends = [1 : i32, 16 : i32, 8400 : i32], step = [1 : i32, 1 : i32, 1 : i32]}> : (tensor<1x32x8400xf32>, tensor<1x16x8400xf32>) -> tensor<1x16x8400xf32>
