...
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% optimization-level=2 experimental-weight-dtype=bfp_bf8 enable-permute-matmul-fusion=false" -o bert_encoder_layer_ttnn.mlir %models/single_blocks_and_layers/bert_encoder_layer.mlir
