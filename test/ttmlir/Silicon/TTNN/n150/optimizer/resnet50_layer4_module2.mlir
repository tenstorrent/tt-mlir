// REQUIRES: opmodel
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% enable-optimizer=true memory-layout-analysis-enabled=true max-legal-layouts=32" -o resnet50_layer4_module2_ttnn.mlir %s --mlir-print-debuginfo
// RUN: ttmlir-translate --ttnn-to-flatbuffer resnet50_layer4_module2_ttnn.mlir > %t.ttnn
#loc = loc("ResNetForImageClassification")
module @ResNetLayer4Module2 attributes {} {
  func.func @forward(%arg0: tensor<8x2048x7x7xbf16> {tt.argument_type = #tt.argument_type<input>, ttir.name = "input"}, %arg1: tensor<1x1x1x512xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_816"}, %arg2: tensor<1x1x1x512xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_816_fork_clone178"}, %arg3: tensor<1x1x1x512xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_832"}, %arg4: tensor<1x1x1x512xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_832_fork_clone89"}, %arg5: tensor<1x2048x1x1xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_848"}, %arg6: tensor<1x2048x1x1xbf16> {tt.argument_type = #tt.argument_type<constant>, ttir.name = "input_0_multiply_848_fork_clone32"}, %arg7: tensor<512x2048x1x1xbf16> {tt.argument_type = #tt.argument_type<parameter>, ttir.name = "resnet.encoder.stages.3.layers.2.layer.0.convolution.weight"}, %arg8: tensor<512x512x3x3xbf16> {tt.argument_type = #tt.argument_type<parameter>, ttir.name = "resnet.encoder.stages.3.layers.2.layer.1.convolution.weight"}, %arg9: tensor<2048x512x1x1xbf16> {tt.argument_type = #tt.argument_type<parameter>, ttir.name = "resnet.encoder.stages.3.layers.2.layer.2.convolution.weight"}, %arg10: tensor<2048x1000xbf16> {tt.argument_type = #tt.argument_type<parameter>, ttir.name = "classifier.1.weight"}, %arg11: tensor<1000xbf16> {tt.argument_type = #tt.argument_type<parameter>, ttir.name = "classifier.1.bias"}) -> (tensor<8x1000xbf16> {ttir.name = "output"}) {
