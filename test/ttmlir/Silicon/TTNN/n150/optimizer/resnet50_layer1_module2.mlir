...
module @ResNetBlock attributes {} {
  func.func @forward(%arg0: tensor<8x56x56x256xbf16> {ttir.name = "input"},
    ...
    %5 = "ttir.multiply"(%3, %arg2) : (tensor<8x56x56x64xbf16>, tensor<1x1x1x64xbf16>) -> tensor<8x56x56x64xbf16> loc(#loc6)
    %7 = "ttir.add"(%5, %arg3) : (tensor<8x56x56x64xbf16>, tensor<1x1x1x64xbf16>) -> tensor<8x56x56x64xbf16> loc(#loc8)
    %9 = "ttir.relu"(%7) : (tensor<8x56x56x64xbf16>) -> tensor<8x56x56x64xbf16> loc(#loc10)
    ...
    %13 = "ttir.multiply"(%11, %arg5) : (tensor<8x56x56x64xbf16>, tensor<1x1x1x64xbf16>) -> tensor<8x56x56x64xbf16> loc(#loc14)
    %15 = "ttir.add"(%13, %arg6) : (tensor<8x56x56x64xbf16>, tensor<1x1x1x64xbf16>) -> tensor<8x56x56x64xbf16> loc(#loc16)
    %17 = "ttir.relu"(%15) : (tensor<8x56x56x64xbf16>) -> tensor<8x56x56x64xbf16> loc(#loc18)
    ...
    %21 = "ttir.multiply"(%19, %arg8) : (tensor<8x56x56x256xbf16>, tensor<1x1x1x256xbf16>) -> tensor<8x56x56x256xbf16> loc(#loc22)
    %23 = "ttir.add"(%21, %arg9) : (tensor<8x56x56x256xbf16>, tensor<1x1x1x256xbf16>) -> tensor<8x56x56x256xbf16> loc(#loc24)
    %25 = "ttir.add"(%23, %1) : (tensor<8x56x56x256xbf16>, tensor<8x56x56x256xbf16>) -> tensor<8x56x56x256xbf16> loc(#loc26)
