// REQUIRES: opmodel
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% optimization-level=1 override-conv2d-config=conv1=shard_layout#height_sharded,conv2=shard_layout#height_sharded" -o resnet50_layer1_module2_ttnn.mlir %s --mlir-print-debuginfo
