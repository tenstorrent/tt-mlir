// REQUIRES: opmodel
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% optimization-level=2 max-legal-layouts=32" -o resnet50_layer3_module2_ttnn.mlir %s --mlir-print-debuginfo
