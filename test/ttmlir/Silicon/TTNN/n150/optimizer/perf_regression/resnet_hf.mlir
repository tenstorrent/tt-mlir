...
<<<<<<< HEAD:test/ttmlir/Silicon/TTNN/n150/optimizer/models_perf_tests/resnet_hf.mlir
...
=======
// RUN: mkdir -p %t
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% enable-optimizer=true memory-layout-analysis-enabled=true enable-fusing-conv2d-with-multiply-pattern=true" %s -o %t/ttnn.mlir
...
>>>>>>> 229428f81 (Add perf regression tests):test/ttmlir/Silicon/TTNN/n150/optimizer/perf_regression/resnet_hf.mlir
