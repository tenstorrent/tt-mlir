// REQUIRES: opmodel
// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% optimization-level=2" -o %t.mlir %s
...
func.func @main(%arg0: tensor<1x20x20x640xbf16>) -> tensor<1x40x40x640xbf16> {
    ...
    %0 = "ttir.upsample2d"(%arg0) <{mode = "nearest", scale_factor = 2 : si32}> {channel_last = true} : (tensor<1x20x20x640xbf16>) -> tensor<1x40x40x640xbf16>
    return %0 : tensor<1x40x40x640xbf16>
}
