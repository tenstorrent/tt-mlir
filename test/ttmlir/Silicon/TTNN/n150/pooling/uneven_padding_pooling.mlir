...
module attributes {} {
  func.func @test_maxpool2d_uneven_padding(%arg0: tensor<1x32x128x128xf32>) -> tensor<1x32x64x64xf32> {
    ...
    %1 = "ttir.pooling"(%arg0, %0) <{
        ...
        padding = array<i64: 0, 0, 0, 0, 0, 1, 0, 1>}> : (tensor<1x32x128x128xf32>, tensor<1x32x64x64xf32>) -> tensor<1x32x64x64xf32>
