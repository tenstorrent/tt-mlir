...
func.func @transpose_8x8(%arg0: tensor<32x32xbf16>) -> tensor<32x32xbf16> {
  // CHECK: = "ttnn.permute"
  %1 = "ttir.transpose"(%arg0) <{dim0 = 0 : si32, dim1 = 1 : si32}> : (tensor<32x32xbf16>) -> tensor<32x32xbf16>
...
func.func @transpose_negative_dims(%arg0: tensor<32x32xbf16>) -> tensor<32x32xbf16> {
  // CHECK: = "ttnn.permute"
  %1 = "ttir.transpose"(%arg0) <{dim0 = -1 : si32, dim1 = -2 : si32}> : (tensor<32x32xbf16>) -> tensor<32x32xbf16>
  return %1 : tensor<32x32xbf16>
}
