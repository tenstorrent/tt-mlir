...
func.func @test_conv2d_sliced() -> tensor<1x16x32x32xbf16> {
    ...
    func.func @test_conv_feature_group_sliced() -> tensor<1x16x9xbf16>{
        ...
        %3 = "ttir.convolution"(%0, %1, %2) <{
            ...
            window_reversal = array<i1: false>,
            window_strides = array<i64: 1>
            }> : (tensor<1x16x9xbf16>, tensor<16x4x1xbf16>, tensor<1x16x9xbf16>) -> tensor<1x16x9xbf16>
        return %3 : tensor<1x16x9xbf16>
    }


    func.func @test_conv2d_feature_group_sliced() -> tensor<1x16x32x32xbf16>{
