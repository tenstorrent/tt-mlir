...
module {
  ...
  // CHECK: "ttnn.generic"
  func.func @single_exp(%shared_tensor: tensor<64x128xf32, #ttnn_layout>) -> (tensor<64x128xf32, #ttnn_layout>) attributes {tt.function_type = "forward_device"} {
    ...
    %result_reg_0_metal = d2m.spatial {grid_ranges = #ttcore.core_range_set<[#ttcore.core_range<(0, 0), (1, 1)>]>}
    ...
    outs(%out_tensor0_metal : tensor<1x1x2x4x!ttcore.tile<32x32, f32>, #ttmetal_layout>) {
      ^region0():
        ...
        ^unified0(%cb0: !d2m.cb<tensor<2x4x!ttcore.tile<32x32, f32>>>, %cb1: !d2m.cb<tensor<2x4x!ttcore.tile<32x32, f32>>>):
          ...
          %reg_0_2 = d2m.remote_load %2 %shared_tensor_metal[%block0, %block1] : tensor<2x4x!ttcore.tile<32x32, f32>>, tensor<1x1x2x4x!ttcore.tile<32x32, f32>, #ttmetal_layout> -> tensor<2x4x!ttcore.tile<32x32, f32>>
          ...
          ^bb0(%in: !ttcore.tile<32x32, f32>, %out: !ttcore.tile<32x32, f32>):
            %reg_0_5 = "d2m.tile_exp"(%in) : (!ttcore.tile<32x32, f32>) -> !ttcore.tile<32x32, f32>
    ...
    return %result0 : tensor<64x128xf32, #ttnn_layout>
  }
}
