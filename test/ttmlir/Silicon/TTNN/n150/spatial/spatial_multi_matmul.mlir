...
module {
  ...
  // CHECK: "ttnn.generic"
  func.func @matmul_test(%arg0: tensor<64x128xf32, #ttnn_layout>, %arg1: tensor<128x64xf32, #ttnn_layout1>) -> (tensor<64x64xf32, #ttnn_layout2>, tensor<64x64xf32, #ttnn_layout3>) attributes {tt.function_type = "forward_device"} {
    ...
    %result_reg_0_metal, %result_reg_1_metal = d2m.spatial {grid_ranges = #ttcore.core_range_set<[#ttcore.core_range<(0, 0), (0, 0)>, #ttcore.core_range<(1, 1), (1, 1)>]>}
      ...
      ^unified0(%cb0: !d2m.cb<tensor<2x4x!ttcore.tile<32x32, f32>>>, %cb1: !d2m.cb<tensor<4x2x!ttcore.tile<32x32, f32>>>, %cb2: !d2m.cb<tensor<2x2x!ttcore.tile<32x32, f32>>>):
