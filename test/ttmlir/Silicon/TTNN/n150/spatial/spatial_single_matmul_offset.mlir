...
module {
  ...
  // CHECK: "ttnn.generic"
  func.func @matmul_test(%arg0: tensor<64x128xf32, #ttnn_layout>, %arg1: tensor<128x64xf32, #ttnn_layout_w>) -> tensor<64x64xf32, #ttnn_layout_output> attributes {tt.function_type = "forward_device"} {
    ...
    %result_reg_0_metal = d2m.spatial {grid_ranges = #ttcore.core_range_set<[#ttcore.core_range<(2,2), (2,2)>]>}
