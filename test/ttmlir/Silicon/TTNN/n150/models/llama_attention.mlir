...
module {
  func.func @test_llama_attention(%arg0: tensor<1x12x3200xf32>, %arg1: tensor<1x1x12x12xf32>, %arg2: tensor<1x12xf32>, %arg3: tensor<1x50x1xf32>, %arg4: tensor<1x32x50x100xf32>, %arg5: tensor<1x1xf32>, %arg6: tensor<1x32x50x100xf32>, %arg7: tensor<1x32x50x100xf32>, %arg8: tensor<1x1xf32>, %arg9: tensor<1x32x50x100xf32>, %arg10: tensor<1x1xf32>, %arg11: tensor<3200x3200xf32>, %arg12: tensor<3200x3200xf32>, %arg13: tensor<3200x3200xf32>, %arg14: tensor<3200x3200xf32>) -> tensor<1x12x3200xf32> {
    ...
    %3 = "ttir.matmul"(%1, %arg11) : (tensor<12x3200xf32>, tensor<3200x3200xf32>) -> tensor<12x3200xf32>
    ...
    %11 = "ttir.matmul"(%arg3, %9) : (tensor<1x50x1xf32>, tensor<1x1x12xf32>) -> tensor<1x50x12xf32>
    ...
    %17 = "ttir.cos"(%15) : (tensor<1x12x100xf32>) -> tensor<1x12x100xf32>
    ...
    %21 = "ttir.multiply"(%7, %19) : (tensor<1x32x12x100xf32>, tensor<1x1x12x100xf32>) -> tensor<1x32x12x100xf32>
    ...
    %25 = "ttir.matmul"(%arg4, %23) : (tensor<1x32x50x100xf32>, tensor<1x32x100x12xf32>) -> tensor<1x32x50x12xf32>
    ...
    %29 = "ttir.multiply"(%27, %arg5) : (tensor<1x32x12x50xf32>, tensor<1x1xf32>) -> tensor<1x32x12x50xf32>
    ...
    %33 = "ttir.matmul"(%arg6, %31) : (tensor<1x32x50x100xf32>, tensor<1x32x100x12xf32>) -> tensor<1x32x50x12xf32>
    ...
    %39 = "ttir.sin"(%15) : (tensor<1x12x100xf32>) -> tensor<1x12x100xf32>
    ...
    %43 = "ttir.multiply"(%37, %41) : (tensor<1x32x12x100xf32>, tensor<1x1x12x100xf32>) -> tensor<1x32x12x100xf32>
    %45 = "ttir.add"(%21, %43) : (tensor<1x32x12x100xf32>, tensor<1x32x12x100xf32>) -> tensor<1x32x12x100xf32>
    ...
    %49 = "ttir.matmul"(%1, %arg12) : (tensor<12x3200xf32>, tensor<3200x3200xf32>) -> tensor<12x3200xf32>
    ...
    %55 = "ttir.multiply"(%53, %19) : (tensor<1x32x12x100xf32>, tensor<1x1x12x100xf32>) -> tensor<1x32x12x100xf32>
    ...
    %59 = "ttir.matmul"(%arg7, %57) : (tensor<1x32x50x100xf32>, tensor<1x32x100x12xf32>) -> tensor<1x32x50x12xf32>
    ...
    %63 = "ttir.multiply"(%61, %arg8) : (tensor<1x32x12x50xf32>, tensor<1x1xf32>) -> tensor<1x32x12x50xf32>
    ...
    %67 = "ttir.matmul"(%arg9, %65) : (tensor<1x32x50x100xf32>, tensor<1x32x100x12xf32>) -> tensor<1x32x50x12xf32>
    ...
    %73 = "ttir.multiply"(%71, %41) : (tensor<1x32x12x100xf32>, tensor<1x1x12x100xf32>) -> tensor<1x32x12x100xf32>
    %75 = "ttir.add"(%55, %73) : (tensor<1x32x12x100xf32>, tensor<1x32x12x100xf32>) -> tensor<1x32x12x100xf32>
    ...
    %81 = "ttir.matmul"(%47, %79) : (tensor<32x12x100xf32>, tensor<32x100x12xf32>) -> tensor<32x12x12xf32>
    ...
    %85 = "ttir.multiply"(%83, %arg10) : (tensor<1x32x12x12xf32>, tensor<1x1xf32>) -> tensor<1x32x12x12xf32>
    %87 = "ttir.add"(%85, %arg1) : (tensor<1x32x12x12xf32>, tensor<1x1x12x12xf32>) -> tensor<1x32x12x12xf32>
    ...
    %93 = "ttir.matmul"(%1, %arg13) : (tensor<12x3200xf32>, tensor<3200x3200xf32>) -> tensor<12x3200xf32>
    ...
    %105 = "ttir.matmul"(%91, %103) : (tensor<32x12x12xf32>, tensor<32x12x100xf32>) -> tensor<32x12x100xf32>
    ...
    %113 = "ttir.matmul"(%111, %arg14) : (tensor<12x3200xf32>, tensor<3200x3200xf32>) -> tensor<12x3200xf32>
