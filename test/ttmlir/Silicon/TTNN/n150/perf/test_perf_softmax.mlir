...
func.func @softmax(%arg0: tensor<512x1024xbf16>) -> tensor<512x1024xbf16> {
  ...
  %1 = "ttir.softmax"(%arg0) <{dimension = 1 : si32}> : (tensor<512x1024xbf16>) -> tensor<512x1024xbf16>
  // CHECK: = "ttnn.softmax"
  // Check for negative dimension attribute
  %3 = "ttir.softmax"(%1) <{dimension = -1 : si32}> : (tensor<512x1024xbf16>) -> tensor<512x1024xbf16>
