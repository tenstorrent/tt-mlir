...
module attributes {} {
  func.func @forward(%arg0: tensor<32x1024xbf16, #ttnn_layout>, %arg1: tensor<1024x1280xbf16, #ttnn_layout1>) -> tensor<32x1280xbf16, #sharded_layout2> {
    %0 = "ttnn.to_memory_config"(%arg0) : (tensor<32x1024xbf16, #ttnn_layout>) -> tensor<32x1024xbf16, #sharded_layout>
    %1 = "ttnn.to_memory_config"(%arg1) : (tensor<1024x1280xbf16, #ttnn_layout1>) -> tensor<1024x1280xbf16, #sharded_layout1>
    %2 = "ttnn.matmul"(%0, %1)
      <{
        transpose_a = false,
        transpose_b = false,
