...
module {
  func.func public @reduce_padding_workaround(%arg0: tensor<128x7xf32>) -> tensor<128xf32> {
    ...
    // CHECK-SAME: tensor<128x7xf32,
    // CHECK-SAME: -> tensor<128xf32,
    %1 = "ttir.max"(%arg0) <{dim_arg = [1 : i32], keep_dim = false}> : (tensor<128x7xf32>) -> tensor<128xf32>
  ...
  func.func public @reduce_not_keep_dim(%arg0: tensor<128x32xf32>) -> tensor<128xf32> {
    ...
    // CHECK-SAME: -> tensor<128xf32,
    %1 = "ttir.max"(%arg0) <{dim_arg = [1 : i32], keep_dim = false}> : (tensor<128x32xf32>) -> tensor<128xf32>
    return %1 : tensor<128xf32>
  }
  ...
  func.func public @reduce_keep_dim(%arg0: tensor<128x32xf32>) -> tensor<128x1xf32> {
    ...
    %1 = "ttir.max"(%arg0) <{dim_arg = [1 : i32], keep_dim = true}> : (tensor<128x32xf32>) -> tensor<128x1xf32>
