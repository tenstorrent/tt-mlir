// RUN: ttmlir-opt --ttir-to-ttnn-backend-pipeline="system-desc-path=%system_desc_path% enable-fusing-pass=true enable-fusing-conv2d-with-multiply-pattern=true" %s > %t.mlir
