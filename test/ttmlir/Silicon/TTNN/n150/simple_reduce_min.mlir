...
module {
  func.func public @reduce_min_not_keep_dim(%arg0: tensor<128x32x32x4xf32>) -> tensor<128x32x4xf32> {
    ...
    %1 = "ttir.min"(%arg0) <{dim_arg = [1: i32], keep_dim = false}> : (tensor<128x32x32x4xf32>) -> tensor<128x32x4xf32>
  ...
  func.func public @reduce_min_keep_dim(%arg0: tensor<128x32x32x4xf32>) -> tensor<128x1x32x4xf32> {
    ...
    %1 = "ttir.min"(%arg0) <{dim_arg = [1 : i32], keep_dim = true}> : (tensor<128x32x32x4xf32>) -> tensor<128x1x32x4xf32>
