...
module attributes {} {
  func.func @forward(%arg0: tensor<256x512xf32>) -> tensor<256x512xf32> {
    ...
    // CHECK: %[[C:.*]] = "ttnn.sqrt"[[C:.*]]
    %1 = "ttir.sqrt"(%arg0, %0) <{operandSegmentSizes = array<i32: 1, 1>, operand_constraints = [#any_device, #any_device]}> : (tensor<256x512xf32>, tensor<256x512xf32>) -> tensor<256x512xf32>
