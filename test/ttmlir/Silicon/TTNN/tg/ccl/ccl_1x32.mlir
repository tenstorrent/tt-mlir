...
func.func @all_reduce_cluster1(%arg0: tensor<1x1x256x512xf32>) -> tensor<1x1x256x16xf32> {
  ...
  %3 = "ttir.all_reduce"(%1, %2) <{all_gather_dim = 3 : si32, cluster_axis = 1 : ui32, reduce_type = #tt.reduce_type<sum>, scatter_dim = 3 : si32}> : (tensor<1x1x256x16xf32>, tensor<1x1x256x16xf32>) -> tensor<1x1x256x16xf32>
