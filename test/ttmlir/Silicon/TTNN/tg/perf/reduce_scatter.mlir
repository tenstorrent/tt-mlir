...
func.func @reduce_scatter_cluster1(%arg0: tensor<1x1x8192x512xf32>) -> (tensor<1x1x8192x128xf32> {jax.result_info = ""}) {
  ...
  %3 = "ttir.reduce_scatter"(%1) <{cluster_axis = 1 : ui32, reduce_type = #ttcore.reduce_type<sum>, scatter_dim = 3 : si32}> : (tensor<1x1x1024x128xf32>) -> tensor<1x1x1024x32xf32>
...
func.func @reduce_scatter_2d_input(%arg0: tensor<8192x512xf32>) -> tensor<1024x128xf32> {
  %1 = "ttir.reduce_scatter"(%arg0) <{cluster_axis = 1 : ui32, reduce_type = #ttcore.reduce_type<sum>, scatter_dim = 1 : si32}> : (tensor<8192x512xf32>) -> tensor<1024x128xf32>
