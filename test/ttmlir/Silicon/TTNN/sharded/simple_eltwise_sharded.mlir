...
func.func @subtract(%arg0: tensor<224x64xf32>, %arg1: tensor<224x64xf32>) -> tensor<224x64xf32> {
  ...
  %1 = "ttir.subtract"(%arg0, %arg1, %0) <{operandSegmentSizes = array<i32: 2, 1>}> : (tensor<224x64xf32>, tensor<224x64xf32>, tensor<224x64xf32>) -> tensor<224x64xf32>
...
func.func @multiply(%arg0: tensor<224x64xf32>, %arg1: tensor<224x64xf32>) -> tensor<224x64xf32> {
  ...
  %1 = "ttir.multiply"(%arg0, %arg1, %0) <{operandSegmentSizes = array<i32: 2, 1>}> : (tensor<224x64xf32>, tensor<224x64xf32>, tensor<224x64xf32>) -> tensor<224x64xf32>
  return %1 : tensor<224x64xf32>
}
...
func.func @relu(%arg0: tensor<224x64xf32>) -> tensor<224x64xf32> {
  ...
  %0 = tensor.empty() : tensor<224x64xf32>
  // CHECK: %[[C:.*]] = "ttnn.relu"[[C:.*]]
  %1 = "ttir.relu"(%arg0, %0) <{operandSegmentSizes = array<i32: 1, 1>}> : (tensor<224x64xf32>, tensor<224x64xf32>) -> tensor<224x64xf32>
  return %1 : tensor<224x64xf32>
}
...
func.func @ge(%arg0: tensor<224x64xf32>, %arg1: tensor<224x64xf32>) -> tensor<224x64xf32> {
  ...
  %0 = tensor.empty() : tensor<224x64xf32>
  // CHECK: %[[C:.*]] = "ttnn.ge"[[C:.*]]
  %1 = "ttir.ge"(%arg0, %arg1, %0) <{operandSegmentSizes = array<i32: 2, 1>}> : (tensor<224x64xf32>, tensor<224x64xf32>, tensor<224x64xf32>) -> tensor<224x64xf32>
  return %1 : tensor<224x64xf32>
}
...
func.func @reciprocal(%arg0: tensor<224x64xf32>) -> tensor<224x64xf32> {
  ...
  %1 = "ttir.reciprocal"(%arg0, %0) <{operandSegmentSizes = array<i32: 1, 1>}> : (tensor<224x64xf32>, tensor<224x64xf32>) -> tensor<224x64xf32>
  return %1 : tensor<224x64xf32>
}
...
func.func @sigmoid(%arg0: tensor<224x64xf32>) -> tensor<224x64xf32> {
  ...
  %1 = "ttir.sigmoid"(%arg0, %0) <{operandSegmentSizes = array<i32: 1, 1>}> : (tensor<224x64xf32>, tensor<224x64xf32>) -> tensor<224x64xf32>
  return %1 : tensor<224x64xf32>
}
...
func.func @sqrt(%arg0: tensor<224x64xf32>) -> tensor<224x64xf32> {
  ...
  %0 = tensor.empty() : tensor<224x64xf32>
  // CHECK: %[[C:.*]] = "ttnn.sqrt"[[C:.*]]
  %1 = "ttir.sqrt"(%arg0, %0) <{operandSegmentSizes = array<i32: 1, 1>}> : (tensor<224x64xf32>, tensor<224x64xf32>) -> tensor<224x64xf32>
  return %1 : tensor<224x64xf32>
}
