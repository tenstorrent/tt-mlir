...
module attributes {} {
  ...
  func.func @test_maxpool2d_0(%arg0: tensor<1x192x28x28xbf16>) -> tensor<1x192x28x28xbf16> {
    // CHECK-LABEL: func.func @test_maxpool2d_0(
  ...
  func.func @test_maxpool2d_1(%arg0: tensor<1x256x28x28xbf16>) -> tensor<1x256x28x28xbf16> {
    // CHECK-LABEL: func.func @test_maxpool2d_1(
  ...
  func.func @test_maxpool2d_2(%arg0: tensor<1x192x28x28xbf16>) -> tensor<1x192x27x28xbf16> {
    // CHECK-LABEL: func.func @test_maxpool2d_2(
  ...
  func.func @test_maxpool2d_3(%arg0: tensor<1x192x28x28xbf16>) -> tensor<1x192x10x27xbf16> {
    // CHECK-LABEL: func.func @test_maxpool2d_3(
