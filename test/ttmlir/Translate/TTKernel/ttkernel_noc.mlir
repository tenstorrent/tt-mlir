...
func.func @ttkernel_noc() -> () {
    ...
    %3 = "ttkernel.get_noc_addr_xy"(%c0_idx, %c0_idx, %c262144_i32) : (index, index, i32) -> !ttkernel.noc_addr
    ...
    %4 = "ttkernel.get_noc_addr_xy"(%c0_idx, %c0_idx, %c262208_i32) : (index, index, i32) -> !ttkernel.noc_addr
