...
func.func @test_lower_interleaved_dram(
  ...
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %[[CAST0]] remapping = #map{{.*}} : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout1>
  ...
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %[[CAST1]] remapping = #map{{.*}} : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout1>
  ...
  // CHECK: %[[CAST2:.*]] = ttir.ttnn_metal_layout_cast %[[RESULT]] : tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout1> -> tensor<1024x1024xbf16, #ttnn_layout>
...
func.func @test_lower_interleaved_dram_1(
  ...
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %[[CAST0]] remapping = #map{{.*}} : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout2> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout3>
  ...
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %[[CAST1]] remapping = #map{{.*}} : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout2> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout3>

  // CHECK: %[[RESULT:.*]] = d2m.generic{{.*}}
  // CHECK: ins(%[[VIEW0]] : tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout3>)
  // CHECK: outs(%[[VIEW1]] : tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout3>)
  // CHECK-DAG: d2m.tile_abs

  // CHECK: %[[CAST2:.*]] = ttir.ttnn_metal_layout_cast %[[RESULT]] : tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout3> -> tensor<2x512x1024xbf16, #ttnn_layout1>
...
func.func @test_lower_interleaved_dram_2(
  ...
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %[[CAST0]] remapping = #map{{.*}} : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout4> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout5>
  ...
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %[[CAST1]] remapping = #map{{.*}} : tensor<1x1x32x32x!ttcore.tile<32x32, bf16>, #layout4> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout5>

  // CHECK: %[[RESULT:.*]] = d2m.generic{{.*}}
  // CHECK: ins(%[[VIEW0]] : tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout5>)
  // CHECK: outs(%[[VIEW1]] : tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout5>)
  // CHECK-DAG: d2m.tile_abs
  // CHECK: %[[CAST2:.*]] = ttir.ttnn_metal_layout_cast %[[RESULT]] : tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout5> -> tensor<2x2x256x1024xbf16, #ttnn_layout2>
