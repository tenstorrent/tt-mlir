...
func.func @test_mixed_operands_eltwise_unary_dram_dram(%arg0: tensor<512x2048xbf16, #ttnn_layout_dram>) -> tensor<512x2048xbf16, #ttnn_layout_dram> {
  ...
  // CHECK: %[[CAST0:.*]] = ttir.ttnn_metal_layout_cast %arg0 {{.*}} -> tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>
  // CHECK: %[[STREAM0:.*]] = "d2m.stream_layout"(%[[CAST0]], %{{.*}}) : (tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout1>) -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>
  // CHECK: %[[CAST1:.*]] = ttir.ttnn_metal_layout_cast %{{.*}} -> tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>
  // CHECK: %[[STREAM1:.*]] = "d2m.stream_layout"(%[[CAST1]], %{{.*}}) : (tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout1>) -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>
  // CHECK: %{{.*}} = d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<8x8>
    ...
    -> tensor<512x2048xbf16, #ttnn_layout_dram>
{
  ...
  // CHECK: %[[STREAM:.*]] = "d2m.stream_layout"(%[[DRAM_CAST]], %{{.*}}) : (tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout1>) -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>
  // CHECK: %[[OUT_CAST:.*]] = ttir.ttnn_metal_layout_cast %{{.*}} -> tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>
  // CHECK: %[[OUT_STREAM:.*]] = "d2m.stream_layout"(%[[OUT_CAST]], %{{.*}}) : (tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout1>) -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>
  // CHECK: %[[VIEW:.*]] = d2m.view_layout %[[L1_CAST]] : tensor<2x2x8x32x!ttcore.tile<32x32, bf16>, #layout1> -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout3>
  // CHECK: %{{.*}} = d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<8x8>
  // CHECK: ins(%[[VIEW]], %[[STREAM]] : tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout3>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>)
  // CHECK: outs(%[[OUT_STREAM]] : tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>)
    ...
    -> tensor<512x2048xbf16, #ttnn_layout_dram>
{
  ...
  // CHECK: %[[OUT_CAST:.*]] = ttir.ttnn_metal_layout_cast %{{.*}} -> tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>
  // CHECK: %[[OUT_STREAM:.*]] = "d2m.stream_layout"(%[[OUT_CAST]], %{{.*}}) : (tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout1>) -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>
  // CHECK: %[[VIEW0:.*]] = d2m.view_layout %[[CAST0]] : tensor<2x2x8x32x!ttcore.tile<32x32, bf16>, #layout1> -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout3>
  // CHECK: %[[VIEW1:.*]] = d2m.view_layout %[[CAST1]] : tensor<2x2x8x32x!ttcore.tile<32x32, bf16>, #layout1> -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout3>
  // CHECK: %{{.*}} = d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<8x8>
  // CHECK: ins(%[[VIEW0]], %[[VIEW1]] : tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout3>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout3>)
  // CHECK: outs(%[[OUT_STREAM]] : tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>)
    ...
    -> tensor<512x2048xbf16, #ttnn_layout_dram>
{
  // CHECK: %[[CAST0:.*]] = ttir.ttnn_metal_layout_cast %arg0 {{.*}} -> tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>
  // CHECK: %[[STREAM0:.*]] = "d2m.stream_layout"(%[[CAST0]], %{{.*}}) : (tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout1>) -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>
  // CHECK: %[[CAST1:.*]] = ttir.ttnn_metal_layout_cast %arg1 {{.*}} -> tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>
  // CHECK: %[[STREAM1:.*]] = "d2m.stream_layout"(%[[CAST1]], %{{.*}}) : (tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout1>) -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>
  // CHECK: %[[OUT_CAST:.*]] = ttir.ttnn_metal_layout_cast %{{.*}} -> tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>
  // CHECK: %[[OUT_STREAM:.*]] = "d2m.stream_layout"(%[[OUT_CAST]], %{{.*}}) : (tensor<1x1x16x64x!ttcore.tile<32x32, bf16>, #layout>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout1>) -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>
  // CHECK: %{{.*}} = d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<8x8>
  // CHECK: ins(%[[STREAM0]], %[[STREAM1]] : tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>)
  // CHECK: outs(%[[OUT_STREAM]] : tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>)
    ...
    -> tensor<512x2048xbf16, #ttnn_layout_l1>
{
  ...
  // CHECK: %[[VIEW:.*]] = d2m.view_layout %[[OUT_CAST]] : tensor<2x2x8x32x!ttcore.tile<32x32, bf16>, #layout1> -> tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout3>
  // CHECK: %{{.*}} = d2m.generic {block_factors = [1, 1], grid = #ttcore.grid<8x8>
  // CHECK: ins(%[[STREAM0]], %[[STREAM1]] : tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>, tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout2>)
  // CHECK: outs(%[[VIEW]] : tensor<8x8x2x8x!ttcore.tile<32x32, bf16>, #layout3>)
