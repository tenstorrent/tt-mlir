...
func.func @dram_to_l1_block_sharded(
    ...
    // CHECK: %[[TOLAYOUT:.*]] = d2m.to_layout %[[GENERIC]], %[[CAST1]] : tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout> into tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout1> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout1>
...
func.func @l1_block_sharded_reshard(
    ...
    // CHECK: %[[CAST1:.*]] = ttir.ttnn_metal_layout_cast %[[EMPTY]] : tensor<2048x2048xbf16, #ttnn_layout3> -> tensor<4x4x16x16x!ttcore.tile<32x32, bf16>, #layout2>
    %1 = ttir.empty() : tensor<2048x2048xbf16, #ttnn_layout3>

    // CHECK: %[[TOLAYOUT:.*]] = d2m.to_layout %[[GENERIC]], %[[CAST1]] : tensor<8x8x8x8x!ttcore.tile<32x32, bf16>, #layout2> into tensor<4x4x16x16x!ttcore.tile<32x32, bf16>, #layout2> -> tensor<4x4x16x16x!ttcore.tile<32x32, bf16>, #layout2>
    // CHECK: %[[CAST2:.*]] = ttir.ttnn_metal_layout_cast %[[TOLAYOUT]] : tensor<4x4x16x16x!ttcore.tile<32x32, bf16>, #layout2> -> tensor<2048x2048xbf16, #ttnn_layout3>
...
func.func @l1_block_sharded_to_height_sharded(
    ...
    // CHECK: %[[CAST2:.*]] = ttir.ttnn_metal_layout_cast %[[TOLAYOUT]] : tensor<8x1x2x8x!ttcore.tile<32x32, bf16>, #layout3> -> tensor<512x256xbf16, #ttnn_layout5>
