...
func.func @dram_to_l1_block_sharded(
    ...
    // CHECK: %[[CAST1:.*]] = ttir.ttnn_metal_layout_cast %4 : tensor<1024x1024xbf16, #ttnn_layout1> -> tensor<8x8x4x4x!ttcore.tile<32x32, bf16>, #layout1>
...
func.func @l1_block_sharded_reshard(
    ...
    // CHECK: %[[CAST1:.*]] = ttir.ttnn_metal_layout_cast %2 : tensor<2048x2048xbf16, #ttnn_layout3> -> tensor<4x4x16x16x!ttcore.tile<32x32, bf16>, #layout3>
    ...
    // CHECK: %[[CAST2:.*]] = ttir.ttnn_metal_layout_cast %3 : tensor<4x4x16x16x!ttcore.tile<32x32, bf16>, #layout3> -> tensor<2048x2048xbf16, #ttnn_layout3>
...
func.func @l1_block_sharded_to_height_sharded(
    ...
    // CHECK: %[[CAST1:.*]] = ttir.ttnn_metal_layout_cast %2 : tensor<512x256xbf16, #ttnn_layout5> -> tensor<8x1x2x8x!ttcore.tile<32x32, bf16>, #layout5>
    ...
    // CHECK: %[[CAST2:.*]] = ttir.ttnn_metal_layout_cast %3 : tensor<8x1x2x8x!ttcore.tile<32x32, bf16>, #layout5> -> tensor<512x256xbf16, #ttnn_layout5>
