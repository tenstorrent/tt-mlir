...
func.func @l1_block_sharded_to_height_sharded(
    ...
    // CHECK: %[[CAST1:.*]] = ttir.ttnn_metal_layout_cast %[[EMPTY]]{{.*}}: tensor<512x256xbf16, #ttnn_layout5> -> tensor<8x1x2x8x!ttcore.tile<32x32, bf16>, #layout4>

    %1 = ttir.empty() : tensor<512x256xbf16, #ttnn_layout5>

    // CHECK: %[[TOLAYOUT:.*]] = d2m.to_layout %[[GENERIC]], %[[CAST1]] : tensor<8x8x2x1x!ttcore.tile<32x32, bf16>, #layout4> into tensor<8x1x2x8x!ttcore.tile<32x32, bf16>, #layout4> -> tensor<8x1x2x8x!ttcore.tile<32x32, bf16>, #layout4>
    // CHECK: %[[CAST2:.*]] = ttir.ttnn_metal_layout_cast %[[TOLAYOUT]] : tensor<8x1x2x8x!ttcore.tile<32x32, bf16>, #layout4> -> tensor<512x256xbf16, #ttnn_layout5>
