...
//ttmlir-opt --convert-ttir-to-nvvm="opt-level=0" test/ttmlir/Conversion/TTIRToLinalg/igranje.mlir -o test/ttmlir/Conversion/TTIRToLinalg/izlaz.mlir

//llc -march=nvptx64 -mcpu=sm_80 test/ttmlir/Conversion/TTIRToLinalg/llvmir.mlir -o test/ttmlir/Conversion/TTIRToLinalg/llvmir.ptx

//ttmlir-opt --convert-ttir-to-nvvm test/ttmlir/Conversion/TTIRToLinalg/igranje.mlir | mlir-translate --mlir-to-llvmir | llc -march=nvptx64 -mcpu=sm_80 -o test/ttmlir/Conversion/TTIRToLinalg/llvmir.ptx
