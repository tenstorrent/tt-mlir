...
module {
  // CHECK-LABEL: func.func @test_to_layout_host_info_relay
  func.func @test_to_layout_host_info_relay(%arg0: memref<43x7xf32>) -> memref<43x7xf32> {
    ...
    // CHECK: "ttmetal.enqueue_write_buffer"(%{{.*}}, %[[DEV_TENSOR]]) {host_info = #ttcore.metal_layout[[DEV_TENSOR_LAYOUT:.*]]}
    ...
    // CHECK: "ttmetal.enqueue_read_buffer"(%[[DEV_TENSOR]], %[[HOST_TENSOR]]) {host_info = #ttcore.metal_layout[[DEV_TENSOR_LAYOUT]]}
