...
module {
  func.func @abs(%arg0: tensor<32x32xf32, #dram_layout>) -> tensor<32x32xf32, #dram_layout> {
    ...
    %storage_in = memref.alloc() {address = 1024 : i64, alignment = 32 : i64} : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #ttcore.memory_space<l1>>
    ...
    // CHECK-NOT: memref.alloc()
    // CHECK-NOT: d2m.stream_layout
    %storage_out = memref.alloc() {address = 1024 : i64, alignment = 32 : i64} : memref<1x1x1x1x!ttcore.tile<32x32, f32>, #ttcore.shard<4096x4096>, #ttcore.memory_space<l1>>
