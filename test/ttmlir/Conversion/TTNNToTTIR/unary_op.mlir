...
module {
    func.func @test(%arg0: tensor<32x32xf32, #dram_layout>) -> tensor<32x32xf32, #dram_layout> {
        %1 = "ttnn.to_memory_config"(%arg0) : (tensor<32x32xf32, #dram_layout>) -> tensor<32x32xf32, #ttnn_layout1>
        ...
        %3 = "ttnn.to_memory_config"(%2) : (tensor<32x32xf32, #ttnn_layout1>) -> tensor<32x32xf32, #dram_layout>
