...
module {
    func.func @test(%arg0: tensor<32x32xf32, #dram_layout>, %arg1: tensor<32x32xf32, #dram_layout>) -> tensor<32x32xf32, #dram_layout> {
        ...
        %3 = "ttnn.add"(%1, %2) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<32x32xf32, #l1_layout>, tensor<32x32xf32, #l1_layout>) -> tensor<32x32xf32, #l1_layout>
