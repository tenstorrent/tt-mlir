...
module {
    func.func @test(%arg0: tensor<32x32xf32, #ttnn_layout>, %arg1: tensor<32x32xf32, #ttnn_layout>) -> tensor<32x32xf32, #ttnn_layout> {
        ...
        %3 = "ttnn.add"(%1, %2) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> {ttnn.hoist_generic_via_d2m} : (tensor<32x32xf32, #ttnn_layout1>, tensor<32x32xf32, #ttnn_layout1>) -> tensor<32x32xf32, #ttnn_layout1>
