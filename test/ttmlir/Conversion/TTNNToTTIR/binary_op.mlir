...
module {
    func.func @test(%arg0: tensor<32x32xf32, #dram_layout>, %arg1: tensor<32x32xf32, #dram_layout>) -> tensor<32x32xf32, #dram_layout> {
        ...
        // CHECK: %{{[0-9]+}} = "ttir.add"(%{{[0-9]+}}, %{{[0-9]+}}) : (tensor<32x32xf32, #ttnn_layout1>, tensor<32x32xf32, #ttnn_layout1>) -> tensor<32x32xf32, #ttnn_layout1>
        %3 = "ttnn.add"(%1, %2) <{dtype = #ttcore.supportedDataTypes<f32>, activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> {ttnn.hoist_generic_via_d2m} : (tensor<32x32xf32, #l1_layout>, tensor<32x32xf32, #l1_layout>) -> tensor<32x32xf32, #l1_layout>
