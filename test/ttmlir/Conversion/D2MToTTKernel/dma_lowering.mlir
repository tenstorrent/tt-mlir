// RUN: ttmlir-opt --ttcore-register-device --d2m-generic-lower-dmas --convert-d2m-to-ttkernel -o %t %s
...
func.func @test_local_to_local_same_core(%arg0: memref<2x2x!ttcore.tile<32x32, f32>, #l1_>, %arg1: memref<2x2x!ttcore.tile<32x32, f32>, #l1_>) attributes {d2m.thread = #d2m.thread<datamovement>} {
...
func.func @test_local_to_remote_multicast_regular(%arg0: memref<2x2x!ttcore.tile<32x32, f32>, #l1_>) attributes {d2m.thread = #d2m.thread<datamovement>} {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
...
func.func @test_local_to_remote_multicast_loopback(%arg0: memref<2x2x!ttcore.tile<32x32, f32>, #l1_>, %arg1: memref<2x2x!ttcore.tile<32x32, f32>, #l1_>) attributes {d2m.thread = #d2m.thread<datamovement>} {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  %c2 = arith.constant 2 : index
  %c3 = arith.constant 3 : index
...
func.func @test_dma_wait_write(%arg0: memref<2x2x!ttcore.tile<32x32, f32>, #l1_>, %arg1: memref<2x2x!ttcore.tile<32x32, f32>, #l1_>) attributes {d2m.thread = #d2m.thread<datamovement>} {
  %c0 = arith.constant 0 : index
  %0 = d2m.dma %arg0[%c0, %c0], %arg1[%c0, %c0] : (memref<2x2x!ttcore.tile<32x32, f32>, #l1_>, memref<2x2x!ttcore.tile<32x32, f32>, #l1_>) -> !d2m.mem_tx
