...
module {
  ...
  func.func @test_tile_tilize_block() attributes {d2m.thread = #d2m.thread<compute>} {
    %arg0 = d2m.get_cb(0) operand_index = 0 : !d2m.cb<memref<128x192xf32, #l1_>>
    %arg1 = d2m.get_cb(1) operand_index = 1 : !d2m.cb<memref<4x6x!ttcore.tile<32x32, f32>, #l1_>>
  ...
  func.func @test_tile_untilize_block() attributes {d2m.thread = #d2m.thread<compute>} {
    %arg0 = d2m.get_cb(0) operand_index = 0 : !d2m.cb<memref<4x6x!ttcore.tile<32x32, f32>, #l1_>>
    %arg1 = d2m.get_cb(1) operand_index = 1 : !d2m.cb<memref<128x192xf32, #l1_>>
  ...
  func.func @test_tile_tilize_block_i32() attributes {d2m.thread = #d2m.thread<compute>} {
    %arg0 = d2m.get_cb(0) operand_index = 0 : !d2m.cb<memref<128x192xi32, #l1_>>
    %arg1 = d2m.get_cb(1) operand_index = 1 : !d2m.cb<memref<4x6x!ttcore.tile<32x32, si32>, #l1_>>
    // CHECK-NOT: d2m.tile_tilize_block
    // CHECK: ttkernel.tilize_init
    // CHECK: ttkernel.experimental::tilize_block
  ...
  func.func @test_tile_untilize_block_i32() attributes {d2m.thread = #d2m.thread<compute>} {
    %arg0 = d2m.get_cb(0) operand_index = 0 : !d2m.cb<memref<4x6x!ttcore.tile<32x32, si32>, #l1_>>
    %arg1 = d2m.get_cb(1) operand_index = 1 : !d2m.cb<memref<128x192xi32, #l1_>>
    // CHECK-NOT: d2m.tile_untilize_block
    // CHECK: ttkernel.pack_untilize_init
    // CHECK: ttkernel.experimental::pack_untilize_block
    // CHECK: ttkernel.pack_untilize_uninit
