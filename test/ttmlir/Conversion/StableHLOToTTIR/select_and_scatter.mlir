...
module @jit_test_select_and_scatter attributes {} {
  func.func public @test_select_and_scatter(%arg0: tensor<1x1x4x4xbf16>) -> tensor<1x1x4x4xbf16> {
    ...
    // CHECK: "ttir.permute"
    // CHECK: <{permutation = array<i64: 0, 2, 3, 1>}> : (tensor<1x1x4x4xbf16>) -> tensor<1x4x4x1xbf16>
    ...
    // CHECK: "ttir.permute"
    // CHECK: <{permutation = array<i64: 0, 3, 1, 2>}> : (tensor<1x4x4x1xbf16>) -> tensor<1x1x4x4xbf16>
