...
module @jit_scatter attributes {} {
    func.func public @test_scatter(%arg0: tensor<1x3x320x320xf32>, %arg1: tensor<1x1xi64>, %arg2: tensor<1x3x32x32xf32>) -> tensor<1x3x320x320xf32> {
        // CHECK: [[VAL0:%[0-9]+]] = ttir.empty() : tensor<1x1x1x1xi64>
        // CHECK: [[VAL1:%[0-9]+]] = "ttir.reshape"(%arg1, [[VAL0]])
        // CHECK: [[VAL2:%[0-9]+]] = ttir.empty() : tensor<1x3x32x32xi64>
        // CHECK: [[VAL3:%[0-9]+]] = "ttir.repeat"([[VAL1]], [[VAL2]])
        // CHECK: [[VAL4:%[0-9]+]] = ttir.empty() : tensor<1x3x320x320xf32>
