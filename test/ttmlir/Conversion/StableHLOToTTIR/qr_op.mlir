...
module {
  ...
  func.func @qr_m_ge_n(%arg0: tensor<4x3xf32>) -> (tensor<4x3xf32>, tensor<3x3xf32>) {
    ...
    // TTNN-NOT: ttir.qr
    // TTNN-NOT: xi1
    // TTNN: "ttnn.qr"(%arg0) : (tensor<4x3xf32, #ttnn_layout>) -> (tensor<4x3xf32, #ttnn_layout>, tensor<3x3xf32, #ttnn_layout>)
    // TTNN-NOT: "ttnn.matmul"
  ...
  func.func @qr_m_lt_n(%arg0: tensor<3x4xf32>) -> (tensor<3x3xf32>, tensor<3x4xf32>) {
    ...
    // TTNN-NOT: ttir.qr
    // TTNN-NOT: xi1
    // TTNN: "ttnn.qr"(%arg0) : (tensor<3x4xf32, #ttnn_layout>) -> (tensor<3x3xf32, #ttnn_layout>, tensor<3x4xf32, #ttnn_layout>)
    // TTNN-NOT: "ttnn.matmul"
