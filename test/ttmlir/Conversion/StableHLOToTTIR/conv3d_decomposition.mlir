...
module @test_convolution3d {
  ...
  func.func @test_conv3d_dilation(%arg0: tensor<1x4x9x9x9xbf16>, %arg1: tensor<16x4x3x3x3xbf16>) -> tensor<1x16x5x5x5xbf16> {
    // CHECK: "ttir.conv3d"
    ...
    %0 = stablehlo.convolution(%arg0, %arg1)
      ...
      window = {
        ...
        feature_group_count = 1 : i64,
        batch_group_count = 1 : i64
      } : (tensor<1x4x9x9x9xbf16>, tensor<16x4x3x3x3xbf16>) -> tensor<1x16x5x5x5xbf16>
    return %0 : tensor<1x16x5x5x5xbf16>
  }
}
