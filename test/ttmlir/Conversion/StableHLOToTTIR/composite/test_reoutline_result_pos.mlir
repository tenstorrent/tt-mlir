...
// The indices result should come before the values result in the block order
...
// But the return statement should return values before indices
// (as specified by the reoutline.result_pos attributes)
