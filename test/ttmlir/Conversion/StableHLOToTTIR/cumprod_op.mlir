...
module @cumprod attributes {} {
  func.func @test_cumprod_0_dim1(%arg0: tensor<1x10xi64>) -> tensor<1x10xi64> {
    // CHECK-LABEL: func.func @test_cumprod_0_dim1
    // CHECK: %[[RET:[0-9]+]] = "ttir.cumprod"(%arg0)
  ...
  func.func @test_cumprod_1_dim0(%arg0: tensor<5xi64>) -> tensor<5xi64> {
    %c = stablehlo.constant dense<1> : tensor<i64>
    // CHECK-LABEL: func.func @test_cumprod_1_dim0
    // CHECK: %[[RET:[0-9]+]] = "ttir.cumprod"(%arg0)
  ...
  func.func @test_cumprod_2_dim0(%arg0: tensor<8x2x4x16xi32>) -> tensor<8x2x4x16xi64> {
    // CHECK-LABEL: func.func @test_cumprod_2_dim0
    // CHECK: %[[RET:[0-9]+]] = "ttir.cumprod"
    // CHECK-SAME: <{dim = 0 : i64}>
    ...
    ^bb0(%arg1: tensor<i64>, %arg2: tensor<i64>):
      %2 = stablehlo.multiply %arg1, %arg2 : tensor<i64>
  ...
  func.func @test_cumprod_2_dim2(%arg0: tensor<8x2x4x16xi32>) -> tensor<8x2x4x16xi64> {
    // CHECK-LABEL: func.func @test_cumprod_2_dim2
    // CHECK: %[[RET:[0-9]+]] = "ttir.cumprod"
  ...
  func.func @test_cumprod_3_dim1(%arg0: tensor<8x1x4x16xi32>) -> tensor<8x1x4x16xi64> {
    // CHECK-LABEL: func.func @test_cumprod_3_dim1
    // CHECK: %[[RET:[0-9]+]] = "ttir.cumprod"
    // CHECK-SAME: <{dim = 1 : i64}>
  ...
  func.func @test_cumprod_3_dim3(%arg0: tensor<8x2x4x1xbf16>) -> tensor<8x2x4x1xbf16> {
    // CHECK-LABEL: func.func @test_cumprod_3_dim3
    // CHECK: %[[RET:[0-9]+]] = "ttir.cumprod"(%arg0)
  ...
  func.func @reduce_window_3d_input_to_cumprod(%arg0: tensor<1x25x34xf32>) -> tensor<1x25x34xf32> {
    // CHECK: %[[RET:[0-9]+]] = "ttir.cumprod"(%arg0)
    // CHECK-SAME: <{dim = 1 : i64}>
    ...
    ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
      %prod = stablehlo.multiply %arg1, %arg2 : tensor<f32>
