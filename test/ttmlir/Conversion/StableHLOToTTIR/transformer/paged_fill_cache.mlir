...
module {
  func.func @paged_update_cache(%cache: tensor<128x4x32x256xbf16>, %fill_value: tensor<1x12x65x256xbf16>, %page_table: tensor<8x16xi32>, %batch_offset: tensor<1xi64>) -> tensor<128x4x32x256xbf16> {
