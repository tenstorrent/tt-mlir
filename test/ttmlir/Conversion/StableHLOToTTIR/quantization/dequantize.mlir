...
module @jit_dequantize attributes {} {
  ...
  func.func @dequantize_per_channel_scale_per_tensor_zp(%arg0: tensor<3x3x7x7x!quant.uniform<i32:f32:0, {0.02,0.01,0.005}>>) -> tensor<3x3x7x7xf32> {
  ...
  func.func @dequantize_per_channel_scale_per_channel_zp(%arg0: tensor<3x3x7x7x!quant.uniform<i32:f32:0, {0.02:10,0.01:20,0.005:30}>>) -> tensor<3x3x7x7xf32> {
