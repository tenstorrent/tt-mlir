...
module {
  func.func @test_decomposition_configs(%arg0: tensor<32x32xbf16>) -> (tensor<32x1xbf16>, tensor<64x128xf32>, tensor<32x1xbf16>) {
    ...
    %1 = "ttir.reduce_or"(%arg0) <{dim_arg = [1 : i32], keep_dim = true}> : (tensor<32x32xbf16>) -> tensor<32x1xbf16>
    ...
    %6 = "ttir.reduce_and"(%arg0) <{dim_arg = [1 : i32], keep_dim = true}> : (tensor<32x32xbf16>) -> tensor<32x1xbf16>

    return %1, %2, %6 : tensor<32x1xbf16>, tensor<64x128xf32>, tensor<32x1xbf16>
  }
}
