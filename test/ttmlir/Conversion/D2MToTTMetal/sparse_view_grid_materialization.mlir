...
module {
  ...
  // CHECK-NOT: memref<3x1x224x32xf32
  // CHECK: memref<3x1x32x32xf32, #ttcore.shard<128x4, 1>, #l1>
  // CHECK: "ttmetal.enqueue_program"{{.*}}#ttmetal.core_range<0x0, 1x1>{{.*}} : (memref<3x1x32x32xf32
  // CHECK-NOT: memref<3x1x224x32xf32
