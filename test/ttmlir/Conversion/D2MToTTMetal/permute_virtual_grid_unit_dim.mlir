...
module {
  ...
  // CHECK: "ttmetal.create_buffer"() <{address = {{[0-9]+}} : i64, virtualGridForwardMapping = #map{{[0-9]*}}, virtualGridInverseMapping = #map{{[0-9]*}}}> : () -> memref<1x1x1x1x1x1x128x64xbf16
  // CHECK: #ttmetal.core_range<0x0, 1x1>
  // CHECK: "ttmetal.enqueue_read_buffer"{{.*}} : (memref<1x1x1x1x1x1x128x64xbf16
