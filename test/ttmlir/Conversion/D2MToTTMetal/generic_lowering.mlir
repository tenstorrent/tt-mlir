...
module {
  func.func @generic0(%arg0: memref<1x1x8x24x!ttcore.tile<32x32, f32>, #ttcore.shard<98304x4096, 1>, #l1_>, %arg1: memref<1x1x24x32x!ttcore.tile<32x32, f32>, #ttcore.shard<131072x4096, 1>, #l1_>) -> memref<8x8x1x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096, 1>, #l1_> {
    ...
    %stream = "d2m.stream_layout"(%arg0, %alloc_0) : (memref<1x1x8x24x!ttcore.tile<32x32, f32>, #ttcore.shard<98304x4096, 1>, #l1_>, memref<8x8x1x3x!ttcore.tile<32x32, f32>, #ttcore.shard<12288x4096, 1>, #l1_>) -> memref<8x8x1x3x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #l1_>
    ...
    %stream_2 = "d2m.stream_layout"(%arg1, %alloc_1) : (memref<1x1x24x32x!ttcore.tile<32x32, f32>, #ttcore.shard<131072x4096, 1>, #l1_>, memref<8x8x3x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096, 1>, #l1_>) -> memref<8x8x3x4x!ttcore.tile<32x32, f32>, #ttcore.view<map(4)>, #l1_>
