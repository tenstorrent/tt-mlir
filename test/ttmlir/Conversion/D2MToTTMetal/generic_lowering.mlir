...
module {
  func.func @generic0(%arg0: memref<1x1x8x24x!ttcore.tile<32x32, f32>, #ttcore.shard<98304x4096, 1>, #l1_>, %arg1: memref<1x1x24x32x!ttcore.tile<32x32, f32>, #ttcore.shard<131072x4096, 1>, #l1_>) -> memref<8x8x1x4x!ttcore.tile<32x32, f32>, #ttcore.shard<16384x4096, 1>, #l1_> {
    ...
    // CHECK-SAME: {{.*}}cb_ports = array<i64: 0, 1, 2>, kernelConfigs = [#ttmetal.noc_config<@datamovement_kernel0, #ttmetal.core_range<0x0, 8x8>, #ttmetal.kernel_args< ct_args = [<cb_port[0]>, <cb_port[1]>, <cb_port[2]>, <local_semaphore[3]>, <local_semaphore[4]>, <local_semaphore[5]>, <local_semaphore[6]>]>, noc0>, #ttmetal.noc_config<@datamovement_kernel1, #ttmetal.core_range<0x0, 8x8>, #ttmetal.kernel_args< ct_args = [<cb_port[0]>, <cb_port[1]>, <cb_port[2]>, <local_semaphore[3]>, <local_semaphore[4]>, <local_semaphore[5]>, <local_semaphore[6]>]>, noc1>, #ttmetal.compute_config<@compute_kernel2, #ttmetal.core_range<0x0, 8x8>, #ttmetal.kernel_args< ct_args = [<cb_port[0]>, <cb_port[1]>, <cb_port[2]>, <local_semaphore[3]>, <local_semaphore[4]>, <local_semaphore[5]>, <local_semaphore[6]>]>, hifi4, true, false, false, [default]>]
  ...
  func.func private @datamovement_kernel0() attributes {d2m.thread = #d2m.thread<datamovement>} {
    ...
    %arg3 = d2m.get_arg(3) : !d2m.local_semaphore
    %arg4 = d2m.get_arg(4) : !d2m.local_semaphore
  ...
  func.func private @compute_kernel2() attributes {d2m.thread = #d2m.thread<compute>} {
    %cb0 = d2m.get_cb(0) operand_index = 0 : !d2m.cb<memref<1x3x!ttcore.tile<32x32, f32>, #l1_>>
    %cb1 = d2m.get_cb(1) operand_index = 1 : !d2m.cb<memref<3x4x!ttcore.tile<32x32, f32>, #l1_>>
    %cb2 = d2m.get_cb(2) operand_index = 2 : !d2m.cb<memref<1x4x!ttcore.tile<32x32, f32>, #l1_>>
    %arg3 = d2m.get_arg(3) : !d2m.local_semaphore
