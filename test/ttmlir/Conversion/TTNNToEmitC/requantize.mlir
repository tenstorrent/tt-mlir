...
module {
    func.func @forward(%arg0: tensor<1x3x320x320x!quant.uniform<i8:f32, 1.000000e-01>, #ttnn_layout>) -> tensor<1x3x320x320x!quant.uniform<i8:f32, 5.000000e-02>, #ttnn_layout1> {
        ...
        }> : (tensor<1x3x320x320x!quant.uniform<i8:f32, 1.000000e-01>, #ttnn_layout>) -> tensor<1x3x320x320x!quant.uniform<i8:f32, 5.000000e-02>, #ttnn_layout1>
        return %0 : tensor<1x3x320x320x!quant.uniform<i8:f32, 5.000000e-02>, #ttnn_layout1>
    }
}
