...
module {
  ...
  module @ttkernel_noc_operations {
    ...
    func.func @test_chained_tensor_accessor_args() -> () attributes {ttkernel.thread = #ttkernel.thread<noc>} {
      ...
      %args1 = "ttkernel.TensorAccessorArgs"(%cta_offset, %crta_offset) : (i32, i32) -> !ttkernel.TensorAccessorArgs
      ...
      %args2 = "ttkernel.TensorAccessorArgs"(%args1, %cta_offset, %crta_offset_2) : (!ttkernel.TensorAccessorArgs, i32, i32) -> !ttkernel.TensorAccessorArgs
      ...
      %args3 = "ttkernel.TensorAccessorArgs"(%args2, %cta_offset, %crta_offset) : (!ttkernel.TensorAccessorArgs, i32, i32) -> !ttkernel.TensorAccessorArgs
    ...
    func.func @test_cta_crta_chained_tensor_accessor_args() -> () attributes {ttkernel.thread = #ttkernel.thread<noc>} {
      ...
      %args_src = "ttkernel.TensorAccessorArgs"(%cta_0, %crta_0) : (i32, i32) -> !ttkernel.TensorAccessorArgs
      ...
      %args_dst = "ttkernel.TensorAccessorArgs"(%args_src, %cta_0, %crta_0) : (!ttkernel.TensorAccessorArgs, i32, i32) -> !ttkernel.TensorAccessorArgs
    ...
    func.func @test_tensor_accessor_args_constexpr() -> () attributes {ttkernel.thread = #ttkernel.thread<noc>} {
      ...
      %args = "ttkernel.TensorAccessorArgs"(%cta_offset, %crta_offset) {cta_expr = "get_base_offset()"} : (i32, i32) -> !ttkernel.TensorAccessorArgs
    ...
    func.func @test_tensor_accessor_args_mixed_crta() -> () attributes {ttkernel.thread = #ttkernel.thread<noc>} {
      ...
      %args1 = "ttkernel.TensorAccessorArgs"(%cta_0, %crta_0) : (i32, i32) -> !ttkernel.TensorAccessorArgs
      ...
      %args2 = "ttkernel.TensorAccessorArgs"(%args1, %cta_0, %crta_0) : (!ttkernel.TensorAccessorArgs, i32, i32) -> !ttkernel.TensorAccessorArgs
