...
module {
  ...
  func.func @test_sub_lowering(%arg0: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg1: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg2: memref<1x!tt.tile<32x32, f32>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
    %1 = affine.load %arg1[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
  ...
  func.func @test_div_lowering(%arg0: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg1: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg2: memref<1x!tt.tile<32x32, f32>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
    %1 = affine.load %arg1[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
  ...
  func.func @test_exp_lowering(%arg0: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg1: memref<1x!tt.tile<32x32, f32>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
    ...
    // CHECK: ttkernel.pack_tile
    affine.store %1, %arg1[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
    return
  }

  // CHECK-LABEL: func.func @test_cos_lowering
  func.func @test_cos_lowering(%arg0: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg1: memref<1x!tt.tile<32x32, f32>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
  ...
  func.func @test_negative_lowering(%arg0: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg1: memref<1x!tt.tile<32x32, f32>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
  ...
  func.func @test_rsqrt_lowering(%arg0: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg1: memref<1x!tt.tile<32x32, f32>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
  ...
  func.func @test_sin_lowering(%arg0: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg1: memref<1x!tt.tile<32x32, f32>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
  ...
  func.func @test_sigmoid_lowering(%arg0: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg1: memref<1x!tt.tile<32x32, f32>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
  ...
  func.func @test_ceil_lowering(%arg0: memref<1x!tt.tile<32x32, bf16>, #l1_>, %arg1: memref<1x!tt.tile<32x32, bf16>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, bf16>, #l1_>
    ...
    // CHECK: ttkernel.pack_tile
    affine.store %1, %arg1[%c0] : memref<1x!tt.tile<32x32, bf16>, #l1_>
    return
  }

  // CHECK-LABEL: func.func @test_ceil_lowering_f32
  func.func @test_ceil_lowering_f32(%arg0: memref<1x!tt.tile<32x32, f32>, #l1_>, %arg1: memref<1x!tt.tile<32x32, f32>, #l1_>) attributes {ttir.thread = #ttir.thread<compute>} {
    %c0 = arith.constant 0 : index
    %0 = affine.load %arg0[%c0] : memref<1x!tt.tile<32x32, f32>, #l1_>
    // CHECK-NOT: ttir.tile_ceil
    // CHECK: ttkernel.init_sfpu
