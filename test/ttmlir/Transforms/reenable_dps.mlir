...
func.func @test_broken_dps_simple(%arg0: tensor<64x128xf32>, %arg1: tensor<64x128xf32>) -> tensor<64x128xf32> attributes {ttir.return_to_output_mapping = 1 : i64} {
...
func.func @test_broken_dps_with_reduce_and_expand(%arg0: tensor<64x128xf32>, %arg1: tensor<1x64x128xf32>) -> tensor<1x64x128xf32> attributes {ttir.return_to_output_mapping = 1 : i64} {
...
// CHECK-SAME: (%[[ARG0:.*]]: tensor<64x128xf32>, %[[ARG1:.*]]: tensor<64x128xf32>)
func.func @test_noop_case(%arg0: tensor<64x128xf32>, %arg1: tensor<64x128xf32>) -> tensor<64x128xf32> attributes {ttir.return_to_output_mapping = 1 : i64} {
...
// CHECK-SAME: (%[[ARG0:.*]]: tensor<64x128xf32>, %[[ARG1:.*]]: tensor<64x128xf32>)
func.func @test_already_enabled_dps(%arg0: tensor<64x128xf32>, %arg1: tensor<64x128xf32>) -> tensor<64x128xf32> attributes {ttir.return_to_output_mapping = 1 : i64} {
