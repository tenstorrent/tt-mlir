...
unary_ops = [
    ...
    sin,
    sqrt,
    square | SkipIf("ttnn", "emitc", "emitpy"),
    softsign | SkipIf("ttnn", "emitc", "emitpy"),
    signbit | SkipIf("ttnn", "emitc", "emitpy"),
    selu | SkipIf("ttnn", "emitc", "emitpy"),
    frac | SkipIf("ttnn", "emitc", "emitpy"),
    trunc | SkipIf("ttnn", "emitc", "emitpy"),
    tan,
    tanh,
]
