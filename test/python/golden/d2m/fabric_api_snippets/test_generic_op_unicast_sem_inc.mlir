      ...
      program = #ttnn.mesh_program_descriptor<[
        #ttnn.mesh_program<
          ...
          program = #ttnn.program<
            ...
            semaphores = []>
        >
      ], fabric_connection_config = #ttcore.fabric_connection_config<thread = #d2m.thread<datamovement, dm_core = 0>, topology = insert_topology, cluster_axis = insert_cluster_axis, routing_mode = insert_routing_mode, num_links = 1>>,
