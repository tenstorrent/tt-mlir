...
def test_complete_tile_masking(
    ...
    compile_and_execute_d2m(
        ...
        custom_pipeline="ttcore-mark-functions-as-forward,d2m-lower-to-layout,canonicalize,ttir-bufferization-pipeline,d2m-insert-scratch-buffers,d2m-generic-apply-interchange,d2m-generate-outer-loops,d2m-decompose-masking,d2m-mark-synchronized-buffers,d2m-allocate,d2m-lower-multicast-loads,d2m-generic-lower-to-explicit-form,canonicalize,d2m-be-pipeline,d2m-to-ttkernel-pipeline,d2m-to-ttmetal-pipeline",
        device=device,
