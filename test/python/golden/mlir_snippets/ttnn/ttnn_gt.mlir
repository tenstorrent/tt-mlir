...
module {
  func.func @model(%arg0: tensor<32x32xsi32, #ttnn_layout>, %arg1: tensor<32x32xsi32, #ttnn_layout>) -> tensor<32x32xsi32, #ttnn_layout> {
    %0 = "ttnn.gt"(%arg0, %arg1) <{activations = [], input_tensor_a_activations = [], input_tensor_b_activations = []}> : (tensor<32x32xsi32, #ttnn_layout>, tensor<32x32xsi32, #ttnn_layout>) -> tensor<32x32xsi32, #ttnn_layout>
