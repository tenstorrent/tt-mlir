...
module attributes {ttcore.meshes = #ttcore.meshes<[<"mesh" = 1x4>]>} {
  func.func @forward(%arg0: tensor<1x1x32x128xbf16, #ttnn_layout2>) -> tensor<1x1x32x32xbf16, #ttnn_layout1> {
    ...
    %1 = "ttnn.distribute_tensor"(%arg0, %0) <{mapper_config = #ttnn.mesh_mapper_config<placements = [<shard, 2 : i64>, <shard, 3 : i64>]>}> : (tensor<1x1x32x128xbf16, #ttnn_layout2>, !ttnn.device) -> tensor<1x1x32x32xbf16, #ttnn_layout1>
