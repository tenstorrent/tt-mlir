module @jit_reduce attributes {} {
  func.func public @forward_sum(%arg0: tensor<2x3xf32>, %arg1: tensor<f32>) -> tensor<3xf32> {
  ...
  func.func public @forward_max(%arg0: tensor<2x3xf32>, %arg1: tensor<f32>) -> tensor<2xf32> {
    %0 = "stablehlo.reduce"(%arg0, %arg1) ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
  ...
  func.func public @forward_min(%arg0: tensor<4x5xf32>, %arg1: tensor<f32>) -> tensor<5xf32> {
    %0 = "stablehlo.reduce"(%arg0, %arg1) ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
