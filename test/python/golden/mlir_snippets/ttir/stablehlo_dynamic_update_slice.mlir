module {
  ...
  ttcore.device_module {
    ...
    func.func private @hoisted_stablehlo_dynamic_update_slice_1x197x768_1x1x768____func(tensor<1x197x768xf32>, tensor<1x1x768xf32>, tensor<i32>) -> tensor<1x197x768xf32> attributes {ttir.cpu_hoisted_func}
    }
  }
}
