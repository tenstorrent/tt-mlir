// DeepSeek-V3 subgraph (issue #8541, d2m_subgraph_11/26).
// 5D RoPE-style sin chain with 16x context dim:
//   (q * cos) - (q_rot * sin), broadcast on the outer batch and middle dims.

module {
  func.func @rope_5d_sub_d16(
    ...
    %2 = "ttir.subtract"(%0, %1) : (tensor<32x16x16x32x1xf32>, tensor<32x16x16x32x1xf32>) -> tensor<32x16x16x32x1xf32>
