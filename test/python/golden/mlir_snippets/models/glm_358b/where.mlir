module {
  ...
  func.func @where_1(%arg0: tensor<1x96x32x32xi1>, %arg1: tensor<1x96x32x32xf32>, %arg2: tensor<1x96x32x32xf32>) -> tensor<1x96x32x32xf32> {
    %0 = "ttir.where"(%arg0, %arg1, %arg2) : (tensor<1x96x32x32xi1>, tensor<1x96x32x32xf32>, tensor<1x96x32x32xf32>) -> tensor<1x96x32x32xf32>
