...
def test_multi_return_support(shapes: List[Shape], dtypes: List[torch.dtype], request):
    """Test that multi-return functionality works after the builder fix."""
    def multi_return_model(in0: Operand, in1: Operand, in2: Operand, builder: TTIRBuilder):
...
def test_triple_return_support(shapes: List[Shape], dtypes: List[torch.dtype], request):
