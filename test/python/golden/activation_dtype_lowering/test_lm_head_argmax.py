...
-> all_gather -> argmax. The matmul output is lowered to bfp_bf8; a
ttnn.to_layout(RowMajor, bf16) is inserted before argmax (lowering to a
single tt-metal untilize kernel via the DecomposeLayouts fast-path).
