...
Builder = Union[TTIRBuilder, StableHLOBuilder, TTNNBuilder, D2MBuilder]
...
def leaky_relu(in0: Operand, builder: Builder, unit_attrs: Optional[List[str]] = None):
...
def get_dimension_size(
    in0: Operand, builder: Builder, unit_attrs: Optional[List[str]] = None
):
    return builder.get_dimension_size(in0, unit_attrs=unit_attrs)


def sum(in0: Operand, builder: Builder, unit_attrs: Optional[List[str]] = None):
    return builder.sum(in0, unit_attrs=unit_attrs)


def mean(in0: Operand, builder: Builder, unit_attrs: Optional[List[str]] = None):
    return builder.mean(in0, unit_attrs=unit_attrs)


def max(in0: Operand, builder: Builder, unit_attrs: Optional[List[str]] = None):
    return builder.max(in0, unit_attrs=unit_attrs)


def min(in0: Operand, builder: Builder, unit_attrs: Optional[List[str]] = None):
...
def transpose(in0: Operand, builder: Builder, unit_attrs: Optional[List[str]] = None):
    return builder.transpose(in0, unit_attrs=unit_attrs)


def reshape(in0: Operand, builder: Builder, unit_attrs: Optional[List[str]] = None):
