...
@pytest.mark.parametrize(
    "shape",
    [(128, 128), (2048, 128), (128, 2048), (64, 4096), (32, 8192),
     (32, 64), (63, 32), (64, 64), (256, 256), (256, 512), (512, 256)],
    ids=shape_str,
)
@pytest.mark.parametrize("dtype", [torch.float32], ids=["f32"])
@pytest.mark.parametrize("target", ["ttmetal"])
def test_virtual_grid_eltwise(shape: Shape, dtype: torch.dtype, target: str, request):
    def eltwise_wrapper(
