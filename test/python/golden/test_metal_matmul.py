...
# 1. F32 inputs are truncated into TF32, losing 13 mantissa bits. These errors
#    accumulate and become especially apparent when the random positive/negative
#    inputs "negate" each other in the summation and result in over 5 orders of
#    magnitude of differences in the output.
# 2. Not all CPUs have native F16/BF16 support, and torch has to use its slow
#    software-emulated matmul routine to generate the golden output.
#
