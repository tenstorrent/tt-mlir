...
RESHAPE_SHAPES: List[Tuple[Tuple[int, ...], Tuple[int, ...]]] = [
    ...
    # ((3, 64, 32), (3, 32, 64)),
    # ((2, 128, 64), (2, 64, 128)),
    # # Weird shapes with prime numbers and odd dimensions
    # ((7, 11), (77,)),
    # ((1, 1024), (32, 32)),
    # ((32, 32), (1, 1024)),
    # ((1, 32), (32, 1)),
    ...
    # ((5, 7, 9, 11), (35, 99)),
    # ((35, 99), (5, 7, 9, 11)),
    # Llama reshape shapes
    # ((1024, 3072), (1, 1024, 3072)),
    # ((128256, 3072), (1, 128256, 3072)),
    # ((128,), (1, 128)),
    # ((18, 128), (1, 18, 128)),
    # ((18, 128), (1, 1, 18, 128)),
    # ((18,), (18, 1)),
    # ((18,), (1, 1, 18)),
    # ((1, 1024, 3072), (1024, 3072)),
    # ((1, 128256, 3072), (128256, 3072)),
    # ((1, 18, 128), (18, 128)),
    # ((1, 18, 128), (1, 1, 18, 128)),
    # ((1, 1, 18), (18,)),
    # ((1, 1, 3072), (3072,)),
    # ((1, 1, 64), (1, 64, 1)),
    # ((1, 3072, 3072), (3072, 3072)),
    # ((1, 3072, 8192), (3072, 8192)),
    # ((1, 32, 18), (576,)),
    # ((1, 8192, 3072), (8192, 3072)),
    # ((3072, 3072), (1, 3072, 3072)),
    # ((3072, 8192), (1, 3072, 8192)),
    # ((3072,), (1, 1, 3072)),
    # ((32, 18, 128), (32, 1, 18, 128)),
    # ((32, 18, 1), (32, 18)),
    # ((32, 18, 24, 128), (576, 3072)),
    # ((32, 18, 3072), (576, 3072)),
    # ((32, 18, 8192), (576, 8192)),
    # ((32, 18), (32, 18, 1)),
    # ((32, 18), (1, 32, 18)),
    # ((32, 1, 18, 128), (32, 18, 128)),
    # ((32, 24, 128, 128), (768, 128, 128)),
    # ((32, 24, 18, 128), (768, 18, 128)),
    # ((32, 24, 18), (32, 24, 18, 1)),
