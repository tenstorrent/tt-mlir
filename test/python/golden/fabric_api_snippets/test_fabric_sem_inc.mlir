...
module attributes {} {
  ...
  func.func @test_fabric_unicast(%arg0: !full_tensor_layout) -> !full_tensor_layout {
    ...
    %semaphore = "ttmetal.create_global_semaphore"() <{address = 300736 : i64, initial_value = 0 : i32, core_range = #ttmetal.core_range<0x0, 1x1>}> : () -> !ttkernel.global_semaphore // #ttmetal.core_range<0x0, 1x1>
