!full_tensor_layout = memref<32x256xbf16>
...
module attributes {} {
  ...
  func.func @test_fabric_p2p(%arg0: !full_tensor_layout) -> !full_tensor_layout {
    %0 = "ttmetal.mesh_shard"(%arg0) <{shard_dims = array<i64: 0, 1>, shard_direction = #ttcore.shard_direction<full_to_shard>, shard_shape = array<i64: 1, 8>, shard_type = #ttcore.shard_type<devices>}> : (!full_tensor_layout) -> !mesh_shard_layout
    ...
    %8 = "ttmetal.mesh_shard"(%alloc_1) <{shard_dims = array<i64: 0, 1>, shard_direction = #ttcore.shard_direction<shard_to_full>, shard_shape = array<i64: 1, 8>, shard_type = #ttcore.shard_type<devices>}> : (!mesh_shard_layout) -> !full_tensor_layout
