...
forward_const_eval_0(::std::vector<::ttnn::Tensor> v1) {
  ...
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      v5,
      ::ttnn::MemoryConfig{
...
forward_const_eval_1(::std::vector<::ttnn::Tensor> v1) {
  ...
  ::ttnn::Tensor v5 = ttnn::reshape(
      v2, ::std::vector<int32_t>{256, 1, 1, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v7 = ttnn::to_layout(
      v6, ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v6, false);
  ::ttnn::Tensor v8 = ttnn::multiply(
      v7, v5, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v7, false);
  ttnn::deallocate(v5, false);
  ::ttnn::Tensor v9 = ttnn::to_layout(
      v8, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v8, false);
  ::ttnn::Tensor v10 = ttnn::from_device(v9);
  ttnn::deallocate(v9, false);
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      v10,
      ::ttnn::MemoryConfig{
          ::ttnn::TensorMemoryLayout::BLOCK_SHARDED, ::ttnn::BufferType::L1,
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 1024, 256, 16, 14, 14,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 7}}}},
                            ::std::array<uint32_t, 2>{1568, 32},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 256, 256, 16, 28, 28,
...
forward_const_eval_3(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::reshape(
      v2, ::std::vector<int32_t>{1, 1000},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
...
forward_const_eval_4(::std::vector<::ttnn::Tensor> v1) {
  ...
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
      v2, ::std::vector<int32_t>{1024, 1, 1, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v6 = ttnn::to_device(
      v3, v4,
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 7}}}},
                            ::std::array<uint32_t, 2>{416, 32},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 256, 1024, 16, 14, 14,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
forward_const_eval_5(::std::vector<::ttnn::Tensor> v1) {
  ...
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
      v2, ::std::vector<int32_t>{64, 1, 1, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v6 = ttnn::to_device(
      v3, v4,
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 6}},
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 7},
                                                  ::ttnn::CoreCoord{6, 7}}}},
                            ::std::array<uint32_t, 2>{800, 256},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 256, 64, 16, 56, 56,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ...
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 7},
                                                  ::ttnn::CoreCoord{6, 7}}}},
                            ::std::array<uint32_t, 2>{800, 64},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 64, 64, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, v3, ::ttnn::DataType::BFLOAT8_B,
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 256, 1024, 16, 14, 14,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
forward_const_eval_8(::std::vector<::ttnn::Tensor> v1) {
  ...
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
      v2, ::std::vector<int32_t>{512, 1, 1, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v6 = ttnn::to_device(
      v3, v4,
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 6}}}},
                            ::std::array<uint32_t, 2>{224, 128},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 128, 512, 16, 28, 28,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 64, 256, 16, 56, 56,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 64, 64, 16, 56, 56,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 6}}}},
                            ::std::array<uint32_t, 2>{128, 64},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 512, 512, 16, 7, 7,
...
forward_const_eval_12(::std::vector<::ttnn::Tensor> v1) {
  ...
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::permute(
      v2, ::ttsl::SmallVector<int64_t>{0, 2, 3, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      0.000000f);
  ::ttnn::Tensor v6 = ttnn::reshape(
      v5, ::std::vector<int32_t>{2048, 1, 1, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v5, false);
  ...
  ::ttnn::Tensor v8 = ttnn::to_layout(
      v7, ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v7, false);
  ::ttnn::Tensor v9 = ttnn::multiply(
      v8, v6, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v8, false);
  ttnn::deallocate(v6, false);
  ::ttnn::Tensor v10 = ttnn::to_layout(
      v9, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v9, false);
  ::ttnn::Tensor v11 = ttnn::from_device(v10);
  ttnn::deallocate(v10, false);
  ::ttnn::Tensor v12 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      v11,
      ::ttnn::MemoryConfig{
          ::ttnn::TensorMemoryLayout::BLOCK_SHARDED, ::ttnn::BufferType::L1,
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 512, 2048, 16, 7, 7,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      false, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt, ::std::nullopt);
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 256, 256, 16, 14, 14,
      ::std::array<uint32_t, 2>{3, 3}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{1, 1, 1, 1}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 6}}}},
                            ::std::array<uint32_t, 2>{448, 64},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 512, 512, 16, 14, 14,
      ::std::array<uint32_t, 2>{3, 3}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{1, 1, 1, 1}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
forward_const_eval_17(::std::vector<::ttnn::Tensor> v1) {
  ...
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
      v2, ::std::vector<int32_t>{128, 1, 1, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v6 = ttnn::to_device(
      v3, v4,
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 128, 128, 16, 28, 28,
      ::std::array<uint32_t, 2>{3, 3}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{1, 1, 1, 1}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 64, 64, 16, 56, 56, ::std::array<uint32_t, 2>{3, 3},
...
forward_const_eval_20(::std::vector<::ttnn::Tensor> v1) {
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      ::ttnn::Layout::TILE, 3, 64, 16, 224, 224,
      ::std::array<uint32_t, 2>{7, 7}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{3, 3, 3, 3}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt);
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 1024, 256, 16, 14, 14,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 64, 256, 16, 56, 56,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
forward_const_eval_28(::std::vector<::ttnn::Tensor> v1) {
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      ::ttnn::Layout::TILE, 256, 512, 16, 56, 56,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
...
forward_const_eval_30(::std::vector<::ttnn::Tensor> v1) {
  ...
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::reshape(
      v2, ::std::vector<int32_t>{1, 1, 2048, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v5 = ttnn::permute(
      v4, ::ttsl::SmallVector<int64_t>{0, 1, 3, 2},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      0.000000f);
  ttnn::deallocate(v4, false);
  ...
  ttnn::deallocate(v5, false);
  ::ttnn::Tensor v7 = ttnn::reshape(
      v6, ::std::vector<int32_t>{1, 1, 784, 2048},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v6, false);
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 6}}}},
                            ::std::array<uint32_t, 2>{224, 512},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 512, 128, 16, 28, 28,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 256, 128, 16, 56, 56,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 512, 128, 16, 28, 28,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
forward_const_eval_40(::std::vector<::ttnn::Tensor> v1) {
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      ::ttnn::Layout::TILE, "OIHW", 2048, 512, 16, 7, 7,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 128, 512, 16, 28, 28,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 256, 64, 16, 56, 56,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 256, 256, 16, 14, 14,
      ::std::array<uint32_t, 2>{3, 3}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{1, 1, 1, 1}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt);
...
forward_const_eval_45(::std::vector<::ttnn::Tensor> v1) {
  ...
  ::ttnn::Tensor v4 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      false, 1, v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt, ::std::nullopt);
  ::std::vector<::ttnn::Tensor> v5 = util_create_vec(v4);
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 1024, 512, 16, 14, 14,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
forward_const_eval_48(::std::vector<::ttnn::Tensor> v1) {
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      ::ttnn::Layout::TILE, "OIHW", 3, 64, 16, 224, 224,
      ::std::array<uint32_t, 2>{7, 7}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{3, 3, 3, 3}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt, ::std::nullopt);
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 7}}}},
                            ::std::array<uint32_t, 2>{1568, 64},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 512, 256, 16, 28, 28,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 128, 128, 16, 28, 28,
      ::std::array<uint32_t, 2>{3, 3}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{1, 1, 1, 1}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_58(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_59(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 6}}}},
                            ::std::array<uint32_t, 2>{896, 128},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 128, 128, 16, 56, 56,
      ::std::array<uint32_t, 2>{3, 3}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{1, 1, 1, 1}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_60(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      ::ttnn::Layout::TILE, 2048, 512, 16, 7, 7,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_61(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_62(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_63(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 128, 128, 16, 56, 56,
      ::std::array<uint32_t, 2>{3, 3}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{1, 1, 1, 1}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_64(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_65(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_66(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 512, 1024, 16, 28, 28,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_67(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_68(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_69(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_70(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_71(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 512, 512, 16, 14, 14,
      ::std::array<uint32_t, 2>{3, 3}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{1, 1, 1, 1}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_72(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_73(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_74(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 512, 1024, 16, 28, 28,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_75(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_76(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_77(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_78(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::permute(
      v2, ::ttsl::SmallVector<int64_t>{0, 2, 3, 1},
...
::std::vector<::ttnn::Tensor>
forward_const_eval_79(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_80(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::permute(
  ...
  ::ttnn::Tensor v6 = ttnn::reshape(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v5, false);
  ::ttnn::Tensor v7 = ttnn::permute(
      v6, ::ttsl::SmallVector<int64_t>{2, 3, 0, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      0.000000f);
  ttnn::deallocate(v6, false);
  ::ttnn::Tensor v8 = ttnn::to_device(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v9 = ttnn::to_layout(
      v8, ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v8, false);
  ::ttnn::Tensor v10 = ttnn::permute(
      v9, ::ttsl::SmallVector<int64_t>{2, 3, 0, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      0.000000f);
  ttnn::deallocate(v9, false);
  ::ttnn::Tensor v11 = ttnn::multiply(
      v10, v7, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v10, false);
  ttnn::deallocate(v7, false);
  ::ttnn::Tensor v12 = ttnn::permute(
      v11, ::ttsl::SmallVector<int64_t>{2, 3, 0, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      0.000000f);
  ttnn::deallocate(v11, false);
  ::ttnn::Tensor v13 = ttnn::to_layout(
      v12, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v12, false);
  ::ttnn::Tensor v14 = ttnn::from_device(v13);
  ttnn::deallocate(v13, false);
  ::ttnn::Tensor v15 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      v14,
      ::ttnn::MemoryConfig{
          ::ttnn::TensorMemoryLayout::BLOCK_SHARDED, ::ttnn::BufferType::L1,
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 6}}}},
                            ::std::array<uint32_t, 2>{448, 128},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 1024, 2048, 16, 14, 14,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      false, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_81(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 256, 256, 16, 28, 28,
      ::std::array<uint32_t, 2>{3, 3}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{1, 1, 1, 1}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_82(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_83(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_84(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 512, 512, 16, 7, 7, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, v3, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_85(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_86(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, "OIHW", 256, 128, 16, 56, 56,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_87(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_88(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_89(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_90(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_91(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_92(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_93(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_94(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_95(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_96(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_97(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_98(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_99(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::reshape(
      v2, ::std::vector<int32_t>{1, 1, 2048, 1},
...
::std::vector<::ttnn::Tensor>
forward_const_eval_100(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
  ...
  ::ttnn::Tensor v6 = ttnn::operations::conv::conv2d::prepare_conv_bias(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}},
      ::ttnn::Layout::TILE, 512, 256, 16, 28, 28,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1}, 1,
      v3, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_101(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_102(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_103(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_104(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor>
forward_const_eval_105(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
  ...
  ::ttnn::Tensor v11 = ttnn::operations::conv::conv2d::prepare_conv_weights(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      ::ttnn::Layout::TILE, "OIHW", 256, 512, 16, 56, 56,
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 2>{2, 2},
      ::std::array<uint32_t, 4>{0, 0, 0, 0}, ::std::array<uint32_t, 2>{1, 1},
      true, 1, v4, ::ttnn::DataType::BFLOAT8_B, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
...
::std::vector<::ttnn::Tensor>
forward_const_eval_106(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ::ttnn::Tensor v3 = v1[1];
  ttnn::distributed::MeshDevice *v4 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v5 = ttnn::reshape(
...
::std::vector<::ttnn::Tensor>
forward_const_eval_107(::std::vector<::ttnn::Tensor> v1) {
  ::ttnn::Tensor v2 = v1[0];
  ttnn::distributed::MeshDevice *v3 = ttnn::DeviceGetter::getInstance();
  ::ttnn::Tensor v4 = ttnn::to_layout(
      v2, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
...
::std::vector<::ttnn::Tensor> forward(::std::vector<::ttnn::Tensor> v1) {
  ...
  ::ttnn::Tensor v705 = ttnn::permute(
      v2, ::ttsl::SmallVector<int64_t>{0, 2, 3, 1},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt},
      0.000000f);
  ttnn::deallocate(v2, false);
  ::ttnn::Tensor v706 = ttnn::reshape(
      v705, ::std::vector<int32_t>{1, 1, 802816, 3},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v705, false);
  ::ttnn::Tensor v707 = ::std::get<0>(ttnn::conv2d(
      v706, v408, v704, 3, 64, 16, 224, 224, ::std::array<uint32_t, 2>{7, 7},
      ::std::array<uint32_t, 2>{2, 2}, ::std::array<uint32_t, 4>{3, 3, 3, 3},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v268,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
  ...
  ::ttnn::Tensor v708 = ttnn::to_layout(
      v707, ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v707, false);
  ::ttnn::Tensor v709 = ttnn::max_pool2d(
      v708, 16, 112, 112, 64, ::std::array<uint32_t, 2>{3, 3},
  ...
  ::ttnn::Tensor v710 = ttnn::to_layout(
      v709, ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v712 = ::std::get<0>(ttnn::conv2d(
      v711, v613, v704, 64, 256, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v563,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v713 = ttnn::to_memory_config(
      v712, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v712, false);
  ::ttnn::Tensor v714 = ttnn::to_layout(
      v709, ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v716 = ::std::get<0>(ttnn::conv2d(
      v715, v218, v704, 64, 64, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v198,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v717 = ::std::get<0>(ttnn::conv2d(
      v716, v243, v704, 64, 64, 16, 56, 56, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v258,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v718 = ::std::get<0>(ttnn::conv2d(
      v717, v608, v704, 64, 256, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v313,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v719 = ttnn::to_memory_config(
      v718, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v718, false);
  ::ttnn::Tensor v720 =
      ttnn::add(v719, v713, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v719, false);
  ttnn::deallocate(v713, false);
  ::ttnn::Tensor v721 = ttnn::relu(
      v720, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v722 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v723 = ::std::get<0>(ttnn::conv2d(
      v722, v193, v704, 256, 64, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v378,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v724 = ::std::get<0>(ttnn::conv2d(
      v723, v423, v704, 64, 64, 16, 56, 56, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v583,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v725 = ::std::get<0>(ttnn::conv2d(
      v724, v348, v704, 64, 256, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v363,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v726 = ttnn::to_memory_config(
      v725, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v725, false);
  ::ttnn::Tensor v727 =
      ttnn::add(v726, v721, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v726, false);
  ttnn::deallocate(v721, false);
  ::ttnn::Tensor v728 = ttnn::relu(
      v727, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v729 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v730 = ::std::get<0>(ttnn::conv2d(
      v729, v508, v704, 256, 64, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v453,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v731 = ::std::get<0>(ttnn::conv2d(
      v730, v618, v704, 64, 64, 16, 56, 56, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v543,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v732 = ::std::get<0>(ttnn::conv2d(
      v731, v298, v704, 64, 256, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v213,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v733 = ttnn::to_memory_config(
      v732, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v732, false);
  ::ttnn::Tensor v734 =
      ttnn::add(v733, v728, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v733, false);
  ttnn::deallocate(v728, false);
  ::ttnn::Tensor v735 = ttnn::relu(
      v734, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v734, false);
  ::ttnn::Tensor v736 = ::std::get<0>(ttnn::conv2d(
      v735, v693, v704, 256, 512, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{2, 2}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v308,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
  ...
  ::ttnn::Tensor v738 = ::std::get<0>(ttnn::conv2d(
      v737, v598, v704, 256, 128, 16, 56, 56, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v333,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v740 = ::std::get<0>(ttnn::conv2d(
      v739, v483, v704, 128, 128, 16, 56, 56, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{2, 2}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v463,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v741 = ::std::get<0>(ttnn::conv2d(
      v740, v293, v704, 128, 512, 16, 28, 28, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v648,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v742 = ttnn::to_memory_config(
      v741, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v741, false);
  ::ttnn::Tensor v743 =
      ttnn::add(v742, v736, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v742, false);
  ttnn::deallocate(v736, false);
  ::ttnn::Tensor v744 = ttnn::relu(
      v743, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v745 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v746 = ::std::get<0>(ttnn::conv2d(
      v745, v438, v704, 512, 128, 16, 28, 28, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v323,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v747 = ::std::get<0>(ttnn::conv2d(
      v746, v253, v704, 128, 128, 16, 28, 28, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v443,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v748 = ::std::get<0>(ttnn::conv2d(
      v747, v633, v704, 128, 512, 16, 28, 28, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v473,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v749 = ttnn::to_memory_config(
      v748, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v748, false);
  ::ttnn::Tensor v750 =
      ttnn::add(v749, v744, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v749, false);
  ttnn::deallocate(v744, false);
  ::ttnn::Tensor v751 = ttnn::relu(
      v750, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v750, false);
  ::ttnn::Tensor v752 = ttnn::to_memory_config(
      v751,
      ::ttnn::MemoryConfig{
          ::ttnn::TensorMemoryLayout::HEIGHT_SHARDED, ::ttnn::BufferType::L1,
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v753 = ::std::get<0>(ttnn::conv2d(
      v752, v343, v704, 512, 128, 16, 28, 28, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v623,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v754 = ::std::get<0>(ttnn::conv2d(
      v753, v603, v704, 128, 128, 16, 28, 28, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v683,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v755 = ::std::get<0>(ttnn::conv2d(
      v754, v638, v704, 128, 512, 16, 28, 28, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v398,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v756 = ttnn::to_memory_config(
      v755, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v755, false);
  ::ttnn::Tensor v757 =
      ttnn::add(v756, v751, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v756, false);
  ttnn::deallocate(v751, false);
  ::ttnn::Tensor v758 = ttnn::relu(
      v757, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v759 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v760 = ::std::get<0>(ttnn::conv2d(
      v759, v593, v704, 512, 128, 16, 28, 28, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v478,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v761 = ::std::get<0>(ttnn::conv2d(
      v760, v278, v704, 128, 128, 16, 28, 28, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v658,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v762 = ::std::get<0>(ttnn::conv2d(
      v761, v208, v704, 128, 512, 16, 28, 28, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v373,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v763 = ttnn::to_memory_config(
      v762, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v762, false);
  ::ttnn::Tensor v764 =
      ttnn::add(v763, v758, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v763, false);
  ttnn::deallocate(v758, false);
  ::ttnn::Tensor v765 = ttnn::relu(
      v764, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v764, false);
  ::ttnn::Tensor v766 = ttnn::to_memory_config(
      v765,
      ::ttnn::MemoryConfig{
          ::ttnn::TensorMemoryLayout::BLOCK_SHARDED, ::ttnn::BufferType::L1,
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v767 = ::std::get<0>(ttnn::conv2d(
      v766, v498, v704, 512, 1024, 16, 28, 28, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{2, 2}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v538,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v768 = ttnn::to_memory_config(
      v767, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v770 = ::std::get<0>(ttnn::conv2d(
      v769, v418, v704, 512, 256, 16, 28, 28, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v668,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v771 = ::std::get<0>(ttnn::conv2d(
      v770, v178, v704, 256, 256, 16, 28, 28, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{2, 2}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v573,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v772 = ::std::get<0>(ttnn::conv2d(
      v771, v673, v704, 256, 1024, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v528,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v773 = ttnn::to_memory_config(
      v772, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v772, false);
  ::ttnn::Tensor v774 =
      ttnn::add(v773, v768, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v773, false);
  ttnn::deallocate(v768, false);
  ::ttnn::Tensor v775 = ttnn::relu(
      v774, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v776 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v777 = ::std::get<0>(ttnn::conv2d(
      v776, v238, v704, 1024, 256, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v448,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v778 = ::std::get<0>(ttnn::conv2d(
      v777, v548, v704, 256, 256, 16, 14, 14, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v383,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v779 = ::std::get<0>(ttnn::conv2d(
      v778, v188, v704, 256, 1024, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v458,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v780 = ttnn::to_memory_config(
      v779, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v779, false);
  ::ttnn::Tensor v781 =
      ttnn::add(v780, v775, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v780, false);
  ttnn::deallocate(v775, false);
  ::ttnn::Tensor v782 = ttnn::relu(
      v781, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v783 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v784 = ::std::get<0>(ttnn::conv2d(
      v783, v173, v704, 1024, 256, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v353,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v785 = ::std::get<0>(ttnn::conv2d(
      v784, v233, v704, 256, 256, 16, 14, 14, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v578,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v786 = ::std::get<0>(ttnn::conv2d(
      v785, v698, v704, 256, 1024, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v628,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v787 = ttnn::to_memory_config(
      v786, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v786, false);
  ::ttnn::Tensor v788 =
      ttnn::add(v787, v782, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v787, false);
  ttnn::deallocate(v782, false);
  ::ttnn::Tensor v789 = ttnn::relu(
      v788, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v790 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v791 = ::std::get<0>(ttnn::conv2d(
      v790, v643, v704, 1024, 256, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v678,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v792 = ::std::get<0>(ttnn::conv2d(
      v791, v328, v704, 256, 256, 16, 14, 14, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v653,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v793 = ::std::get<0>(ttnn::conv2d(
      v792, v433, v704, 256, 1024, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v263,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v794 = ttnn::to_memory_config(
      v793, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v793, false);
  ::ttnn::Tensor v795 =
      ttnn::add(v794, v789, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v794, false);
  ttnn::deallocate(v789, false);
  ::ttnn::Tensor v796 = ttnn::relu(
      v795, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v797 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v798 = ::std::get<0>(ttnn::conv2d(
      v797, v273, v704, 1024, 256, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v288,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v799 = ::std::get<0>(ttnn::conv2d(
      v798, v338, v704, 256, 256, 16, 14, 14, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v688,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v800 = ::std::get<0>(ttnn::conv2d(
      v799, v413, v704, 256, 1024, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v203,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v801 = ttnn::to_memory_config(
      v800, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v800, false);
  ::ttnn::Tensor v802 =
      ttnn::add(v801, v796, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v801, false);
  ttnn::deallocate(v796, false);
  ::ttnn::Tensor v803 = ttnn::relu(
      v802, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v804 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v805 = ::std::get<0>(ttnn::conv2d(
      v804, v493, v704, 1024, 256, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v488,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v806 = ::std::get<0>(ttnn::conv2d(
      v805, v303, v704, 256, 256, 16, 14, 14, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v503,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v807 = ::std::get<0>(ttnn::conv2d(
      v806, v283, v704, 256, 1024, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v553,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v808 = ttnn::to_memory_config(
      v807, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v807, false);
  ::ttnn::Tensor v809 =
      ttnn::add(v808, v803, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v808, false);
  ttnn::deallocate(v803, false);
  ::ttnn::Tensor v810 = ttnn::relu(
      v809, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v811 = ttnn::to_memory_config(
      ...
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                            ...
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}});
  ::ttnn::Tensor v812 = ::std::get<0>(ttnn::conv2d(
      v811, v403, v704, 1024, 512, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v168,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v814 = ::std::get<0>(ttnn::conv2d(
      v813, v248, v704, 512, 512, 16, 14, 14, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{2, 2}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v523,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v815 = ::std::get<0>(ttnn::conv2d(
      v814, v358, v704, 512, 2048, 16, 7, 7, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B,
      ::std::nullopt,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
          ...
          ::ttnn::ShardSpec{::ttnn::CoreRangeSet{::std::set<::ttnn::CoreRange>{
                                ::ttnn::CoreRange{::ttnn::CoreCoord{0, 0},
                                                  ::ttnn::CoreCoord{7, 6}}}},
                            ::std::array<uint32_t, 2>{128, 256},
                            ::ttnn::types::ShardOrientation::ROW_MAJOR,
                            ::ttnn::types::ShardMode::PHYSICAL}}));
  ttnn::deallocate(v814, false);
  ttnn::deallocate(v358, false);
  ::ttnn::Tensor v816 = ttnn::to_memory_config(
      v815, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v815, false);
  ::ttnn::Tensor v817 =
      ttnn::add(v816, v428, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v819 = ::std::get<0>(ttnn::conv2d(
      v818, v568, v704, 1024, 2048, 16, 14, 14, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{2, 2}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B,
      ::std::nullopt,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v820 = ttnn::to_memory_config(
      v819, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v819, false);
  ::ttnn::Tensor v821 =
      ttnn::add(v820, v388, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v820, false);
  ttnn::deallocate(v388, false);
  ::ttnn::Tensor v822 =
      ttnn::add(v817, v821, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v821, false);
  ttnn::deallocate(v817, false);
  ::ttnn::Tensor v823 = ttnn::relu(
      v822, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v822, false);
  ::ttnn::Tensor v824 = ::std::get<0>(ttnn::conv2d(
      v823, v533, v704, 2048, 512, 16, 7, 7, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v513,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v825 = ::std::get<0>(ttnn::conv2d(
      v824, v518, v704, 512, 512, 16, 7, 7, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v703,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v826 = ::std::get<0>(ttnn::conv2d(
      v825, v228, v704, 512, 2048, 16, 7, 7, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B,
      ::std::nullopt,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v827 = ttnn::to_memory_config(
      v826, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v826, false);
  ::ttnn::Tensor v828 =
      ttnn::add(v827, v558, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v827, false);
  ttnn::deallocate(v558, false);
  ::ttnn::Tensor v829 =
      ttnn::add(v828, v823, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v828, false);
  ttnn::deallocate(v823, false);
  ::ttnn::Tensor v830 = ttnn::relu(
      v829, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v829, false);
  ::ttnn::Tensor v831 = ::std::get<0>(ttnn::conv2d(
      v830, v368, v704, 2048, 512, 16, 7, 7, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v468,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v832 = ::std::get<0>(ttnn::conv2d(
      v831, v223, v704, 512, 512, 16, 7, 7, ::std::array<uint32_t, 2>{3, 3},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{1, 1, 1, 1},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B, v588,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
          .weights_dtype = ::ttnn::DataType::BFLOAT8_B, .activation = "relu"},
      ::std::nullopt,
      ::ttnn::MemoryConfig{
  ...
  ::ttnn::Tensor v833 = ::std::get<0>(ttnn::conv2d(
      v832, v393, v704, 512, 2048, 16, 7, 7, ::std::array<uint32_t, 2>{1, 1},
      ::std::array<uint32_t, 2>{1, 1}, ::std::array<uint32_t, 4>{0, 0, 0, 0},
      ::std::array<uint32_t, 2>{1, 1}, 1, ::ttnn::DataType::BFLOAT8_B,
      ::std::nullopt,
      ::ttnn::operations::conv::conv2d::Conv2dConfig{
  ...
  ::ttnn::Tensor v834 = ttnn::to_memory_config(
      v833, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v833, false);
  ::ttnn::Tensor v835 = ttnn::multiply(
      v834, v318, ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v834, false);
  ttnn::deallocate(v318, false);
  ::ttnn::Tensor v836 =
      ttnn::add(v835, v663, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v835, false);
  ttnn::deallocate(v663, false);
  ::ttnn::Tensor v837 =
      ttnn::add(v836, v830, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v836, false);
  ttnn::deallocate(v830, false);
  ::ttnn::Tensor v838 = ttnn::relu(
      v837, ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                 ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v837, false);
  ::ttnn::Tensor v839 = ttnn::reshape(
      v838, ::std::vector<int32_t>{16, 1, 49, 2048},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v838, false);
  ::ttnn::Tensor v840 = ttnn::mean(
      v839, ::ttsl::SmallVector<int32_t>{-2}, true,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v839, false);
  ::ttnn::Tensor v841 = ttnn::reshape(
      v840, ::std::vector<int32_t>{16, 2048},
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v840, false);
  ::ttnn::Tensor v842 = ttnn::matmul(
      v841, v162, false, false,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ttnn::deallocate(v841, false);
  ttnn::deallocate(v162, false);
  ::ttnn::Tensor v843 =
      ttnn::add(v842, v183, ::ttnn::DataType::BFLOAT8_B,
                ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                                     ::ttnn::BufferType::DRAM, ::std::nullopt});
...
::std::vector<::ttnn::Tensor> create_inputs_for_forward() {
  ...
  ::ttnn::Tensor v2 = ttnn::ones(
      ::ttnn::Shape({16, 3, 224, 224}), ::ttnn::DataType::BFLOAT8_B,
  ...
  ::ttnn::Tensor v4 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 64}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v16 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v20 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v21 = ttnn::to_device(
      v20, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v24 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v25 = ttnn::to_device(
      v24, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v26 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v27 = ttnn::to_device(
      v26, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v28 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v29 = ttnn::to_device(
      v28, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v30 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v31 = ttnn::to_device(
      v30, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ...
  ::ttnn::Tensor v34 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v35 = ttnn::to_device(
      v34, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v36 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v37 = ttnn::to_device(
      v36, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v38 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v39 = ttnn::to_device(
      v38, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v40 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v41 = ttnn::to_device(
      v40, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v42 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v43 = ttnn::to_device(
      v42, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v44 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v45 = ttnn::to_device(
      v44, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v46 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v47 = ttnn::to_device(
      v46, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v48 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 128}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v49 = ttnn::to_device(
      v48, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v50 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v51 = ttnn::to_device(
      v50, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v52 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v53 = ttnn::to_device(
      v52, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v54 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v55 = ttnn::to_device(
      v54, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v56 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v57 = ttnn::to_device(
      v56, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v58 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v59 = ttnn::to_device(
      v58, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v60 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v61 = ttnn::to_device(
      v60, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v62 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v63 = ttnn::to_device(
      v62, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v64 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v65 = ttnn::to_device(
      v64, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v66 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v67 = ttnn::to_device(
      v66, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v68 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v69 = ttnn::to_device(
      v68, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v70 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v71 = ttnn::to_device(
      v70, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v72 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v73 = ttnn::to_device(
      v72, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v74 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v75 = ttnn::to_device(
      v74, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v76 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v77 = ttnn::to_device(
      v76, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v78 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v79 = ttnn::to_device(
      v78, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v80 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v81 = ttnn::to_device(
      v80, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v82 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v83 = ttnn::to_device(
      v82, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v84 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v85 = ttnn::to_device(
      v84, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v86 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v87 = ttnn::to_device(
      v86, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v88 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v89 = ttnn::to_device(
      v88, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v90 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v91 = ttnn::to_device(
      v90, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v92 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v93 = ttnn::to_device(
      v92, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v94 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v95 = ttnn::to_device(
      v94, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v96 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v97 = ttnn::to_device(
      v96, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v98 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v99 = ttnn::to_device(
      v98, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v100 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v101 = ttnn::to_device(
      v100, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v102 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v103 = ttnn::to_device(
      v102, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v104 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v105 = ttnn::to_device(
      v104, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v106 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v107 = ttnn::to_device(
      v106, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v108 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 1024}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v109 = ttnn::to_device(
      v108, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v110 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v111 = ttnn::to_device(
      v110, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v112 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v113 = ttnn::to_device(
      v112, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v114 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v115 = ttnn::to_device(
      v114, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v116 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v117 = ttnn::to_device(
      v116, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v118 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v119 = ttnn::to_device(
      v118, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v120 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v121 = ttnn::to_device(
      v120, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v122 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v123 = ttnn::to_device(
      v122, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v124 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v125 = ttnn::to_device(
      v124, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v126 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v127 = ttnn::to_device(
      v126, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v128 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v129 = ttnn::to_device(
      v128, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v130 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v131 = ttnn::to_device(
      v130, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v132 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v133 = ttnn::to_device(
      v132, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v134 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v135 = ttnn::to_device(
      v134, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v136 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v137 = ttnn::to_device(
      v136, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v138 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v139 = ttnn::to_device(
      v138, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v140 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v141 = ttnn::to_device(
      v140, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v142 = ttnn::ones(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v143 = ttnn::to_device(
      v142, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v144 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v145 = ttnn::to_device(
      v144, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v146 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v147 = ttnn::to_device(
      v146, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v148 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 1024}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v149 = ttnn::to_device(
      v148, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v150 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 1024}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v151 = ttnn::to_device(
      v150, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v152 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v153 = ttnn::to_device(
      v152, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v154 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v155 = ttnn::to_device(
      v154, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v156 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v157 = ttnn::to_device(
      v156, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v158 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v159 = ttnn::to_device(
      v158, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v160 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 1024}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v161 = ttnn::to_device(
      v160, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v162 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 1024}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v163 = ttnn::to_device(
      v162, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v164 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v165 = ttnn::to_device(
      v164, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v166 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v167 = ttnn::to_device(
      v166, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v168 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v169 = ttnn::to_device(
      v168, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v170 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 256}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v171 = ttnn::to_device(
      v170, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v172 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 1024}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v173 = ttnn::to_device(
      v172, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v174 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 1024}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v175 = ttnn::to_device(
      v174, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v176 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v177 = ttnn::to_device(
      v176, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v178 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v179 = ttnn::to_device(
      v178, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v180 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v181 = ttnn::to_device(
      v180, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v182 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v183 = ttnn::to_device(
      v182, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v184 = ttnn::ones(
      ::ttnn::Shape({1, 2048, 1, 1}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v185 = ttnn::to_device(
      v184, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v186 = ttnn::ones(
      ::ttnn::Shape({1, 2048, 1, 1}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v187 = ttnn::to_device(
      v186, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v188 = ttnn::ones(
      ::ttnn::Shape({1, 2048, 1, 1}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v189 = ttnn::to_device(
      v188, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v190 = ttnn::ones(
      ::ttnn::Shape({1, 2048, 1, 1}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v191 = ttnn::to_device(
      v190, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v192 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v193 = ttnn::to_device(
      v192, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v194 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v195 = ttnn::to_device(
      v194, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v196 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v197 = ttnn::to_device(
      v196, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v198 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v199 = ttnn::to_device(
      v198, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v200 = ttnn::ones(
      ::ttnn::Shape({1, 2048, 1, 1}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v201 = ttnn::to_device(
      v200, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v202 = ttnn::ones(
      ::ttnn::Shape({1, 2048, 1, 1}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v203 = ttnn::to_device(
      v202, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v204 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v205 = ttnn::to_device(
      v204, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v206 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v207 = ttnn::to_device(
      v206, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v208 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v209 = ttnn::to_device(
      v208, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v210 = ttnn::ones(
      ::ttnn::Shape({1, 1, 1, 512}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v211 = ttnn::to_device(
      v210, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v212 = ttnn::ones(
      ::ttnn::Shape({1, 2048, 1, 1}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v213 = ttnn::to_device(
      v212, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v214 = ttnn::ones(
      ::ttnn::Shape({1, 2048, 1, 1}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v215 = ttnn::to_device(
      v214, v1,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v216 = ttnn::ones(
      ::ttnn::Shape({64, 3, 7, 7}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v217 = ttnn::ones(
      ::ttnn::Shape({64, 64, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v218 = ttnn::ones(
      ::ttnn::Shape({64, 64, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v219 = ttnn::ones(
      ::ttnn::Shape({256, 64, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v220 = ttnn::ones(
      ::ttnn::Shape({256, 64, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v221 = ttnn::ones(
      ::ttnn::Shape({64, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v222 = ttnn::ones(
      ::ttnn::Shape({64, 64, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v223 = ttnn::ones(
      ::ttnn::Shape({256, 64, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v224 = ttnn::ones(
      ::ttnn::Shape({64, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v225 = ttnn::ones(
      ::ttnn::Shape({64, 64, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v226 = ttnn::ones(
      ::ttnn::Shape({256, 64, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v227 = ttnn::ones(
      ::ttnn::Shape({128, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v228 = ttnn::ones(
      ::ttnn::Shape({128, 128, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v229 = ttnn::ones(
      ::ttnn::Shape({512, 128, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v230 = ttnn::ones(
      ::ttnn::Shape({512, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v231 = ttnn::ones(
      ::ttnn::Shape({128, 512, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v232 = ttnn::ones(
      ::ttnn::Shape({128, 128, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v233 = ttnn::ones(
      ::ttnn::Shape({512, 128, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v234 = ttnn::ones(
      ::ttnn::Shape({128, 512, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v235 = ttnn::ones(
      ::ttnn::Shape({128, 128, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v236 = ttnn::ones(
      ::ttnn::Shape({512, 128, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v237 = ttnn::ones(
      ::ttnn::Shape({128, 512, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v238 = ttnn::ones(
      ::ttnn::Shape({128, 128, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v239 = ttnn::ones(
      ::ttnn::Shape({512, 128, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v240 = ttnn::ones(
      ::ttnn::Shape({256, 512, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v241 = ttnn::ones(
      ::ttnn::Shape({256, 256, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v242 = ttnn::ones(
      ::ttnn::Shape({1024, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v243 = ttnn::ones(
      ::ttnn::Shape({1024, 512, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v244 = ttnn::ones(
      ::ttnn::Shape({256, 1024, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v245 = ttnn::ones(
      ::ttnn::Shape({256, 256, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v246 = ttnn::ones(
      ::ttnn::Shape({1024, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v247 = ttnn::ones(
      ::ttnn::Shape({256, 1024, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v248 = ttnn::ones(
      ::ttnn::Shape({256, 256, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v249 = ttnn::ones(
      ::ttnn::Shape({1024, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v250 = ttnn::ones(
      ::ttnn::Shape({256, 1024, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v251 = ttnn::ones(
      ::ttnn::Shape({256, 256, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v252 = ttnn::ones(
      ::ttnn::Shape({1024, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v253 = ttnn::ones(
      ::ttnn::Shape({256, 1024, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v254 = ttnn::ones(
      ::ttnn::Shape({256, 256, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v255 = ttnn::ones(
      ::ttnn::Shape({1024, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v256 = ttnn::ones(
      ::ttnn::Shape({256, 1024, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v257 = ttnn::ones(
      ::ttnn::Shape({256, 256, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v258 = ttnn::ones(
      ::ttnn::Shape({1024, 256, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v259 = ttnn::ones(
      ::ttnn::Shape({512, 1024, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v260 = ttnn::ones(
      ::ttnn::Shape({512, 512, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v261 = ttnn::ones(
      ::ttnn::Shape({2048, 512, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v262 = ttnn::ones(
      ::ttnn::Shape({2048, 1024, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v263 = ttnn::ones(
      ::ttnn::Shape({512, 2048, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v264 = ttnn::ones(
      ::ttnn::Shape({512, 512, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v265 = ttnn::ones(
      ::ttnn::Shape({2048, 512, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v266 = ttnn::ones(
      ::ttnn::Shape({512, 2048, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v267 = ttnn::ones(
      ::ttnn::Shape({512, 512, 3, 3}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v268 = ttnn::ones(
      ::ttnn::Shape({2048, 512, 1, 1}), ::ttnn::DataType::BFLOAT16,
      ::ttnn::Layout::ROW_MAJOR, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::SYSTEM_MEMORY, ::std::nullopt});
  ::ttnn::Tensor v269 = ttnn::ones(
      ::ttnn::Shape({2048, 1000}), ::ttnn::DataType::BFLOAT8_B,
      ::ttnn::Layout::TILE, ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v270 = ttnn::to_device(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v271 = ttnn::ones(
      ::ttnn::Shape({1000}), ::ttnn::DataType::BFLOAT8_B, ::ttnn::Layout::TILE,
      ::std::nullopt,
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::ttnn::Tensor v272 = ttnn::to_device(
      ...
      ::ttnn::MemoryConfig{::ttnn::TensorMemoryLayout::INTERLEAVED,
                           ::ttnn::BufferType::DRAM, ::std::nullopt});
  ::std::vector<::ttnn::Tensor> v273 = util_create_vec(
      v3, v5, v7, v9, v11, v13, v15, v17, v19, v21, v23, v25, v27, v29, v31,
      v33, v35, v37, v39, v41, v43, v45, v47, v49, v51, v53, v55, v57, v59, v61,
      v63, v65, v67, v69, v71, v73, v75, v77, v79, v81, v83, v85, v87, v89, v91,
      v93, v95, v97, v99, v101, v103, v105, v107, v109, v111, v113, v115, v117,
      v119, v121, v123, v125, v127, v129, v131, v133, v135, v137, v139, v141,
      v143, v145, v147, v149, v151, v153, v155, v157, v159, v161, v163, v165,
      v167, v169, v171, v173, v175, v177, v179, v181, v183, v185, v187, v189,
      v191, v193, v195, v197, v199, v201, v203, v205, v207, v209, v211, v213,
      ...
      v263, v264, v265, v266, v267, v268, v270, v272);
  return v273;
}
...
int32_t main() {
  ...
  std::cout << "Warmup completed in " << warmup_duration.count()
  ...
  std::cout << "Samples per second: "
            << batch_size / (warmup_duration.count() / SECOND_SCALE)
            << std::endl;
  std::cout << "\n\n";
  ...
  for (int i = 0; i < warmup_loop_count; i++) {
    ...
    warmup_duration = std::chrono::duration_cast<std::chrono::nanoseconds>(
        warmup_end - warmup_start);
    std::cout << "Iteration " << i + 1 << " completed in "
              << warmup_duration.count() << " nanoseconds." << std::endl;
    warmup_execution_time += warmup_duration.count();
  }

  warmup_execution_time /= SECOND_SCALE;

  std::cout << "ResNet50 additional warmup forward pass completed in: "
            << warmup_execution_time << " seconds" << std::endl;
  std::cout << "Batch size, number of samples: " << batch_size << std::endl;
  std::cout << "Total iterations: " << warmup_loop_count << std::endl;
  std::cout << "Total number of samples: " << warmup_loop_count * batch_size
            << std::endl;
  std::cout << "Samples per second: "
            << warmup_loop_count * batch_size / warmup_execution_time
            << std::endl;
  std::cout << "\n\n";
  ...
  for (int i = 0; i < loop_count; ++i) {
    ...
    std::cout << "Iteration " << i + 1 << " completed in " << duration.count()
              << " nanoseconds." << std::endl;
  ...
  std::cout << "ResNet50 forward pass completed in: " << execution_time
            << " seconds" << std::endl;
  std::cout << "Batch size, number of samples: " << batch_size << std::endl;
  std::cout << "Total iterations: " << loop_count << std::endl;
  std::cout << "Total number of samples: " << loop_count * batch_size
            << std::endl;
  std::cout << "Samples per second: "
            << loop_count * batch_size / execution_time << std::endl;
  std::cout << "\n\n";
