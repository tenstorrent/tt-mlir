...
TEST_F(Conv2dConfigOverrideTest, ParseFullConv2dConfigOverride) {
  ...
  ASSERT_EQ(params.dtype.value(), mlir::ttcore::DataType::BFloat16);
  ASSERT_TRUE(params.weightsDtype.has_value());
  ASSERT_EQ(params.weightsDtype.value(), mlir::ttcore::DataType::BFloat16);
...
TEST_F(Conv2dConfigOverrideTest, ParsePartialConv2dConfigOverride) {
  ...
  const auto &params = parsedOverride["op0"];
  ASSERT_TRUE(params.dtype.has_value());
  ASSERT_EQ(params.dtype.value(), mlir::ttcore::DataType::Float32);
  ASSERT_TRUE(params.activation.has_value());
...
TEST_F(Conv2dConfigOverrideTest, ParseMultipleOps) {
  ...
  ASSERT_EQ(params0.dtype.value(), mlir::ttcore::DataType::Float32);
  ...
  ASSERT_EQ(params1.dtype.value(), mlir::ttcore::DataType::BFloat16);
  ASSERT_TRUE(params1.weightsDtype.has_value());
  ASSERT_EQ(params1.weightsDtype.value(), mlir::ttcore::DataType::BFloat16);
...
TEST_F(OutputLayoutOverrideTest, ParseFullOutputLayoutOverride) {
  ...
  ASSERT_EQ(params.dataType.value(), mlir::ttcore::DataType::Float32);
}
...
TEST_F(OutputLayoutOverrideTest, ParseMultipleOps) {
  ...
  ASSERT_EQ(params1.dataType.value(), mlir::ttcore::DataType::Float32);
  ...
  ASSERT_EQ(params2.dataType.value(), mlir::ttcore::DataType::Float16);
}
...
public:
  ...
  OutputLayoutOverrideParams createOutputLayoutOverrideParams_0() {
    ...
    outputLayoutOverrideParams.dataType = mlir::ttcore::DataType::Float16;
...
TEST_F(TestOptimizerOverrideHandler, TestToString) {
  ...
  optimizerOverridesHandler.addOutputLayoutOverride(
      ...
      Layout::RowMajor, mlir::ttcore::DataType::Float32);
