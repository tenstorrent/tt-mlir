...
protected:
  std::map<UnaryEltwiseOpType,
      ...
      runtimeMap = {
          ...
          {UnaryEltwiseOpType::Expm1, Expm1OpInterface::getOpRuntime},
      };
  std::map<UnaryEltwiseOpType,
      ...
      constraintsMap = {
          ...
          {UnaryEltwiseOpType::Expm1, Expm1OpInterface::getOpConstraints},
      };
  void RunTest() {
...
INSTANTIATE_TEST_SUITE_P(SignTests, OpModelUnaryEltwiseParam,
                         generateBinaryEltwiseParams(UnaryEltwiseOpType::Sign,
                                                     unaryEltwiseParams));
...
INSTANTIATE_TEST_SUITE_P(FloorTests, OpModelUnaryEltwiseParam,
                         generateBinaryEltwiseParams(UnaryEltwiseOpType::Floor,
                                                     unaryEltwiseParams));
...
INSTANTIATE_TEST_SUITE_P(AtanTests, OpModelUnaryEltwiseParam,
                         generateBinaryEltwiseParams(UnaryEltwiseOpType::Atan,
                                                     unaryEltwiseParams));
...
INSTANTIATE_TEST_SUITE_P(Expm1Tests, OpModelUnaryEltwiseParam,
                         generateBinaryEltwiseParams(UnaryEltwiseOpType::Expm1,
                                                     unaryEltwiseParams));
...
TEST_F(OpModelTest, MorehCumSum) {
  ...
  auto constraintsExp = MorehCumSumOpInterface::getOpConstraints(
  ...
  auto runtimeExp = MorehCumSumOpInterface::getOpRuntime(
      tensorShape, layoutDRAM, 0, layoutDRAM);
  EXPECT_TRUE(static_cast<bool>(runtimeExp));
  EXPECT_TRUE(runtimeExp.get() > 0);

  constraintsExp = MorehCumSumOpInterface::getOpConstraints(
  ...
  runtimeExp = MorehCumSumOpInterface::getOpRuntime(tensorShape, layoutDRAM, 0,
                                                    layoutL1Interleaved);
  EXPECT_TRUE(static_cast<bool>(runtimeExp));
  EXPECT_TRUE(runtimeExp.get() > 0);
  ...
  opCstr = constraintsExp.get();
  EXPECT_EQ(opCstr.cbL1PeakSize, 8192);
  EXPECT_EQ(opCstr.tensorL1PeakSize, 133120);
  EXPECT_EQ(opCstr.outputL1BufferSize, 2048);

  runtimeExp = MorehCumSumOpInterface::getOpRuntime(
