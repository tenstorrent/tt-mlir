...
const TestTensor interleaved1X2048Dram = {{1, 2048},
                                          TensorMemoryLayout::Interleaved,
                                          BufferType::DRAM,
                                          llvm::SmallVector<int64_t>{8, 8}};
...
const TestTensor interleaved1X2048L1 = {{1, 2048},
                                        TensorMemoryLayout::Interleaved,
                                        BufferType::L1,
                                        llvm::SmallVector<int64_t>{8, 8}};
} // namespace detail
    ...
    ::testing::Values(
        ...
        std::make_tuple(detail::TestTensor{{56 * 32, 56 * 32},
                        ...
                        detail::TestTensor{{56 * 32, 56 * 32},
                                           ...
                                           llvm::SmallVector<int64_t>{7, 8}},
                        llvm::SmallVector<int64_t>{7, 8},
                        detail::ExpectedResult{true, 262144, 516096, 778240,
                                               114688}),
        std::make_tuple(detail::TestTensor{{56 * 32, 56 * 32},
                                           TensorMemoryLayout::BlockSharded,
                                           BufferType::L1,
                        ...
                        detail::TestTensor{{56 * 32, 56 * 32},
                                           ...
                                           llvm::SmallVector<int64_t>{7, 8}},
                        llvm::SmallVector<int64_t>{7, 8},
                        detail::ExpectedResult{true, 559168, 0, 559168, 0}),
        std::make_tuple(detail::TestTensor{{56 * 32, 56 * 32},
                                           TensorMemoryLayout::BlockSharded,
                                           BufferType::L1,
                                           llvm::SmallVector<int64_t>{7, 8}},
        ...
        std::make_tuple(
            ...
            detail::TestTensor{llvm::SmallVector<int64_t>{1 * 32, 56 * 32},
                               ...
                               llvm::SmallVector<int64_t>{1, 56}},
            llvm::SmallVector<int64_t>{7, 8},
            detail::ExpectedResult{true, 16384, 4096, 16384 + 4096, 2048}),
