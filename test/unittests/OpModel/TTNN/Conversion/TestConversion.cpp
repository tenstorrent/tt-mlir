...
class ConversionDataType
    : public MlirToTtnnConversion,
      public testing::WithParamInterface<
          std::tuple<mlir::ttcore::DataType, ::tt::tt_metal::DataType>> {};

TEST_P(ConversionDataType, DataType) {
  const mlir::ttcore::DataType &dataType = std::get<0>(GetParam());
  ...
  auto layout = mlir::tt::ttnn::TTNNLayoutAttr::get(
      &context, tensorShape,
      mlir::ttcore::TileType::get(&context, {32, 32}, dataType),
      mlir::tt::ttnn::BufferType::L1,
      mlir::ttcore::GridAttr::get(&context, {8, 8}),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(std::make_tuple(mlir::ttcore::DataType::Float32,
                                      ::tt::tt_metal::DataType::FLOAT32),
                      std::make_tuple(mlir::ttcore::DataType::BFloat16,
                                      ::tt::tt_metal::DataType::BFLOAT16),
                      std::make_tuple(mlir::ttcore::DataType::BFP_BFloat8,
                                      ::tt::tt_metal::DataType::BFLOAT8_B),
                      std::make_tuple(mlir::ttcore::DataType::BFP_BFloat4,
                                      ::tt::tt_metal::DataType::BFLOAT4_B),
                      std::make_tuple(mlir::ttcore::DataType::UInt32,
                                      ::tt::tt_metal::DataType::UINT32),
                      std::make_tuple(mlir::ttcore::DataType::UInt16,
                                      ::tt::tt_metal::DataType::UINT16),
                      std::make_tuple(mlir::ttcore::DataType::UInt8,
                                      ::tt::tt_metal::DataType::UINT8),
                      std::make_tuple(mlir::ttcore::DataType::Int32,
