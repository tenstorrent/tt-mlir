...
//     return mlir::RankedTensorType::get(getTensorShape(),
//     builder.getF32Type());
//   }
...
//   llvm::SmallVector<mlir::Attribute> createOperandConstraints() {
//     llvm::SmallVector<mlir::Attribute, 3> operand_constraints;
//     mlir::Attribute operand_constraint_attribute =
//         builder.getAttr<mlir::tt::OperandConstraintAttr>(
...
//   // Create a chain of operations by using the result of the previous
//   operation llvm::SmallVector<mlir::Value> operands = {rhs,
...
// // Then we have two operations which work on the result of the first
// operation
// // and arg1. Then we have forth operation which works on the result of the
// // second and third operation. So the scheduler should first yield the first
// op
