...
def run_pykernel_demo(device):
    ...
    reader_attributes = ttnn.DataMovementAttributes(
        core_spec=core_grid,
        kernel_path=reader_pykernel_path,  # "third_party/tt-metal/src/tt-metal/ttnn/cpp/ttnn/operations/eltwise/unary/device/kernels/dataflow/reader_unary_interleaved_start_id.cpp",
    ...
    writer_attributes = ttnn.DataMovementAttributes(
        core_spec=core_grid,
        kernel_path=writer_pykernel_path,  # "third_party/tt-metal/src/tt-metal/ttnn/cpp/ttnn/operations/eltwise/unary/device/kernels/dataflow/writer_unary_interleaved_start_id.cpp",
    ...
    compute_attributes = ttnn.ComputeAttributes(
        core_spec=core_grid,
        kernel_path=compute_pykernel_path,  # "third_party/tt-metal/src/tt-metal/tt_metal/kernels/compute/eltwise_sfpu.cpp",
