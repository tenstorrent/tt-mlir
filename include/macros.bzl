...
def all_inc_gen():
    include_deps = [
        ...
        "//include/ttmlir/Dialect/TTIR/Transforms:ttir_pass_inc_gen",
        ...
        "//include/ttmlir/Dialect/TTMetal/Transforms:ttmetal_pass_inc_gen",
        ...
        "//include/ttmlir/Dialect/TTNN/Transforms:ttnn_pass_inc_gen",
