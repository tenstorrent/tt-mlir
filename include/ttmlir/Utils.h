...
// A small metaprogramming helper for working with variadic typelists.
//
// Main metafunctions are 'head_t' and 'tail_t', with obvious semantics.
// They return 'void' on end-of-list condition.
namespace list {
...
template <typename K, typename... KVs>
using find_key_t = typename find_key<K, KVs...>::type;
...
template <typename K, typename... KVs>
struct find_key<K, std::tuple<KVs...>> {
  using L = std::tuple<KVs...>;
  using type = std::conditional_t<
      std::is_same_v<K, typename list::head_t<L>::first_type>, list::head_t<L>,
      find_key_t<K, list::tail_t<L>>>;
};
//............................................................................

template <typename KV>
struct value_of {
  using type = typename KV::second_type;
};
...
struct find {
  using entry = typename map::find_key<K, MAP>::type;
  using type = typename map::value_of<entry>::type;
};

} // namespace map
} // namespace impl
//............................................................................
// A small metaprogramming helper for working with type maps defined via lists
// of std::pairs, with the first type acting as the key and the second type
// as the value.
//
...
using map_find_t = typename impl::map::find<K, MAP>::type;
