...
#ifndef TTMLIR_CONVERSION_TTIRTOCPUTTIR_H
#define TTMLIR_CONVERSION_TTIRTOCPUTTIR_H
...
namespace mlir::tt {
#define GEN_PASS_DECL_CONVERTTIRTOCPU
...
LogicalResult
emitDispatchOpRegionAsCPU(Region *region, std::string &regionCpp,
                          const ttkernel::KernelConfigInterface &kernelConfig);

// // Converts dispatch op's regions to C++ code.
// LogicalResult
// emitDispatchOpRegionAsCPU(ttmetal::DispatchOp dispatchOp,
