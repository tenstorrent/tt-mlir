...
public:
  ...
  convertSdyShardingToMeshSharding(mlir::sdy::TensorShardingAttr sdySharding,
                                   ...
                                   mlir::ttcore::MeshShardDirection direction);
  ...
  mlir::ttcore::TensorMeshShardingAttr
  ...
  void extractMeshShardingFromTensorMeshShardingAttr(
      mlir::ttcore::MeshAttr mesh,
      mlir::ttcore::TensorMeshShardingAttr tensorMeshShardingAttr,
      mlir::ttcore::MeshShardDirection direction);

  // Getter functions.
  mlir::ttcore::MeshShardDirection getShardDirection() const {
  ...
  mlir::ttcore::MeshShardType getShardType() const { return shardType; }
...
private:
  ...
  void setDummyShardingOp() {
    shardType = mlir::ttcore::MeshShardType::Identity;
  }
...
private:
  mlir::ttcore::MeshShardDirection shardDirection =
      mlir::ttcore::MeshShardDirection::ShardToFull;
  mlir::ttcore::MeshShardType shardType = mlir::ttcore::MeshShardType::Identity;
