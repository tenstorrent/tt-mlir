...
#include "ttmlir/Dialect/TTNN/Utils/OptionParsers.h"
...
struct TTIRToTTNNDevicePipelineOptions
  ...
  // default.
  Option<std::optional<MathFidelity>> computeCfgMathFidelity{
      *this, "compute-cfg-math-fidelity",
      ...
      llvm::cl::init(std::optional<MathFidelity>(MathFidelity::HiFi4))};
