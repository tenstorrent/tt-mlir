...
// moves toward the split output where NLPCreateQKVHeadsDecodeFusing consumes it.
class DecodeRelabelThroughRMSNorm
    : public mlir::OpRewritePattern<RMSNormOp> {
public:
...
class DecodeRelabelThroughSlice
