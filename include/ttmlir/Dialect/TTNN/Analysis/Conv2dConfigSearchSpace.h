...
struct Conv2dConfigSearchSpace {
  llvm::SmallVector<tt::DataType> dtype;
  llvm::SmallVector<tt::DataType> weightsDtype;
  ...
  llvm::SmallVector<bool> preprocessWeightsOnDevice;
  llvm::SmallVector<bool> alwaysPreprocessWeights;
  ...
  bool isPreprocessWeightsOnDeviceSetForSearch() const {
    return !preprocessWeightsOnDevice.empty();
  }
  bool isAlwaysPreprocessWeightsSetForSearch() const {
    return !alwaysPreprocessWeights.empty();
  }
  ...
  bool isAnyFieldSetForSearch() const {
    return isDtypeSetForSearch() || isWeightsDtypeSetForSearch() ||
           ...
           isPreprocessWeightsOnDeviceSetForSearch() ||
           isAlwaysPreprocessWeightsSetForSearch() ||
...
struct Conv2dConfigGeneratorSearchFieldInfo {
  using SearchValueVariant =
      std::variant<llvm::SmallVector<tt::DataType>,
  ...
  tt::DataType getCurrentDataType() const {
    return std::get<llvm::SmallVector<tt::DataType>>(values)[currentIndex];
  }
