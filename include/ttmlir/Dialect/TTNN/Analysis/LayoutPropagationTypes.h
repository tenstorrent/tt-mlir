...
#ifndef TTMLIR_DIALECT_TTNN_ANALYSIS_LAYOUTPROPAGATIONTYPES_H
#define TTMLIR_DIALECT_TTNN_ANALYSIS_LAYOUTPROPAGATIONTYPES_H
...
#endif // TTMLIR_DIALECT_TTNN_ANALYSIS_LAYOUTPROPAGATIONTYPES_H
