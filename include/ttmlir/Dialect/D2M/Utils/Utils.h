...
// getVirtualGridMapping but returns the forward map attribute.
...
// virtual grid mapping (via getVirtualGridMapping) instead of re-deriving
// virtualization status from the grid shape.
