...
namespace llvm {
template <>
struct DenseMapInfo<mlir::ttcore::PhysicalCoreCoord> {
  static mlir::ttcore::PhysicalCoreCoord getEmptyKey() {
    return mlir::ttcore::PhysicalCoreCoord{-1, -1, -1};
  }

  static mlir::ttcore::PhysicalCoreCoord getTombstoneKey() {
    return mlir::ttcore::PhysicalCoreCoord{-2, -2, -2};
  }

  static unsigned getHashValue(mlir::ttcore::PhysicalCoreCoord coord) {
    return llvm::hash_combine(coord.d, coord.y, coord.x);
  }

  static bool isEqual(mlir::ttcore::PhysicalCoreCoord lhs,
                      mlir::ttcore::PhysicalCoreCoord rhs) {
    return lhs == rhs;
  }
};
} // namespace llvm
