...
public:
  ...
  MeshSharding(mlir::tt::ttcore::MeshShardDirection shardDirection,
      ...
      : shardDirection(shardDirection), shardType(shardType),
        shardShape(shardShape), shardDims(shardDims),
        meshShape(meshShape), deviceIds(deviceIds) {}
...
public:
  ...
  static llvm::Expected<GSPMDMeshSharding> generate(llvm::StringRef opShardingStr, llvm::StringRef operandShardingStr);
  GSPMDMeshSharding(mlir::tt::ttcore::MeshShardDirection shardDirection,
      ...
      : MeshSharding(shardDirection, shardType, shardShape, shardDims, meshShape, deviceIds, shardStatus),
        lastTileDimReplicate(lastTileDimReplicate), opShardingStr(opShardingStr), operandShardingStr(operandShardingStr) {}
...
public:
  // Static factory method
  static llvm::Expected<ShardyMeshSharding> generate(sdy::MeshAttr meshAttr, sdy::TensorShardingAttr sdySharding, ttcore::MeshShardDirection shardDirection);
  ShardyMeshSharding(mlir::tt::ttcore::MeshShardDirection shardDirection,
                ...
                : MeshSharding(direction, type, shape, dims, meshShape, deviceIds, shardStatus),
