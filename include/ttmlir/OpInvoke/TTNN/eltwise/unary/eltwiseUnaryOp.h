...
callEltwiseUnary(CallType callType,
  ...
  auto makeTuple = [&](auto tag) {
    return createEltwiseUnaryTuple(tag, eltwiseUnaryOpT, input, device, params);
  };
...
callEltwiseUnaryTanh(CallType callType,
  ...
  auto makeTuple = [&](auto tag) {
    return createEltwiseUnaryTanhTuple(tag, eltwiseUnaryOpT, input, device,
                                       params);
  };
...
EltwiseUnaryOpResult callEltwiseUnaryWithFastAndApproximateMode(
  ...
  auto makeTuple = [&](auto tag) {
    return createEltwiseUnaryWithFastAndApproximateModeTuple(
        tag, eltwiseUnaryOpT, input, device, params);
  };
...
EltwiseUnaryOpResult callEltwiseUnarySigmoid(
  ...
  auto makeTuple = [&](auto tag) {
    return createEltwiseUnarySigmoidTuple(tag, eltwiseUnaryOpT, input, device,
                                          params);
  };
...
EltwiseUnaryOpResult callEltwiseUnaryWithFloatParameter(
  ...
  auto makeTuple = [&](auto tag) {
    return createEltwiseUnaryWithFloatParameterTuple(tag, eltwiseUnaryOpT,
                                                     input, device, params);
  };
