...
#ifndef TTNN_OP_INVOKE_PREPARE_CONV_2D_WEIGHTS_OP_H
#define TTNN_OP_INVOKE_PREPARE_CONV_2D_WEIGHTS_OP_H
...
callPrepareConv2dWeights(CallType callType,
                         ...
                         TensorArg weightTensor,
                         ::ttnn::MeshDevice &targetDevice);

} // namespace ttnn_op_invoke

#endif // TTNN_OP_INVOKE_PREPARE_CONV_2D_WEIGHTS_OP_H
