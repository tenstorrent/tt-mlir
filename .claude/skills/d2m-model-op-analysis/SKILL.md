...
```bash
python tools/scripts/ttir_model_op_inventory.py "$INPUT_DIR"/*/preprocessed.mlir
```
...
Run **`tools/scripts/ttir_model_op_inventory.py`** on each `preprocessed.mlir` file
