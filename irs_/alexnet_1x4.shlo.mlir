...
module @jit__lambda attributes {mhlo.num_partitions = 4 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func public @main(%arg0: tensor<64xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_0']['bias']"), %arg1: tensor<11x11x3x64xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {}, {}, {}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_0']['kernel']"), %arg2: tensor<192xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_1']['bias']"), %arg3: tensor<5x5x64x192xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {}, {}, {}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_1']['kernel']"), %arg4: tensor<384xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_2']['bias']"), %arg5: tensor<3x3x192x384xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {}, {}, {}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_2']['kernel']"), %arg6: tensor<256xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_3']['bias']"), %arg7: tensor<3x3x384x256xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {}, {}, {}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_3']['kernel']"), %arg8: tensor<256xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_4']['bias']"), %arg9: tensor<3x3x256x256xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {}, {}, {}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Conv_4']['kernel']"), %arg10: tensor<4096xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{"X"}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Dense_0']['bias'].value"), %arg11: tensor<6400x4096xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {"X"}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Dense_0']['kernel'].value"), %arg12: tensor<4096xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{"X"}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Dense_1']['bias'].value"), %arg13: tensor<4096x4096xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {"X"}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Dense_1']['kernel'].value"), %arg14: tensor<1000xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{"X"}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Dense_2']['bias'].value"), %arg15: tensor<4096x1000xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{}, {"X"}]>, ttcore.argument_type = #ttcore.argument_type<parameter>} loc("variables['params']['Dense_2']['kernel'].value"), %arg16: tensor<8x224x224x3xi32> {sdy.sharding = #sdy.sharding<@mesh, [{"X"}, {}, {}, {}]>, ttcore.argument_type = #ttcore.argument_type<input>} loc("args[0]")) -> (tensor<8x1000xbf16> {jax.result_info = "result", sdy.sharding = #sdy.sharding<@mesh, [{}, {}]>}) {
    %0 = sdy.manual_computation(%arg0, %arg1, %arg2, %arg3, %arg4, %arg5, %arg6, %arg7, %arg8, %arg9, %arg10, %arg11, %arg12, %arg13, %arg14, %arg15, %arg16) in_shardings=[<@mesh, [{}]>, <@mesh, [{}, {}, {}, {}]>, <@mesh, [{}]>, <@mesh, [{}, {}, {}, {}]>, <@mesh, [{}]>, <@mesh, [{}, {}, {}, {}]>, <@mesh, [{}]>, <@mesh, [{}, {}, {}, {}]>, <@mesh, [{}]>, <@mesh, [{}, {}, {}, {}]>, <@mesh, [{"X"}]>, <@mesh, [{}, {"X"}]>, <@mesh, [{"X"}]>, <@mesh, [{}, {"X"}]>, <@mesh, [{"X"}]>, <@mesh, [{}, {"X"}]>, <@mesh, [{"X"}, {}, {}, {}]>] out_shardings=[<@mesh, [{}, {}]>] manual_axes={"X"} (%arg17: tensor<64xbf16> loc("shard_map"), %arg18: tensor<11x11x3x64xbf16> loc("shard_map"), %arg19: tensor<192xbf16> loc("shard_map"), %arg20: tensor<5x5x64x192xbf16> loc("shard_map"), %arg21: tensor<384xbf16> loc("shard_map"), %arg22: tensor<3x3x192x384xbf16> loc("shard_map"), %arg23: tensor<256xbf16> loc("shard_map"), %arg24: tensor<3x3x384x256xbf16> loc("shard_map"), %arg25: tensor<256xbf16> loc("shard_map"), %arg26: tensor<3x3x256x256xbf16> loc("shard_map"), %arg27: tensor<1024xbf16> loc("shard_map"), %arg28: tensor<6400x1024xbf16> loc("shard_map"), %arg29: tensor<1024xbf16> loc("shard_map"), %arg30: tensor<4096x1024xbf16> loc("shard_map"), %arg31: tensor<250xbf16> loc("shard_map"), %arg32: tensor<4096x250xbf16> loc("shard_map"), %arg33: tensor<2x224x224x3xi32> loc("shard_map")) {
      %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32> loc(#loc85)
      %cst_0 = stablehlo.constant dense<0xFF80> : tensor<bf16> loc(#loc)
      %1 = stablehlo.convert %arg33 : (tensor<2x224x224x3xi32>) -> tensor<2x224x224x3xbf16> loc(#loc86)
      %2 = stablehlo.convolution(%1, %arg18) dim_numbers = [b, 0, 1, f]x[0, 1, i, o]->[b, 0, 1, f], window = {stride = [4, 4]} {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<2x224x224x3xbf16>, tensor<11x11x3x64xbf16>) -> tensor<2x54x54x64xbf16> loc(#loc87)
      %3 = stablehlo.reshape %arg17 : (tensor<64xbf16>) -> tensor<1x1x1x64xbf16> loc(#loc88)
      %4 = stablehlo.broadcast_in_dim %3, dims = [0, 1, 2, 3] : (tensor<1x1x1x64xbf16>) -> tensor<2x54x54x64xbf16> loc(#loc89)
      %5 = stablehlo.add %2, %4 : tensor<2x54x54x64xbf16> loc(#loc89)
      %6 = func.call @relu(%5) : (tensor<2x54x54x64xbf16>) -> tensor<2x54x54x64xbf16> loc(#loc90)
      ...
      }) : (tensor<2x54x54x64xbf16>, tensor<bf16>) -> tensor<2x26x26x64xbf16> loc(#loc91)
      %9 = stablehlo.convolution(%8, %arg20) dim_numbers = [b, 0, 1, f]x[0, 1, i, o]->[b, 0, 1, f], window = {pad = [[2, 2], [2, 2]]} {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<2x26x26x64xbf16>, tensor<5x5x64x192xbf16>) -> tensor<2x26x26x192xbf16> loc(#loc92)
      %10 = stablehlo.reshape %arg19 : (tensor<192xbf16>) -> tensor<1x1x1x192xbf16> loc(#loc93)
      %11 = stablehlo.broadcast_in_dim %10, dims = [0, 1, 2, 3] : (tensor<1x1x1x192xbf16>) -> tensor<2x26x26x192xbf16> loc(#loc94)
      %12 = stablehlo.add %9, %11 : tensor<2x26x26x192xbf16> loc(#loc94)
      %13 = func.call @relu_17(%12) : (tensor<2x26x26x192xbf16>) -> tensor<2x26x26x192xbf16> loc(#loc90)
      ...
      ^bb0(%arg34: tensor<bf16> loc("reduce_window_max"), %arg35: tensor<bf16> loc("reduce_window_max")):
        %65 = stablehlo.maximum %arg34, %arg35 : tensor<bf16> loc(#loc91)
        stablehlo.return %65 : tensor<bf16> loc(#loc91)
      }) : (tensor<2x26x26x192xbf16>, tensor<bf16>) -> tensor<2x12x12x192xbf16> loc(#loc91)
      %16 = stablehlo.convolution(%15, %arg22) dim_numbers = [b, 0, 1, f]x[0, 1, i, o]->[b, 0, 1, f], window = {pad = [[1, 1], [1, 1]]} {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<2x12x12x192xbf16>, tensor<3x3x192x384xbf16>) -> tensor<2x12x12x384xbf16> loc(#loc95)
      %17 = stablehlo.reshape %arg21 : (tensor<384xbf16>) -> tensor<1x1x1x384xbf16> loc(#loc96)
      %18 = stablehlo.broadcast_in_dim %17, dims = [0, 1, 2, 3] : (tensor<1x1x1x384xbf16>) -> tensor<2x12x12x384xbf16> loc(#loc97)
      %19 = stablehlo.add %16, %18 : tensor<2x12x12x384xbf16> loc(#loc97)
      %20 = func.call @relu_24(%19) : (tensor<2x12x12x384xbf16>) -> tensor<2x12x12x384xbf16> loc(#loc90)
      %21 = stablehlo.convolution(%20, %arg24) dim_numbers = [b, 0, 1, f]x[0, 1, i, o]->[b, 0, 1, f], window = {pad = [[1, 1], [1, 1]]} {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<2x12x12x384xbf16>, tensor<3x3x384x256xbf16>) -> tensor<2x12x12x256xbf16> loc(#loc98)
      %22 = stablehlo.reshape %arg23 : (tensor<256xbf16>) -> tensor<1x1x1x256xbf16> loc(#loc99)
      %23 = stablehlo.broadcast_in_dim %22, dims = [0, 1, 2, 3] : (tensor<1x1x1x256xbf16>) -> tensor<2x12x12x256xbf16> loc(#loc100)
      %24 = stablehlo.add %21, %23 : tensor<2x12x12x256xbf16> loc(#loc100)
      %25 = func.call @relu_30(%24) : (tensor<2x12x12x256xbf16>) -> tensor<2x12x12x256xbf16> loc(#loc90)
      %26 = stablehlo.convolution(%25, %arg26) dim_numbers = [b, 0, 1, f]x[0, 1, i, o]->[b, 0, 1, f], window = {pad = [[1, 1], [1, 1]]} {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<2x12x12x256xbf16>, tensor<3x3x256x256xbf16>) -> tensor<2x12x12x256xbf16> loc(#loc101)
      %27 = stablehlo.reshape %arg25 : (tensor<256xbf16>) -> tensor<1x1x1x256xbf16> loc(#loc102)
      %28 = stablehlo.broadcast_in_dim %27, dims = [0, 1, 2, 3] : (tensor<1x1x1x256xbf16>) -> tensor<2x12x12x256xbf16> loc(#loc103)
      %29 = stablehlo.add %26, %28 : tensor<2x12x12x256xbf16> loc(#loc103)
      %30 = func.call @relu_30(%29) : (tensor<2x12x12x256xbf16>) -> tensor<2x12x12x256xbf16> loc(#loc90)
      ...
      ^bb0(%arg34: tensor<bf16> loc("reduce_window_max"), %arg35: tensor<bf16> loc("reduce_window_max")):
        %65 = stablehlo.maximum %arg34, %arg35 : tensor<bf16> loc(#loc91)
        stablehlo.return %65 : tensor<bf16> loc(#loc91)
      }) : (tensor<2x12x12x256xbf16>, tensor<bf16>) -> tensor<2x5x5x256xbf16> loc(#loc91)
      %33 = stablehlo.reshape %32 : (tensor<2x5x5x256xbf16>) -> tensor<2x6400xbf16> loc(#loc104)
      %34 = "stablehlo.all_gather"(%33) <{all_gather_dim = 0 : i64, channel_handle = #stablehlo.channel_handle<handle = 1, type = 0>, replica_groups = dense<[[0, 1, 2, 3]]> : tensor<1x4xi64>, use_global_device_ids}> : (tensor<2x6400xbf16>) -> tensor<8x6400xbf16> loc(#loc105)
      %35 = stablehlo.dot_general %34, %arg28, contracting_dims = [1] x [0] : (tensor<8x6400xbf16>, tensor<6400x1024xbf16>) -> tensor<8x1024xbf16> loc(#loc106)
      %36 = stablehlo.reshape %arg27 : (tensor<1024xbf16>) -> tensor<1x1024xbf16> loc(#loc107)
      %37 = stablehlo.broadcast_in_dim %36, dims = [0, 1] : (tensor<1x1024xbf16>) -> tensor<8x1024xbf16> loc(#loc108)
      %38 = stablehlo.add %35, %37 : tensor<8x1024xbf16> loc(#loc108)
      %39 = func.call @relu_39(%38) : (tensor<8x1024xbf16>) -> tensor<8x1024xbf16> loc(#loc90)
      %40 = "stablehlo.all_gather"(%39) <{all_gather_dim = 1 : i64, channel_handle = #stablehlo.channel_handle<handle = 2, type = 0>, replica_groups = dense<[[0, 1, 2, 3]]> : tensor<1x4xi64>, use_global_device_ids}> : (tensor<8x1024xbf16>) -> tensor<8x4096xbf16> loc(#loc105)
      %41 = stablehlo.dot_general %40, %arg30, contracting_dims = [1] x [0] : (tensor<8x4096xbf16>, tensor<4096x1024xbf16>) -> tensor<8x1024xbf16> loc(#loc109)
      %42 = stablehlo.reshape %arg29 : (tensor<1024xbf16>) -> tensor<1x1024xbf16> loc(#loc110)
      %43 = stablehlo.broadcast_in_dim %42, dims = [0, 1] : (tensor<1x1024xbf16>) -> tensor<8x1024xbf16> loc(#loc111)
      %44 = stablehlo.add %41, %43 : tensor<8x1024xbf16> loc(#loc111)
      %45 = func.call @relu_39(%44) : (tensor<8x1024xbf16>) -> tensor<8x1024xbf16> loc(#loc90)
      %46 = "stablehlo.all_gather"(%45) <{all_gather_dim = 1 : i64, channel_handle = #stablehlo.channel_handle<handle = 2, type = 0>, replica_groups = dense<[[0, 1, 2, 3]]> : tensor<1x4xi64>, use_global_device_ids}> : (tensor<8x1024xbf16>) -> tensor<8x4096xbf16> loc(#loc105)
      %47 = stablehlo.dot_general %46, %arg32, contracting_dims = [1] x [0] : (tensor<8x4096xbf16>, tensor<4096x250xbf16>) -> tensor<8x250xbf16> loc(#loc112)
      %48 = stablehlo.reshape %arg31 : (tensor<250xbf16>) -> tensor<1x250xbf16> loc(#loc113)
      %49 = stablehlo.broadcast_in_dim %48, dims = [0, 1] : (tensor<1x250xbf16>) -> tensor<8x250xbf16> loc(#loc114)
      %50 = stablehlo.add %47, %49 : tensor<8x250xbf16> loc(#loc114)
      %51 = "stablehlo.all_gather"(%50) <{all_gather_dim = 1 : i64, channel_handle = #stablehlo.channel_handle<handle = 3, type = 0>, replica_groups = dense<[[0, 1, 2, 3]]> : tensor<1x4xi64>, use_global_device_ids}> : (tensor<8x250xbf16>) -> tensor<8x1000xbf16> loc(#loc105)
  ...
  func.func private @relu(%arg0: tensor<2x54x54x64xbf16> {ttcore.argument_type = #ttcore.argument_type<input>} loc(unknown)) -> tensor<2x54x54x64xbf16> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<bf16> loc(#loc132)
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<bf16>) -> tensor<2x54x54x64xbf16> loc(#loc123)
    %1 = stablehlo.maximum %arg0, %0 : tensor<2x54x54x64xbf16> loc(#loc123)
    return %1 : tensor<2x54x54x64xbf16> loc(#loc132)
  } loc(#loc132)
  func.func private @relu_17(%arg0: tensor<2x26x26x192xbf16> {ttcore.argument_type = #ttcore.argument_type<input>} loc(unknown)) -> tensor<2x26x26x192xbf16> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<bf16> loc(#loc133)
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<bf16>) -> tensor<2x26x26x192xbf16> loc(#loc125)
    %1 = stablehlo.maximum %arg0, %0 : tensor<2x26x26x192xbf16> loc(#loc125)
    return %1 : tensor<2x26x26x192xbf16> loc(#loc133)
  } loc(#loc133)
  func.func private @relu_24(%arg0: tensor<2x12x12x384xbf16> {ttcore.argument_type = #ttcore.argument_type<input>} loc(unknown)) -> tensor<2x12x12x384xbf16> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<bf16> loc(#loc134)
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<bf16>) -> tensor<2x12x12x384xbf16> loc(#loc127)
    %1 = stablehlo.maximum %arg0, %0 : tensor<2x12x12x384xbf16> loc(#loc127)
    return %1 : tensor<2x12x12x384xbf16> loc(#loc134)
  } loc(#loc134)
  func.func private @relu_30(%arg0: tensor<2x12x12x256xbf16> {ttcore.argument_type = #ttcore.argument_type<input>} loc(unknown)) -> tensor<2x12x12x256xbf16> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<bf16> loc(#loc135)
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<bf16>) -> tensor<2x12x12x256xbf16> loc(#loc129)
    %1 = stablehlo.maximum %arg0, %0 : tensor<2x12x12x256xbf16> loc(#loc129)
    return %1 : tensor<2x12x12x256xbf16> loc(#loc135)
  } loc(#loc135)
  func.func private @relu_39(%arg0: tensor<8x1024xbf16> {ttcore.argument_type = #ttcore.argument_type<input>} loc(unknown)) -> tensor<8x1024xbf16> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<bf16> loc(#loc136)
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<bf16>) -> tensor<8x1024xbf16> loc(#loc131)
    %1 = stablehlo.maximum %arg0, %0 : tensor<8x1024xbf16> loc(#loc131)
    return %1 : tensor<8x1024xbf16> loc(#loc136)
  } loc(#loc136)
} loc(#loc)
...
#loc24 = loc("/localdev/svuckovic/_workspace/repos/tt-xla/tests/jax/multi_chip/llmbox/4_devices/models/tensor_parallel/alexnet/test_alexnet_llmbox_1x4.py":73:8 to :31)
...
#loc47 = loc("test_alexnet_multichip_llmbox_1x4_inference_shardy"(#loc24))
