  ...
  tt_attribute_class<tt::ttnn::Conv2dConfigAttr>(m, "Conv2dConfigAttr")
      .def_static("get",
                  [](MlirContext ctx, std::optional<tt::DataType> dtype,
                     std::optional<tt::DataType> weightsDtype,
                     ...
                     tt::ttnn::CoreRangeSetAttr coreGrid,
                    ...
                    return wrap(tt::ttnn::Conv2dConfigAttr::get(
                        ...
                        reshardIfNotOptimal, overrideShardingConfig,
                        shardLayout, coreGrid, transposeShards, outputLayout,
