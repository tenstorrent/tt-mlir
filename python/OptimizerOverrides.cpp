...
void populateOptimizerOverridesModule(nb::module_ &m) {
  ...
  nb::enum_<mlir::ttcore::DataType>(m, "DataType")
      .value("Float32", mlir::ttcore::DataType::Float32)
      .value("Float16", mlir::ttcore::DataType::Float16)
      .value("BFloat16", mlir::ttcore::DataType::BFloat16)
      .value("BFP_Float8", mlir::ttcore::DataType::BFP_Float8)
      .value("BFP_BFloat8", mlir::ttcore::DataType::BFP_BFloat8)
      .value("BFP_Float4", mlir::ttcore::DataType::BFP_Float4)
      .value("BFP_BFloat4", mlir::ttcore::DataType::BFP_BFloat4)
      .value("BFP_Float2", mlir::ttcore::DataType::BFP_Float2)
      .value("BFP_BFloat2", mlir::ttcore::DataType::BFP_BFloat2)
      .value("UInt32", mlir::ttcore::DataType::UInt32)
      .value("UInt16", mlir::ttcore::DataType::UInt16)
      .value("UInt8", mlir::ttcore::DataType::UInt8)
      .value("Int32", mlir::ttcore::DataType::Int32);
  ...
  nb::class_<mlir::tt::ttnn::OutputLayoutOverrideParams>(
      ...
      .def("set_data_type_from_str",
           [](mlir::tt::ttnn::OutputLayoutOverrideParams &obj,
              const std::string &value) {
             if (auto dataType_ = mlir::ttcore::DataTypeStringToEnum(value)) {
  ...
  nb::class_<mlir::tt::ttnn::Conv2dConfigOverrideParams>(
      ...
      .def("set_dtype_from_str",
           [](mlir::tt::ttnn::Conv2dConfigOverrideParams &obj,
              const std::string &value) {
             if (auto dtype_ = mlir::ttcore::DataTypeStringToEnum(value)) {
               obj.dtype = dtype_;
             } else {
      ...
      .def("set_weights_dtype_from_str",
           [](mlir::tt::ttnn::Conv2dConfigOverrideParams &obj,
             ...
             if (auto weightsDtype_ =
                     mlir::ttcore::DataTypeStringToEnum(value)) {
