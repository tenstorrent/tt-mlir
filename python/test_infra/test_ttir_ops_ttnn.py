...
"""
@ttnn_to_flatbuffer(output_file_name="taps/test_exp.ttnn")
@ttir_to_ttnn(output_file_name="taps/test_exp.mlir", system_desc_path=f"{system_desc_path}")
@compile_as_mlir_module((128, 128), module_dump=True)
...
@ttnn_to_flatbuffer(output_file_name="taps/test_add.ttnn")
@ttir_to_ttnn(
    output_file_name="taps/test_add.mlir", system_desc_path=f"{system_desc_path}"
)
