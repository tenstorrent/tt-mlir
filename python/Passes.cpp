...
void populatePassesModule(nb::module_ &m) {
  ...
  // NOTE: Pipeline functions (tt_populate_argument_types, stablehlo_pipeline,
  // ttir_to_ttnn_backend_pipeline, ttir_to_ttmetal_backend_pipeline,
  // ttnn_to_ttmetal_pipeline, stablehlo_to_ttir_pipeline,
  // ttir_to_emitpy_pipeline, pykernel_compile_pipeline) have been moved to
  // Python using PassManager.parse(). See tools/builder/base/builder_utils.py
