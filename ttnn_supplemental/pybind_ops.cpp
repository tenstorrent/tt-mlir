...
PYBIND11_MODULE(ttnn_supplemental, m) {
    ...
    // Bind enums
    py::enum_<ttnn::ccl::MeshShardDirection>(m, "MeshShardDirection")
        .value("FullToShard", ttnn::ccl::MeshShardDirection::FullToShard)
        .value("ShardToFull", ttnn::ccl::MeshShardDirection::ShardToFull)
        .export_values();

    py::enum_<ttnn::ccl::MeshShardType>(m, "MeshShardType")
        .value("Identity", ttnn::ccl::MeshShardType::Identity)
        .value("Replicate", ttnn::ccl::MeshShardType::Replicate)
        .value("Maximal", ttnn::ccl::MeshShardType::Maximal)
        .value("Devices", ttnn::ccl::MeshShardType::Devices)
        .export_values();
