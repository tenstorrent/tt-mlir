...
::flatbuffers::Offset<::tt::target::Conv2dConfigDesc>
conv2dConfigToFlatbuffer(FlatbufferObjectCache &cache,
  ...
  ::flatbuffers::Optional<::tt::target::TensorMemoryLayout> shardLayout =
  ...
  ::flatbuffers::Offset<::tt::target::Conv2dConfigDesc> conv2dConfigDesc =
...
createOp(FlatbufferObjectCache &cache, Conv2dOp op) {
  ...
  std::optional<::flatbuffers::Offset<::tt::target::Conv2dConfigDesc>>
      conv2dConfig =
