...
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints>
AbsOpInterface::getOpConstraints(mlir::tt::ttcore::GridAttr deviceGrid,
                                 llvm::ArrayRef<int64_t> inputShape,
                                 mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                 llvm::ArrayRef<int64_t> outputShape,
                                 mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpConstraints("AbsOpInterface", ::ttnn::abs, deviceGrid,
                                      inputShape, inputLayout, outputShape,
                                      outputLayout);
#else
  return OpConstraints{};
...
llvm::Expected<size_t>
AbsOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                             mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                             llvm::ArrayRef<int64_t> outputShape,
                             mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("AbsOpInterface", ::ttnn::abs, inputShape,
                                  inputLayout, outputShape, outputLayout);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
...
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints>
CbrtOpInterface::getOpConstraints(mlir::tt::ttcore::GridAttr deviceGrid,
                                  llvm::ArrayRef<int64_t> inputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                  llvm::ArrayRef<int64_t> outputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpConstraints("CbrtOpInterface", ::ttnn::cbrt,
                                      deviceGrid, inputShape, inputLayout,
                                      outputShape, outputLayout);
#else
  return OpConstraints{};
...
llvm::Expected<size_t>
CbrtOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                              llvm::ArrayRef<int64_t> outputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("CbrtOpInterface", ::ttnn::cbrt, inputShape,
                                  inputLayout, outputShape, outputLayout);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
...
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints>
CeilOpInterface::getOpConstraints(mlir::tt::ttcore::GridAttr deviceGrid,
                                  llvm::ArrayRef<int64_t> inputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                  llvm::ArrayRef<int64_t> outputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpConstraints("CeilOpInterface", ::ttnn::ceil,
                                      deviceGrid, inputShape, inputLayout,
                                      outputShape, outputLayout);
#else
  return OpConstraints{};
...
llvm::Expected<size_t>
CeilOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                              llvm::ArrayRef<int64_t> outputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("CeilOpInterface", ::ttnn::ceil, inputShape,
                                  inputLayout, outputShape, outputLayout);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
...
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints>
SignOpInterface::getOpConstraints(mlir::tt::ttcore::GridAttr deviceGrid,
                                  llvm::ArrayRef<int64_t> inputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                  llvm::ArrayRef<int64_t> outputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpConstraints("SignOpInterface", ::ttnn::sign,
                                      deviceGrid, inputShape, inputLayout,
                                      outputShape, outputLayout);
#else
  return OpConstraints{};
...
llvm::Expected<size_t>
SignOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                              llvm::ArrayRef<int64_t> outputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("SignOpInterface", ::ttnn::sign, inputShape,
                                  inputLayout, outputShape, outputLayout);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
...
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints>
ErfOpInterface::getOpConstraints(mlir::tt::ttcore::GridAttr deviceGrid,
                                 llvm::ArrayRef<int64_t> inputShape,
                                 mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                 llvm::ArrayRef<int64_t> outputShape,
                                 mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
  ...
  return operation::getOpConstraints("ErfOpInterface", inputLayout.getContext(),
                                     deviceGrid, erfOpQuery);
#else
  return OpConstraints{};
#endif // TTMLIR_ENABLE_OPMODEL
}
...
llvm::Expected<size_t>
ErfOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                             mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                             llvm::ArrayRef<int64_t> outputShape,
                             mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  ...
  return operation::getOpRuntime("ErfOpInterface", erfOpQuery);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
}
...
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints>
ErfcOpInterface::getOpConstraints(mlir::tt::ttcore::GridAttr deviceGrid,
                                  llvm::ArrayRef<int64_t> inputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                  llvm::ArrayRef<int64_t> outputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
  ...
  return operation::getOpConstraints(
      "ErfcOpInterface", inputLayout.getContext(), deviceGrid, erfcOpQuery);
#else
  return OpConstraints{};
#endif // TTMLIR_ENABLE_OPMODEL
}
...
llvm::Expected<size_t>
ErfcOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                              llvm::ArrayRef<int64_t> outputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  ...
  return operation::getOpRuntime("ErfcOpInterface", erfcOpQuery);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
}
...
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints>
GeluOpInterface::getOpConstraints(mlir::tt::ttcore::GridAttr deviceGrid,
                                  llvm::ArrayRef<int64_t> inputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                  llvm::ArrayRef<int64_t> outputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
  ...
  return operation::getOpConstraints(
      "GeluOpInterface", inputLayout.getContext(), deviceGrid, geluOpQuery);
#else
  return OpConstraints{};
#endif // TTMLIR_ENABLE_OPMODEL
}
...
llvm::Expected<size_t>
GeluOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                              llvm::ArrayRef<int64_t> outputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  ...
  return operation::getOpRuntime("GeluOpInterface", geluOpQuery);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
}
...
// IsFiniteOp
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints> IsFiniteOpInterface::getOpConstraints(
    mlir::tt::ttcore::GridAttr deviceGrid, llvm::ArrayRef<int64_t> inputShape,
    mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
    llvm::ArrayRef<int64_t> outputShape,
    mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpConstraints("IsFiniteOpInterface", ::ttnn::isfinite,
                                      deviceGrid, inputShape, inputLayout,
                                      outputShape, outputLayout);
#else
  return OpConstraints{};
...
llvm::Expected<size_t>
IsFiniteOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                  llvm::ArrayRef<int64_t> outputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("IsFiniteOpInterface", ::ttnn::isfinite,
                                  inputShape, inputLayout, outputShape,
                                  outputLayout);
#else
  return llvm::createStringError("Not Implemented");
...
// LogicalNotOp
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints> LogicalNotOpInterface::getOpConstraints(
    mlir::tt::ttcore::GridAttr deviceGrid, llvm::ArrayRef<int64_t> inputShape,
    mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
    llvm::ArrayRef<int64_t> outputShape,
    mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
  ...
  return getEltwiseUnaryOpConstraints(
      "LogicalNotOpInterface", ::ttnn::logical_not, deviceGrid, inputShape,
      inputLayout, outputShape, outputLayout);
#else
  return OpConstraints{};
#endif // TTMLIR_ENABLE_OPMODEL
...
llvm::Expected<size_t> LogicalNotOpInterface::getOpRuntime(
    llvm::ArrayRef<int64_t> inputShape,
    mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
    llvm::ArrayRef<int64_t> outputShape,
    mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("LogicalNotOpInterface", ::ttnn::logical_not,
                                  inputShape, inputLayout, outputShape,
                                  outputLayout);
#else
  return llvm::createStringError("Not Implemented");
...
// BitwiseNotOp
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints> BitwiseNotOpInterface::getOpConstraints(
    mlir::tt::ttcore::GridAttr deviceGrid, llvm::ArrayRef<int64_t> inputShape,
    mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
    llvm::ArrayRef<int64_t> outputShape,
    mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpConstraints(
      "BitwiseNotOpInterface", ::ttnn::bitwise_not, deviceGrid, inputShape,
      inputLayout, outputShape, outputLayout);
#else
  return OpConstraints{};
#endif // TTMLIR_ENABLE_OPMODEL
...
llvm::Expected<size_t> BitwiseNotOpInterface::getOpRuntime(
    llvm::ArrayRef<int64_t> inputShape,
    mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
    llvm::ArrayRef<int64_t> outputShape,
    mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("BitwiseNotOpInterface", ::ttnn::bitwise_not,
                                  inputShape, inputLayout, outputShape,
                                  outputLayout);
#else
  return llvm::createStringError("Not Implemented");
...
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints>
NegOpInterface::getOpConstraints(mlir::tt::ttcore::GridAttr deviceGrid,
                                 llvm::ArrayRef<int64_t> inputShape,
                                 mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                 llvm::ArrayRef<int64_t> outputShape,
                                 mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpConstraints("NegOpInterface", ::ttnn::neg, deviceGrid,
                                      inputShape, inputLayout, outputShape,
                                      outputLayout);
#else
  return OpConstraints{};
...
llvm::Expected<size_t>
NegOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                             mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                             llvm::ArrayRef<int64_t> outputShape,
                             mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("NegOpInterface", ::ttnn::neg, inputShape,
                                  inputLayout, outputShape, outputLayout);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
...
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints>
AtanOpInterface::getOpConstraints(mlir::tt::ttcore::GridAttr deviceGrid,
                                  llvm::ArrayRef<int64_t> inputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                                  llvm::ArrayRef<int64_t> outputShape,
                                  mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpConstraints("AtanOpInterface", ::ttnn::atan,
                                      deviceGrid, inputShape, inputLayout,
                                      outputShape, outputLayout);
#else
  return OpConstraints{};
...
llvm::Expected<size_t>
AtanOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                              llvm::ArrayRef<int64_t> outputShape,
                              mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("AtanOpInterface", ::ttnn::atan, inputShape,
                                  inputLayout, outputShape, outputLayout);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
...
// Log1pOp
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints> Log1pOpInterface::getOpConstraints(
    mlir::tt::ttcore::GridAttr deviceGrid, llvm::ArrayRef<int64_t> inputShape,
    mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
    llvm::ArrayRef<int64_t> outputShape,
    mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpConstraints("Log1pOpInterface", ::ttnn::log1p,
                                      deviceGrid, inputShape, inputLayout,
                                      outputShape, outputLayout);
#else
  return OpConstraints{};
...
llvm::Expected<size_t>
Log1pOpInterface::getOpRuntime(llvm::ArrayRef<int64_t> inputShape,
                               mlir::tt::ttnn::TTNNLayoutAttr inputLayout,
                               llvm::ArrayRef<int64_t> outputShape,
                               mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  return getEltwiseUnaryOpRuntime("Log1pOpInterface", ::ttnn::log1p, inputShape,
                                  inputLayout, outputShape, outputLayout);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
...
// MorehCumSumOp
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints> MorehCumSumOpInterface::getOpConstraints(
    mlir::tt::ttcore::GridAttr deviceGrid, llvm::ArrayRef<int64_t> inputShape,
  ...
  return operation::getOpConstraints("MorehCumSumOpInterface",
                                     inputLayout.getContext(), deviceGrid,
                                     morehCumSumOpQuery);
#else
  return OpConstraints{};
...
llvm::Expected<size_t> MorehCumSumOpInterface::getOpRuntime(
    llvm::ArrayRef<int64_t> inputShape,
    mlir::tt::ttnn::TTNNLayoutAttr inputLayout, const int64_t dim,
    mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  ...
  return operation::getOpRuntime("MorehCumSumOpInterface", morehCumSumOpQuery);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
}
...
// RepeatInterleaveOp
//===----------------------------------------------------------------------===//
llvm::Expected<OpConstraints> RepeatInterleaveOpInterface::getOpConstraints(
    mlir::tt::ttcore::GridAttr deviceGrid, llvm::ArrayRef<int64_t> inputShape,
  ...
  return operation::getOpConstraints("RepeatInterleaveOpInterface",
                                     inputLayout.getContext(), deviceGrid,
...
llvm::Expected<size_t> RepeatInterleaveOpInterface::getOpRuntime(
    llvm::ArrayRef<int64_t> inputShape,
    mlir::tt::ttnn::TTNNLayoutAttr inputLayout, const unsigned int repeats,
    const int dim, mlir::tt::ttnn::TTNNLayoutAttr outputLayout) {
#ifdef TTMLIR_ENABLE_OPMODEL
  ...
  return operation::getOpRuntime("RepeatInterleaveOpInterface",
                                 repeatInterleaveOpQuery);
#else
  return llvm::createStringError("Not Implemented");
#endif // TTMLIR_ENABLE_OPMODEL
