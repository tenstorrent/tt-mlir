...
llvm::Expected<OpConstraints> OpModel<MaxPool2dWithIndicesOp>::getOpConstraints(
    ...
    llvm::ArrayRef<int32_t> kernelSize, llvm::ArrayRef<int32_t> stride,
    llvm::ArrayRef<int32_t> padding, llvm::ArrayRef<int32_t> dilation,
    bool ceilMode, bool inPlaceHalo, TTNNLayoutAttr outputLayout, bool deallocate_input,
    bool reallocate_halo_output, bool return_indices) {
  ...
  auto maxPool2DWithIndicesQuery = [=]() {
    return ::ttnn::graph::query_op_constraints(
        ...
        ceilMode, detail::getNullableMemoryConfig(outputLayout),
        std::nullopt /* applied_shard_scheme */, inPlaceHalo,
        deallocate_input /* deallocate_input */, reallocate_halo_output /* reallocate_halo_output */,
...
llvm::Expected<size_t> OpModel<MaxPool2dWithIndicesOp>::getOpRuntime(
    ...
    llvm::ArrayRef<int32_t> stride, llvm::ArrayRef<int32_t> padding,
    llvm::ArrayRef<int32_t> dilation, bool ceilMode, bool inPlaceHalo,
    TTNNLayoutAttr outputLayout, bool deallocate_input, bool reallocate_halo_output,
    bool return_indices) {
#ifdef TTMLIR_ENABLE_OPMODEL
  ::tt::tt_metal::distributed::MeshDevice *device =
      SingletonDeviceContext::getInstance().getDevice();
