...
auto createPrepareConvTranspose2dWeightsTuple(
    Tag tag, const ::tt::target::ttnn::PrepareConvTranspose2dWeightsOpT &opT,
  ...
  return std::make_tuple(
      *std::get<const ::ttnn::Tensor *>(weightTensor), params.inputMemoryConfig,
      ...
      params.computeConfig, params.sliceConfig, opT.mirror_kernel);
}
...
PrepareConvTranspose2dWeightsOpResult callPrepareConvTranspose2dWeights(
  ...
  PrepareConvTranspose2dWeightsResolvedParams params =
      resolvePrepareConvTranspose2dWeightsParams(opT, callType);

  auto makeTuple = [&](auto tag) {
    return createPrepareConvTranspose2dWeightsTuple(tag, opT, weightTensor,
                                                    targetDevice, params);
  };
  ...
  case CallType::QUERY_OP_RUNTIME: {
    ...
    response.error_message =
        "Runtime query not implemented for PrepareConvTranspose2dWeightsOp yet";
    return response;
  }
