...
const auto noop = [](const auto &lhs, const auto &rhs)
...
mlir::LogicalResult constFoldBinaryOp(
    mlir::Attribute lhsConst, mlir::Attribute rhsConst, mlir::Type resultType,
    llvm::SmallVectorImpl<mlir::OpFoldResult> &results,
    ComputeBinaryIntegerTy &&computeInt, ComputeBinaryFloatTy &&computeFloat) {
...
::mlir::LogicalResult mlir::tt::ttir::DivOp::fold(
  ...
  return constFoldBinaryOp(adaptor.getInputs()[0], adaptor.getInputs()[1],
                           getType(0), results, noop, std::divides<>());
}
...
::mlir::LogicalResult mlir::tt::ttir::RemainderOp::fold(
  ...
  return constFoldBinaryOp(
      adaptor.getInputs()[0], adaptor.getInputs()[1], getType(0), results, noop,
