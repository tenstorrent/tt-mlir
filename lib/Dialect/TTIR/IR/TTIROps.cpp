...
#if 0
  rewriter.create<::mlir::tt::ttir::GenericOp>(
      getLoc(), ValueRange(), getInputs(), getCbs(), getOutputs(), getGrid(),
      getIndexingMaps(), getIteratorTypes(), getOperandCbMapping());
  rewriter.replaceAllUsesWith(getResult(0), getOutputs()[0]);
  rewriter.eraseOp(*this);
#else
  // auto rankedTensorType =
  //     mlir::cast<::mlir::RankedTensorType>(getResult(0).getType());
