...
public:
  ...
  void runOnOperation() final {
    ...
    commutePatterns.add<TTIRCommuteTmsAboveElementwiseUnaryRewriter>(
        &getContext());
    commutePatterns.add<TTIRCommuteTmsAboveElementwiseBinaryRewriter>(
        &getContext());
    FrozenRewritePatternSet commutePatternSet(std::move(commutePatterns));

    RewritePatternSet erasePatterns(&getContext());
    erasePatterns.add<TTIREraseInverseTransposes>(&getContext());
    erasePatterns.add<TTIREraseInversePermutations>(&getContext());
    erasePatterns.add<TTIREraseInverseReshapes>(&getContext());
