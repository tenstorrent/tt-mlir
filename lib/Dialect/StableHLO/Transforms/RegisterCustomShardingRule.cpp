...
public:
  ...
  void runOnOperation() final {
    ...
    // Insert sharding constraints on reshape ops that involve dimension
    // splits/merges. This forces Shardy to replicate sharded dimensions
    // before the reshape, preventing global-vs-local shape mismatches.
