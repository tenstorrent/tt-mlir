...
getMoeGptShardingRule(mlir::stablehlo::CustomCallOp op) {
  ...
  builder.addFactor({3, mlir::sdy::kNullDim, mlir::sdy::kNullDim,
                     mlir::sdy::kNullDim, 1, mlir::sdy::kNullDim,
                     mlir::sdy::kNullDim, mlir::sdy::kNullDim},
                    {mlir::sdy::kNullDim, mlir::sdy::kNullDim,
                     mlir::sdy::kNullDim, mlir::sdy::kNullDim,
                     mlir::sdy::kNullDim},
  ...
  builder.addFactor(
      {mlir::sdy::kNullDim, 3, 3, mlir::sdy::kNullDim, mlir::sdy::kNullDim,
  ...
  builder.addFactor({mlir::sdy::kNullDim, mlir::sdy::kNullDim,
                     mlir::sdy::kNullDim, mlir::sdy::kNullDim,
                     mlir::sdy::kNullDim, mlir::sdy::kNullDim, 1,
                     mlir::sdy::kNullDim},
                    {mlir::sdy::kNullDim, mlir::sdy::kNullDim,
                     mlir::sdy::kNullDim, mlir::sdy::kNullDim,
                     mlir::sdy::kNullDim},
...
getSelectiveReduceCombineShardingRule(mlir::stablehlo::CustomCallOp op) {
  ...
  builder.addFactor(
      {mlir::sdy::kNullDim, 3, 3, mlir::sdy::kNullDim}, {0}, kDim,
      mlir::sdy::FactorType::kNeedReplication,
      /*isBlocked=*/true);

  builder.addFactor(
      {inputSDim, 2, 2, mlir::sdy::kNullDim}, {resultSDim}, sDim,
                    mlir::sdy::FactorType::kNeedReplication,
                    /*isBlocked=*/true);

  builder.addFactor(
      {inputBDDim, 1, 1, mlir::sdy::kNullDim}, {resultBDDim}, bdDim,
      mlir::sdy::FactorType::kNeedReplication,
      /*isBlocked=*/true);
