...
void d2m::GenericOp::build(
  ...
  llvm::SmallVector<Type> blockTypes = llvm::map_to_vector(
      llvm::enumerate(TypeRange(state.operands)),
      [&](auto indexedPair) -> Type {
...
SmallVector<ttcore::MemorySpace>
d2m::GenericOp::getBlockArgumentMemorySpaces() {
