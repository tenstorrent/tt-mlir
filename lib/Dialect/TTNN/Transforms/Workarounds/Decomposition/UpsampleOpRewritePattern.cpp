...
LogicalResult UpsampleOpBilinearPaddingRewritePattern::matchAndRewrite(
  ...
  ttnn::TTNNLayoutAttr paddedLayout = ttnn::TTNNLayoutAttr::Builder(
      mlir::cast<ttnn::TTNNLayoutAttr>(inputType.getEncoding()), paddedShape);
  ...
  ttnn::TTNNLayoutAttr upsamplePaddedLayout = ttnn::TTNNLayoutAttr::Builder(
