...
#define GEN_PASS_DEF_TTNNUNIQUEOPLOCATIONS
#include "ttmlir/Dialect/TTNN/Transforms/Passes.h.inc"

namespace {

class TTNNUniqueOpLocations
    : public impl::TTNNUniqueOpLocationsBase<TTNNUniqueOpLocations> {

public:
  TTNNUniqueOpLocations() = default;
