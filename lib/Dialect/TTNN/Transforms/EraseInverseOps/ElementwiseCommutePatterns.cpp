...
class TTNNCommuteTmsThroughElementwiseRewriter
    : public TTNNCommuteOpInterfaceRewritePattern<
          TMOpType, ElementwiseInterfaceType, commuteDirection> {
public:
  using TTNNCommuteOpInterfaceRewritePattern<
      TMOpType, ElementwiseInterfaceType,
      commuteDirection>::TTNNCommuteOpInterfaceRewritePattern;
...
private:
  ...
  bool isCommuteDownwardsFavorable(ElementwiseInterfaceType op,
    ...
    // Commuting downwards is favorable if all other operands are an identical
    // TM.
    for (auto operand : op->getOperands()) {
...
void populateElementwiseCommutePatterns(MLIRContext *ctx,
  ...
  patterns.add<
      TTNNCommuteTmsThroughElementwiseRewriter<PermuteOp, ElementwiseUnary,
                                               commuteDirection>,
      TTNNCommuteTmsThroughElementwiseRewriter<ReshapeOp, ElementwiseUnary,
                                               commuteDirection>,
      TTNNCommuteTmsThroughElementwiseRewriter<PermuteOp, ElementwiseBinary,
                                               commuteDirection>,
      TTNNCommuteTmsThroughElementwiseRewriter<ReshapeOp, ElementwiseBinary,
