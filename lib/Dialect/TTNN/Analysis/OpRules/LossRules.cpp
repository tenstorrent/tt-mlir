...
LayoutFilterFn
CrossEntropyRuleBook::getInputLayoutFilter(unsigned operandIdx) const {
  if (operandIdx == 0) {
...
bool CrossEntropyRuleBook::shouldExploreReshards() const { return false; }

bool CrossEntropyRuleBook::generatesRowMajorInputSiblings(
    unsigned operandIdx) const {
  return operandIdx == 1;
}

OutputHints CrossEntropyRuleBook::getOutputHints(
