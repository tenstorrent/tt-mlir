...
Conv2dConfigGenerator::Conv2dConfigGenerator(
  ...
  if (searchSpace.isPreprocessWeightsOnDeviceSetForSearch() &&
    ...
    activeSearchFields.emplace_back(
        ...
        [](Conv2dConfigAttr attr,
           const Conv2dConfigGeneratorSearchFieldInfo &info)
            -> Conv2dConfigAttr {
          return attr.withPreprocessWeightsOnDevice(info.getCurrentBool());
        });
  }
  if (searchSpace.isAlwaysPreprocessWeightsSetForSearch() &&
    ...
    activeSearchFields.emplace_back(
        ...
        [](Conv2dConfigAttr attr,
           const Conv2dConfigGeneratorSearchFieldInfo &info)
            -> Conv2dConfigAttr {
          return attr.withAlwaysPreprocessWeights(info.getCurrentBool());
        });
  }
