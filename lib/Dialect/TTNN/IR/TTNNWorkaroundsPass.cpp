...
TTNNOperandsWorkarounds
TTNNOperandsWorkaroundsFactory::
    createAllToAllCombineOpOperandsWorkarounds() {
  TTNNOperandWorkarounds rowMajorBf16Workaround;
  rowMajorBf16Workaround.tensorLayoutWorkaround = Layout::RowMajor;
  rowMajorBf16Workaround.tensorDataTypeWorkaround =
      ttcore::DataType::BFloat16;
