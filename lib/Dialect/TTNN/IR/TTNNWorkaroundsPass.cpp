...
TTNNOperandsWorkaroundsFactory::createZerosOpOperandsWorkarounds(
  ...
  mlir::ttcore::DataType dataType =
      mlir::ttcore::elementTypeToDataType(outputType.getElementType());
  if (dataType == mlir::ttcore::DataType::Int32) {
...
TTNNOperandsWorkaroundsFactory::createMeshShardOpOperandsWorkarounds(
    mlir::ttcore::MeshShardType shardType) {
  wa::TTNNOperandWorkarounds sysMemWorkaround;
  if (shardType != mlir::ttcore::MeshShardType::Identity) {
...
TTNNOperandsWorkaroundsFactory::createReshapeOpOperandsWorkarounds(
  ...
  mlir::ttcore::DataType dataType =
      mlir::ttcore::elementTypeToDataType(inputElementType);
  if (dataType == mlir::ttcore::DataType::Int32) {
    typeWorkarounds.tensorDataTypeWorkaround = mlir::ttcore::DataType::Float32;
  }
  return TTNNOperandsWorkarounds::createEmptyTTNNOperandsWorkarounds()
...
TTNNOperandsWorkaroundsFactory::createUpdateCacheOpOperandsWorkarounds(
  ...
  TTNNOperandWorkarounds typeWorkarounds;
  mlir::ttcore::DataType dataType =
      mlir::ttcore::elementTypeToDataType(updateIndexElementType);
  if (dataType == mlir::ttcore::DataType::Int32) {
    typeWorkarounds.tensorDataTypeWorkaround = mlir::ttcore::DataType::UInt32;
  }
  return TTNNOperandsWorkarounds::createEmptyTTNNOperandsWorkarounds()
...
static std::optional<mlir::ttcore::DataType>
binaryOpDTypeWorkaround(mlir::Operation *op, mlir::Type elementType) {
  mlir::ttcore::DataType dType =
      mlir::ttcore::elementTypeToDataType(elementType);

  if (isa<ttnn::AddOp, ttnn::SubtractOp>(op)) {
    if (dType == mlir::ttcore::DataType::Float32 ||
        dType == mlir::ttcore::DataType::BFloat16 ||
        dType == mlir::ttcore::DataType::BFP_BFloat8 ||
        dType == mlir::ttcore::DataType::BFP_BFloat4) {
      return {};
    }
    if (dType == mlir::ttcore::DataType::Int32) {
      ...
      if (lhsType.getShape() != rhsType.getShape()) {
        return mlir::ttcore::DataType::BFloat16;
      }
      return {};
    }
    return mlir::ttcore::DataType::BFloat16;
  ...
  if (isa<ttnn::BitwiseAndOp, ttnn::BitwiseOrOp, ttnn::BitwiseXorOp>(op)) {
    ...
    return mlir::ttcore::DataType::Int32;
  }
...
TTNNOperandsWorkaroundsFactory::createTanhOpOperandsWorkarounds() {
  ...
  operandWorkaround.tensorDataTypeWorkaround = mlir::ttcore::DataType::BFloat16;
