...
void createTTNNPipelineTTIRPasses(
  ...
  mlir::tt::TTPopulateArgumentTypesOptions populateArgumentTypesOptions;
  populateArgumentTypesOptions.argumentTypeMap = options.argumentTypeMap;
  pm.addPass(
      mlir::tt::createTTPopulateArgumentTypes(populateArgumentTypesOptions));
