...
toTTNNBufferType(const mlir::ttcore::MemorySpace memorySpace) {
  switch (memorySpace) {
  case mlir::ttcore::MemorySpace::System:
  case mlir::ttcore::MemorySpace::SystemMMIO:
    return BufferType::SystemMemory;
  case mlir::ttcore::MemorySpace::DeviceDRAM:
    return BufferType::DRAM;
  case mlir::ttcore::MemorySpace::DeviceL1:
    return BufferType::L1;
  case mlir::ttcore::MemorySpace::RegisterDst:
...
mlir::ttcore::MemorySpace
toTTMemorySpace(const mlir::tt::ttnn::BufferType bufferType) {
  switch (bufferType) {
  case ttnn::BufferType::SystemMemory:
    return mlir::ttcore::MemorySpace::System;
  case ttnn::BufferType::DRAM:
    return mlir::ttcore::MemorySpace::DeviceDRAM;
  case ttnn::BufferType::L1:
    return mlir::ttcore::MemorySpace::DeviceL1;
...
RankedTensorType RankedTensorTypeFactory::create(RankedTensorType tensorType,
  ...
  ttcore::DataType dataType =
      mlir::ttcore::elementTypeToDataType(tensorType.getElementType());
  Type memrefElementType =
...
Type getElementType(MLIRContext *context, Layout tensorLayout,
  ...
  return tensorLayout == Layout::Tile
             ...
             : mlir::ttcore::dataTypeToElementType(context, dataType);
}
