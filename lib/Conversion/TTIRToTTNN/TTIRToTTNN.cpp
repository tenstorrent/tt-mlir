...
private:
  ...
  // The decode kernel also requires k_chunk_size % 32 == 0, where k_chunk_size
  // is the largest power-of-2 divisor of the key sequence length (capped at
  // 512). This is only guaranteed when kSeqLen is divisible by 32.
