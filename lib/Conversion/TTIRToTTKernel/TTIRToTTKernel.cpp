...
using ComputeOpMap = OpMap<
  ...
  // Reductions FPU
  std::pair<ttir::TileReduceSumOp, std::pair<ttkernel::ReduceInitOp, ttkernel::ReduceTileOp>>,
  std::pair<ttir::TileReduceMaxOp, std::pair<ttkernel::ReduceInitOp, ttkernel::ReduceTileOp>>,
...
void populateTTIRToTTKernelPatterns(
  ...
  patterns.add<ttkernel::TTIRKernelFunctionArgsRewriter,
               ...
               // Reductions FPU.
               ttkernel::TTIRFPUOpsRewriter<ttir::TileReduceSumOp>,
               ttkernel::TTIRFPUOpsRewriter<ttir::TileReduceMaxOp>,
