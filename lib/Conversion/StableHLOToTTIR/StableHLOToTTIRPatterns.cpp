...
public:
  ...
  matchAndRewrite(mlir::stablehlo::SelectAndScatterOp srcOp,
    ...
    auto scatterResult = ttir::utils::createDPSOp<ttir::ScatterOp>(
    ...
    if (cacheUpdateInputShape[0] != 1) {
      ...
      if (batchSize > 1) {
        ...
        for (int32_t batchOffset = 0; batchOffset < batchSize; batchOffset++) {
          ...
          // Create slice op.
          auto slicedUpdates =
              ttir::utils::createDPSOp<mlir::tt::ttir::SliceStaticOp>(
      ...
      if (batchSize > 1) {
        ...
        updates = ttir::utils::createDPSOp<mlir::tt::ttir::PermuteOp>(
  ...
  matchAndRewrite(mlir::stablehlo::ScatterOp srcOp,
    ...
    if (scatterDimsToOperandDims.size() == 1) {
      ...
      ttir::utils::replaceOpWithNewDPSOp<ttir::ScatterOp>(
          rewriter, srcOp, outputType, inputTensor, finalIndexTensor,
    ...
    if (scatterDimsToOperandDims.size() > 1) {
      ...
      Value scatterResult = ttir::utils::createDPSOp<ttir::ScatterOp>(
