...
public:
  ...
  using Adaptor = typename tt::ttnn::AvgPool2dOp::Adaptor;

  LogicalResult
  matchAndRewrite(tt::ttnn::AvgPool2dOp srcOp, Adaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
    ...
    llvm::SmallVector<mlir::Attribute> args{
        ...
        emitter.emit(std::nullopt /*divisor_override*/),
...
public:
  ...
  using Adaptor = typename tt::ttnn::MaxPool2dOp::Adaptor;

  LogicalResult
  matchAndRewrite(tt::ttnn::MaxPool2dOp srcOp, Adaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
