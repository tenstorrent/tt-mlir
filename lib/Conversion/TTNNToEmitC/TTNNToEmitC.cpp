...
// AllGatherMinimalMatmulAsyncOp conversion pattern
//
namespace {
...
void populateTTNNToEmitCPatterns(mlir::MLIRContext *ctx,
  ...
  patterns.add<AllGatherMinimalMatmulAsyncOpConversionPattern>(typeConverter,
                                                               ctx);
