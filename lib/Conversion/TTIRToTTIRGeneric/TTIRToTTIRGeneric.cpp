...
protected:
  ...
  toLayoutOperands(mlir::ConversionPatternRewriter &rewriter,
    ...
    for (Value value : operands) {
      ...
      fprintf(stderr, "++ Converting layout of operand: ");
      value.dump();
      ...
      fprintf(stderr, "++ Generated MetalLayoutAttr: ");
      layout.dump();
      ...
      fprintf(stderr, "++ Derived physicalShape");
  ...
  getBroadcastAffineMapsArray(mlir::OpBuilder &builder, ArrayRef<Value> inputs,
    ...
    assert(outRank == std::max(in0Rank, in1Rank));
