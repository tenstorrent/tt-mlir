...
private:
  ...
  rewritePool2d(ttir::PoolingOp op, OpAdaptor adaptor,
    ...
    // The padding attribute in PoolingOp will be in the order of [..., top,
    // left, bottom, right, ...] MaxPool2dOp and AvgPool2dOp expect the padding
    // to be in the order of [top, left, bottom, right]
    auto paddingAttr = rewriter.getDenseI32ArrayAttr({
