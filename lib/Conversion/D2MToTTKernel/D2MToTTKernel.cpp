...
using ComputeOpMap = OpMap<
  // Elementwise FPU.
  std::pair<d2m::TileAddOp,         std::pair<ttkernel::AddTilesInitOp,            ttkernel::AddTilesOp>>,
  ...
  std::pair<d2m::TileMulOp,         std::pair<ttkernel::MulTilesInitOp,            ttkernel::MulTilesOp>>,
  std::pair<d2m::TileSubOp,         std::pair<ttkernel::SubTilesInitOp,            ttkernel::SubTilesOp>>,
  ...
  std::pair<d2m::TileSubBinaryOp,   std::pair<ttkernel::SubBinaryTilesInitOp,      ttkernel::SubBinaryTilesOp>>,
...
public:
  ...
  matchAndRewrite(ConcreteOp op, typename ConcreteOp::Adaptor adaptor,
    ...
    // per compute kernel.
    if constexpr (!std::is_same_v<ConcreteOp, d2m::TileSubBinaryOp>) {
...
void populateD2MToTTKernelPatterns(
  ...
  patterns.add<ttkernel::D2MKernelFunctionArgsRewriter,
               ...
               // Elementwise FPU.
               ttkernel::D2MFPUOpsRewriter<d2m::TileAddOp>,
               ttkernel::D2MFPUOpsRewriter<d2m::TileMatmulOp>,
               ttkernel::D2MFPUOpsRewriter<d2m::TileMatmulBlockOp>,
               ttkernel::D2MFPUOpsRewriter<d2m::TileMulOp>,
               ttkernel::D2MFPUOpsRewriter<d2m::TileSubOp>,
               ...
               // Elementwise SFPU Binary.
               ttkernel::D2MSFPUOpsRewriter<d2m::TileSubBinaryOp>,
