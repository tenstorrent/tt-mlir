...
typedef enum OrtErrorCode {
    ...
    ORT_NO_SUCHFILE,
    /**
     * Legacy/unused but retained for ABI compatibility. Historically returned when a model could not be found by name
     * in the ONNX Runtime Server (removed in 2022).
     */
    ORT_NO_MODEL,
    /**
