...
_STRUCTURAL = [
    ...
    tt_onnx.make_node("Concat", ["t", "t"], ["y"], axis=0),
]
...
_CASES = {
    ...
    "cast_f32_i32": (
        [tt_onnx.make_node("Cast", ["a"], ["y"], to=tt_onnx.DType.I32)],
        tt_onnx.DType.F32,
        tt_onnx.DType.I32,
        1,
        0.0,
    ...
    "cast_i32_f32": (
        [tt_onnx.make_node("Cast", ["a"], ["y"], to=tt_onnx.DType.F32)],
        tt_onnx.DType.I32,
        tt_onnx.DType.F32,
        1,
        1e-5,
    ...
    "cast_f32_i64": (
        [tt_onnx.make_node("Cast", ["a"], ["y"], to=tt_onnx.DType.I64)],
        tt_onnx.DType.F32,
        tt_onnx.DType.I64,
        1,
        0.0,
...
def test_dtype_support(case: str) -> None:
    ...
    model = tt_onnx.make_model(
        nodes,
        [tt_onnx.vi(name, [16, 16], in_dtype) for name in inputs],
        [tt_onnx.vi("y", None, out_dtype)],
    )
...
def test_integer_matmul_div_fail_session_creation(op: str) -> None:
    ...
    model = tt_onnx.make_model(
        [tt_onnx.make_node(op, ["a", "b"], ["y"])],
        [
            tt_onnx.vi("a", [16, 16], tt_onnx.DType.I32),
            tt_onnx.vi("b", [16, 16], tt_onnx.DType.I32),
        ],
