...
_STRUCTURAL = [
    make_node("Transpose", ["a"], ["t"], perm=[1, 0]),
    make_node("Concat", ["t", "t"], ["y"], axis=0),
]
...
_CASES = {
    ...
    "cast_i32_f32": (
        [make_node("Cast", ["a"], ["y"], to=DType.F32)],
        DType.I32,
        DType.F32,
        1,
        1e-5,
    ...
    "cast_f32_i64": (
        [make_node("Cast", ["a"], ["y"], to=DType.I64)],
        DType.F32,
        DType.I64,
        1,
        0.0,
