# Bundle tt-metal's Python modules (tracy CLI and ttnn) into tt-kurbla.
#
...
#
# Unconditional: bundling is always-on, independent of TT_KURBLA_TRACY_ZONES.

function(_tt_kurbla_add_bundle_target target_name src lnk)
...
_tt_kurbla_add_bundle_target(bundle-tracy
    "${TT_KURBLA_TTMLIR_INSTALL_DIR}/tt-metal/tools/tracy"
    "${PROJECT_SOURCE_DIR}/python/tracy/_original"
)

_tt_kurbla_add_bundle_target(bundle-ttnn
    "${TT_KURBLA_TTMLIR_INSTALL_DIR}/tt-metal/ttnn/ttnn"
