...
TT_CRANK_API const ::tt::runtime::Device &runtime_device();

// Number of physical chips available.
TT_CRANK_API std::uint32_t runtime_device_num_chips();
...
TT_CRANK_API void open_runtime_device_mesh(std::uint32_t rows, std::uint32_t cols);
...
TT_CRANK_API const std::vector<std::uint32_t> &runtime_device_mesh_shape();
...
TT_CRANK_API std::uint32_t runtime_device_mesh_size();
...
TT_CRANK_API const ::tt::runtime::MeshFabricConfig &runtime_mesh_fabric_config();

// Close the mesh device if open.
TT_CRANK_API void close_runtime_device_mesh();

// Current architecture.
TT_CRANK_API mlir::tt::ttcore::Arch arch();

// System descriptor.
TT_CRANK_API const ::tt::runtime::SystemDesc &sys_desc();
