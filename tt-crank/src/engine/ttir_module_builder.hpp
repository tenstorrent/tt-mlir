...
TT_KURBLA_API mlir::Type to_mlir_element_type(mlir::MLIRContext &ctx, ::tt::target::DataType dtype);
...
class TT_KURBLA_API ModuleBuilder {
public:
...
TT_KURBLA_API llvm::SmallVector<std::int64_t> broadcast_shape(llvm::ArrayRef<std::int64_t> lhs,
                                                              llvm::ArrayRef<std::int64_t> rhs);

// Emit TTIR for `lhs + alpha * rhs`. `lhs` and `rhs` must already share an
// element type.
TT_KURBLA_API mlir::Value build_add(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs, double alpha = 1.0);

// Emit TTIR for `lhs @ rhs` (2D matrix multiply). `lhs` and `rhs` must
// already share an element type and be 2D ranked tensors.
TT_KURBLA_API mlir::Value build_mm(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);
...
TT_KURBLA_API mlir::Value build_addmm(ModuleBuilder &mb, mlir::Value bias, mlir::Value mat1, mlir::Value mat2,
                                      double beta = 1.0, double alpha = 1.0);

// Emit TTIR for 2D transpose (aten::t): swaps dim 0 and dim 1.
TT_KURBLA_API mlir::Value build_t(ModuleBuilder &mb, mlir::Value input);

// Emit TTIR for element-wise ReLU.
TT_KURBLA_API mlir::Value build_relu(ModuleBuilder &mb, mlir::Value input);

// Emit TTIR for `lhs - alpha * rhs`. Same type rules as build_add.
TT_KURBLA_API mlir::Value build_sub(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs, double alpha = 1.0);

// Emit TTIR for element-wise `lhs * rhs`. Inputs must share element type.
TT_KURBLA_API mlir::Value build_mul(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);

// Emit TTIR for element-wise reciprocal square root.
TT_KURBLA_API mlir::Value build_rsqrt(ModuleBuilder &mb, mlir::Value input);

// Emit TTIR for tensor reshape. `new_shape` must already have any -1 resolved;
// total element count must match the input.
TT_KURBLA_API mlir::Value build_reshape(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<std::int64_t> new_shape);
...
TT_KURBLA_API mlir::Value build_mean(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<std::int64_t> dims,
                                     bool keepdim);

// Emit TTIR for sum reduction along `dims` (negative dims are normalised
// against the input rank). Empty `dims` reduces over all dimensions.
// `keepdim` controls whether reduced dimensions are retained as size-1.
TT_KURBLA_API mlir::Value build_sum(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<std::int64_t> dims,
                                    bool keepdim);
...
TT_KURBLA_API mlir::Value build_cumsum(ModuleBuilder &mb, mlir::Value input, int64_t dim);
...
TT_KURBLA_API mlir::Value build_threshold_backward(ModuleBuilder &mb, mlir::Value grad_output, mlir::Value self,
                                                   double threshold);
...
TT_KURBLA_API mlir::Value build_mse_loss(ModuleBuilder &mb, mlir::Value self, mlir::Value target,
...
TT_KURBLA_API mlir::Value build_mse_loss_backward(ModuleBuilder &mb, mlir::Value grad_output, mlir::Value self,
...
// creation ops.
TT_KURBLA_API mlir::Value build_zeros(ModuleBuilder &mb, llvm::ArrayRef<int64_t> shape, mlir::Type element_type);
TT_KURBLA_API mlir::Value build_ones(ModuleBuilder &mb, llvm::ArrayRef<int64_t> shape, mlir::Type element_type);
TT_KURBLA_API mlir::Value build_full(ModuleBuilder &mb, llvm::ArrayRef<int64_t> shape, double value,
...
TT_KURBLA_API mlir::Value build_all_reduce(ModuleBuilder &mb, mlir::Value input, const std::string &reduce_op,
...
TT_KURBLA_API mlir::Value build_all_gather(ModuleBuilder &mb, mlir::Value input, std::int64_t group_size,
                                           std::uint32_t cluster_axis);
...
TT_KURBLA_API mlir::Value build_reduce_scatter(ModuleBuilder &mb, mlir::Value input, std::int64_t group_size,
...
TT_KURBLA_API mlir::Value scale_tensor(ModuleBuilder &mb, mlir::Value tensor, double value);

// Emit TTIR for tensor dimension permutation. `permutation[i]` gives the
// source dimension index for output dimension `i`.
TT_KURBLA_API mlir::Value build_permute(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<int64_t> permutation);
...
TT_KURBLA_API mlir::Value build_max_pool2d(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<int64_t> kernel_size,
...
TT_KURBLA_API mlir::Value build_conv2d(ModuleBuilder &mb, mlir::Value input, mlir::Value weight, mlir::Value bias,
                                       llvm::ArrayRef<int64_t> stride, llvm::ArrayRef<int64_t> padding,
                                       llvm::ArrayRef<int64_t> dilation, int64_t groups);
...
TT_KURBLA_API mlir::Value build_sin(ModuleBuilder &mb, mlir::Value input);

// Emit TTIR for element-wise negation.
TT_KURBLA_API mlir::Value build_neg(ModuleBuilder &mb, mlir::Value input);

// Emit TTIR for element-wise natural logarithm.
TT_KURBLA_API mlir::Value build_log(ModuleBuilder &mb, mlir::Value input);

// Emit TTIR for element-wise natural exponential.
TT_KURBLA_API mlir::Value build_exp(ModuleBuilder &mb, mlir::Value input);
...
TT_KURBLA_API mlir::Value build_log1p(ModuleBuilder &mb, mlir::Value input);
...
TT_KURBLA_API mlir::Value build_reciprocal(ModuleBuilder &mb, mlir::Value input);
...
TT_KURBLA_API mlir::Value build_sigmoid(ModuleBuilder &mb, mlir::Value input);
...
TT_KURBLA_API mlir::Value build_gelu(ModuleBuilder &mb, mlir::Value input);

// Emit TTIR for element-wise `lhs / rhs`. Inputs must share element type.
TT_KURBLA_API mlir::Value build_div(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);
...
TT_KURBLA_API mlir::Value build_floor_divide(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);
...
TT_KURBLA_API mlir::Value build_clamp(ModuleBuilder &mb, mlir::Value input, std::optional<double> min_val,
                                      std::optional<double> max_val);

// Emit TTIR for element-wise `lhs ^ rhs`. Inputs must share element type.
TT_KURBLA_API mlir::Value build_pow(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);
...
TT_KURBLA_API mlir::Value build_softmax(ModuleBuilder &mb, mlir::Value input, int64_t dim);
...
TT_KURBLA_API mlir::Value build_argmax(ModuleBuilder &mb, mlir::Value input, std::optional<int64_t> dim, bool keepdim);
...
TT_KURBLA_API mlir::Value build_unsqueeze(ModuleBuilder &mb, mlir::Value input, int64_t dim);
...
TT_KURBLA_API mlir::Value build_squeeze(ModuleBuilder &mb, mlir::Value input, int64_t dim);
...
TT_KURBLA_API mlir::Value build_transpose(ModuleBuilder &mb, mlir::Value input, int64_t dim0, int64_t dim1);
...
TT_KURBLA_API mlir::Value build_broadcast(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<int64_t> target_shape);
...
TT_KURBLA_API mlir::Value build_cat(ModuleBuilder &mb, llvm::ArrayRef<mlir::Value> inputs, int64_t dim);
...
TT_KURBLA_API mlir::Value build_slice(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<int64_t> begins,
...
TT_KURBLA_API mlir::Value build_pad(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<std::int64_t> low,
...
TT_KURBLA_API mlir::Value build_arange(ModuleBuilder &mb, int64_t start, int64_t end, int64_t step, mlir::Type dtype);
...
TT_KURBLA_API mlir::Value build_linear(ModuleBuilder &mb, mlir::Value input, mlir::Value weight, mlir::Value bias);
...
TT_KURBLA_API mlir::Value build_matmul(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);
...
TT_KURBLA_API std::pair<std::optional<mlir::Value>, std::optional<mlir::Value>>
...
TT_KURBLA_API std::tuple<std::optional<mlir::Value>, std::optional<mlir::Value>, std::optional<mlir::Value>>
...
TT_KURBLA_API mlir::Value build_where(ModuleBuilder &mb, mlir::Value condition, mlir::Value true_val,
...
TT_KURBLA_API mlir::Value build_tril(ModuleBuilder &mb, mlir::Value input, int64_t diagonal);
...
TT_KURBLA_API mlir::Value build_isneginf(ModuleBuilder &mb, mlir::Value input);
...
// Bool (i1).
TT_KURBLA_API mlir::Value build_all(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<int64_t> dims, bool keepdim);
TT_KURBLA_API mlir::Value build_any(ModuleBuilder &mb, mlir::Value input, llvm::ArrayRef<int64_t> dims, bool keepdim);
...
TT_KURBLA_API mlir::Value build_le(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);

// Emit TTIR for element-wise less-than comparison:
//   result[i] = (lhs[i] < rhs[i])
// `lhs` and `rhs` must share element type — callers must promote first.
// Output is Bool (i1), broadcast-shaped from lhs and rhs.
TT_KURBLA_API mlir::Value build_lt(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);

// Emit TTIR for element-wise greater-than comparison:
//   result[i] = (lhs[i] > rhs[i])
// `lhs` and `rhs` must share element type — callers must promote first.
// Output is Bool (i1), broadcast-shaped from lhs and rhs.
TT_KURBLA_API mlir::Value build_gt(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);

// Emit TTIR for element-wise greater-than-or-equal comparison:
//   result[i] = (lhs[i] >= rhs[i])
// `lhs` and `rhs` must share element type — callers must promote first.
// Output is Bool (i1), broadcast-shaped from lhs and rhs.
TT_KURBLA_API mlir::Value build_ge(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);

// Emit TTIR for element-wise equality comparison:
//   result[i] = (lhs[i] == rhs[i])
// `lhs` and `rhs` must share element type — callers must promote first.
// Output is Bool (i1), broadcast-shaped from lhs and rhs.
TT_KURBLA_API mlir::Value build_eq(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);

// Emit TTIR for element-wise inequality comparison:
//   result[i] = (lhs[i] != rhs[i])
// `lhs` and `rhs` must share element type — callers must promote first.
// Output is Bool (i1), broadcast-shaped from lhs and rhs.
TT_KURBLA_API mlir::Value build_ne(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);
...
TT_KURBLA_API mlir::Value build_bitwise_and(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);

// Emit TTIR for element-wise bitwise OR:
//   result[i] = lhs[i] | rhs[i]
// `lhs` and `rhs` must share element type — callers must promote first. Output
// keeps that element type (Bool operands give logical OR).
TT_KURBLA_API mlir::Value build_bitwise_or(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);

// Emit TTIR for element-wise bitwise NOT:
//   result[i] = ~input[i]
// Output keeps the input element type (Bool operands give logical NOT).
TT_KURBLA_API mlir::Value build_bitwise_not(ModuleBuilder &mb, mlir::Value input);
...
TT_KURBLA_API mlir::Value build_logical_and(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);
TT_KURBLA_API mlir::Value build_logical_or(ModuleBuilder &mb, mlir::Value lhs, mlir::Value rhs);
TT_KURBLA_API mlir::Value build_logical_not(ModuleBuilder &mb, mlir::Value input);
...
TT_KURBLA_API mlir::Value build_index_copy(ModuleBuilder &mb, mlir::Value input, int64_t dim, mlir::Value index,
                                           mlir::Value source);
...
TT_KURBLA_API mlir::Value build_sdpa(ModuleBuilder &mb, mlir::Value query, mlir::Value key, mlir::Value value,
