...
echo "Run Optimizer LLM Blocks and Layers Perf Tests"
llvm-lit -v --xunit-xml-output ${TEST_REPORT_PATH%_*}_llm_blocks_and_layers_perf_tests_${TEST_REPORT_PATH##*_} --param TTMLIR_ENABLE_OPTIMIZER_MODELS_PERF_TESTS=1 $BUILD_DIR/test/ttmlir/Silicon/TTNN/n150/optimizer/llm_blocks_and_layers_perf_tests
