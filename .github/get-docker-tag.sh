...
DOCKERFILE_HASH_FILES=".github/Dockerfile.base .github/Dockerfile.ci .github/Dockerfile.ird env/CMakeLists.txt env/build_venv.sh env/build-requirements.txt env/patches/shardy.patch"
