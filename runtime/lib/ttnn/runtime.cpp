...
createOwnedTTNNTensor(const void *data, const std::vector<std::uint32_t> &shape,
  ...
  ::ttnn::DataType ttnnDataType = unifiedOpLib::operations::utils::toTTNNDataType(dataTypeToUse);
...
Layout getLayout(Binary executableHandle, std::uint32_t programIndex,
  ...
  ::ttnn::DataType inputDataType = unifiedOpLib::operations::utils::toTTNNDataType(
