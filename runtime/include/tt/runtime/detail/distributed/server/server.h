...
struct AwaitingResponseQueueEntry {
  ...
  std::tuple<std::unique_ptr<std::vector<SharedHandle>>,
...
public:
  ...
  void setClientShutdownTimeout(const std::chrono::seconds &timeout);
...
private:
  ...
  std::chrono::seconds clientShutdownTimeout_{60};
