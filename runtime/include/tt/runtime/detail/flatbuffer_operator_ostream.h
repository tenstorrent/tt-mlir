...
#ifndef TT_RUNTIME_DETAIL_FLATBUFFER_OPERATOR_OSTREAM
#define TT_RUNTIME_DETAIL_FLATBUFFER_OPERATOR_OSTREAM
...
std::ostream &print(std::ostream &os, const FlatbufferT &f) {
  ...
  ::flatbuffers::Parser const &parser = getParser<Schema>();
  std::string json;
...
#endif // TT_RUNTIME_DETAIL_FLATBUFFER_OPERATOR_OSTREAM
