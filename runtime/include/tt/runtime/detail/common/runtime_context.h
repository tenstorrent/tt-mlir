...
public:
  ...
  ::tt::target::FabricConfig getCurrentFabricConfig() const;
  void setCurrentFabricConfig(const tt::target::FabricConfig &config);
...
private:
  ...
  std::atomic<tt::target::FabricConfig> currentFabricConfig_ =
      tt::target::FabricConfig::DISABLED;
};
