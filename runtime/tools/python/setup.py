...
if enable_runtime:
    ...
    extra_files_three = package_files(f"{src_dir}/build/runtime/tools/python/ttrt/runtime/ttnn/")

    metallibs += extra_files_one
    metallibs += extra_files_two
    metallibs += extra_files_three
