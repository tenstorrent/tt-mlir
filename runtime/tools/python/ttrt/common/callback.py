...
def pre_callback(callback_runtime_config, binary, program_context, op_context):
...
def pre_get_callback_fn(callback_runtime_config):
    return partial(pre_callback, callback_runtime_config)


def post_callback(callback_runtime_config, binary, program_context, op_context):
...
def post_get_callback_fn(callback_runtime_config):
    return partial(post_callback, callback_runtime_config)
