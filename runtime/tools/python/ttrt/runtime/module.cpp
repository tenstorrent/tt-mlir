...
PYBIND11_MODULE(_C, m) {
  ...
  py::enum_<::tt::target::DataType>(m, "DataType")
      ...
      .value("BC_Float8", ::tt::target::DataType::BC_Float8)
      .value("BC_BFloat8", ::tt::target::DataType::BC_BFloat8)
      .value("BC_Float4", ::tt::target::DataType::BC_Float4)
      .value("BC_BFloat4", ::tt::target::DataType::BC_BFloat4)
      .value("BC_Float2", ::tt::target::DataType::BC_Float2)
      .value("BC_BFloat2", ::tt::target::DataType::BC_BFloat2)
