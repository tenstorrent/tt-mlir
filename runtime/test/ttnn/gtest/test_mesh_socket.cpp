...
// Pipeline-parallel basic: device-to-device socket round-trip between two 1x1
// submeshes of a [2,2] mesh over FABRIC_2D. See
// plans/pipeline-parallel-basic/implementation-plan.md (Phase 1, Task 1.5).
