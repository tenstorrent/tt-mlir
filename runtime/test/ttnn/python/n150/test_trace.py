...
def test_trace_memory_overwrite_multi_graph(helper: Helper, request, trace_region_size):
    """
    This test verifies that the two traced graphs do not overwrite each others memory.
    ...
    agains the current generation id of the cache. In case of mismatch, we re-capture & re-cache the trace to ensure that
