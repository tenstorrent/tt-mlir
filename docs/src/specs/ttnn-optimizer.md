...
#### 5.4.4 Backtracking Provides Little Practical Benefit
...
#### 5.6.1 Pass 1: L1 Sharding Propagation
...
#### 5.8.1 Beam Search for Layout Propagation
...
#### 5.8.2 Dynamic Programming for Optimal Spill Selection
