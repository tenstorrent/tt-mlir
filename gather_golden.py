                ...
                for a in range(output.shape[3]):
                    for b in range(output.shape[4]):
                        ...
                        for d_start in range(len(start_index_map)):
                            ...
                            clamped_index = max(0, min(start_index[d_start], operand.shape[d_operand] - slice_sizes[d_operand]))
                        ...
                        '''
                        zero_offset_indices = set(collapsed_slice_dims) | set(operand_batching_dims)
                        ...
                        '''
                        operand_index = [
                            full_start_index[d] + full_batching_index[d] + full_offset_index[d]
