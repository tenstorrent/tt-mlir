...
resolvePrepareConvTranspose2dWeightsParams(
  ...
  LOG_ASSERT(opT.input_memory_config, "Input memory config must be present for "
                                      "PrepareConvTranspose2dWeights");
...
PrepareConvTranspose2dWeightsOpResult callPrepareConvTranspose2dWeights(
  ...
  case CallType::QUERY_OP_CONSTRAINTS:
    return QUERY_OP_CONSTRAINTS(
        ...
        &targetDevice, *std::get<const ::ttnn::Tensor *>(weight),
    ...
    return ::ttnn::operations::conv::conv_transpose2d::
        prepare_conv_transpose2d_weights(
            *std::get<const ::ttnn::Tensor *>(weight), params.inputMemoryConfig,
            ...
            params.sliceConfig, opT.mirror_kernel);
  }
}
