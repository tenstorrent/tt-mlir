...
resolvePrepareConvTranspose2dBiasParams(
  ...
  LOG_ASSERT(
      ...
      "Input memory config must be present for PrepareConvTranspose2dBias");
...
PrepareConvTranspose2dBiasOpResult callPrepareConvTranspose2dBias(
  ...
  PrepareConvTranspose2dBiasResolvedParams params =
      resolvePrepareConvTranspose2dBiasParams(opT, callType);
  ...
  case CallType::QUERY_OP_CONSTRAINTS:
    return QUERY_OP_CONSTRAINTS(
        ...
        &targetDevice, *std::get<const ::ttnn::Tensor *>(bias),
        params.inputMemoryConfig, params.inputLayout, opT.in_channels,
        ...
        opT.groups, &targetDevice, params.inputDtype, params.outputDtype,
  ...
  case CallType::QUERY_OP_RUNTIME: {
    ...
    response.error_message =
        "Runtime query not implemented for PrepareConvTranspose2dBiasOp yet";
    return response;
  }
  case CallType::EXECUTE:
    return ::ttnn::operations::conv::conv_transpose2d::
        prepare_conv_transpose2d_bias(
            *std::get<const ::ttnn::Tensor *>(bias), params.inputMemoryConfig,
            params.inputLayout, opT.in_channels, opT.out_channels,
            opT.batch_size, opT.input_height, opT.input_width,
            params.kernelSize, params.stride, params.padding, params.dilation,
            opT.groups, &targetDevice, params.inputDtype, params.outputDtype,
            params.conv2dConfig, params.computeConfig, params.sliceConfig);
  }
