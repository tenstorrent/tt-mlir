...
EltwiseTernaryResolvedParams
resolveEltwiseTernaryParams(const tt::target::ttnn::EltwiseTernaryWhereOpT &eltwiseTernaryOpT);

template <typename Fn>
EltwiseTernaryOpResult callEltwiseTernary(
    CallType callType, const tt::target::ttnn::EltwiseTernaryWhereOpT &eltwiseTernaryWhereOpT,
    Fn eltwiseTernaryOp, TensorArg first, TensorArg second, TensorArg third, ::ttnn::MeshDevice *device = nullptr,
