...
def _main(v1): 
  ...
  v32 = ttnn.mesh_shard(v12, v19, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [8], [-1, 0])
  ttnn.deallocate(v12, False)
  v33 = ttnn.mesh_shard(v13, v19, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [1, 8], [-1, 1])
  ttnn.deallocate(v13, False)
  v34 = ttnn.mesh_shard(v14, v19, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [8], [-1, 0])
  ttnn.deallocate(v14, False)
  v35 = ttnn.mesh_shard(v15, v19, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [1, 8], [-1, 1])
  ttnn.deallocate(v15, False)
  v36 = ttnn.mesh_shard(v16, v19, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [8], [-1, 0])
  ttnn.deallocate(v16, False)
  v37 = ttnn.mesh_shard(v17, v19, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [1, 8], [-1, 1])
  ttnn.deallocate(v17, False)
  v38 = ttnn.mesh_shard(v18, v19, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [8, 1, 1, 1], [-1, 0])
  ...
  v42 = ttnn.reshape(v41, [1, 1, 50176, 3], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v54 = ttnn.conv2d(input_tensor=v53, weight_tensor=v50, device=v19, in_channels=3, out_channels=64, batch_size=1, input_height=224, input_width=224, kernel_size=[11, 11], stride=[4, 4], padding=[0, 0, 0, 0], dilation=[1, 1], groups=1, bias_tensor=v52, conv_config=None, compute_config=None, memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v58 = ttnn.max_pool2d(v57, 1, 54, 54, 64, [3, 3], [2, 2], [0, 0], [1, 1], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None), applied_shard_scheme=None, ceil_mode=False, in_place_halo=False)
  ...
  v69 = ttnn.conv2d(input_tensor=v58, weight_tensor=v66, device=v19, in_channels=64, out_channels=192, batch_size=1, input_height=26, input_width=26, kernel_size=[5, 5], stride=[1, 1], padding=[2, 2, 2, 2], dilation=[1, 1], groups=1, bias_tensor=v68, conv_config=None, compute_config=None, memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v73 = ttnn.max_pool2d(v72, 1, 26, 26, 192, [3, 3], [2, 2], [0, 0], [1, 1], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None), applied_shard_scheme=None, ceil_mode=False, in_place_halo=False)
  ...
  v116 = ttnn.max_pool2d(v115, 1, 12, 12, 256, [3, 3], [2, 2], [0, 0], [1, 1], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None), applied_shard_scheme=None, ceil_mode=False, in_place_halo=False)
  ...
  v118 = ttnn.reshape(v117, [1, 1, 1, 6400], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v126 = ttnn.reshape(v125, [1, 512], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v130 = ttnn.reshape(v129, [1, 1, 8, 512], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v138 = ttnn.reshape(v137, [1, 512], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v142 = ttnn.reshape(v141, [1, 1, 8, 512], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v150 = ttnn.reshape(v149, [1, 125], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v152 = ttnn.reshape(v151, [1, 1, 8, 125], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
