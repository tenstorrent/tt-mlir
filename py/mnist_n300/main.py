...
def _main(v1): 
  ...
  v14 = ttnn.mesh_shard(v2, v11, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [2], [-1, 0])
  ttnn.deallocate(v2, False)
  v15 = ttnn.mesh_shard(v3, v11, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [1, 2], [-1, 1])
  ttnn.deallocate(v3, False)
  v16 = ttnn.mesh_shard(v4, v11, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [2], [-1, 0])
  ttnn.deallocate(v4, False)
  v17 = ttnn.mesh_shard(v5, v11, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [1, 2], [-1, 1])
  ttnn.deallocate(v5, False)
  v18 = ttnn.mesh_shard(v6, v11, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [2], [-1, 0])
  ttnn.deallocate(v6, False)
  v19 = ttnn.mesh_shard(v7, v11, ttnn.MeshShardDirection.FullToShard, ttnn.MeshShardType.Devices, [1, 2], [-1, 1])
  ...
  v31 = ttnn.reshape(v30, [1, 512], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v37 = ttnn.reshape(v36, [1, 1, 32, 512], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v45 = ttnn.reshape(v44, [1, 256], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v51 = ttnn.reshape(v50, [1, 1, 32, 256], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v59 = ttnn.reshape(v58, [1, 128], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
  ...
  v65 = ttnn.reshape(v64, [1, 1, 32, 128], memory_config=ttnn.MemoryConfig(ttnn.TensorMemoryLayout.INTERLEAVED, ttnn.BufferType.DRAM, None))
